            ...
            <div class="x_content">
                ...
                ?>
                 ...
                 <?= Select2::widget([
                        ...
                        'data' => ['1'=> 'JANUARI - APRIL','2'=> 'MEI - OGOS', '3' => 'SEPTEMBER - DISEMBER'],
                ...
                'columns' => [
                    [
                       ...
                       [
                        ...
                        [
                          ...
                          [
                           'label' => 'Bil. Bulan Emolumen kurang 40%',
                           'value' => 'cnt'
                    ...
                    [
                        ...
                        'value' => function($model) {
                              if(($model->kakitangan->kewangan->tarikh_hantar != null) && ($model->kakitangan->kewangan->sesi == Yii::$app->request->queryParams['sesi']) && ($model->kakitangan->kewangan->tahun == Yii::$app->request->queryParams['tahun'])){
                                return $model->kakitangan->kewangan->reason;
                            }else{
                    ...
                    [
                        ...
                        'value' => function($model) {
                          if(($model->kakitangan->kewangan->tarikh_hantar != null) && ($model->kakitangan->kewangan->sesi == Yii::$app->request->queryParams['sesi']) && ($model->kakitangan->kewangan->tahun == Yii::$app->request->queryParams['tahun'])){
                                return $model->kakitangan->kewangan->tarikh_hantar;
                            }else{
                                return '<span class="label label-danger">Tiada Tindakan</span>';
                            }
                ...
                GridView::widget([
                    ...
                    [
                        ...
                        //      return  Html::button('<i class="fa fa-info" aria-hidden="true"></i> INFO', ['value' => \yii\helpers\Url::to(['keterhutangan/detail-view', 'id' => $data->sm_ic_no]), 'class' => 'mapBtn btn-sm btn-danger btn-block']);
                             return Html::a('<i class="fa fa-eye">', ["keterhutangan/detail-view", 'id' => $data->sm_ic_no,'tahun' => Yii::$app->request->queryParams['tahun'], 'sesi' => Yii::$app->request->queryParams['sesi']]);                   
