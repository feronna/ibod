...
?>
                    ...
                    <table class="table table-striped table-bordered jambo_table" >
                        <thead>
                            <th scope="col" colspan=17" width="30%" class="headings"><center>ELAUN PERPINDAHAN RUMAH<br>
                            <tr class="headings">
                            ...
                            <tr>
                                ...
                                <?php } ?>  
                                 ...
                                 <td class="text-left">
                                   ...
                                   <?= \yii\helpers\Html::a(' DOKUMEN SOKONGAN', Yii::$app->FileManager->DisplayFile($list->dokumen_sokongan), ['class'=>'fa fa-download', 'target' => '_blank'])?><br> 
                                ...
                                <?php if ($list->jeniskemudahan == '1') { ?>
                                <td style=" ">
                                 <?php if($list->isActive2 == '1' && $list->jeniskemudahan == '1'){?>
                                <div class="container" align="left">
                                <?= \yii\helpers\Html::a(' KELULUSAN KETUA BSM', ['borangperpindahan/slulus', 'id' => $list->id], ['class'=>'fa fa-download', 'target' => '_blank'])?></td>
                                <?php }?>  
                                <?php }?>
                                
                                <?php if ($list->stat_bendahari == 'MENUNGGU TINDAKAN' || $list->stat_bendahari == 'DALAM PROSES BAYARAN') { ?>
                                <td class="text-center"><?= Html::a('<i class="fa fa-eye">', ["borangperpindahan/tindakan_bendahari", 'id' => $list->id]); ?></td>
                                <?php } else { ?><td class="text-center"><?= Html::a('<i class="fa fa-eye">', ["borangperpindahan/tindakan_bendahari", 'id' => $list->id]); ?></td>
                                <?php } ?>
