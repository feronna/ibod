...
$sheet->setCellValue('A1', 'LAPORAN TUNTUTAN PERPINDAHAN PERUMAHAN');;
...
$writer->save("LAPORAN TUNTUTAN PERPINDAHAN PERUMAHAN.xlsx");
Yii::$app->response->redirect(['LAPORAN TUNTUTAN PERPINDAHAN PERUMAHAN.xlsx']);
?>
