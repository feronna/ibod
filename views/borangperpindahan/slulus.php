 ...
 <div style="margin-bottom:-12px; margin-left:-61px;margin-right:-61px; font-size: 10px;">
                 <table class="table table-sm table-bordered" style=" font-size: 10px;"  width:100%;>
                    ...
                    <tr> 
                     ...
                     <tr> 
                     <td style="width:30%" height="25px"><strong>TARIKH PERPINDAHAN RUMAH</strong></td>
                     <td style="width:70%" height="25px"><?= ucwords(strtoupper($facility->movedate))?></td> 
                     </tr>
                     ...
                     <tr> 
                     <td style="width:30%" height="25px"><strong>ALAMAT RUMAH LAMA</strong></td>
                     <td style="width:70%" height="25px"><?= $facility->old_add?></td> 
                     </tr>
                     
                     <tr> 
                     <td style="width:30%" height="25px"><strong>ALAMAT RUMAH BARU</strong></td>
                     <td style="width:70%" height="25px"><?= $facility->new_add?></td> 
                     </tr> 
...
<div style="margin-bottom:-12px; margin-left:-61px;margin-right:-61px; font-size: 10px;"> 
                  <table class="table table-sm table-bordered" style=" font-size: 10px; width:100%;">
                     ...
                     <?php }else{?>
                     <td style="width:70%"  height="25px"><?php echo 'Tidak Berkaitan'?> </td> 
                     <?php } ?>
                     </tr>
