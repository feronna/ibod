    ...
    <div class="x_panel">
        ...
        <thead>
                ...
                <tr>
                        ...
                        <td colspan="4">  
                          <?= $form->field($model, 'date_pindah')->textInput(['maxlength' => true, 'disabled'=>'disabled'])->label(false); ?>
                  ...
                  <tr>
                        ...
                        <td colspan="4"> 
                           ...
                           <?= $form->field($model, 'new_add')->textArea(['maxlength' => true, 'disabled'=>'disabled']) ->label(false);?> 
                        </div>
                          </td>
                ...
                <tr>
                        ...
                        <td colspan="4"> 
                           ...
                           <?= $form->field($model, 'old_add')->textArea(['maxlength' => true, 'disabled'=>'disabled']) ->label(false);?> 
                        </div>
                          </td>
