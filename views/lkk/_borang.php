        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                    ...
                    <tr>
                        ...
                        <td><?= $form->field($b, 'studentno')->textInput(['maxlength' => true]) ->label(false);?> 
                        </td>
                    </tr>
...
?></td> 
                    ...
                    <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">MODE OF STUDY:<br></th>
                        <td colspan="5">
                                  
                  <?= $form->field($b->mod, 'studyMode')->textInput(['maxlength' => true, 'size'=>100])->textInput(['disabled' => 'disabled'])->label(false); ?>
                 ...
                 {?>
                   <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">Current Mode of Study:<br> <i><small style="color:red">*Please Key In Your Mode of Study (For Unit Pengajian Lanjutan's Record)</small></i></th>
                        <td colspan="5">
                            <?=
                    $form->field($model, 'modeID')->label(false)->widget(Select2::classname(), [
                    'data' => ArrayHelper::map(app\models\cbelajar\Modpengajian::find()->where(['id'=>[11,12]])->all(), 'modeID', 'studyMode'),
                    'options' => ['placeholder' => 'Please Choose Your Study Mode', 'class' => 'form-control col-md-7 col-xs-12'],
                    'pluginOptions' => [
                        'allowClear' => true,
//                        'disabled'=> true,
                    ],
                 ...
                 <?php }?>
                    ...
                    <tr>
                        ...
                        <td> <?= $form->field($b, 'tajuk_tesis')->textArea(['maxlength' => true]) ->label(false);?> 
</td> 
                    </tr>
        ...
        {?>
          <div class="x_panel">
        <div class="x_title">
            <strong><i class="fa fa-user-secret"></i> SUPERVISOR'S DETAIL</strong><br>
           <i style="color:green">Please keyin your current supervisor details in the current semester.
               <br>If you does not have supervisor yet, just field the blanks, "Non"</i>
                    <div class="clearfix"></div>
        </div>
        <div class="x_content">
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                     ...
                     <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">NAME OF SUPERVISOR:</th>
                        <td> <?= $form->field($sv, 'nama')->textArea(['maxlength' => true]) ->label(false);?> 
</td> 
                    </tr>
                     <tr>
                         <th class="col-md-3 col-sm-3 col-xs-12">SUPERVISOR EMAIL <br> <i><small style="color:red">*Only One</small></i>:</th>
                        <td> <?= $form->field($sv, 'emel')->textInput(['maxlength' => true]) ->label(false);?> 
</td> 
                    </tr>
                    
                    <tr>
                         <th class="col-md-3 col-sm-3 col-xs-12">POSITION:</th>
                        <td> <?= $form->field($sv, 'jawatan')->textInput(['maxlength' => true]) ->label(false);?> 
</td> 
                    </tr>
  <tr>
                         <th class="col-md-3 col-sm-3 col-xs-12">DIVISION/FACULTY:</th>
                        <td> <?= $form->field($sv, 'jabatan')->textInput(['maxlength' => true]) ->label(false);?> 
</td> 
                    </tr>                  
        ...
        <div class="x_title">
            <strong><i class="fa fa-user-secret"></i> SUPERVISOR'S DETAIL</strong><br>
<!--           <i style="color:green">Please keyin your current supervisor details in the current semester.</i>-->
           <i style="color:green">Please keyin your current supervisor details in the current semester.
               <br>If you does not have supervisor yet, just field the blanks, "Non"</i>
                    <div class="clearfix"></div>
        </div>
        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                     ...
                     <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">NAME OF SUPERVISOR:</th>
                        <td> <?= $form->field($s, 'nama')->textArea(['maxlength' => true]) ->label(false);?> 
</td> 
                    </tr>
                     <tr>
                         <th class="col-md-3 col-sm-3 col-xs-12">SUPERVISOR EMAIL <br> <i><small style="color:red">*Only One</small></i>:</th>
                        <td> <?= $form->field($s, 'emel')->textInput(['maxlength' => true]) ->label(false);?> 
</td> 
                    </tr>
                    
                    <tr>
                         <th class="col-md-3 col-sm-3 col-xs-12">POSITION:</th>
                        <td> <?= $form->field($s, 'jawatan')->textInput(['maxlength' => true]) ->label(false);?> 
</td> 
                    </tr>
  <tr>
                         <th class="col-md-3 col-sm-3 col-xs-12">DIVISION/FACULTY:</th>
                        <td> <?= $form->field($s, 'jabatan')->textInput(['maxlength' => true]) ->label(false);?> 
</td> 
                    </tr>                  
...
:</th>
        ...
        <div class="x_panel">
        <div class="x_title">
            <strong><i class="fa fa-bar-chart-o"></i> STUDENT'S REPORT</strong> 
                    <div class="clearfix"></div>
        </div>
        <div class="x_content">
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                     <tr>
                         <th colspan='5' style="background-color:lightseagreen;color:white"><center>WRITING REPORT</center></th>
                    </tr>
