...
<?php }?>
<?php
                                $mod2 = \app\models\cbelajar\LkkDean::find()->where(['parent_id'=>2,'status'=>"MASTER", 'icno'=>$model->icno])->one();
if($mod2)
{?>
<div class="x_panel">
...
<?php
                                $mod3 = \app\models\cbelajar\LkkDean::find()->where(['parent_id'=>3,'status'=>"MASTER", 'icno'=>$model->icno])->one();
if($mod3)
{?>
<div class="x_panel">
...
//                             }
    ...
    <?php
                                $mod4 = \app\models\cbelajar\LkkDean::find()->where(['parent_id'=>4,'status'=>"MASTER", 'icno'=>$model->icno])->one();
if($mod4)
{?>
<div class="x_panel">
