...
<p align="right"><?= Html::a('Back', ['cb-lkk/a-view-rating?i='.$i.'&id='.$i], 
...
<div class="x_panel">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-2 ">
        <ul class="to_do">
            ...
            <a href="gambar">
            <li style="#f2f2f2">
                <p><b>             <?= Html::a('PROGRESS REPORT', ['lkk/tindakan-pp?id='.$i]) ?>
                </b></p><p>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12 col-lg-2 ">
        <ul class="to_do">
            ...
            <a href="gambar">
            <li style="#f2f2f2">
                <p><b>             <?= Html::a('SUPERVISOR RATING', ['cb-lkk/pp-view-rating?i='.$i]) ?>
                </b></p><p>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-2 ">
        <ul class="to_do">
            ...
            <li style="#f2f2f2">
                <p >
                    <b style='color:red'>             <?= Html::a('GOT SCHEDULE', ['lkk/p-achievement-master?i='.$i.'&id='.$id ]) ?></b>
            </p></li>                              
                            <?php    }
?>
     ...
     <div class="col-md-12 col-sm-12 col-xs-12 col-lg-2 ">
        <ul class="to_do">
            ...
            <a href="gambar">
            <li style="#f2f2f2">
                <p><b>             <?= Html::a('VERIFICATION', ['lkk/pengesahan-pp?id='.$i.'&icno='.$id]) ?>
                </b></p><p>
...
//                             }
 ...
 <p align="right"> <?= Html::a('Next', ['lkk/pengesahan-pp?id='.$model->reportID.'&icno='.$model->icno ], 
         ['class' => 'btn btn-primary btn-sm']) ?></p>     
<?php ActiveForm::end(); ?>
