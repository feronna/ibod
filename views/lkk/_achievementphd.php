...
error_reporting(0);
                $pd = app\models\cbelajar\LkkDean::find()->where(['icno'=>$icno,'dokumen'=>58])->all();

?> 
<?php echo $this->render('/cutibelajar/_topmenu'); ?>
<?php $form = ActiveForm::begin(['options' => ['class' => 'form-horizontal form-label-left']]); ?>
<p align="right"><?= Html::a('Back', ['lkk/senarailkk'], ['class' => 'btn btn-primary btn-sm'])
?></p>
<div class="x_panel">
    <div class="x_content">  
...
<div class="tile-stats" style='padding:10px'>
                        <div class="x_content">
                            ...
                            <div style='padding: 15px;' class="table-bordered">
                                ...
                                IF YOU HAVING TROUBLE ON SAVING THE STEP 1, STEP 2 AND STEP 3 SUCH AS WHEN YOU CLICK THE
...
<!--                    <h2>  <span class="label label-success">SEMESTER 1</span></h2>-->
        ...
        <!--                                    <td class="text-center"><input type="radio" name="<?= $kpi->id . 'result' ?>" value="y" <?php
                                        if ($mod->result) {
                                            if ($mod->result === 'y') {
                                                echo "checked";
                                            }
                                        ...
                                        ?>></td>-->
        <!--                                    <td class="text-center"><input type="radio" name="<?= $kpi->id . 'result' ?>" value="n" <?php
                                        if ($mod->result) {
                                            if ($mod->result === 'n') {
                                                echo "checked";
                                            }
...
//var_dump($dean->namafile);die;
                                                if (\app\models\cbelajar\LkkDean::find()->where(['icno' => $icno, 'dokumen' => $kpi->id])->orderBy(['created_dt' => SORT_DESC])->one()) {
                                                    ...
                                                    if ($dean->namafile) {
                                                        echo strtoupper($dean->comment). '<a class="form-control" style="background-color: transparent;border:0;box-shadow: none;" 
                                href=" ' . Url::to(Yii::$app->FileManager->DisplayFile($dean->namafile), true) . '" target="_blank" >
                                <i class="fa fa-download"></i> <strong><small><u> Download  </u></small></strong></a><br>';
...
//                             }
                            ...
                            ?>
                                    SUBMITTED FIRST LKP (SUPERVISOR): <?= $model->r_dt;?>
...
<!--                    <h2>  <span class="label label-success">SEMESTER 1</span></h2>-->
            ...
            <legend class="scheduler-border">   <h5><i class='fa fa-book'></i> PROPOSAL DEFENSE HISTORY</h5>
            </legend> 
            <?php
              if($pd){ ?>
              <p style="color:red"> 
                  *Proposal Defense can be updated from time to time. Just click the button edit below.
     </p>
            <div>
                <form id="w0" class="form-horizontal form-label-left" action="">
                    ...
                    <tr class="headings">
                                    <th class="text-center" rowspan="2" style="vertical-align:middle" width='5%'>BIL</th>
                                    <th class="text-center" rowspan="2" style="vertical-align:middle" width='10%'>SUBMISSION DATE</th>
                                    <th class="text-center" rowspan="2" style="vertical-align:middle" width='30%'>ACTIVITY</th>
                                    <th class="text-center" colspan="2" >ACTION</th>
                                    <th class="text-center" rowspan="2" style="vertical-align:middle">EVIDENCE/OUTPUT/<br>DATE SUBMITTED</th>
                    ...
                    <?php $bil=1; foreach ($pd as $akademik) { ?>

                        <tr>

                            <td><?= $bil++ ?></td>
                            <td><?= strtoupper($akademik->created_dt); ?></td>
                            <td><?= strtoupper($akademik->activity->activity); ?></td>
                           <td class="text-center">
                                            <p align="center">
                                                <?php
//                                                $dean = \app\models\cbelajar\LkkDean::find()->where(['icno' => $icno, 'dokumen' => 58])->orderBy(['created_dt' => SORT_DESC])->all();


                                                if ($akademik->result == 1) {
                                                    echo ' <i class="fa fa-check-circle  fa-lg" aria-hidden="true" style="color: green"></i>';
                                                } else {
                                                    echo '-';
                                                }
                           ...
                           <td class="text-center">
                                            <p align="center">
                                                <?php
//var_dump($dean->namafile);die;
                                                if (\app\models\cbelajar\LkkDean::find()->where(['icno' => $icno, 'dokumen' => 58])->orderBy(['created_dt' => SORT_DESC])->all()) {


                                                    if ($akademik->namafile) {
                                                        echo'<a class="form-control" style="background-color: transparent;border:0;box-shadow: none;" 
                                href=" ' . Url::to(Yii::$app->FileManager->DisplayFile($akademik->namafile), true) . '" target="_blank" >
                                <i class="fa fa-download"></i> <strong><small><u> Download  </u></small></strong></a>'
                                                        ;
                                                    } else {
                                                        echo '<small>'.strtoupper($akademik->comment).'</small>';
                                                    }
                                                }
//    else{
//     
...
//                 ;
              ...
              <?php }
                  ...
                  <tr>
                  <p style="color:red"><b> PLEASE KEY IN YOUR PROPOSAL DEFENSE STATUS</b></p>
                      <td class="text-center"><b> NO RECORD</b></td>
    ...
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            <div class="x_title">
                ...
                <h5 style='color:green'> <strong><i class="fa fa-bar-chart-o"></i> SEMESTER 5</strong> </h5>
...
//                 ;
                            ...
                            if ($no == 1) {
                                ...
                                <td rowspan='9'  class="text-center">
                                 ...
                                 $c = \app\models\cbelajar\DeanComment::find()->where(['icno' => $icno,'sem'=>5])->orderBy(['create_dt' => SORT_DESC])->one();
                                 if($c->d_comment)
                                 {?>
                                    <small><?= strtoupper($c->d_comment)?></small><br/>
    ...
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            <div class="x_title">
                ...
                <h5 style='color:green'> <strong><i class="fa fa-bar-chart-o"></i> SEMESTER 6</strong> </h5>
                        ...
                        <table class="table table-striped table-sm jambo_table table-bordered">
                            ...
                            if ($no == 1) {
                                ...
                                <td rowspan='9'  class="text-center">
                                 ...
                                 $c = \app\models\cbelajar\DeanComment::find()->where(['icno' => $icno,'sem'=>6])->orderBy(['create_dt' => SORT_DESC])->one();
                                 if($c->d_comment)
                                 {?>
                                    <small><?= strtoupper($c->d_comment)?></small><br/>
