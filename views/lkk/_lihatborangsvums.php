...
<p align="right">  <?= Html::a('Back', ['cb-lkk/view-lkk-ums', 'id'=>$model->icno], ['class' => 'btn btn-primary btn-sm']) ?></p>
        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped">
                    ...
                    <tr>
                        ...
                        <td><?= $model->maklumat->studentno; ?></td> 
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?= strtoupper($model->maklumat->tahapPendidikan); ?></td> 
                    </tr>
                    <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">PERIOD AND PLACE OF STUDY APPROVED:</th>
                        <td>(DARI) <?= strtoupper($model->maklumat->tarikhmula); ?> (HINGGA) <?= strtoupper($model->maklumat->tarikhtamat); ?>  |  <?= ucwords(strtoupper($model->maklumat->InstNm)) ?>  </td> 
                    </tr>
                    <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">THESIS TITLE:</th>
                        <td><?= $model->maklumat->tajuk_tesis; ?></td> 
                    </tr>
