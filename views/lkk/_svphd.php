...
<p align="right"><?= Html::a('Back', ['cb-lkk/view-penyelia?i='.$model->reportID], 
...
<div class="x_panel">
        ...
        <ul class="to_do">
            ...
            <a href="gambar">
            <li style="#f2f2f2">
                <p><b>             <?= Html::a('PROGRESS REPORT', ['cb-lkk/view-penyelia?i='.$model->reportID]) ?>
                </b></p><p>
...
?>
        ...
        <ul class="to_do">
            ...
            <a href="gambar">
            <li style="#f2f2f2">
                <p><b>             <?= Html::a('SUPERVISOR RATING', ['cb-lkk/rating?i='.$model->reportID]) ?>
                </b></p><p>
...
<p align="right"><?= Html::a('Next', ['cb-lkk/rating?i='.$model->reportID], 
         ['class' => 'btn btn-primary btn-sm']) ?></p>
<?php ActiveForm::end(); ?>
