        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped">
                    ...
                    <tr>
                        ...
                        <td>(DARI) <?= strtoupper($model->pengajian->tarikhmula); ?> (HINGGA) <?= strtoupper($model->pengajian->tarikhtamat); ?>  |   <?php 
...
?>
    ...
    echo Html::button('Muatnaik Semula Dokumen <i class="fa fa-pencil" aria-hidden="true"></i>', 
                    ['id' => 'modalButton', 
                    'value' => \yii\helpers\Url::to(['cbadmin/update-dokumen', 'id'=> $model->reportID]),
