                            ...
                            if ($no == 1) {
                               ...
                               <?= strtoupper($c->d_comment)?><br/>
                                    ...
                                    Html::button('COMMENT <i class="fa fa-plus" aria-hidden="true"></i>', ['id' => 'modalButton',
                                        'value' => \yii\helpers\Url::to(['comment-semm1?id=' . $model->reportID . '&icno=' . $id . '&sem=1']),
                                        'class' => 'btn btn-primary btn-xs mapBtn'])
                                    ;
                            }}
                                ?>
      ...
      <i class="fa fa-download"></i> <strong><small><u> Download  </u></small></strong></a>';
                            ...
                            if ($no == 1) {
                               ...
                               <?= strtoupper($c->d_comment)?><br/>
                                    ...
                                    <?=
                                    Html::button('COMMENT <i class="fa fa-plus" aria-hidden="true"></i>', ['id' => 'modalButton',
                                        'value' => \yii\helpers\Url::to(['comment-semm2?id=' . $model->reportID . '&icno=' . $id . '&sem=2']),
                                        'class' => 'btn btn-primary btn-xs mapBtn'])
                                    ;
                            }}
                                ?>
      ...
      <i class="fa fa-download"></i> <strong><small><u> Download  </u></small></strong></a>';
                            ...
                            if ($no == 1) {
                               ...
                               <?= strtoupper($c->d_comment)?><br/>
                                    ...
                                    <?=
                                    Html::button('COMMENT <i class="fa fa-plus" aria-hidden="true"></i>', ['id' => 'modalButton',
                                        'value' => \yii\helpers\Url::to(['comment-semm3?id=' . $model->reportID . '&icno=' . $id . '&sem=3']),
                                        'class' => 'btn btn-primary btn-xs mapBtn'])
                                    ;
                            }}
                                ?>
      ...
      <i class="fa fa-download"></i> <strong><small><u> Download  </u></small></strong></a>';
                            ...
                            <td rowspan='9'  class="text-center">
                               ...
                               <?= strtoupper($c->d_comment)?><br/>
                                    ...
                                    <?=
                                    Html::button('COMMENT <i class="fa fa-plus" aria-hidden="true"></i>', ['id' => 'modalButton',
                                        'value' => \yii\helpers\Url::to(['comment-semm4?id=' . $model->reportID . '&icno=' . $id . '&sem=4']),
                                        'class' => 'btn btn-primary btn-xs mapBtn'])
                                    ;
                            }}
                                ?>
...
//                             }
                                        ...
                                        <p align="right"> <?= Html::a('Next', ['lkk/pengesahan-kj?id='.$model->reportID.'&icno='.$model->icno ], 
         ['class' => 'btn btn-primary btn-sm']) ?></p>
<?php ActiveForm::end(); ?>
