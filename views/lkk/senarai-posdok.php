...
?>
  ...
  <p align="right"><?= Html::a('Kembali', ['lkk/statistik-pengajian-jabatan'], 
...
<div class="col-md-12 col-xs-12"> 
         <div class="x_title">
            <h5><strong><i class="fa fa-check-circle fa-lg" style="color:green"></i> SENARAI KAKITANGAN YANG MENGAMBIL POS DOKTORAL</strong></h5>
            <p align ="left">  <?=
                    ExportMenu::widget([
                            'dataProvider' => $dataProvider,
                            'columns' => $gridColumns,
                            'filename' => '_senarai_pos_doktoral '.' '.$my,
                            'clearBuffers' => true,
                            'stream' => false,
