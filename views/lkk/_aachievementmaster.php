...
<p align="right"><?= Html::a('Back', ['cb-lkk/a-view-rating?i='.$model->reportID.'&id='.$model->icno ], 
...
<div class="x_panel">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-2 ">
        <ul class="to_do">
            ...
            <a href="gambar">
            <li style="#f2f2f2">
                <p><b>             <?= Html::a('PROGRESS REPORT', ['lkk/adminview?id='.$i]) ?>
                </b></p><p>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12 col-lg-2 ">
        <ul class="to_do">
            ...
            <a href="gambar">
            <li style="#f2f2f2">
                <p><b>             <?= Html::a('SUPERVISOR RATING', ['cb-lkk/a-view-rating?i='.$i]) ?>
                </b></p><p>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-2 ">
        <ul class="to_do">
            ...
            <li style="#f2f2f2">
                <p >
                    <b style='color:red'>             <?= Html::a('GOT SCHEDULE', ['lkk/a-achievement-master?i='.$i.'&id='.$id ]) ?></b>
            </p></li>                              
                            <?php    }
?>
     ...
     <div class="col-md-12 col-sm-12 col-xs-12 col-lg-2 ">
        <ul class="to_do">
            ...
            <a href="gambar">
            <li style="#f2f2f2">
                <p><b>             <?= Html::a('VERIFICATION', ['lkk/pengesahan-admin?id='.$i.'&icno='.$id]) ?>
                </b></p><p>
...
//                                $mod = \app\models\cbelajar\LkkDean::find()->where(['parent_id'=>1,'idsem'=> $dok->id, 'icno'=>$id])->one();
                                         $dean = \app\models\cbelajar\LkkDean::find()->where(['icno'=>$model->icno,'dokumen'=>$dok->id])
                            ...
                            <td class="text-center">
                                <p align="center">
                                    <?php
                                    $dean2 = \app\models\cbelajar\LkkDean::find()->where(['icno' => $model->icno, 'dokumen' => $dok->id])
                                            ->orderBy(['created_dt' => SORT_DESC])->one();
//var_dump($dean->namafile);die;
                                    if (\app\models\cbelajar\LkkDean::find()->where(['icno' => $model->icno, 'dokumen' => $dok->id])
                                            ->orderBy(['created_dt' => SORT_DESC])->one()) {
                                        if ($dean2->namafile) {
...
//                                    }
     ...
     <?php
                                $mod3 = \app\models\cbelajar\LkkDean::find()->where(['parent_id'=>3,'status'=>"PHD", 'icno'=>$id])
                                        ->orderBy(['created_dt' => SORT_DESC])->one();
?>
<div class="x_panel">
...
//                             }
 ...
 <p align="right"> <?= Html::a('Next', ['lkk/pengesahan-admin?id='.$model->reportID.'&icno='.$model->icno ], 
         ['class' => 'btn btn-primary btn-sm']) ?></p>     
<?php ActiveForm::end(); ?>
