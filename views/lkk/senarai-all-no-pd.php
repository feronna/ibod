...
//            ],
    ...
    [
        ...
        'value' => function ($data) {
            //return Html::a(ucwords(strtoupper($data->sasaran3->tajukLatihan)));
            return strtoupper($data->mod->studyMode);
        },
        'format' => 'raw'
    ],
    [
                        ...
                        <div class="x_panel">
                            <div class="row"> 
                                ...
                                <div class="col-md-12 col-xs-12"> 
                                    <div class="x_title">
                                        <h5><strong><i class="fa fa-check-circle fa-lg" style="color:green"></i> SENARAI KAKITANGAN YANG <b style="color:red">TIDAK</b> <i>PASS PROPOSAL DEFENSE DI SEMESTER 2</i></strong></h5>
                                        <p align ="left">  <?=
                        ExportMenu::widget([
                            'dataProvider' => $dataProvider,
                            'columns' => $gridColumns,
                            'filename' => '_senarai_no_pd',
                            'clearBuffers' => true,
                            'stream' => false,
...
//                            'contentOptions' => ['class'=>'text-center'],
                                ...
                                return Html::a('<strong><small>' . strtoupper($model->InstNm) . '</small></strong><br>' .
                                        ...
                                        '<strong><small>' . strtoupper($model->mod->studyMode) . '</small></strong><br>');
                            },
                                    'format' => 'html',
                                ],
...
//                            'contentOptions' => ['class'=>'text-center'],
                                    'value' => function($model) {
                                if ($model->lkp->got->result == 2) {
                                    return '<b style="color:red">NO</b><br>'. '<small>'.$model->lkp->got->comment.'</small>';
                                } else {
                                    return 'NO RECORD';
                                }
