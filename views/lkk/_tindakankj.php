...
<div>
 ...
 <p align="right"><?= Html::a('Back', ['lkk/senaraitindakan'], 
...
?>
 ...
 <div class="row">
        ...
        <h6><strong><i class="fa fa-th-list"></i> SEMESTER DETAIL</strong></h6> 
                </div>
                </br>
...
<div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-heading">
        <h6><strong><i class="fa fa-user-circle"></i> STUDENT'S DETAIL</strong></h6> 
                </div>
                </br>
                <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
  ...
  <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-heading">
        <h6><strong><i class="fa fa-user-secret"></i> SUPERVISOR'S DETAIL</strong></h6> 
                </div>
                </br>
                <div class="table-responsive">
            <table class="table table-sm table-bordered jambo_table table-striped"> 
...
<div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-heading">
        <h6><strong><i class="fa fa-pencil-square"></i> COURSEWORK</strong></h6> 
                </div>
                </br>
                <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
 ...
 <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-heading">
        <h6><strong><i class="fa fa-check-square"></i> SUPERVISOR COMMENT</strong></h6> 
                </div>
                </br>
                <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
...
<p align="right"> 
  ...
  {?>
    ...
    <?= Html::a('Next', ['cb-lkk/kj-view-rating?i='.$model->reportID], 
