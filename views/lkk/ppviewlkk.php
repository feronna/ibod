...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div>
                <p align="right">  <?= Html::a('Kembali', ['/cutibelajar/senarai-staff-fakulti-pp'], ['class' => 'btn btn-primary btn-sm']) ?></p>
            </div>
            <div class="x_title">
...
<td>
                                        <?php if ($lkk->status_bsm == "Admin Manually Upload") {
                                            ?>
                   <?= Html::a('<i class="fa fa-file-pdf-o" aria-hidden="true"></i>', ['lkk/lihat-borang-pp', "id" => $lkk->reportID], ['class' => 'btn btn-default btn-xs'])
            ?>
                                                <?php } 
                                                
                                          elseif($lkk->agree == 1){?>
                                                    
                                                <?= Html::a('<i class="fa fa-bar-chart" aria-hidden="true"></i>', ['tindakan-pp', "i" => $lkk->reportID], ['class' => 'btn btn-default btn-xs'])?>
                                      <?php          } else{
                                          echo '-';
                                      }
?>
...
//                                 $lkk = app\models\cbelajar\TblLkk::find()->where(['icno'=> $id, 'reportID'=> $i, 'status_form'=>2])->one();
        ...
        <?php if ($lkk->status_bsm == "Admin Manually Upload") {
            ...
            ?>
                                        ...
                                        <?= Html::a('<i class="fa fa-bar-chart" aria-hidden="true"></i>', ['lkk/tindakan-pp', "i" => $lkk->reportID], ['class' => 'btn btn-default btn-xs'])
                                        ?> 
