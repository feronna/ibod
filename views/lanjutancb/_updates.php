...
<h5> <strong><center>KEMASKINI REKOD PELANJUTAN</center></strong> </h5>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_content">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12">JUSTIFIKASI PELANJUTAN:<span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                        <?= $form->field($model, 'justifikasi')->textArea(['maxlength' => true, 'rows' => 10])->label(false); ?>
