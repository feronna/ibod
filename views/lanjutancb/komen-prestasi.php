...
<h5> <strong><center>KEMASKINI PELARASAN TARIKH PENGHANTARAN LKK</center></strong> </h5>
...
?>
        ...
        <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12">SESI:<span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  
                        <td><?= $form->field($model, 'session')->textInput(['maxlength' => true]) ->label(false);?> 

                </div>
</div>
<div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12">TARIKH MULA HANTAR:<span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  
<?= $form->field($model, 'effectivedt')->widget(DatePicker::className(),
