...
<div class="col-md-12 col-xs-12"> 
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Pelupusan Harta</strong></h2>
                <div class="clearfix"></div>
            </div>
          
                  <div class="table-responsive">
                    <?php $form = ActiveForm::begin(['options' => ['class' => 'form-horizontal form-label-left']]); ?>
                      <p style="color:red">Adakah anda pasti ingin melupuskan rekod ini?</p>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <?=
                            $form->field($model, 'status_padam')->label(false)->widget(Select2::classname(), [
                            'data' => [1 =>'YA'],
