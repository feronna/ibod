        ...
        <div class="x_content">
            ...
            <div class="form-group">
                ...
                <?=
                            ...
                            'data' => [1 =>'Sendiri', 2 => 'Pasangan' , 3 => 'Anak'],
            ...
            <div class="form-group" id="daerah" >
               ...
               <?=  $form->field($model, 'AcqSrcCd')->widget(Select2::classname(), [
                        ...
                        <div id="Lain-lain" style="display: none">
                                        <?= $form->field($model, 'AcqSrcCd')->textInput()->label(false); ?>
                              </div>
                    </div>
                </div>
               ...
               <?=  $form->field($model, 'FinclSrcTypeCd')->widget(Select2::classname(), [
                            ...
                            'data' => \yii\helpers\ArrayHelper::map(Tblreffinancialsourcetype::find()->all(),'FinclSrcTypeCd', 'FinclSrcTypeNm'),
                             'options' => ['placeholder' => 'Pilih Sumber', 'class' => 'form-control col-md-7 col-xs-12',
                                    'onchange' => 'javascript:if ($(this).val() == "XX"){
                                    $("#Lain-lain Pinjaman").show();
                                         }
                                    else{
                                    $("#Lain-lain Pinjaman").hide();
                                    }'],
                        ...
                        <br>
                        <div id="Lain-lain Pinjaman" style="display: none">
                                        <?= $form->field($model, 'FinclSrcTypeCd')->textInput()->label(false); ?>
                              </div>
                    </div>
                </div>
            ...
            <div class="form-group">
               ...
               <div class="form-group" align="right">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12" >Tempoh bayaran balik Sumber Kewangan<span class="required" style="color:red;">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?= $form->field($model, 'FinclSrcRepaymtPeriod')->textInput(['maxlength' => true])->label(false) ?>
                </div>
            </div>
            
              <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12" >Ansuran Bulanan Sumber Kewangan(RM)<span class="required" style="color:red;">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12" align="left">
                       <?=
              ...
              <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Tarikh Mula Bayar Ansuran Bulanan<span class="required" style="color:red;">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
          <?= $form->field($model, 'FinclSrcInstlmtStDt')->widget(DatePicker::classname(), [
                            'name' => 'FinclSrcInstlmtStDt',
                            'value' => date('d-m-Y'),
                            'template' => '{addon}{input}',
                            'clientOptions' => [
                             'autoclose' => true,
              ...
              <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Tarikh Akhir Bayar Ansuran Bulanan<span class="required" style="color:red;">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                   <?= $form->field($model, 'FinclSrcInstlmtEndDt')->widget(DatePicker::classname(), [
                            'name' => 'FinclSrcInstlmtEndDt',
                            'value' => date('d-m-Y'),
                            'template' => '{addon}{input}',
                            'clientOptions' => [
                                'autoclose' => true,
