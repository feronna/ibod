...
<div class="x_panel">
<?php 
   echo $this->render('_menu3', ['title' => $title]) ;      
                ...
                <tbody>
                 ...
                 ?></td>
                     ...
                     ?></td>
                           ...
                           <td align= 'center' ><?=Html::button('', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['mohon2', 'id' => $maklumats->id]),'style'=>'background-color: transparent; 
