    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <table class="table table-sm table-bordered " style="text-align:center">
             ...
             <div class="form-group">
                     <?= Html::a('Mesyuarat JTKK', ['urus-mesyuarat'], ['class' => 'btn btn-primary']) ?>
                </div>
             </div>
        </div>
    </div>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value'=>function ($data){
                                    ...
                                    return Html::a('<i class="fa fa-edit">', ["harta/tindakans", 'id' => $data->id]);
                                 
                              
                              //    .   Html::a('<i class="fa fa-eye">', ["harta/borang", 'id' => $data->id]);
