...
<div class="col-md-12 col-sm-12 col-xs-12 ">
    <div class="form_wizard wizard_horizontal">
        <ul class="wizard_steps">
                ...
                <li>Langkah<br /> <br /> 
                    <a href="<?= Url::toRoute(['harta/pelupusan'])?>">   
                    ...
                    <span class="step_descr"> 
                        ...
                        if ($title == "Pelupusan") {
                            echo '<box2><i class="fa fa-arrow-right" aria-hidden="true"></i>&nbsp;&nbsp;Pelupusan&nbsp;Harta&nbsp;&nbsp;<i class="fa fa-money" aria-hidden="true"></i></box2><br/><br/>';
                        } else {
                            echo '<box>Pelupusan&nbsp;Harta&nbsp;&nbsp;<i class="fa fa-money" aria-hidden="true"></i></box><br/><br/>';
                        }
             ...
             <li>Langkah<br /> <br /> 
                   <a href="<?= Url::toRoute(['harta/pengakuan-pegawai2'])?>">   
