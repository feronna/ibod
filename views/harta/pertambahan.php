...
<div class="col-md-12 col-xs-12"> 
    ...
    <p>
        <?= Html::a('Tambah', ['tambah-harta'], ['class' => 'btn btn-success']) ?>
    </p>
            ...
            <table class="table table-sm table-bordered">
                ...
                ?>
                     ...
                     <td class="text-center"> <?= Html::a('<i class="fa fa-info" aria-hidden="true"></i>', ['detail-harta', 'id' => $item->id]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['kemaskini-harta', 'id' => $item->id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['padam-tambah-harta', 'id' => $item->id], [
                         'data' => [
