...
$gridColumnsK = [
    ...
    [
        ...
        'headerOptions' => [
            ...
            [
                'attribute' => 'check',
                'label' => 'TELAH ISYTIHAR <span class="fa fa-check">',
                'encodeLabel' => false,
//                                    'label' => 'JUMLAH',
                'vAlign' => 'middle',
                'hAlign' => 'center',
...
//            return Department::countProposalDefense($model->id, 0);
                    return Html::a(app\models\harta\TblHarta::countSelesai($model->id, 0));
                },
                    ...
                    [
                        'attribute' => 'times',
                        'label' => 'BELUM ISYTIHAR <span class="fa fa-times">',
                        'encodeLabel' => false,
                        'vAlign' => 'middle',
                        'hAlign' => 'center',
                        'format' => 'raw',
...
//                                                  },
                        'value' => function ($model)  {
                            return Html::a(app\models\harta\TblHarta::countBelumSelesai($model->id, 0));
                        },
...
//                                                  },
                        'value' => function ($model)  {
                            return Html::a(app\models\harta\TblHarta::countKeseluruhan($model->id, 0));
                        },
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                             <h5><i class="fa fa-briefcase"></i> Jumlah Periytiharan Harta Mengikut JAFPIB</h5>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
