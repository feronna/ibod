...
<div > 
    <div class="x_panel"> 
        ...
        <div class="form-group" id="tempoh" ><br><br>
            ...
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Dimuat Naik : <span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <a class="form-control" style="border:0;box-shadow: none;" href="<?php echo yii\helpers\Url::to(Yii::$app->FileManager->DisplayFile($dokumen->dokumen), true); ?>" target="_blank" ><i></i><u>Dokumen.pdf</u></a><br>
