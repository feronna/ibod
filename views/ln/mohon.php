        ...
        <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function($ln) { return $ln->dateFrom  . " - " . $ln->dateTo ;}, 
                            'format'=>'raw',
                            'hAlign' => 'center',
                        ],
                        [
    ...
    <div class="x_panel" >
        ...
        <div class="table-responsive"> 
            <div class="col-md-10 col-sm-10 col-xs-12"> 
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-4">Tujuan Aktiviti:<span class="required" style="color:red;">*</span></label>        
                    <div class="col-md-8 col-sm-8 col-xs-10"> 
                    <?= $form->field($model, 'tujuan_aktiviti')->widget(Select2::classname(), 
                                ['data' => ArrayHelper::map(\app\models\ln\Refaktiviti::find()->all(), 'aktiviti', 'aktiviti'),
                                'options' => [
                                    'placeholder' => 'Pilh Tujuan Aktiviti'],
                            ])->label(false); ?>
                    </div>
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2 col-sm-2 col-xs-4">Tarikh Mula Aktiviti:<span class="required" style="color:red;">*</span></label>  
                    <div class="col-md-3 col-sm-3 col-xs-10"> 
                    <?= $form->field($model, 'start_aktiviti')->widget(DatePicker::className(),
                    ...
                    <label class="control-label col-md-2 col-sm-2 col-xs-4">Tarikh Akhir Aktiviti:<span class="required" style="color:red;">*</span></label>   
                    <div class="col-md-3 col-sm-3 col-xs-10"> 
                      <?= $form->field($model, 'end_aktiviti')->widget(DatePicker::className(),
                              ['clientOptions' => ['changeMonth' => true,'yearRange' => '1996:2099','changeYear' => true, 'format' => 'yyyy-mm-dd', 'autoclose' => true],
                              'options' => [ 'placeholder' => 'Pilih tarikh ']])->label(false);?>   
                    </div>
                                </div>
...
<!--                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <?= $form->field($model, 'date_from')->widget(DatePicker::className(),
                        ...
                        today.setMinutes(0);
                        today.setSeconds(0);
                        if (Date.parse(today)+1814400000 > Date.parse(t)) {
                            alert("Permohonan perjalanan adalah kurang daripada 21 hari, sila pastikan permohonan dibuat dalam 21 hari sebelum tarikh permohonan untuk mengelakkan sebarang masalah. Permohonan lewat dari tempoh tersebut hendaklahlah disertakan dengan alasan/justifikasi yang kukuh.");
                            $(this).val() = NULL;
                        }
//                         else {
//                           alert("");
//                        }' ]])->label(false);?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-10"> 
                    <?= $form->field($model, 'justifikasi')->textArea(['maxlength' => true, 'placeholder' => 'Justifikasi/alasan permohonan yang lewat (perjalanan yang kurang 21 hari dari tarikh perjalanan)']) ->label(false);?>
                    </div>
                </div> 
                <div class="form-group">
