...
<!--    <= ucwords(strtolower($letter->jawatan->nama))?><br>  jawatan hakiki -->
    <?= ucwords(strtolower($letter->adminpos->adminpos->position_name))?><br> <!--jawatan pentadbiran -->
<!--    (<?= $letter->jawatan->gred?>)-->
    <?=ucwords(strtolower($letter->adminpos->dept->fullname)) ?>
    <br> 
...
<div style="margin-bottom: 10px">
    <br><strong>PERMOHONAN BERTUGAS RASMI KE LUAR NEGARA</strong><br>
</div>
...
<div style="margin-bottom: 15px; text-align:justify">
    2.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adalah dimaklumkan bahawa, YBhg. Prof. Datuk ChM. Dr. Naib Canselor, <b>tidak meluluskan</b> Permohonan
            ...
            <div class="table-responsive">
                <table style="vertical-align:11px; font-size: 12px; border: 1px solid black; border-collapse: collapse;"  width="100%">
                    ...
                    <tr style ="border: 1px solid #000;">
                        ...
                        <td style="border: 1px solid black"><?= strtoupper($model->nama_tempat)?></td>
                    </tr>
                    <tr style ="border: 1px solid #000;">
                        <th style="text-align:center;">TUJUAN</th> 
                        <td style="border: 1px solid black"><?= strtoupper($model->nama_lawatan) ?></td>
                    </tr>
                    <tr style ="border: 1px solid #000;">
                        <th style="text-align:center;">JUMLAH ROMBONGAN</th>
                        <td style="border: 1px solid black"><?= strtoupper($model->bil_peserta) ?> ORANG</td>
                    </tr>
                    <tr style ="border: 1px solid #000;">
                        <th style="text-align:center;">ULASAN</th>
                        <td style="border: 1px solid black"><b><?= strtoupper($model->ulasan_admin) ?></b></td>
                    </tr>
                </table>
             </div>
        </div><br>
            
3.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sila ambil maklum bahawa permohonan bertugas rasmi ke luar negara yang lengkap hendaklah dikemukakan 
ke pejabat ini selewat-lewatnya dua (2) minggu dari tarikh perjalanan. 
<br>
Pihak
                <?php  if ($letter->TitleCd == 'P019'){
                echo  'Puan';
            ...
            ?> hendaklah memastikan perkara ini tidak berlaku lagi di masa akan datang untuk mengelak sebarang implikasi terhadap perkhidmatan
             <?php  if ($letter->TitleCd == 'P019'){
                echo  'Puan.';
                }
                if ($letter->TitleCd == 'L001'){
            ...
            ?>
                <br><br>
Kerjasama dan perhatian pihak  <?php  if ($letter->TitleCd == 'P019'){
                echo  'Puan';
                }
                if ($letter->TitleCd == 'L001'){
                echo  'Tuan';
            ...
            ?> dalam perkara ini amat dihargai dan saya dahului dengan ucapan ribuan terima kasih.
                <br><br>
