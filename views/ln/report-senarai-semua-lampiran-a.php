...
//    else{
//    {
        $phpExcel = PhpOffice\PhpSpreadsheet\IOFactory::load('uploads/rekodlantikan/template-rekod-senarai-semua-lampiran-a.xls');
//    }
...
$writer->save("Senarai Rekod Lampiran A.xlsx");
Yii::$app->response->redirect(['Senarai Rekod Lampiran A.xlsx']);
?>