...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            ...
            <p align="right"> 
                <?php 
                echo Html::a('<i class="fa far fa-hand-point-up"></i> Cetak Borang', ['cetak-ln1-pemohon', 'id' => $model->id,
                    'target'=>'_blank'], [
        ...
        <div class="table-responsive">
            <div class="col-md-10 col-sm-10 col-xs-12"> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-10"> 
                    <?= $form->field($model, 'faedah_lawatan')->textArea(['disabled'=>'disabled', 'maxlength' => true, 'placeholder' => 'Nama seminar yang dihadiri']) ->label(false);?>
                    </div>
                </div>
                <div class="form-group">
