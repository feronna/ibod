...
//    else{
//    {
        $phpExcel = PhpOffice\PhpSpreadsheet\IOFactory::load('uploads/rekodlantikan/template-rekod-senarai-rekod-ln1.xls');
//    }
...
// $sheet->setCellValue('K'.$i , "Jumlah");
//   if($bulan != 00){
//       $sheet->setCellValue('L'.$i ,'RM '. $model->getTotalYear($tahun,$bulan));
//   }
//   else{
//       $sheet->setCellValue('L'.$i ,'RM '. $model->getTotal($tahun,$bulan));
//   }  
