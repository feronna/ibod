                ...
                <table style="vertical-align:11px; font-size: 12px; border: 1px solid black; border-collapse: collapse;"  width="100%">
                    ...
                    <tr style ="border: 1px solid #000;">
                        ...
                        <td style="border: 1px solid black"><?= strtoupper($model->bil_peserta) ?> ORANG
                            ...
                            ?>
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?= $bil++ ?>. <?= strtoupper($pesertakakitangan->kakitangan->gelaran->Title) ?>&nbsp;<?= $pesertakakitangan->kakitangan->CONm; ?></p>
                               <?php } 
                            } else{
                                ?>                      
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;Tiada Rekod</p>                     
                    ...
                    <tr style ="border: 1px solid #000;">
                        ...
                        <td style="border: 1px solid black"><b>&nbsp;<?= strtoupper($model->kod_peruntukan_cn) ?> (RM<?= strtoupper($model->jumlah3) ?>)</b></td>
                    </tr>
                </table>
             </div>
        </div><br>
