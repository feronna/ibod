...
<!--            <p align="right"><?= \yii\helpers\Html::a('Kembali', ['semakan-nc'], ['class' => 'btn btn-primary']) ?></p>      -->
...
<!--    <div class="col-md-12 col-xs-12" style="display: <?php if($model->status != 'DALAM TINDAKAN BSM'){echo 'none';}?>">
    <div class="x_panel">
        <div class="x_title">
            <h2><strong><i class="fa fa-book"></i> Status Perakuan BSM</strong></h2>
            <ul class="nav navbar-right panel_toolbox">
                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
    ...
    <div class="x_panel">
        ...
        <div class="col-md-10 col-sm-10 col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?=
                    $form->field($model, 'jumlah3')->widget(NumberControl::classname(), [
                         'name' => 'jumlah3',
                           'pluginOptions'=>[
                           'initialize' => true,
                                                    ],
            ...
            <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="wp_id">Status Kelulusan:<span class="required" style="color:red;">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?=
                        $form->field($model, 'status_nc')->label(false)->widget(Select2::classname(), [
                            'data' => ['Diluluskan' => 'PERMOHOHAN DILULUSKAN', 'Tidak Diluluskan' => 'PERMOHONAN DITOLAK'],
                            'options' => ['placeholder' => 'Pilih', 'class' => 'form-control col-md-7 col-xs-12',
                                'onchange' => 'javascript:if ($(this).val() == "Diperakui"){
                            $("#ulasan").show();
                            }
            ...
            <div class="form-group" id="ulasan" style="display: none">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?= $form->field($model, 'ulasan_nc')->textArea(['maxlength' => true, 'rows' => 4])->label(false); ?>
                    </div>
            </div>
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
