...
<div class="table-responsive">
    ...
    <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?= Html::activeLabel($model, 'status_kad'); ?>
            <i class="fa fa-info-circle fa-xs" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Status"></i>
        </label>
        <div class="col-md-6 col-sm-6 col-xs-12">

            <?php
            echo $form->field($model, 'status_kad')->dropDownList(
                $data,
                ['prompt' => 'Sila Pilih...']
            )->label(false);
            ?>
    ...
    <div class="form-group">
        ...
        <?= $form->field($model, 'app_remark')->textarea(['rows' => 4])->label(false); ?>
