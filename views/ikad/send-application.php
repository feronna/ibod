...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            ...
            <?php } ?>
            <br>
            <?= Html::a('<i class="fa fa-arrow-left"></i>&nbsp;Back', ['ikad/index'], ['class' => 'btn btn-warning']) ?>

            <?php echo Html::a(
                    'Confirm & Submit',
                    [
                        '/ikad/send', 'id' => Yii::$app->getRequest()->getQueryParam('id')
                    ],
                    ['name' => 'verify', 'class' => 'btn btn-success', 'data' => ['confirm' => 'Are You Sure to Submit . You cannot change after submitting?']]
                ) ?>
        </div>
