...
<h5> <strong><center>KEMASKINI AKSES PENGGUNA </center></strong> </h5>
<div> 
    <div class="x_panel"> 
        ...
        <div class="form-group">
         ...
         <div class="form-group"> 
                <label class="control-label col-md-3 col-sm-3 col-xs-12">JENIS AKSES PENGGUNA:</label>
                <div class="col-md-3 col-sm-6 col-xs-12">
                <?=
                    $form->field($model, 'access_level')->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(RefAkses::find()->orderBy(['id' => SORT_ASC])->all(), 'id', 'access_level'),
...
//                        'hideSearch' => true,
        ...
        <div class="form-group"> 
               ...
               <?php
                                ...
                                dropDownList(['1' => 'AKTIF ',
                                              '0' => 'TIDAK AKTIF', 
                                            
                                            ],['prompt'=>'Pilih Status'])->label(false);
?>
                </div>
