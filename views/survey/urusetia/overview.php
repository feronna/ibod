        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="pull-right">
                    <?= Html::a('<i class="fa fa-arrow-left"></i>&nbsp;Sebelumnya', ['senarai-pengundi', 'id' => $id], ['class' => 'btn btn-warning']) ?>
                    <?= Html::a('<i class="fa fa-list"></i>&nbsp;Kembali ke senarai aktiviti', ['senarai-aktiviti'], ['class' => 'btn btn-primary']) ?>
                </div>
            </div>
        </div>
    </div>
