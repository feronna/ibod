    ...
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        $form->field($model, 'icno')->label(false)->widget(Select2::classname(), [
                            'data' => ArrayHelper::map(Tblprcobiodata::findAll(['Status' => 1]), 'ICNO', 'displayTitleName'),
                            'options' => ['placeholder' => 'Pilih Nama staff', 'class' => 'form-control col-md-7 col-xs-12'],
                            'pluginOptions' => [
                                'allowClear' => true
                            ],
                        ]);
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12"><?= Html::activeLabel($model, 'akses'); ?>
                    </label>
                ...
                <div class="form-group">
                    ...
                    <?= Html::a('<i class="fa fa-arrow-left"></i>&nbsp;Kembali', ['senarai-akses', 'id' => $model->id], ['class' => 'btn btn-warning']); ?>
