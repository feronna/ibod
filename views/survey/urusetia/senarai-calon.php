...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <?= Html::beginForm(['senarai-calon', 'id' => $id], 'GET', ['class' => 'form-horizontal form-label-left disable-submit-buttons']); ?>
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label">Mempunyai PHD ?</label>

            <div class="col-md-6 col-sm-6 col-xs-6">
                <?= Html::checkbox('phd', $phd, ['class' => '']) ?>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">Gred 51 dan e atas ?</label>

            <div class="col-md-6 col-sm-6 col-xs-6">
                <?= Html::checkbox('gred', $gred, ['class' => '']) ?>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">Tidak Kurang dari 3 tahun sebelum bersara ?</label>

            <div class="col-md-6 col-sm-6 col-xs-6">
                <?= Html::checkbox('tempoh', $tempoh, ['class' => '']) ?>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">Lantikan Tetap Sahaja ?</label>

            <div class="col-md-6 col-sm-6 col-xs-6">
                <?= Html::checkbox('tetap', $tetap, ['class' => '']) ?>
            </div>
        </div>
        ...
        <div class="pull-right">
            ...
            <?= Html::a('Seterusnya&nbsp;<i class="fa fa-arrow-right"></i>', ['senarai-pengundi', 'id' => $id], ['class' => 'btn btn-success']) ?>
        </div>
    </div>
</div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm jambo_table table-bordered">
                        ...
                        <?php if ($kakitangan) { ?>
                            ...
                            <?= Html::submitButton('Tetapkan sebagai calon&nbsp;<i class="fa fa-arrow-right"></i>', ['class' => 'btn btn-primary pull-right', 'data' => ['disabled-text' => 'Please Wait..']]) ?>
                            <?php ActiveForm::end() ?>
                        <?php } else { ?>
                            <tr>
