...
<div class="col-md-12">
   <div class="x_panel">
        <div class="x_title">
            <h2>Kemaskini Syarat Tambahan</h2>
            <p align="right" >
    ...
    <?php $form = ActiveForm::begin(['options' => ['class' => 'form-horizontal form-label-left'], 'method' => 'post']); ?>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <?= $form->field($lihatSyarat, 'syarat_tambahan')->textarea(['maxlength' => true, 'rows' => 4])->label(false); ?>
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                ...
                <?= Html::a('Kembali', ['my-portfolio/lihat-kelayakan'], ['class'=>'btn btn-warning']) ?>
            </div>
        </div>
            <?php ActiveForm::end();?>
