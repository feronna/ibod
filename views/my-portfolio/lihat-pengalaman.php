...
<?php
  ...
  echo Html::a(Yii::t('app','Kelayakan Akademik'), ['/my-portfolio/lihat-kelayakan','id' => $deskripsi->id], ['class' => 'btn btn-success']);
  echo Html::a(Yii::t('app','Kompetensi'), ['/my-portfolio/lihat-kompetensi','id' => $deskripsi->id], ['class' => 'btn btn-success']);
  echo Html::a(Yii::t('app','Pengalaman'), ['/my-portfolio/lihat-pengalaman','id' => $deskripsi->id], ['class' => 'btn btn-warning']);
...
<div class="col-md-12 col-xs-12"> 
    <div class="x_panel">
        ...
        <div class="x_content">
         ...
         <?= Html::a('Tambah', ['my-portfolio/pengalaman', 'id' => $deskripsi->id], ['class' => 'btn btn-primary']) ?>
                      <p style="color:red">* Wajib melengkapkan dan menyimpan maklumat didalam 'maklumat Umum' sebelum mengisi 'Pengalaman'</p>
                <table class="table table-sm table-bordered">
                  
                     <tr>
                         <th width="50px" align="center"> Bil. </th>
                         <th><strong>PENGALAMAN</strong></th>
                         <th width="50px"><strong>TINDAKAN</strong></th>
                    </tr>
                     <?php if($pengalaman) {
                ...
                ?>
                    <tr>
                            ...
                            <?= $item->tempoh?> <?= $item->pengalaman?></td>
                              <td class="text-center"><?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['my-portfolio/kemaskini-pengalaman', 'id' => $item->id,'portfolio_id' => $item->portfolio_id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['delete-pengalaman', 'id' => $item->id,'portfolio_id' => $item->portfolio_id], [
                         'data' => [
