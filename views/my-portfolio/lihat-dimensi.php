...
<?php
  ...
  echo Html::a(Yii::t('app','Tujuan Pewujudan Jawatan'), ['/my-portfolio/tujuan-jawatan','id' => $deskripsi->id], ['class' => 'btn btn-success']);
  echo Html::a(Yii::t('app','Akauntabiliti'), ['/my-portfolio/lihat-akauntabiliti','id' => $deskripsi->id], ['class' => 'btn btn-success']);
  echo Html::a(Yii::t('app','Dimensi'), ['/my-portfolio/lihat-dimensi','id' => $deskripsi->id], ['class' => 'btn btn-warning']);
  echo Html::a(Yii::t('app','Kelayakan Akademik'), ['/my-portfolio/lihat-kelayakan','id' => $deskripsi->id], ['class' => 'btn btn-success']);
  echo Html::a(Yii::t('app','Kompetensi'), ['/my-portfolio/lihat-kompetensi','id' => $deskripsi->id], ['class' => 'btn btn-success']);
  echo Html::a(Yii::t('app','Pengalaman'), ['/my-portfolio/lihat-pengalaman','id' => $deskripsi->id], ['class' => 'btn btn-success']);
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
              <div class="table-responsive">
                    <?= Html::a('Tambah', ['my-portfolio/dimensi', 'id' => $deskripsi->id], ['class' => 'btn btn-primary']) ?>
             <p style="color:red">* Wajib melengkapkan dan menyimpan maklumat didalam 'maklumat Umum' sebelum mengisi 'Dimensi'</p>
                <table class="table table-sm table-bordered">
            
                         
                    <tr>
                        <th>Bil.</th>
                          <th width="700px" align="center"><strong>DIMENSI</strong></td>
                          <th width="700px" align="center"><strong>SKOP</strong></td>
                ...
                ?>
                    <tr>
                            ...
                            <td>
                            <?= $item->dimensi?>
                            <td><?= $item->dimensi_utama?> </td>
                                <td class="text-center"><?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['kemaskini-dimensi', 'id' => $item->id, 'portfolio_id' => $item->portfolio_id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['delete-dimensi', 'id' => $item->id, 'portfolio_id' => $item->portfolio_id], [
                         'data' => [
