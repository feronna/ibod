                        ...
                        <tbody>
                            <?php foreach ($model as $rows) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?= Html::a('<i class="fa fa-envelope">', ["keselamatan/letter", 'id' => md5($rows->icno), 'tahun' => $tahun, 'bulan' => $month, 'color' => $color], ['target' => '_blank']); ?></td>
                                    <td class="text-center"><?= Html::a('<i class="fa fa-file-text-o">', ["keselamatan/report", 'id' => $rows->icno, 'tahun' => $tahun, 'bulan' => $monthBefore], ['target' => '_blank']); ?></td>
                                    <td class="text-center"><?= Html::a('<i class="fa fa-file-text-o">', ["keselamatan/report-ot", 'id' => $rows->icno, 'tahun' => $tahun, 'bulan' => $monthBefore], ['target' => '_blank']); ?></td>
                                    <td class="text-center"><?= Html::a('<i class="fa fa-flag">', ["keselamatan/report", 'id' => $rows->icno, 'tahun' => 2019, 'bulan' => $monthBefore], ['target' => '_blank']); ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
