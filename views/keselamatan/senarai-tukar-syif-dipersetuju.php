...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12"> 
        <div class="x_panel">
            <div class="x_title">
                <h2><strong><i class="fa fa-list"></i> Permohonan Tukar Syif</strong></h2>
                    ...
                    <table class="table table-striped table-sm jambo_table table-bordered">
                        <thead>
                            <tr class="headings">
                                ...
                                <th class="text-center">Syif Pemohon</th>
                                <th class="text-center">Penganti</th>
                                <th class="text-center">Syif Penganti</th>
                        ...
                        <?php foreach ($model as $models) { ?>
                            <tr>
                                ...
                                <td class="text-center"  style="text-align:center"><?= $models->tarikh_permohonan ?></td>                                
                                ...
                                <td class="text-center"  style="text-align:center"><?= Html::button('<i class="fa fa-edit"></i>', ['value' => Url::to(['keselamatan/pegawai-luluskan-penukaran', 'id' => $models->id]), 'class' => 'mapBtn', 'id' => 'modalButton']) ?></td>
