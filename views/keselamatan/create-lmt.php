...
use app\models\kehadiran\RefLmt;
...
<!--<div class="col-md-12">--> 
    <div class="x_panel">
        <div class="x_title">
            <h5><i class="fa fa-plus-circle"></i>&nbsp;ADD NEW LMT <strong><?= $staffname; ?></strong>
        ...
        <div class="x_content">
            ...
            <?php foreach ($models as $k => $v) { ?>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" ><?php echo date("d/m/Y (l)", strtotime($tarikh)) ?> :
                    </label>

                    <div class="col-md-4 col-sm-4 col-xs-6">

                        <?=
                        $form->field($v, "[$k]lmt_id")->label(false)->widget(Select2::classname(), [
