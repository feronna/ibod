...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <?= Html::beginForm(['clock-patrol'], 'GET'); ?>
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($data) {
                                    ...
                                    $check = TblRekodPatrol::find()->where(['icno' => $data->icno])->andWhere(['patrol_id' => Yii::$app->getRequest()->getQueryParam('id')])->exists();

                                    if($check) {
                                        $validate = TblRekodPatrol::find()->where(['icno' => $data->icno])->andWhere(['patrol_id' => Yii::$app->getRequest()->getQueryParam('id')])->one();
                                        if ($validate->icno == $data->icno) {
                                    ...
                                    return Html::a('<input type="checkbox" name="' . $data->icno . '" value="patrol' . $data->icno . '" ' . $checked1 . ' >');
                                },
