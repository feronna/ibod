...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12"> 
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Laporan Yang Telah Disahkan</strong></h2>
                        ...
                        <thead>
                            ...
                            <?php foreach ($verified as $r) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?= Html::a('<i class="fa fa-eye">', ["keselamatan/verifying-report", 'syif'=>$r->syif,'date' => $r->date,'id'=>Yii::$app->user->identity->ICNO]); ?></td>
