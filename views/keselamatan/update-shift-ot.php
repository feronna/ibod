...
<div class="x_panel">
    <div class="x_title">
        <h5><i class="fa fa-pencil"></i>&nbsp;UPDATE SHIFT FOR <strong><?= $staffname; ?></strong> 
            <div class="pull-right"><i class="fa fa-calendar"></i>&nbsp;<strong><?= TblRekodOt::viewBulan($bulan) . ' ' . $tahun?></strong></div></h5>
    ...
    <div class="x_content">
        ...
        <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <?= Html::submitButton('<i class="fa fa-floppy-o"></i>&nbsp; Kemaskini Shift', ['class' => 'btn btn-success']) ?>
            </div>
        </div>
