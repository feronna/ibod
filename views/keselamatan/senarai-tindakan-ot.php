                ...
                <div class="table-responsive">
                    <table class="table table-sm table-bordered jambo_table"  style="font-size: 11px">
                        ...
                        <?php if ($lulus_ot) { ?>
                            ...
                            ?>
                            <?php foreach ($lulus_ot as $senarai) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $senarai->statusAllOt; ?></td>
                                    <td><?php echo $senarai->remark; ?></td>
                                    <td class="text-center"><?= Html::a('<i class="fa fa-edit">', ["keselamatan/pengesahan-ot", 'id' => $senarai->id]); ?></td>
                                </tr>
                            <?php } ?>
