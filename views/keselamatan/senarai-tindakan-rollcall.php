                        ...
                        <?php if ($lulus) { ?>
                            ...
                            <?php foreach ($lulus as $senarai) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $senarai->formatdate; ?></td>
                                    <td class="text-center"><?php echo $senarai->statusH; ?></td>
                                    <td><?php echo $senarai->remark; ?></td>
                                    <td class="text-center"><?= Html::a('<i class="fa fa-edit">', ["keselamatan/pengesahan-rollcall", 'id' => $senarai->id]); ?></td>
                                </tr>
                            <?php } ?>
