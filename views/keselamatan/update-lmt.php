...
<div class="x_panel">
    <div class="x_title">
        <h5><i class="fa fa-pencil"></i>&nbsp;Kemaskini Lebihan Masa Tambahan Untuk <strong><?= $staffname; ?></strong> 
    ...
    <div class="x_content">
        ...
        <?php foreach ($models as $index => $model) { ?>
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="lmt_id"><?php echo date("d/m/Y (l)", strtotime($model->tarikh)) ?> :
                </label>

                <div class="col-md-4 col-sm-4 col-xs-6">

                    <?=
                    $form->field($model, "[$index]lmt_id")->label(false)->widget(Select2::classname(), [
