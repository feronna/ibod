...
/* @var $model app\models\keselamatan\TblRekodSearch */
...
<div class="tbl-rekod-search">
    ...
    <?php // echo $form->field($model, 'incomplete') ?>
    ...
    <?php // echo $form->field($model, 'in_lat_lng') ?>

    <?php // echo $form->field($model, 'out_lat_lng') ?>

    <?php // echo $form->field($model, 'ot_in_lat_lng') ?>

    <?php // echo $form->field($model, 'ot_out_lat_lng') ?>
