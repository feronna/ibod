...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <?= Html::beginForm(['manual-rollcall'], 'GET'); ?>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($data) {
                                ...
                                $validate = app\models\keselamatan\TblRollcall::find()->where(['anggota_icno' => $data->icno])->andWhere(['date' => Yii::$app->getRequest()->getQueryParam('date')])->andWhere(['type' => 'H'])->andWhere(['!=', 'status', 'SIMPAN'])->one();
                                if ($validate) {
                        ...
                        [
                            ...
                            'format' => 'raw',
                            'value' => function ($data) {
                                $syif = RefShifts::syif(Yii::$app->getRequest()->getQueryParam('id'));
                                $validation = app\models\keselamatan\TblRollcall::find()->where(['anggota_icno' => $data->icno])->andWhere(['date' => Yii::$app->getRequest()->getQueryParam('date')])->andWhere(['type' => 'H'])->andWhere(['IN', 'syif', $syif])->one();
                                if ($validation) {


                                    if ($validation->THBH == 0) {
                                        // echo 'd';die;
                                        $checked1 = 'checked disabled';
                        ...
                        [
                            ...
                            'value' => function ($data) {
                                ...
                                $validate = app\models\keselamatan\TblRollcall::find()->where(['anggota_icno' => $data->icno])->andWhere(['date' => Yii::$app->getRequest()->getQueryParam('date')])->andWhere(['type' => 'H'])->andWhere(['IN', 'syif', $syif])->one();
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($data) {
                                    ...
                                    $validate = app\models\keselamatan\TblRollcall::find()->where(['anggota_icno' => $data->icno])->andWhere(['date' => Yii::$app->getRequest()->getQueryParam('date')])->andWhere(['type' => 'LMJ'])->andWhere(['IN','syif', $syif])->andWhere(['!=', 'status', 'SIMPAN'])->one();
                                    if ($validate) {
                                        $checked1 = 'checked disabled';
                                    } else {
                                        $checked1 = 'disabled';
                            ...
                            [
                                ...
                                'value' => function ($data) {
                                    $syif = RefShifts::syif(Yii::$app->getRequest()->getQueryParam('id'));
                                    $validation = app\models\keselamatan\TblRollcall::find()->where(['anggota_icno' => $data->icno])->andWhere(['date' => Yii::$app->getRequest()->getQueryParam('date')])->andWhere(['type' => 'LMJ'])->andWhere(['IN','syif',$syif])->one();

                                  
                                    if ($validation) {
                                      if ($validation->THBLMJ == 0) {
                                            $checked1 = 'checked disabled';
                                            //                                //npending utk rejected tp baru kena simpan
                                        } else {
                                            $checked1 = 'disabled';
                            ...
                            [
                                ...
                                'value' => function ($data) {
                                    $syif = RefShifts::syif(Yii::$app->getRequest()->getQueryParam('id'));
                                    $validate = app\models\keselamatan\TblRollcall::find()->where(['anggota_icno' => $data->icno])->andWhere(['date' => Yii::$app->getRequest()->getQueryParam('date')])->andWhere(['type' => 'LMJ'])->andWhere(['IN','syif',$syif])->one();
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($data) {
                                    ...
                                    $validate = app\models\keselamatan\TblRollcall::find()->where(['anggota_icno' => $data->icno])->andWhere(['date' => Yii::$app->getRequest()->getQueryParam('date')])->andWhere(['type' => 'LMT'])->andWhere(['IN','syif', $syif])->andWhere(['!=', 'status', 'SIMPAN'])->one();
                                    if ($validate) {
                                        $checked1 = 'checked disabled';
                                    } else {
                                        $checked1 = 'disabled';
                            ...
                            [
                                ...
                                'value' => function ($data) {
                                    ...
                                    $validation = app\models\keselamatan\TblRollcall::find()->where(['anggota_icno' => $data->icno])->andWhere(['date' => Yii::$app->getRequest()->getQueryParam('date')])->andWhere(['type' => 'LMT'])->andWhere(['IN','syif', $syif])->one();

                                    if ($validation) {
                                       
                                        if ($validation->THBLMT == 0) {
                                            $checked1 = 'checked disabled';
                                            //                                //npending utk rejected tp baru kena simpan
                                        } else {
                                            $checked1 = 'disabled';
                            ...
                            [
                                ...
                                'value' => function ($data) {
                                    ...
                                    $validate = app\models\keselamatan\TblRollcall::find()->where(['anggota_icno' => $data->icno])->andWhere(['date' => Yii::$app->getRequest()->getQueryParam('date')])->andWhere(['type' => 'LMT'])->andWhere(['IN','syif', $syif])->one();
