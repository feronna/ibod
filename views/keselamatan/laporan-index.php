                        ...
                        <table class="table table-striped table-sm jambo_table table-bordered">
                            ...
                            <?php foreach ($var as $k => $v) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"  style="text-align:center"><?= (TblRekod::DisplayShift($icno, $v) != '-') ? Html::button('<i class="fa fa-eye"></i>', ['value' => Url::to(['keselamatan/detailrekod', 'icno' => $icno, 'tarikh' => $v]), 'class' => 'mapBtn', 'id' => 'modalButton']) : ''; ?></td>
                                </tr>
                            <?php } ?>
                        </table>
                    </div>
