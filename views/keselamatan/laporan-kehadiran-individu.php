...
use yii\helpers\ArrayHelper;use app\models\keselamatan\TblRekod;
use yii\helpers\Url;
    ...
    <div class="col-xs-12 col-md-12 col-lg-12"> 
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <?= Html::beginForm(['laporan-kehadiran-individu', 'id' => $icno], 'GET'); ?>
...
<?php if ($var != null) { ?>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form id="w0" class="form-horizontal form-label-left" action="/basic/web/index.php?r=kehadiran%2Fremark&amp;id=51" method="post">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Warna Kad
                            </label>
    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12"> 
            <div class="x_panel">
                <div class="x_title">
                    <h2><strong><i class="fa fa-list"></i> Laporan Kehadiran Hakiki</strong></h2>
                        ...
                        <table class="table table-striped table-sm jambo_table table-bordered">
                            ...
                            <?php foreach ($var as $k => $v) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"  style="text-align:center"><?= (TblRekod::DisplayShift($icno, $v) != '-') ? Html::button('<i class="fa fa-eye"></i>', ['value' => Url::to(['keselamatan/detailrekod', 'icno' => $icno, 'tarikh' => $v,'type'=>1]), 'class' => 'mapBtn', 'id' => 'modalButton']) : ''; ?></td>
                                </tr>
                            <?php } ?>
                        </table>
                    </div>
