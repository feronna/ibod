        ...
        <div class="x_content">
            ...
            <div class="row">
                ...
                <div style="background-color:lightblue" class="col-xs-12 col-md-3">
                    ...
                    echo Html::a($cr, ['keselamatan/add-patrol-pos']);
                    ?>
                </div>
                <div class="col-xs-12 col-md-3">
                    ...
                    echo Html::a($ck, ['keselamatan/add-patrol-staff']);
                    ?>
                </div>
                <div class="col-xs-12 col-md-3">
                    <br>
        ...
        <div class="x_content">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?= $form->field($patrol, 'jenis_shifts')->textInput(['maxlength' => true, 'rows' => 4])->label(false); ?>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?= $form->field($patrol, 'details')->textArea(['maxlength' => true, 'rows' => 4])->label(false); ?>
                </div>
            </div>
        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function ($data) {
                        return Html::button('', ['id' => 'modalButton', 'value' => Url::to(['update-patrol', 'id' => $data->id]), 'class' => 'fa fa-pencil mapBtn']);
                    },
                    'vAlign' => 'middle',
                    'hAlign' => 'center',
                ],
