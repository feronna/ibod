...
<div class="col-md-5 col-sm-5 col-xs-12 col-lg-5">
    <div class="x_panel">
        <div class="x_title">
            <h2><i class="fa fa-clock-o"></i>&nbsp;Kehadiran Keselamatan (Jadual Hakiki Sahaja)</h2>
        ...
        <h1 class="text-center align-center">
            <a href="../keselamatan/index1" class="btn-sm btn-info" target="_blank"><i class="fa fa-clock-o"></i>&nbsp;Lebih Masa Berjadual</a>
            <a href="../keselamatan/index2" class="btn-sm btn-info" target="_blank"><i class="fa fa-clock-o"></i>&nbsp;Lebih Masa Tambahan</a>
        </h1>
        ...
        <div class="x_content text-center">
            ...
            <?php if ($wp_id != 1 && $wp_id != 2 && $wp_id != 40 && $wp_id != NULL) { ?>
                ...
                <h2>&nbsp;<strong><?php echo $model_wp->jenis_shifts; ?></strong></h2>
