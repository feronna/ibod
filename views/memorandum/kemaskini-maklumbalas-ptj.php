...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
               <p align="right" >
                    <?php echo Html::a('Kembali', ['tambah-maklumbalas', 'id_rekod' => $model->id_rekod, 'id_perkara' => $model->id_perkara], ['class' => 'btn btn-primary btn-sm']); ?>  
               
                </p>
                <h2><i class="fa fa-book"></i>&nbsp;<strong>Kemaskini Maklumbalas Memorandum</strong></h2>
                <hr>
            <div class="x_content">
