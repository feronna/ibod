...
$statusLabel = [
        0 => '<span class="label label-danger">BELUM DIPERAKU</span>',
        1 => '<span class="label label-success">DIPERAKU</span>',
...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
                  <p align="right" >
                    <?php echo Html::a('Kembali', ['senarai-memorandum-ptj'], ['class' => 'btn btn-primary btn-sm']); ?>  
            ...
            <div class="x_content">
                <form id="w0" class="form-horizontal form-label-left" action="">
                    ...
                    <tr class="headings">
                        ...
                        <th class="column-title">Kemaskini </th>
                    </tr>
                  ...
                  <?php if($senarai) {
                        ...
                        <tr>
                          ...
                          if($options['open'] == true ){
                                if($senarai->status_kj == 0){
                                    echo Html::a('<i class="fa fa-edit" aria-hidden="true"></i>', ['kemaskini-maklumbalas-ptj', 'id_rekod' => $senarai->id_rekod, 'id_perkara' => $senarai->id_perkara, 'id' => $senarai->id], ['class' => 'btn btn-default']);
                                }else{
                                    echo 'TELAH DIPERAKUKAN';
                                }
                          }else{
                              echo Html::a('<i class="fa fa-edit" aria-hidden="true"></i>', ['kemaskini-maklumbalas-ptj', 'id_rekod' => $senarai->id_rekod, 'id_perkara' => $senarai->id_perkara, 'id' => $senarai->id], ['class' => 'btn btn-default disabled']);
...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
                <h2><i class="fa fa-book"></i>&nbsp;<strong>Maklumbalas Memorandum</strong></h2>
                <hr>
            <div class="x_content">
