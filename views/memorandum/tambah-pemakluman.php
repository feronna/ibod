...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
                ...
                <h2><i class="fa fa-book"></i>&nbsp;<strong>Pemakluman Pegawai</strong></h2>
                <hr>
            <div class="x_content">
        ...
        <div class="panel-body">
            ...
            <?php foreach ($modelMakluman as $i => $modelMakluman): ?>
             ...
             <div class="form-group">
                ...
                <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="wp_id">Nama Pegawai :<span class="required" style="color:red;">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                      <?=
                    $form->field($modelMakluman, "[{$i}]icno")->label(false)->widget(Select2::classname(), [
