...
//        ], 
                 ...
                 if($data->tblMaklumbalasPtj2->maklumbalas_ptj != null){
                         return 
                           $data->tblMaklumbalasPtj2->MaklumbalasJafpib($data->id);
                      }else{
             ...
             if($data->tblRekod->status == 1){
                ...
                [
                        ...
                        'value' => function ($data) {
                                ...
                                Html::a('<i class="fa fa-plus" aria-hidden="true"></i>', ['tambah-maklumbalas', 'id_rekod' => $data->tblRekod->id, 'id_perkara' => $data->id], ['class' => 'btn btn-default']);
                                    }else{
                                return   Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['detail-memorandum', 'id' => $data->tblRekod->id,  'id_perkara' => $data->id], ['class' => 'btn btn-default']);
