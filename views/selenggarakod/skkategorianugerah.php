...
/* @var $searchModel app\models\hronline\KategoriAnugerahSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Kategori Anugerah';
?>
<div class="kategori-anugerah-index">
    ...
    <p>
        ...
        <?= Html::a('Tambah Kategori Anugerah', ['tk_kategorianugerah?id='], ['class' => 'btn btn-primary']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            ['class' => 'yii\grid\ActionColumn',
             'header'=>'Tindakan',
             'template' => '{tk_kategorianugerah}',
               'buttons'=>[
                'tk_kategorianugerah' => function($url){
