...
<!--    <div class="x_panel">        
    <div class="row"> 
         <div class="x_panel">
        <div class="x_title">
            <h2><strong><i class="fa fa-list"></i> Permohonan Tuntutan Staf Secara Atas Talian(On-line): Pakaian Istiadat</strong></h2>
        ...
        <div class="x_content">
            ...
            <select class="form-control"id="foo">
             <option value="" disabled selected>Pakaian Istiadat</option>
