...
$sheet->setCellValue('A1', 'LAPORAN TUNTUTAN PAKAIAN ISTIADAT');;
...
$writer->save("LAPORAN TUNTUTAN PAKAIAN ISTIADAT.xlsx");
Yii::$app->response->redirect(['LAPORAN TUNTUTAN PAKAIAN ISTIADAT.xlsx']);
?>
<a href="<?php echo Url::to('@web/'.'hello worldsssssss.xlsx', true); ?>" target="_blank" ><i class="fa fa-download"></i> Laporan Tuntutan Pakaian Istiadat</a><br>
