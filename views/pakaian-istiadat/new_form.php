...
?>
 ...
 <?php $form = ActiveForm::begin(['options' => ['class' => 'form-horizontal form-label-left disable-submit-buttons']]); ?>
        ...
        <div class="x_panel">
        <div class="x_title">
            <h2><strong><i class="fa fa-user"></i> PENGISIAN PERMOHONAN PAKAIAN ISTIADAT</strong></h2>
        ...
        <thead>
                <th scope="col" colspan=12" width="30%" style="background-color:lightgrey;"><center>MAKLUMAT TUNTUAN PAKAIAN ISTIADAT</center></th>
                <tr>
                ...
                <tr>
                        ...
                        <td colspan="5">  
                            <div class="col-md-6 col-sm-6 col-xs-10"> 
                              <?= $form->field($model, 'jeniskemudahan')->textInput(['disabled'=>'disabled', 'value' =>  'Pakaian Istiadat'])->label(false)?>
                            </div>
                        </td>
                </tr>
                <tr>
