    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
         ...
         <?= Html::a('Kembali', ['data/dashboard'], ['class' => 'btn btn-primary btn-sm']) ?>
            ...
            <div class="x_title">
                <h2><strong>JUMLAH KAKITANGAN CUTI BELAJAR KAMPUS KOTA KINABALU</strong></h2>
<!--                <p align="right"><= \yii\helpers\Html::a('Kembali', ['halaman-utama-keseluruhan'], ['class' => 'btn btn-primary']) ?></p>   -->
           ...
           <?php
            echo ExportMenu::widget([
                ...
                'exportConfig' => [ // set styling for your custom dropdown list items
                    ...
                    ExportMenu::FORMAT_EXCEL_X =>
                        [
                            ...
                            'config' => [
                                'methods' => [
                                    'SetHeader' => ['Senarai Kakitangan Cuti Belajar Kampus KK'],
                                ]
                            ],
                        ],
                ...
                'filename' => 'Senarai Kakitangan Cuti Belajar Kampus KK',
                'asDropdown' => false,
            ]);
