...
<!--         <div class="x_title">
    ...
    <div class="x_title">
            <h5><strong>SENARAI GRED 48 - 54</strong></h5>
...
<?php
  echo Html::a(Yii::t('app','<i class="fa fa-users"></i> <span class="label label-success">GRED 48-54</span>'), ['data/search'], ['class' => 'btn btn-default btn-lg']);
  echo Html::a(Yii::t('app','<i class="fa fa-university"></i> <span class="label label-info">KESELURUHAN</span>'), ['data/search-all'], ['class' => 'btn btn-default btn-lg']);
...
<div class="x_panel">
    ...
    <div class="x_panel">
        <div class="x_title">
            <p style="font-size:18px;font-weight: bold;">REKOD KAKITANGAN AKADEMIK DAN PENTADBIRAN (GRED 48 - 54)</p>
            <div class="clearfix"></div>
        </div>
        <div class="x_content">
