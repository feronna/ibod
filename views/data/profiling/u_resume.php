...
//        echo 'No data - (SUMBER + elnpt.tbl_blended_learning)';
            ...
            <h5><b>4.1 SUPERVISION BY RESEARCH (UMS)</b></h5>
            <?php
            $penyeliaan = $biodata->penyeliaan2PHD;
...
//            echo 'No data (PHP) - (SUMBER + dbo.Ext_HR02_Penyeliaan)';
            ...
            <?php
            $penyeliaanM = $biodata->penyeliaan2MASTER;
...
//            echo 'No data (PHP) - (SUMBER + dbo.Ext_HR02_Penyeliaan)';
            ...
            <?php
            $penyeliaanPHIL = $biodata->penyeliaan2PHIL;
            ...
            if ($penyeliaanPHIL) {
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-bordered jambo_table table-striped">  
                        ...
                        <?php
                        $counter = 0;
                        foreach ($penyeliaanPHIL as $penyeliaan) {
...
//            echo 'No data (PHP) - (SUMBER + dbo.Ext_HR02_Penyeliaan)';
            ...
            <h5><b>4.2 SUPERVISION BY RESEARCH (EXTERNAL)</b></h5>
...
//            echo 'No data (PHP) - (SUMBER + dbo.Ext_HR02_Penyeliaan)';
            ...
            <h5><b>4.3 SUPERVISION BY MIXED MODE</b></h5>

            <?php
            $penyeliaanMMPHD = $biodata->penyeliaan2PHDModCampuran;
            ...
            if ($penyeliaanMMPHD) {
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-bordered jambo_table table-striped">  
                        ...
                        <?php
                        $counter = 0;
                        foreach ($penyeliaanMMPHD as $penyeliaan) {
...
//            echo 'No data (PHP) - (SUMBER + dbo.Ext_HR02_Penyeliaan)';
            ...
            <?php
            $penyeliaanMMMASTER = $biodata->penyeliaan2MASTERModCampuran;

            if ($penyeliaanMMMASTER) {
                ?> 
                <div class="table-responsive">
                    <table class="table table-sm table-bordered jambo_table table-striped">  
                        <tr>
                        ...
                        <?php
                        $counter = 0;
                        foreach ($penyeliaanMMMASTER as $penyeliaan) {
                        ...
                        foreach ($outreaching as $outreaching) {
                            if ($outreaching->ApproveStatus == 'V') {
                                ...
                                <tr>
                                    ...
                                    <td><?= $outreaching->TarikhMula ? $outreaching->TarikhMula : ' '; ?> <?= $outreaching->TarikhAkhir ? $outreaching->TarikhAkhir : ' '; ?></td> 
                                </tr> 
                                <?php
                            }
                        }
