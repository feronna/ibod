...
<?php
  ...
  echo Html::a(Yii::t('app',' SENARAI LATIHAN 2020-2022'), ['senarai-latihan'], ['class' => 'btn btn-warning']);
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                ?>
                    ...
                    <?= $form->field($searchModel, 'tajukLatihan')->textInput(['placeholder' => 'Tajuk Latihan','style'=>'width:1000px'])->label(false) ?> 
                   ...
                   <?=
                            $form->field($searchModel, 'kategoriJawatanID')->label(false)->widget(Select2::classname(), [
                         //   'data' => ArrayHelper::map(Kumpulankhidmat::find()->all(), 'id', 'name'),
                              'data' => ['AKADEMIK' => 'AKADEMIK', 'PENTADBIRAN' => 'PENTADBIRAN', 'Terbuka' => 'TERBUKA'],
                             'options' => ['placeholder' => 'Pilih Kategori Jawatan', 'class' => 'form-control col-md-7 col-xs-12'],
                            'pluginOptions' => [
                                'allowClear' => true
                                ],
                            ]);
...
$forms = ActiveForm::begin([
    'action' => ['senarai-latihan',  'page' => Yii::$app->getRequest()->getQueryParam('page')],
    'method' => 'post',
]);
?>
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Senarai Latihan 2020-2022 Dihadiri</strong></h2>
                <ul class="nav navbar-right panel_toolbox">
                </ul>
                <div class="clearfix"></div>
   ...
   [
                    ...
                    [
                       ...
                       [
                        ...
                        'value' => 'kategoriJawatanID'
                    ],

                    [
                        'label' => 'JENIS LATIHAN',
                        'value' => 'jenisLatihanID'
                    ],
...
//                            'value'=>function ($data) {
//
//                          $pelulusId = $data->kursusLatihanID;
//     
//                          return Html::radioList("kategori_latihan[$pelulusId]",$pelulusId,([1=>'KEPIMPINAN', 0 => 'BUKAN KEPIMPINAN']));
//                        
//
//                        }, 
//                        
...
//                        ],
                        ...
                        return Html::a('<input type="radio" name="'.$data->kursusLatihanID.'" value="1'.$data->kursusLatihanID.'" '."$checked".'> <span class="label label-success">KEPIMPINAN</span>').'  '.Html::a('<input type="radio" name="'.$data->kursusLatihanID.'" value="0'.$data->kursusLatihanID.'" '.$checked1.'> <span class="label label-danger">BUKAN KEPIMPINAN</span>');
                      },
