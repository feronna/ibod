...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
                 <p align="right"> 
         <?= Html::a('Kembali', ['data/dashboard'], ['class' => 'btn btn-primary btn-sm']) ?>
        </p>
            <div class="x_title">
                <h2><strong>JUMLAH KAKITANGAN KESELURUHAN
                    (TANPA MENGAMBIL KIRA PROF ADJUNG) KAMPUS SANDAKAN</strong></h2>
            ...
            echo ExportMenu::widget([
                ...
                'columns' => [
                    ...
                    [
                       ...
                       ->andWhere(['campus.campus_id'=>3])->all(),
                        'ICNO', 'CONm'),
                ...
                'exportConfig' => [ // set styling for your custom dropdown list items
                    ...
                    ExportMenu::FORMAT_EXCEL_X =>
                        [
                            ...
                            'config' => [
                                'methods' => [
                                    'SetHeader' => ['Senarai Kakitangan Keseluruhan Kampus Sandakan'],
                                ]
                            ],
                        ],
                ...
                'filename' => 'Senarai Kakitangan Keseluruhan Kampus Sandakan',
                'asDropdown' => false,
            ]);
