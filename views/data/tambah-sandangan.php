        ...
        <div class="x_content">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?=
                    $form->field($models, 'gredjawatan')->label(false)->widget(Select2::classname(), [
                        'data' => $gredJawatan,
             ...
             <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Status Sandangan<span class="required" style="color:red;">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?=
                    $form->field($models, 'sandangan_id')->label(false)->widget(Select2::classname(), [
                        'data' => $senaraiSandangan,
                        'options' => ['placeholder' => 'Pilih', 'class' => 'form-control col-md-7 col-xs-12'],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?=
                    $form->field($models, 'ApmtTypeCd')->label(false)->widget(Select2::classname(), [
                        'data' => $jenisLantikan,
                        'options' => ['placeholder' => 'Pilih', 'class' => 'form-control col-md-7 col-xs-12'],
                        'pluginOptions' => [
                            'allowClear' => true
