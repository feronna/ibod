...
<!--         <div class="x_title">
    ...
    <div class="x_title">
            <h5><strong>SENARAI AKTIVITI - UNIVERSITI</strong></h5>
...
<?php
  echo Html::a(Yii::t('app','<i class="fa fa-users"></i> <span class="label label-info">KOMUNITI</span>'), ['data/senarai-aktivitikomuniti'], ['class' => 'btn btn-default btn-lg']);
  echo Html::a(Yii::t('app','<i class="fa fa-university"></i> <span class="label label-success">UNIVERSITI</span>'), ['data/senarai-aktivitiuniversiti'], ['class' => 'btn btn-default btn-lg']);
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                $form = ActiveForm::begin([
                    'action' => ['senarai-aktivitiuniversiti'],
                    'method' => 'get',
                    'options' => [
                        'data-pjax' => 1
                    ],
                ...
                ?>
                  ...
                  <?=
                            ...
                            'data' => ArrayHelper::map(\app\models\cv\TblSwUniversity::find()->all(), 'fid', 'service'),
