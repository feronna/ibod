...
<div class="col-md-12 col-sm-12 col-xs-12 "> 
    <div class="x_panel">
        ...
        <div class="x_content">
         ...
         <?= Html::a('Tambah Kecacatan', ['admintambahkecacatan', 'icno' => $ICNO], ['class' => 'btn btn-primary']) ?>   
            ...
            <table class="table table-sm table-bordered jambo_table table-striped">
                ...
                <tr>
                    ...
                    <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['adminlihatkecacatan', 'id' => $kecacatankakitangan->id]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['adminupdate', 'id' => $kecacatankakitangan->id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['admindelete', 'id' => $kecacatankakitangan->id], [
                         'data' => [
