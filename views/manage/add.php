    ...
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?=
                        $form->field($model, 'level')->label(false)->widget(Select2::classname(), [
                            'data' => ['0'=>'Penyelia','1'=> 'Pegawai'],
                            'options' => ['placeholder' => 'Choose Level', 'class' => 'form-control col-md-7 col-xs-12'],
                            'pluginOptions' => [
                                'allowClear' => true
                            ],
                        ]);
            ...
            <label class="control-label col-md-3 col-sm-3 col-xs-12"> User
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?= $form->field($model, 'user')->textInput(['maxlength' => true, 'rows' => 4,'placeholder' => 'Eg : Cuti '])->label(false); ?>
                </div>
            </div>
            <div class="form-group">
            ...
            <label class="control-label col-md-3 col-sm-3 col-xs-12"> Title
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?= $form->field($model, 'title')->textInput(['maxlength' => true, 'rows' => 4,'placeholder' => 'Eg : KEBENARAN CUTI BERSALIN '])->label(false); ?>
                </div>
            </div>
