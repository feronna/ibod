    ...
    <div class="table-responsive">     
        ...
        $gridColumns = [
            ...
            [
                ...
                'value'=>function ($list){ 
                    if($list->apsu_suppid){
                    return $list->getJenisKontraktor($list->apsu_suppid);
                    // return $list->jenis? $list->jenis->jenis_desc:'TIADA MAKLUMAT';
                    }
                  },
            ],
            [
                ...
                'value'=>function ($list){
                        ...
                        return  
                        Html::a('<i class="fa fa-edit">', ["kontraktor/perkhidmatan-syarikat", 'id' => $list->apsu_suppid]);
