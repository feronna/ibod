...
//                            },
                            ...
                            'format' => 'html',
                            'value' => $batch->payDetails->elaunPakaian->kemudahan,
                        ],
                        [
                            'label' => 'UMSPER',
                            'headerOptions' => ['class' => 'text-center'],
                            'contentOptions' => ['class' => 'text-left'],
                            'value' => $batch->payDetails->kakitangan->COOldID,
                        ],
                        [
                            'label' => 'Nama',
                            'headerOptions' => ['class' => 'text-center'],
                            'contentOptions' => ['class' => 'text-left'],
                            'value' => $batch->payDetails->kakitangan->CONm,
                        ],
                        [
                        ...
                        [
                            'label' => 'JFPIU Proses',
                            'value' => $batch->payDetails->kakitangan->department->fullname,
                        ],
                        [
                            'label' => 'Tarikh Kuatkuasa',
                            'value' => $batch->payDetails->datefrom,
                        ],
                        [
                            'label' => 'Status',
                            'format' => 'raw',
