...
<?php // $this->render('/borang/_topmenu') ?>
...
<div class="row"> 
    ...
    <div class="x_panel">
        ...
        <thead>
         ...
         <?php if($model->status == 'MENUNGGU TINDAKAN' || $model->status == '' && $model->entry_type == 1){?>   
        <div class="x_panel">
            <div class="x_title">
        ...
        <?php if($model->status == 'SEMAKAN LAYAK' || $model->status == 'SEMAKAN TIDAK LAYAK' || $model->status  == 'LAYAK' || $model->status  == 'TIDAK LAYAK'){?>    
