...
<div class="customer-form">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?php foreach ($modelsStaff as $i => $modelStaff): ?>
                ...
                <div class="item panel panel-default"><!-- widgetBody -->
                    ...
                    <div class="panel-body">
                        <?php
                            ...
                            if (! $modelStaff->isNewRecord) {
                                echo Html::activeHiddenInput($modelStaff, "[{$i}]id");
                            }
                        ?>
                        ...
                        <div class="row">
                                                     ...
                                                     <?=
                $form->field($modelStaff, "[{$i}]icno")->label(false)->  widget(Select2::classname(), [
                    'data' => $MultipleStaff,
                ...
                ?>
                        ...
                        <div class="row">
                                                               <?=
                $form->field($modelStaff, "[{$i}]new_dept")->label(false)->  widget(Select2::classname(), [
                    'data' => $MultipleDepartments,
                    'options' => ['placeholder' => 'Pilih JFPIU', 'class' => 'form-control col-md-7 col-xs-12', 'required' => true],
                    'pluginOptions' => [
                        'allowClear' => true
                    ],
                ]);
                ?>
                              ...
                              <div class="row">
                                                               <?=
                $form->field($modelStaff, "[{$i}]new_campus")->label(false)->  widget(Select2::classname(), [
                    'data' => $MultipleCampus,
                ...
                ?>
                         ...
                         <div class="row">
                                                               <?=
                $form->field($modelStaff, "[{$i}]justifikasi")->label(false)->  widget(Select2::classname(), [
