...
<div class="col-md-12 col-xs-12"> 
        <div class="x_panel">
                <div class="x_title">
            <h2><strong>Kakitangan Baharu</strong></h2>
        ...
        <div class="x_content">
            ...
            <table class="table table-sm table-bordered">
                ...
                ?>
                             ...
                             <td>   <?php  if ($item->effective_date != null){
                   echo  $item->effective;
                  }else{
                    echo 'Tiada Tindakan';
                 }
                ?></td>
                            ...
                            <td>
                                 ...
                                 <td class="text-center"><?=  Html::a('<i class="fa fa-edit">', ["ptb/tindakan-lapor-diri", 'id' => $item->id])?></td>
