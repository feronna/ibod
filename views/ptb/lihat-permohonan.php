        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?= $form->field($model, 'kali_ke')->textInput(['maxlength' => true, 'rows' => 4,'value' => Yii::$app->request->get('tmp'), 'disabled' => 'disabled'])->label(false);
                        ?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                   <?= $form->field($model, 'tarikh_mesyuarat')->textInput(['maxlength' => true, 'rows' => 4,'value' => Yii::$app->request->get('tmp'), 'disabled' => 'disabled'])->label(false);
                        ?>
                    </div>
                </div>
                 <div class="form-group inline">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12" style="display: inline-block">
                        <label class="inline">UMS/PN2.2/P44/2/</label>
                        <?= Html::textInput('letter_reference', $model->letter_reference, ['class' => 'form-control inline', 'disabled' => true]) ?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea name="notes" class="form-control" rows="5" disabled><?= $model->pelulus->notes?></textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <?= Select2::widget([
                            'name' => 'approved_dept',
                            'data' => $departments,
                            'options' => ['placeholder' => 'Sila pilih Jabatan', 'default' => 0],
                            'pluginOptions' => [
                                'allowClear' => true
                            ],
                            'value' => $model->approved_dept,
                            'disabled' =>  true
                        ]);; ?>
                    </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="effective_date" value="<?=  $model->effective ?>" class="form-control" disabled>
                ...
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <?= Html::submitButton('Hantar', ['class' => 'btn btn-success', 'disabled' => true]) ?>
                    </div>
                </div>
                <?php ActiveForm::end(); ?>
                <!--form-->
