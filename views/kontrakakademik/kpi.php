                ...
                <table style="font-size:12px;" class="table table-striped table-sm jambo_table table-bordered">
                    <thead>
                        <tr class="headings">
                            ...
                            <th style="width:18%" rowspan="2" class="text-center">Comment <?= $kontrak->secondapp?></th>
                        </tr>
                        <tr class="headings">
                    ...
                    <?php if($kpi->id<=3){?>
                        <tr>
                            ...
                            <?php $first=1; foreach($model as $m){
                                ...
                                <td rowspan="<?= $count?>">
                            <?= TblKpi::comment_kp($kontrak->id, $kpi->id)?>
                            </td>
                                <td rowspan="<?= $count?>">
                            <?php if($kontrak->status == '2' && Yii::$app->user->getId() === $kontrak->app_by){?>
                                <textarea style="resize: none;" rows="4" name="catatan_4<?=$kpi->id?>"><?= TblKpi::comment_kj($kontrak->id, $kpi->id)?></textarea>
                                <?php }else{
                                    echo TblKpi::comment_kj($kontrak->id, $kpi->id);
                                }?></td></tr>
                    <?php }
                    else{
                                ?>
                            ...
                            <td rowspan="<?=$count +1?>"><?php if($kontrak->status == '2' && Yii::$app->user->getId() === $kontrak->app_by){?>
                                <textarea style="resize: none;" rows="4" name="catatan_4<?=$kpi->id?>"><?= TblKpi::comment_kj($kontrak->id, $kpi->id)?></textarea>
                                <?php }else{
                                    echo TblKpi::comment_kj($kontrak->id, $kpi->id);
                                }?></td>
