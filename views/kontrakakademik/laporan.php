...
//    if($no==$row){
    ...
    $sheet->setCellValue('E'.$i, $model->kakitangan->umurpanjang);
    ...
    $sheet->setCellValue('AB'.$i, $model->jumlahPenerbitanfirstcorresponding);
    $sheet->setCellValue('AC'.$i, $model->kakitangan->scopus->h_index);
    $sheet->setCellValue('AD'.$i, $model->kakitangan->scopus->Citations);
    $sheet->setCellValue('AE'.$i, $model->kakitangan->googleScholar->h_index);
    $sheet->setCellValue('AF'.$i, $model->kakitangan->googleScholar->Citations);
...
'EXPECTED TO GRADUATE'
  ...
  (substr($var['KodSesi_Sem'], -9) > $model->sesimulakontrak || (substr($var['KodSesi_Sem'], -9) == $model->sesimulakontrak && substr($var['KodSesi_Sem'], 0,1) >= $model->semmulakontrak))
    ...
    $sheet->setCellValue('AT'.$i, $model->jumlahJurnalbyyear('2021'));
    $sheet->setCellValue('AU'.$i, $model->jumlahBukubyyear('2021'));
    $sheet->setCellValue('AV'.$i, $model->jumlahBabDalamBukubyyear('2021'));
    $sheet->setCellValue('AW'.$i, $model->jumlahPenerbitanfirstcorrespondingbyyear('2021'));
    $sheet->setCellValue('AX'.$i, $model->jumlahJurnalbyyear('2020'));
    $sheet->setCellValue('AY'.$i, $model->jumlahBukubyyear('2020'));
    $sheet->setCellValue('AZ'.$i, $model->jumlahBabDalamBukubyyear('2020'));
    $sheet->setCellValue('BA'.$i, $model->jumlahPenerbitanfirstcorrespondingbyyear('2020'));
    $sheet->setCellValue('BB'.$i, $model->umur);
    $sheet->setCellValue('BC'.$i, $model->umurTamatKontrak);
//    
    ...
    $sheet->getStyle('A'.$i.':BA'.$i)->applyFromArray($content);
