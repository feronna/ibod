...
//                    },
                    ...
                    [
                        'label' => 'Tarikh Buka Permohonan',
                        'value' => function ($data) {
                        $akses = \app\models\kontrak\TblAkses::find()->where(['icno' => $data->ICNO, 'role' => 'pemohon'])->one();
                        if($akses){
                        return 
                            $akses->start_date? date_format(date_create($akses->start_date), 'd F Y'):'';}
                        else{
                            return 'Belum Buka';
                        }
                },
                       ...
                       $akses = \app\models\kontrak\TblAkses::find()->where(['icno' => $data->ICNO, 'role' => 'pemohon'])->one();
                        if($akses){
                        return 
                            $akses->end_date? date_format(date_create($akses->end_date), 'd F Y'):'';}
                        else{
                            return 'Belum Buka';
                        }
                },
