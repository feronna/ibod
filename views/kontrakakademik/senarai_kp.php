    ...
    <div class="x_panel">
        ...
        'columns' => [
            ...
            [
                ...
                if($data->status == '1'){
            $return = Html::button('', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['mtindakan_kp', 'id' => $data->id]),'style'=>'background-color: transparent; 
            border: none;', 'class' => 'fa fa-edit mapBtn']).
            Html::a('<i class="fa fa-eye"></i>', ["maklumatkontrak_kp", 'id' => $data->id]);
                }
                else{
            $return =  Html::a('<i class="fa fa-eye"></i>', ["maklumatkontrak_kp", 'id' => $data->id]);
                }
                if($data->offerletter!=''){
                                $surat = ' '. 
