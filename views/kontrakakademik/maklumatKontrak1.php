...
<div class="row text-center"><h2><b>Application For Contract Extension [Academic Staff]</b></h2><br></div>
        ...
        <?php
        if($model->status != '2'){
            echo $this->render('_viewhodendorsement',['model'=>$model,]);
        }
        else{?>
        <div class="row"> 
            <div class="x_panel">
                ...
                <div id="pop" class="form-group">
                    ...
                    <button value = "/staff/web/kontrakakademik/kpi?id=<?= $model->id?>&modal=modal" id="op" type="button" class="btn btn-primary btn-md fa fa-edit mapBtn" style=" width : 100%;"> Key Performance Indicators</button></div>
                    <br>   <br>         
                </div>
