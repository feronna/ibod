        ...
        <div class="x_content">  
            ...
            <div class="form-group">
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">  
                    <?=
                    $form->field($model, 'lvl')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(app\models\esticker\RefAccess::find()->all(), 'id', 'desc'), 
                        'options' => ['placeholder' => '...', 'class' => 'form-control col-md-7 col-xs-12', 'multiple' => true],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],
                    ]);
...
<div class="table-responsive">
                ...
                $gridColumns = [
                    ...
                    [
                        'label' => 'Action',
                        'value' => function($model) {
                            return Html::a('<i class="fa fa-edit"></i>', ['edit-access', 'id' => SHA1($model->ICNO)], ['class' => 'btn btn-default btn-md',]).Html::a('<i class="fa fa-trash"></i>', ['delete-access', 'id' => $model->ICNO], ['class' => 'btn btn-danger btn-md',]);
                        },
                                'format' => 'raw',
