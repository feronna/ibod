        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6"> 
                    <?= $form->field($model, 'ICNO')->textInput(['disabled' => true, 'value' => $model->pelawat->ICNO])->label(false); ?>
                </div>
            </div>
        </div>
        <div class="form-group"> 
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6"> 
                    <?= $form->field($model, 'CONm')->textInput(['disabled' => true, 'value' => $model->pelawat->CONm])->label(false); ?>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4"> 
                    <?= $form->field($model, 'COOffTelNo')->textInput(['disabled' => true, 'value' => $model->pelawat->COOffTelNo])->label(false); ?>
                </div>
            </div>
        </div>

        <?php if (in_array($url, ['carian-keluar-pelawat', 'senarai-keluar-pelawat'])) { ?> 
            <div class="hide">       
