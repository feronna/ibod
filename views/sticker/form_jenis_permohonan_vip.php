        ...
        if ($record) {
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">    
                    <?= $form->field($model, 'id_kenderaan')->textInput(['value' => $kenderaan->reg_number,'disabled'=>true])->label(false); ?>
                </div>
            </div>
        <div class="form-group">
...
<div class="x_panel">   
    ...
    <div class="hide">  
        <?= $form->field($model, 'id_lpu')->hiddenInput(['value' => $record->id])->label(false); ?>  
        <?= $form->field($model, 'status_mohon')->hiddenInput(['value' => 'AKTIF'])->label(false); ?> 
