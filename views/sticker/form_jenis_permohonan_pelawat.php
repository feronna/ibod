...
<div class="x_panel">  
    ...
    <div class="form-group">
        ...
        <div class="col-md-2 col-sm-2 col-xs-12">
            ...
            <?= $form->field($model, 'total')->textInput(['value' => $record->findStickerRate(), 'disabled' => true])->label(false); ?>
        </div>
    </div> 
    ...
    <div class="hide">  
        <?= $form->field($model, 'id_pelawat')->hiddenInput(['value' => $record->id])->label(false); ?>  
