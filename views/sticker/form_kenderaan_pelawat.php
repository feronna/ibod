...
<div class="x_panel"> 
    ...
    <div class="x_content">     
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6"> 
                    <?=
                    $form->field($model, 'v_co_icno')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(\app\models\esticker\TblPelawat::find()->where(['not in','CatCd',[1]])->all(), 'ICNO', 'CONm'),
        ...
        <?php if (Yii::$app->controller->action->id == 'tambah-kenderaan-pelawat') { ?>
            <div class="hide">
...
<div class="x_panel"> 
    <div class="x_title">
        <h2>Kakitangan (Penjaga/mentor/penyelia yang bertanggungjawab)</h2> 
        <div class="clearfix"></div>
    </div>
    <div class="x_content">     
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6"> 
                    <?=
                    $form->field($model, 'staf_v_co_icno')->label(false)->widget(Select2::classname(), [ 'data' => ArrayHelper::map(\app\models\hronline\Tblprcobiodata::find()->all(), 'ICNO', 'CONm'),
                        'options' => [ 'placeholder' => 'Nama', 'class' => 'form-control col-md-7 col-xs-12'],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">   
                    <?=
                    $form->field($model, 'staf_rel')->label(false)->widget(Select2::classname(), [
                        'data' => ['DIRI SENDIRI' => 'DIRI SENDIRI', 'SUAMI' => 'SUAMI', 'ISTERI' => 'ISTERI'
                            , 'ANAK' => 'ANAK', 'BAPA' => 'BAPA', 'IBU' => 'IBU'
                            , 'BAPA MERTUA' => 'BAPA MERTUA', 'IBU MERTUA' => 'IBU MERTUA', 'KAKAK' => 'KAKAK'
                            , 'ABANG' => 'ABANG', 'ADIK' => 'ADIK', 'ATUK' => 'ATUK', 'NENEK' => 'NENEK', 'SEPUPU' => 'SEPUPU', 'LAIN-LAIN' => 'LAIN-LAIN'
