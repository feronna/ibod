...
<div class="x_panel">
    ...
    <div class="x_content"> 
        ...
        $form = ActiveForm::begin([
                    'action' => ['laporan-pelekat-jabatan'],
                    'method' => 'get',
                    'options' => [
                        'data-pjax' => 1
                    ],
        ...
        <div class="col-md-2 col-sm-2 col-xs-2">
            ...
            $form->field($searchModel, 'dept_id')->label(false)->widget(Select2::classname(), [
                'data' => ArrayHelper::map(\app\models\hronline\Department::find()->where(['isActive'=>1])->andWhere(['is not','shortname',NULL])->orderBY(['shortname'=>SORT_ASC])->all(), 'id', 'shortname'),
                'options' => ['placeholder' => 'JABATAN', 'class' => 'form-control col-md-7 col-xs-12'],
                'pluginOptions' => [
                    'allowClear' => true
                ],
            ]);
    ...
    <div class="table-responsive">     
        ...
        $gridColumns = [
            ...
            [
                ...
                'value' => function($model) {
                    return $model->kenderaan ? $model->kenderaan->department ? $model->kenderaan->department->shortname : '' : '';
                },
            ],
            [
                'label' => 'Nama',
        ...
        echo GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<h2>Laporan Pelekat Jabatan</h2>',
            ],
        ]);
        ?>
<?php Pjax::end(); ?>
