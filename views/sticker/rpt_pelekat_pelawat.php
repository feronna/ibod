...
<div class="x_panel">
    ...
    <div class="x_content"> 
        ...
        $form = ActiveForm::begin([
                    'action' => ['laporan-pelekat-pelawat'],
                    'method' => 'get',
                    'options' => [
                        'data-pjax' => 1
                    ],
        ...
        <div class="col-md-3 col-sm-3 col-xs-3">
            <?=
            $form->field($searchModel, 'CatCd')->label(false)->widget(Select2::classname(), [
                'data' => ArrayHelper::map(\app\models\esticker\RefKategoriPelawat::find()->where(['not in','id',[1]])->all(), 'id', 'nama'),
    ...
    <div class="table-responsive">     
        ...
        echo GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<h2>Laporan Pelekat Pelawat</h2>',
            ],
        ]);
        ?>
<?php Pjax::end(); ?>
