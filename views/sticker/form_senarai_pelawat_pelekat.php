        ...
        if ($biodata) {
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">  
                    <?=
                    $form->field($biodata, 'CatCd')->label(false)->widget(Select2::classname(), [
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6"> 
                        <?= $form->field($biodata, 'ICNO')->textInput(['maxlength' => true, 'disabled' => true])->label(false); ?>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-3"> 
                        <?= Html::a('<i class="fa fa-edit"></i>', ['kemaskini-pelawat', 'id' => $biodata->id], ['class' => 'btn btn-default btn-sm']); ?>
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">  
                        <?= $form->field($biodata, 'COOffTelNo')->textInput(['maxlength' => true, 'disabled' => true])->label(false); ?>
                    </div>
                </div>
            </div> 
            <?php
