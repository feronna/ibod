        ...
        <div class="x_content"> 
            ...
            <div class="col-md-3 col-sm-3 col-xs-2">
                <?=$form->field($searchModel, 'ICNO')->label(false)->widget(Select2::classname(), [
                    'data' => ArrayHelper::map(\app\models\esticker\TblPelawat::find()->where(['CatCd'=>1])->all(), 'ICNO', 'CONm'),
            ...
            <div class="col-md-2 col-sm-2 col-xs-2">
                <?=$form->field($searchModel, 'campus_id')->label(false)->widget(Select2::classname(), [
                    'data' => ArrayHelper::map(app\models\hronline\Kampus::find()->all(), 'campus_id', 'campus_name'),
                    'options' => ['placeholder' => 'Kampus', 'class' => 'form-control col-md-7 col-xs-12'],
                    'pluginOptions' => [
                        'allowClear' => true
                    ],
                ]);
...
<div class="table-responsive">     
            ...
            echo GridView::widget([
                            ...
                            'panel' => [
                                ...
                                'heading' => '<h2>Laporan Pelawat Harian</h2>',
                            ],
                        ]);
