            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'label' => 'Tindakan',
                        'value' => function ($model) {
                            return Html::a('<i class="fa fa-plus-circle" aria-hidden="true"></i> SENARAI HITAM', ['senarai-hitam-kontraktor','id'=>$model->pekerja->ICNO,'url'=>Yii::$app->controller->action->id,'flag' => 1], ['class' => 'btn btn-warning btn-sm']);
                        },
                                'format' => 'raw',
                            ],
                        ],
