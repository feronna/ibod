                    ...
                    [
                        ...
                        'value' => function($model) {
                            ...
                            if ($model->status_mohon == 'DITOLAK') {
                                ...
                                if ($model->status_mohon == 'MENUNGGU BAYARAN KAUNTER') {
                                    $title = 'Menunggu Bayaran Kaunter';
                                    $btn = 'edit';
                                ...
                                return Html::a('<i class="fa fa-' . $btn . '"></i>', ['tindakan', 'id' => $model->id, 'title' => $title], ['class' => 'btn btn-default btn-sm']);
                            }
                        },
                                'format' => 'raw',
