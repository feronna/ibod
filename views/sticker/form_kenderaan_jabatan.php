...
<div class="x_panel"> 
    ...
    <div class="x_content">    
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6"> 
                    <?=
                    $form->field($model, 'v_co_icno')->label(false)->widget(Select2::classname(), [ 'data' => ArrayHelper::map(\app\models\hronline\Tblprcobiodata::find()->where(['deptId'=>$model->findCurrentDept()])->all(), 'ICNO', 'CONm'),
        ...
        <div class="hide">  
            ...
            <?= $form->field($model, 'dept_id')->hiddenInput(['value' => $model->findCurrentDept()])->label(false); ?>  
