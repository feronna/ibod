...
use app\models\patrol\PatrolRefSeksyen;
...
<div class="col-md-12"> 
    <div class="x_panel" >
        <div class="x_title">
            <h2><strong>Kemaskini DO/Pegawai</strong></h2>
        ...
        <div class="x_content">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-3" for="wp_id">Role<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <?=
                    $form->field($model, 'rolebased')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(PatrolRefSeksyen::find()->all(), 'id', 'seksyen'),
