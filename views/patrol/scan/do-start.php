    ...
    <table>
        <div class="container text-center" style="background-color: rgba(0, 0, 0, 0.4)">
            ...
            if ($status == 1) { ?>
                ...
                <br />
                <?php $form = ActiveForm::begin(['action' => ['patrol/scan/start-do', 'id' => $id, 'latlng' => Yii::$app->request->post()['Rekod']['latlng']], 'options' => ['class' => 'form-horizontal form-label-left disable-submit-buttons', 'enctype' => 'multipart/form-data']]); ?>
                <font style="font-size:10px">
                    <div class="row">
                        <div class="col-xs-12 col-md-offset-4 col-md-4" style="background-color:#081b26;color: white; padding:10px;">MULA RONDAAN</div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-offset-4 col-md-4" style="background-color:#081b26;color: white; padding:10px;">Catatan</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-md-offset-4 col-md-4" style="background-color:#081b26;color: white; padding:10px;"><strong><?= $form->field($model, 'catatan')->textArea(['maxlength' => true, 'readonly' => false])->label(false) ?>
                            </strong></div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <?= Html::submitButton('<i class="fa fa-arrow-right"></i>&nbsp;Mula Rondaan', ['class' => 'btn btn-primary', 'data' => ['disabled-text' => 'Please Wait..']]) ?>
                        </div>
