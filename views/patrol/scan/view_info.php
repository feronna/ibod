    ...
    <table>
        <div class="container text-center" style="background-color: rgba(0, 0, 0, 0.4)">
            ...
            if ($status == 1) { ?>
                ...
                <br />
                <?php $form = ActiveForm::begin(['action' => ['patrol/scan/clock', 'id' => $id, 'latlng' => Yii::$app->request->post()['Rekod']['latlng'],$shift], 'options' => ['class' => 'form-horizontal form-label-left disable-submit-buttons', 'enctype' => 'multipart/form-data']]); ?>
                <font style="font-size:10px">
                    <div class="row">
                        <div class="col-xs-12 col-md-offset-4 col-md-4" style="background-color:#081b26;color: white; padding:10px;">MAKLUMAT PERONDA</div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-md-offset-4 col-md-2" style="background-color:#081b26;color: white; padding:10px;">NAMA BIT</div>
                        <div class="col-xs-6 col-md-2" style="background-color:white; padding:10px;"><strong><?= $bit->bit_name; ?> </strong></div>
                    </div>
                    <div class="row">
