    ...
    <table>
        <div class="container text-center" style="background-color: rgba(0, 0, 0, 0.4)">
            ...
            if ($status == 1) { ?>
                ...
                <br />
                <?php $form = ActiveForm::begin(['action' => ['patrol/scan/end-patrolling', 'id' => $id, 'latlng' => Yii::$app->request->post()['Rekod']['latlng'],$shift], 'options' => ['class' => 'form-horizontal form-label-left disable-submit-buttons', 'enctype' => 'multipart/form-data']]); ?>
