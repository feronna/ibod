    ...
    <div class="x_content">
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Bit</i>
                <i class="fa fa-info-circle fa-xs" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Nama bit"></i>
            </label>
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Kedudukan/Nombor Bit</i>
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Status</i>
                <i class="fa fa-info-circle fa-xs" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Status Bit"></i>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <?=
        ...
        <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Open Maps
                </label>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <?= RefBit::DisplayLoc($model->id) ?>
                </div>
            </div>
