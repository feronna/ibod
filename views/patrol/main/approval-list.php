...
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-list-alt"></i>&nbsp;<strong>Menunggu Persetujuan Penyelia</strong></h2>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-6 col-xs-12">
                        <div class="x_panel">
                            <div class="x_content">
                                ...
                                <p><strong>Tarikh Syif </i>: </strong><?= $models->date; ?></p>
                                <p><strong>Catatan/<i>Remark </i>: </strong><?= $models->remark; ?></p>
                                <?= Html::a('<i class="fa fa-check-circle-o"></i> Click to Approve', Url::to(['patrol/main/approve','id'=>$models->id]), ['class' => 'btn btn-success btn-sm pull-right']) ?>
                            </div>
                        </div>
                    </div>
                </div>
