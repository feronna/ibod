...
//english title
$this->title = 'Catatan Tamat Bertugas ';
?>
    ...
    <div class="x_content">
        ...
        <div class="form-group">
            ...
            <?= $form->field($model, 'type')->widget(Select2::className(), [
                    'data' => ['1' => 'Tamat Rondaan','2' => 'Tamat Bertugas'],
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <?php echo $form->field($model, 'report')->label(false)->textArea(['class' => 'form-control col-md-3 col-sm-3 col-xs-12', 'disabled' => false, 'placeholder' => 'Catatan Anda']); ?>
            </div>
        </div>
