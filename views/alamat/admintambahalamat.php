            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="form-group checkboxsama" id="checkboxsama">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <?= Html::a('Alamat Tetap = Alamat Semasa', ['admintambahalamat','icno'=>$model->ICNO, 'samadengan' => '01', 'tambah' => '03'], ['class' => 'btn btn-primary']) ?>
                            </br>
                            </br>
                            <text>Jika alamat tetap anda sama dengan alamat semasa anda, sila tekan butang biru diatas [Alamat Tetap = Alamat Semasa].</text>
                        </div>
                    </div>
                </div>
