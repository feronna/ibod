...
$js = <<<js
    $(document).ready(function(){
     var val3 = $alamat;
        ...
        $('#jenisalamat').on('select2:close', function(e) {
            
            var val1 = $('#jenisalamat').val();
...
<div class="tblpraddress-form">
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?=
                        $form->field($model, 'AddrTypeCd')->label(false)->widget(Select2::classname(), [
                            ...
                            'options' => ['placeholder' => 'Pilih Jenis Alamat', 'class' => 'form-control col-md-7 col-xs-12', 'id' => 'jenisalamat'],
                            'pluginOptions' => [
                                'allowClear' => true
                            ],
                        ]);
            ...
            <div class="form-group checkboxsama" id="checkboxsama">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="checkboxsama"> <span class="required" style="color:red;"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?= Html::a('Sama Alamat', ['tambahalamat', 'samadengan' => '01', 'tambah' => '03'], ['class' => 'btn btn-primary']) ?>
                    </br>
                    </br>
                    <text>Jika alamat tetap anda sama dengan alamat semasa anda, sila tekan butang diatas.</text>
                </div>
                <div class="jtooltip"><i class="fa fa-info-circle fa-md"></i>
                    <text>Jika alamat tetap anda sama dengan alamat semasa anda, sila tandakan checkbox diatas dan terus tekan butang "simpan".</text>
                </div>
            </div>
        </div>
