...
<!--<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <?= Html::beginForm(['laporan-lanjutan ', 'id' => $icno], 'GET'); ?>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="col-xs-12 col-md-12 col-lg-12"> 
                <div class="x_title">
        <h5><strong><i class="fa fa-calendar-check-o"></i> STATISTIK BULANAN KAKITANGAN YANG MEMOHON PELANJUTAN TEMPOH CUTI BELAJAR</strong></h5>
        ...
        <div class="x_panel">
            <div class="x_title">
                <h5><strong><i class="fa fa-plus-square"></i> LAPORAN PERMOHONAN LANJUTAN CUTI BELAJAR</strong></h5>
<!--                <ul class="nav navbar-right panel_toolbox">
                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
            ...
            <div class="col-xs-12 col-md-12 col-lg-12"> 
                ...
                <div class="x_panel">
                    ...
                    <div class="x_title">
        <h5><strong><i class="fa fa-graduation-cap"></i> SENARAI KAKITANGAN YANG MEMOHON</strong></h5>
                           ...
                           //'attribute' => 'CONm',
                            ...
                            'value' => function($model) {
                                ...
                                return Html::a('<strong>'.$model->kakitangan->CONm.'</strong>').'<br><small>'.$model->kakitangan->department->fullname.'</small>'.
                                    ...
                                    [
                'label' => 'TARIKH PELANJUTAN BAHARU DIPOHON',
                 'options' => ['style' => 'width:15%'],

                'value'=>function ($data) {
                    if($data->lanjutansdt)
                    {
                    return strtoupper($data->stlanjutan). ' HINGGA '. strtoupper($data->ndlanjutan) ;
                    }
                    else
                    {
...
//                        ],
                        ...
                        'value' => function($model) {
                            ...
                            return Html::a('<i class="fa fa-th-list" aria-hidden="true"></i>',  ['lanjutancb/adminview',  'id' => $model->iklan_id, 'i'=>$id], [
