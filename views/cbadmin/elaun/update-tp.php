...
<h5> <strong><center>BAYARAN TIKET PENERBANGAN CUTI BELAJAR</center></strong> </h5>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_content">
       ...
       <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12">KATEGORI TUNTUTAN:<span class="required"></span>
                </label>
