...
<h5> <strong><center>TAMBAH ELAUN AKHIR PENGAJIAN - BUJANG</center></strong> </h5>
    ...
    <div class="x_content">
      ...
      {?>
        ...
        <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12">AMAUN (RM):
                     <br/> <small><i>Jika amaun yang diluluskan berbeza</i></small>
