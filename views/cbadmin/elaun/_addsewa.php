...
<h5> <strong><center>BAYARAN ELAUN BANTUAN SEWA RUMAH (EBSR) </center></strong> 
    <center> <small><i style="color:red">Selepas dipersetujui Bendahari UMS</i></small></center></h5>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_content">
       ...
       <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12">KATEGORI EBSR:<span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  
 <?php
            echo $form->field($model,'jenis_elaun')->
            dropDownList(['EBSR' => 'ELAUN BANTUAN SEWA RUMAH (BULANAN) - PEGAWAI DAN PASANGAN ',
                          'EBSR2' => 'ELAUN BANTUAN SEWA RUMAH (BULANAN) - PEGAWAI, PASANGAN DAN 1 ANAK',
                          'EBSR3' => 'ELAUN BANTUAN SEWA RUMAH (BULANAN)- PEGAWAI, PASANGAN DAN 2 ATAU LEBIH ANAK',
                          'EBSR4' => 'ELAUN BANTUAN SEWA RUMAH (BULANAN)- PEGAWAI, PASANGAN DAN 2 ATAU LEBIH ANAK',
                          'EBSR5' => 'ELAUN BANTUAN SEWA RUMAH (BULANAN)- PEGAWAI DAN 1 ANAK',
                          'EBSR6' => 'ELAUN BANTUAN SEWA RUMAH (BULANAN)- PEGAWAI DAN 2 ATAU LEBIH ANAK',
