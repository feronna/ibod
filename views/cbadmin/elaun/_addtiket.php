...
<h5> <strong><center>TUNTUTAN TIKET PENERBANGAN KAKITANGAN </center></strong> 
    <center> <small><i style="color:red">Selepas dipersetujui Unit Pentadbiran BSM</i></small></center></h5>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_content">
       ...
       <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12">TUJUAN TUNTUTAN:<span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  
 <?php
            echo $form->field($model,'jenis_elaun')->
            dropDownList(['TIKET' => 'MEMULAKAN PENGAJIAN LANJUTAN ',
                          'TIKET2' => 'MELAPOR DIRI KEMBALI BERTUGAS',
