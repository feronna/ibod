...
<div > 
    <div class="x_panel"> 
        <div class="x_title">
            <h2><i class="fa fa-upload"></i><strong> MUAT NAIK SURAT KELULUSAN</strong></h2>
        ...
        <div class="form-group" id="tempoh" ><br><br>
            ...
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Surat Kelulusan : <span class="required"></span>
                </label>
