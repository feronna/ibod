...
<div class="col-md-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            <p style="color: green">
                * Semua kakitangan akan dapat notifikasi
            </p>
            <!--form-->
            ...
            <div class="form-group">
                    <input type="name" value ="<?=Yii::$app->request->queryParams['icno']?>" id="icno" class="form-control" name="icno" placeholder="Nama Kakitangan">
