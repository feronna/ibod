        ...
        <div class="x_content">
            <?php $form = ActiveForm::begin(['id' => 'search',  'method' => 'get', 'options' => ['class' => 'form-horizontal form-label-left']]); ?>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Kakitangan</label>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <?=
                            $form->field($model->kakitangan, 'CONm')->textInput([
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">No. KP:</label>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <?=
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <?=
                            $form->field($model->kakitangan, 'DeptId')->label(false)->widget(Select2::classname(), [
