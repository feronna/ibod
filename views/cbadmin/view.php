            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-4">
                 ...
                 <div class="col-xs-12 col-md-4">
                    ...
                    echo Html::a($semakan, ['adminview?id='.$model->ICNO.'&page=rekod-lkk']);
                    ?>
           </div>
...
<div class="row">
                ...
                <div class="col-xs-12 col-md-4">
                 ...
                 <div class="col-xs-12 col-md-4">
                    ...
                    echo Html::a($semakan, ['adminview?id='.$model->ICNO.'&page=rekod-lapor-diri']);
                    ?>
           </div>
   ...
   <thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= $akademik->HighestEduLevel; ?></td>
            <td><?= $akademik->major; ?></td>
            <td><?= $akademik->InstNm; ?></td>
            <td><?= $akademik->tajaan; ?></td>
            <td><?= $akademik->tarikhmohon; ?></td>
            <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>',  ["cutisabatikal/adminview",  'id'=>$akademik->id, 'ICNO'=>$akademik->icno, 'takwim_id'=>$akademik->iklan_id]) ?> | <?= Html::a('<i class="fa fa-print" aria-hidden="true"></i>', ['adminview','id'=>$model->ICNO]) ?> </td>  
   ...
   <thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= $pengajian->fulldt; ?></td>
            <td><?= $pengajian->justifikasi; ?></td>
            <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>',  ["lanjutancb/adminview", 'id'=>$pengajian->iklan_id, 'i'=>$pengajian->id]) ?> | <?= Html::a('<i class="fa fa-print" aria-hidden="true"></i>', ['adminview','id'=>$model->ICNO]) ?> </td>  
   ...
   <thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ["tiketpenerbangan/adminview",  'id'=>$penerbangan->id]) ?> | <?= Html::a('<i class="fa fa-print" aria-hidden="true"></i>', ['adminview','id'=>$model->ICNO]) ?> </td>  
   ...
   <thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['adminview','id'=>$model->ICNO]) ?> | <?= Html::a('<i class="fa fa-print" aria-hidden="true"></i>', ['adminview','id'=>$model->ICNO]) ?> </td>  
   ...
   <thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>',  ["lapordiri/adminview", 'id'=>$lapor->iklan_id, 'i'=>$lapor->laporID]) ?> | <?= Html::a('<i class="fa fa-print" aria-hidden="true"></i>', ['adminview','id'=>$model->ICNO]) ?> </td>  
