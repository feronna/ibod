        ...
        <div class="x_content"> 
            ...
            <div class="x_content">    
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Penyelia: <span class="required" style="color:red;">*</span>
                    </label>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12"> 
                        ...
                        $form->field($model, 'level')->widget(Select2::classname(), [
                            'data' => ['1' => 'PENTADBIR SISTEM', '2' => 'UPP', '3' => 'ADMIN - UNIT PENTADBIRAN',
                                '4'=> 'ADMIN - BAHAGIAN PERUNDANGAN & INTEGRITI', '5'=>'TESTER', '6'=> 'PENYELIA'],
