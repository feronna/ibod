...
<h5> <strong><center>REKOD PELAPORAN DIRI</center></strong> </h5>
...
<table class="table table-sm table-bordered">
                        ...
                        <td style="width:20%"><span class="label label-success"> <?=  strtoupper($model->kakitangan->serviceStatus->ServStatusNm);?></span>
