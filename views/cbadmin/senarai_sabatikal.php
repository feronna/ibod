...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12"> 
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Senarai Permohonan Cuti Sabatikal </strong></h2>
            ...
            <?= Html::a('<i class="text-success fa fa-download"></i> Muat Turun', ['report', 'sesi' => $sesi, 'tahun'=> $sesitahun],['style'=>"float: right; font-size:18px;", 'target' => "_blank"]) ?>
                ...
                'class' => 'table-responsive',
                    ...
                    'columns' => [
                        ...
                        'filter' => Select2::widget([
                            ...
                            'data' => ArrayHelper::map(\app\models\cbelajar\TblPermohonan::find()->where(['jenis_user_id' => '1', 'idBorang'=>2])->all(), 'icno', 'kakitangan.CONm'),
                            'options' => ['placeholder' => ''],
                            'pluginOptions' => [
                                'allowClear' => true
                            ],
                        ...
                        'filter' => Select2::widget([
                            ...
                            'data' => ArrayHelper::map(\app\models\cbelajar\TblPermohonan::find()->where(['idBorang'=>2])->all(), 'kakitangan.jawatan.id', 'kakitangan.jawatan.fname'),
                            'options' => ['placeholder' => ''],
                            'pluginOptions' => [
                                'allowClear' => true
                            ],
                        ...
                        'filter' => Select2::widget([
                            ...
                            'data' => ArrayHelper::map(\app\models\cbelajar\TblPermohonan::find()->where(['jenis_user_id' => '1', 'idBorang'=>2])->all(), 'kakitangan.department.id', 'kakitangan.department.shortname'),
                            'options' => ['placeholder' => ''],
                            'pluginOptions' => [
                                'allowClear' => true
                            ],
...
//                    ],
                        ...
                        Html::a('<i class="fa fa-eye">', ["kontrak/permohonankontrak", 'id' => $data->id], ['target' => '_blank']);}
                        else{
                            return Html::a('<i class="fa fa-eye">', ["kontrak/permohonankontrak", 'id' => $data->id], ['target' => '_blank']);
                        }
                      },
             ],
                    [
