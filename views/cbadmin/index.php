...
$this->title = 'Rekod Peribadi - Pengajian Lanjutan';
?>
                        ...
                        if (!empty($model)) {
                            ...
                            foreach ($model->getModels() as $data) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $data->displayPendidikan ?></td>
                                    <td><?= $data->displayServiceStatus ?></td>
                                    <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['adminview','id'=>$data->ICNO]) ?> 
                                        | <?= Html::a('<i class="fa fa-graduation-cap" aria-hidden="true"></i>', ['status-perkhidmatan/view','icno'=>$data->ICNO], ['target'=>'_blank']) ?>
                                </tr>
                                <?php
                            }
                        } else {
