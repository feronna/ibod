...
<div class="x_panel" >
    <div class="x_title">
        ...
        <p align="right"> 
<?= Html::a('Lihat Semua', ['cbadmin/search-all-biasiswa'], 
                        ['class' => 'btn btn-success btn-sm',    'target' => '_blank',]) ?> <?= Html::a('Kembali', ['cbadmin/page-tuntutan'], 
...
//                        'visible' => $role,
            ...
            [
                        ...
                        'filter' => Select2::widget([
                            ...
                            'data' => ArrayHelper::map(\app\models\cbelajar\TblBiasiswa::find()->where(['status'=>1])->all(), 'icno', 'kakitangan.CONm'),
                            'options' => ['placeholder' => ''],
                            'pluginOptions' => [
                             'allowClear' => true
                            ],
