...
<h5> <strong><center>KEMASKINI REKOD PELANJUTAN TAJAAN</center></strong> </h5>
    ...
    <div class="x_content">
        ...
        <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   ...
                   <?= $form->field($model, 'dt_slanjutb')->widget(DatePicker::className(),
       ...
       <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                   ...
                   <?= $form->field($model, 'dt_nlanjutb')->widget(DatePicker::className(),
                            ['clientOptions' => ['changeMonth' => true,'yearRange' => '1996:2099','changeYear' => true, 'format' => 'yyyy-mm-dd', 'autoclose' => true],
        ...
        <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <?= $form->field($model, 'c_lanjut')->textArea(['maxlength' => true, 'rows' => 4])->label(false); ?>
                </div>
</div>
