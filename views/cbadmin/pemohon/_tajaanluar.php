                                 ...
                                 <label> Nama Agensi / Tajaan </label>
                                  ...
                                  <div class="col-sm-6">
                                    ...
                                    <?= $form->field($modelAddress, "[{$i}]BantuanCd")->widget(Select2::classname(), [
                                                                'data' => ArrayHelper::map(app\models\cbelajar\RefBantuan::find()->all(), 'BantuanCd', 'bentukBantuan_ums'),                                    'options' => ['placeholder' => 'Pilih Bentuk Tajaan', 'class' => 'testing form-control col-md-12 col-xs-12',
                                    'onchange' => 'javascript:if ($(this).val() == "6"){
                                    $("#lain2").show();
                                         }
                                    else{
                                    $("#lain2").show();
