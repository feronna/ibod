...
<?php echo Html::a('Kembali',['cutibelajar/halaman-pemohon',], 
    ...
    <div class="x_panel">
        <div class="x_content">  
            <span class="required" style="color:black;">
                <strong>
                    <center><?= strtoupper('
     UNIT PENGEMBANGAN PROFESIONALISME | SEKTOR PEMBANGUNAN SUMBER MANUSIA<br/><u> PERMOHONAN PENGAJIAN LANJUTAN PENTADBIRAN
 '); ?>
                </strong> </center>
            </span> 
        </div>
...
<div class="col-xs-12 col-md-12 col-lg-12">
        ...
        <div class="x_panel">
             <div class="x_title">
   <h5 ><strong><i class="fa fa-paper-clip"></i> DOKUMEN PERIBADI BAGI PERMOHONAN BAHARU</strong></h5>
...
<div class="row" > 
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <h4 style="color:grey;"><small>Tarikh Hantar: <?php echo $model->tarikhmohon;?></small></h4><br/>
        </div>
    </div>
</div>
  ...
  <?php if($model3->status_jfpiu == "Diperakukan" || $model3->statusjfpiu == "Tidak Diperakukan")
                {?>
               <div class="x_panel">                  
<div class="x_content">
        <div class="table-responsive">
...
<center>STATUS PERAKUAN KETUA JABATAN/DEKAN</center></th>
                    ...
                    <tr class="headings">
                        ...
                        <td> <?php if($model3->status_jfpiu == "DALAM TINDAKAN KETUA JABATAN")
                        {
                        ...
                        {
                            echo strtoupper($model3->statusjfpiu).'  [ '. $model3->app_date. ' ] ';
                        }?>
                </td>
                    ...
                    <tr class="headings">
                        ...
                        {
                            echo strtoupper($model3->ulasan_jfpiu);
                        }?>   </td>
                     ...
                     <tr class="headings">
                        ...
                        <td> <?= $model3->tarikh_m;?>  </td>

                        
                    </tr>
                     <tr class="headings">
                        <th class="col-md-3 col-sm-3 col-xs-12">STATUS PERMOHONAN:</th>
                        <td> <?= ucwords(strtoupper($model3->status));?>  </td>
