...
<div class="sticky">
    <div class="form_wizard wizard_horizontal">
        <ul class="wizard_steps">
             ...
             <li><br /> <br /> 
                <a href="<?= Url::toRoute(['cbadmin/pemohon/gambar', 'id' => $id])?>">  
            ...
            <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['cbadmin/pemohon/maklumat-peribadi', 'id' => $id])?>">  
            ...
            <li> <br /> <br /> 
                    <a href="<?= Url::toRoute(['cbadmin/pemohon/maklumat-akademik','id' => $id])?>">  
            ...
            <li> <br/> <br /> 
                    <a href="<?= Url::toRoute(['cbadmin/pemohon/maklumat-pengajian', 'id' => $id])?>">  
            ...
            <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['cbadmin/pemohon/maklumat-biasiswa', 'id' => $id])?>">  
            ...
            <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['cbadmin/pemohon/maklumat-keluarga', 'id' => $id])?>">  
            ...
            <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['cbadmin/pemohon/senarai-dokumen-dimuatnaik', 'id' => $id])?>">  
             ...
             <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['cbadmin/pemohon/pengakuan-pemohon', 'id' => $id])?>">  
