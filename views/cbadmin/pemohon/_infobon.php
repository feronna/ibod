...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_content">
        ...
        <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12">TEMPOH BON PHD:<span class="required"></span>
                </label>
        ...
        <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12">TEMPOH BON SABATIKAL :<span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?= $form->field($model, 't_sabatikal')->textArea(['maxlength' => true, 'rows' => 4])->label(false); ?>
                </div>
            </div>
