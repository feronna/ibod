...
<div class="col-md-12 col-sm-12 col-xs-12 "> 
    <div class="x_panel">
        ...
        <div class="x_content">
            <h4><strong>DOKUMEN BAGI PERMOHONAN PENGAJIAN LANJUTAN</strong></h4>
...
?>
                ...
                <p align ="right">
                 <?= Html::a('Seterusnya', ['pengakuan-pemohon', 'id'=> $iklan->id], ['class' => 'btn btn-info btn-sm']); ?>
                 <?= Html::a('Kembali', ['cutibelajar/halaman-pemohon'], ['class' => 'btn btn-primary btn-sm']) ?>
         </p> 
            </div>
   </div>
     </div> 
