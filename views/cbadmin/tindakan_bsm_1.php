...
<h5> <strong><center>KEPUTUSAN MESYUARAT UNIT PENGAJIAN LANJUTAN (UPL) <br/> LAIN -LAIN PERMOHONAN</center></strong> </h5>
...
<div class="form-group">
                ...
                <label class="control-label col-md-3 col-sm-3 col-xs-3" for="wp_id">Keputusan:<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <?=
                    $form->field($model, 'result')->label(false)->widget(Select2::classname(), [
                        'data' => ['DALAM TEMPOH PENGAJIAN ASAL' => 'DALAM TEMPOH PENGAJIAN ASAL', 'PELARASAN TARIKH TAMAT BAHARU' => 'PELARASAN TARIKH TAMAT BAHARU',
                            'DALAM TEMPOH PENGAJIAN ASAL & PELARASAN TARIKH TAMAT BAHARU'=>  'DALAM TEMPOH PENGAJIAN ASAL & PELARASAN TARIKH TAMAT BAHARU'],
