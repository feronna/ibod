...
$gridColumns = [
 ...
 [   
  ...
  return $data->kakitangan->jawatan->job_category == 1? 'AKADEMIK':'PENTADBIRAN';                            },
                            'format' => 'raw'
                        ...
                        [   
                            ...
                            'value' => function ($data){
                                //return Html::a(ucwords(strtoupper($data->sasaran3->tajukLatihan)));
                                return Html::a(strtoupper($data->kakitangan->COOldID));
                            },
                            'format' => 'raw'
                            ...
                            'value' => function ($data){
                                //return Html::a(ucwords(strtoupper($data->sasaran3->tajukLatihan)));
                                return Html::a(strtoupper($data->kakitangan->jawatan->gred));
                            },
                            'format' => 'raw'
                ...
                'value'=>function ($data) {
                    return $data->kakitangan->department->shortname;
                        ...
                        [   
                            ...
                            'value' => function ($data){
                                //return Html::a(ucwords(strtoupper($data->sasaran3->tajukLatihan)));
                                return Html::a(strtoupper($data->tahapPendidikan));
                            },
                            'format' => 'raw'
...
//                             }
                             ...
                             return strtoupper(\app\models\cbelajar\TblLanjutan::find()->where(['icno'=>$data->icno,'idLanjutan'=>1])->one()->stlanjutan)
                             . ' HINGGA '.strtoupper(\app\models\cbelajar\TblLanjutan::find()->where(['icno'=>$data->icno,'idLanjutan'=>1])->one()->ndlanjutan) ;
...
//                             }
                             ...
                             return strtoupper(\app\models\cbelajar\TblLanjutan::find()->where(['icno'=>$data->icno,'idLanjutan'=>2])->one()->stlanjutan)
                             . ' HINGGA '.strtoupper(\app\models\cbelajar\TblLanjutan::find()->where(['icno'=>$data->icno,'idLanjutan'=>2])->one()->ndlanjutan) ;
...
//                             }
                             ...
                             return strtoupper(\app\models\cbelajar\TblLanjutan::find()->where(['icno'=>$data->icno,'idLanjutan'=>3])->one()->stlanjutan)
                             . ' HINGGA '.strtoupper(\app\models\cbelajar\TblLanjutan::find()->where(['icno'=>$data->icno,'idLanjutan'=>3])->one()->ndlanjutan) ;
...
<div class="col-md-12 col-sm-12 col-xs-12 "> 
 ...
 <div class="x_panel" >
    ...
    <div class="x_title">
        ...
        <p align="right"> 
<?= Html::a('Lihat Semua', ['cbadmin/search-all-pengajian'], 
...
<div class="x_panel">
    <div class="x_title">
        <h5><i class="fa fa-th-list"></i><strong> REKOD PERMOHONAN PENGAJIAN 
                KAKITANGAN YANG DILULUSKAN (AKTIF)</strong></h5>
...
//                'label' => 'JFPIB',
    ...
    return strtoupper($model->tahapPendidikan);
                ...
                'hAlign' => 'center', 
                        ...
                        'filter' => Select2::widget([
                            'name' => 'modeID',
                            'value' => isset(Yii::$app->request->queryParams['modeID'])? Yii::$app->request->queryParams['modeID']:'',
                            'data' => ArrayHelper::map(app\models\cbelajar\Modpengajian::find()->all(), 'id', 'studyMode'),
                            'options' => ['placeholder' => ''],
                            'pluginOptions' => [
                                'allowClear' => true
                            ],
                             ...
                             if($model->modeID)
                             {
                              return strtoupper($model->mod->studyMode);}
                             else
                             {
                                    return '-';
                             }
...
//                                        'target' => '_blank',
                        ...
                        return Html::button('', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['view_e', 'id' =>$data->id]),'style'=>'background-color: transparent; 
