...
?>
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12"> 
                ...
                <div class="x_panel" id="rcorners2">
                    <h5><i class="fa fa-address-book"></i> SENARAI PERMOHONAN BAHARU [PHD/POS DOKTORAL/ SARJANA/ CUTI SABATIKAL/ LATIHAN INDUSTRI/LATIHAN PENSIJILAN PROFESIONAL]</h5>

                    <hr>
                                 <?= $this->render('/cutisabatikal/_senarai_menunggu', ['bil' => 1,  'icno' => $icno, 'senarai' => $senarai,
                                         'permohonanlulus'=>$permohonanlulus,'tolak'=>$tolak,
