            ...
            <div class="row">
                <div class="col-xs-12 col-md-4">
                    ...
                    $resume = \yiister\gentelella\widgets\StatsTile::widget(
                                    [
                                        'icon' => 'legal',
                                        'header' => 'NOMINAL DAMAGES',
                                        'text' => 'Nominal Damages',
                                        'number' => '1',
                                    ]
                    );
                    echo Html::a($resume, ['view-bon?id='.SHA1($model->ICNO).'&page=rekod-bon']);
                ...
                <div class="col-xs-12 col-md-4">
                    ...
                    echo Html::a($dokumen, ['view-bon?id='.SHA1($model->ICNO).'&page=rekod-bon']);
                    ?>
                </div>
                 ...
                 <div class="col-xs-12 col-md-4">
                    ...
                    echo Html::a($semakan, ['view-bon?id='.SHA1($model->ICNO).'&page=rekod-bon']);
                    ?>
           </div>
...
<!--            <= Html::a('Kemaskini', ['update2', 'id' => $model->ICNO], ['class' => 'btn btn-primary mapBtn ', 'id' => 'modalButton']) ?>-->
            <?= Html::button('Tambah Rekod', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['add-bon', 'id' => $model->ICNO]),'class' => 'btn btn-primary btn-xs mapBtn']) ?>
...
<form id="w0" class="form-horizontal form-label-left" action="">
   ...
   <thead>
        ...
        <tr class="headings">
            ...
            <th class="column-title text-center">TARIKH MULA BERKHIDMAT </th>
...
<td class="text-center"><?= $bil++ ?></td>
            <td class="text-center"><?= $bon->dt_mkhidmat; ?></td>
