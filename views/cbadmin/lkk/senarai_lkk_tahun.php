                ...
                'value'=>function ($data) {
                    return $data->kakitangan->department->shortname;
                        ...
                        [   
                            ...
                            'label' => 'MOD PENGAJIAN',
                            'value' => function ($data) {
                                if($data->pengajian->mod)
                                {
                                //return Html::a(ucwords(strtoupper($data->sasaran3->tajukLatihan)));
                                return Html::a(strtoupper($data->pengajian->mod->studyMode));
                                }
                                else{
                                    echo '-';
                                }
...
<!--         <div class="x_title">
    ...
    <div class="x_title">
            <h5><strong>MUAT TURUN LAPORAN KEMAJUAN PENGAJIAN (LKP)</strong></h5>
...
<p align ="left">  <?=
                    ExportMenu::widget([
                            ...
                            'columns' => $gridColumns,
                            'filename' => 'LAPORAN PENGHANTARAN LKP BULANAN '.' '.$tahun,
                            'clearBuffers' => true,
                            'stream' => false,
