...
?>
    ...
    <p align="right">  <?= Html::a('Kembali', ['cutibelajar/senarai-staff-fakulti-pp'], 
...
<div class="x_panel">
            <div class="x_title">
                <h5><strong><i class="fa fa-bar-chart"></i>PEMANTAUAN LAPORAN KEMAJUAN PENGAJIAN KAKITANGAN AKADEMIK <i>(BY MONTH)</i></strong></h5>
