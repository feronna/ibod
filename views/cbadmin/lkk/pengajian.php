...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 "> 
        <p align="right">  <?= Html::a('Kembali', ['cbadmin/main-lkp?id=' . $biodata->ICNO], ['class' => 'btn btn-primary btn-sm']) ?></p>
...
//        foreach ($b as $b) {
                                ...
                                <?php if ($b->t) {
                                    ...
                                    <tr> 
                                        ...
                                        <td style="width:20%">
                                            ...
                                            <?php
                                            if (($b->t->MajorCd == NULL) && ($b->t->MajorMinor != NULL)) {
        ...
        <?php
        if (($b->HighestEduLevelCd === 1) || ($b->HighestEduLevelCd === 202) || ($b->HighestEduLevelCd === 205) ||
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <p align="left"> 
                            <?=
                            Html::button('Tambah Rekod', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['add-lkk?id=' . $b->id,
...
//                                 $lkk = app\models\cbelajar\TblLkk::find()->where(['icno'=> $id, 'reportID'=> $i, 'status_form'=>2])->one();
                                            ...
                                            <td class="text-center" style="width:30%;">
                                                <?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['lkk/adminview', "id" => $lkk->reportID], ['class' => 'btn btn-default btn-xs'])
                                                ?> | 
                                                <?=
                                                Html::button('<i class="fa fa-pencil" aria-hidden="true"></i>', ['id' => 'modalButton',
                                                    'value' => \yii\helpers\Url::to(['up-lkk', 'id' => $lkk->reportID]),
                                                    'class' => 'btn btn-default btn-xs mapBtn'])
                                                ?> | 
                                                <?=
                                                Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['cbadmin/delete-lkk?id=' . $lkk->reportID], ['class' => 'btn btn-default btn-xs',
                                                    'data' => ['confirm' => 'Anda ingin membuang rekod ini?',],
                                                ])
                                                ?> |
                                                <?= Html::a('<i class="fa fa-bullhorn" aria-hidden="true"></i>', ['notifistaf?id=' . $id . '&&n_date=' . $lkk->effectivedt], ['class' => 'btn btn-primary btn-xs'])
                                                ?>
            ...
            <?php
        } elseif ($b->HighestEduLevelCd === 210) {
            ?>
            <div class="col-md-12 col-sm-12 col-xs-12">
...
//                        echo round($sem);
                                        ?>  <tr>
                                            ...
                                            <td style="width:30%;"> 
                                                ...
                                                } elseif ($lkk->semester == 2) {
                                                    ?>

                                                    <?php
                                                    echo '<span class="label label-success">AWAL BULAN KE-6</span>';
                                                } else {
                                                    ?>
...
//                                 $lkk = app\models\cbelajar\TblLkk::find()->where(['icno'=> $id, 'reportID'=> $i, 'status_form'=>2])->one();
                                            ...
                                            <td class="text-center" style="width:30%;">
                                                <?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['lkk/pengesahan-admin-ir', "id" => $lkk->reportID], ['class' => 'btn btn-default btn-xs'])
                                                ?> | 
                                                <?=
                                                Html::button('<i class="fa fa-pencil" aria-hidden="true"></i>', ['id' => 'modalButton',
                                                    'value' => \yii\helpers\Url::to(['up-lkk', 'id' => $lkk->reportID]),
