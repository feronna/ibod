...
//                    ],
                ...
                'value'=>function ($data) use ($lkk){
//                                          $year = date('m', strtotime($data->effectivedt));

                    return $data->lkk->effectivedt;
                },
                'filter' => Select2::widget([
...
//                                1 => 'JANUARI', 2 => 'FEBRUARI', 3=>'MAC'],
                ...
                'hAlign' => 'center',
                        ...
                        {
                            return "<strong><small>TELAH DIHANTAR</small></strong>";
                        }
                        }
                        ,
                            'vAlign' => 'middle',
