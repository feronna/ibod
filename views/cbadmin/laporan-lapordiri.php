...
<!--<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <?= Html::beginForm(['laporan-lapor-diri ', 'id' => $icno], 'GET'); ?>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="col-xs-12 col-md-12 col-lg-12"> 
                <div class="x_title">
        <h5><strong><i class="fa fa-calendar-check-o"></i> STATISTIK BULANAN KAKITANGAN YANG LAPOR DIRI KEMBALI BERTUGAS</strong></h5>
        ...
        <div class="x_panel">
            <div class="x_title">
                <h5><strong><i class="fa fa-suitcase"></i> LAPORAN KAKITANGAN LAPOR DIRI KEMBALI BERTUGAS</strong></h5>
<!--                <ul class="nav navbar-right panel_toolbox">
                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
            ...
            <div class="x_content">
                <?= Html::beginForm(['laporan-lapor-diri ', 'id' => $icno], 'GET'); ?>
                <?= Html::dropDownList('tahun', $tahun, ['2022'=>'2022','2021' => '2021', '2020' => '2020', '2019' => '2019', '2018' => '2018', '2017' => '2017', '2016' => '2016',
                    '2015'=>'2015','2014'=>'2014','2013'=>'2013','2012'=>'2012','2011'=>'2011','2010'=>'2010'], ['class' => 'form-control col-md-3 col-sm-3 col-xs-12']); ?>
                <br>
                <br>
                <?= Html::dropDownList('bulan', $bulan, ['01' => 'Januari', '02' => 'Februari', '03' => 'Mac', '04' => 'April', '05' => 'Mei', '06' => 'Jun', '07' => 'Julai', '08' => 'Ogos', '09' => 'September', '10' => 'Oktober', '11' => 'November', '12' => 'Disember'], ['class' => 'form-control col-md-1 col-sm-1 col-xs-12']); ?>
                <br>
            ...
            <div class="col-xs-12 col-md-12 col-lg-12"> 
                ...
                <div class="x_panel">
                    ...
                    <div class="x_title">
        <h5><strong><i class="fa fa-graduation-cap"></i> SENARAI KAKITANGAN YANG TELAH KEMBALI BERTUGAS</strong></h5>
...
//                            'contentOptions' => ['class'=>'text-center'],
                            ...
                            return Html::a('<strong><small>' . strtoupper($model->studysemasa->InstNm) . '</small></strong><br>' .
                                            '<small>' . $model->studysemasa->tahapPendidikan . '</small><br>' .
                                            '<small>' . strtoupper($model->studysemasa->tarikhmula) . ' HINGGA</small> ' .
                                            '<small>' . strtoupper($model->studysemasa->tarikhtamat) . '</small> ' .
                                            '<small>(' . strtoupper($model->studysemasa->tempohtajaan) . ')</small><br>');
                        },
                                'format' => 'html',
                            ],
                                    [
...
//                        ],
                        ...
                        'value' => function($model) {
                            ...
                            return Html::a('<i class="fa fa-th-list" aria-hidden="true"></i>',  ['view-rekod-staf',  'id' => $ICNO], [
