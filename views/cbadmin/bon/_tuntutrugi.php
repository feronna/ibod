...
<h5> <strong><center>PENGIRAAN JUMLAH TUNTUTAN GANTIRUGI</center></strong> </h5>
...
?>          </div>
        ...
        <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12">JUMLAH TUNTUTAN:<span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12">JUMLAH KUTIPAN NOMINAL DAMAGES :<span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?= $form->field($model, 'c1')->textArea(['maxlength' => true, 'rows' => 4])->label(false); ?>
                </div>
            </div>
       <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12">JUMLAH TUNTUTAN SEBENAR:<span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
