...
<?php
  echo Html::a(Yii::t('app','<i class="fa fa-address-card"></i> <span class="label label-success">BELUM ADA PELANJUTAN</span>'), ['cbadmin/belum-ada-pelanjutan'], ['class' => 'btn btn-default btn-lg']);
  echo Html::a(Yii::t('app','<i class="fa fa-calendar"></i> <span class="label label-info">ADA PELANJUTAN</span>'), ['cbadmin/search-cb'], ['class' => 'btn btn-default btn-lg']);
...
<div class="x_panel">
    <div class="x_title">
        <h4><strong><i class="fa fa-suitcase fa-md" style="color:purple"></i> SENARAI KAKITANGAN YANG BELUM MEMOHON PELANJUTAN TEMPOH CUTI BELAJAR</strong></h4>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
