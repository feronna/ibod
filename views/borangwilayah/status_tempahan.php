...
<?php if($model->status_tempahan == '' || $model->status_tempahan == 'NEW' ){?>
<div class="row"> 
    <div class="x_panel" >
        <div class="x_title">
            <h2><strong>Status Tempahan Penerbangan</strong></h2>
                <p align="right"><?= \yii\helpers\Html::a('Kembali', ['borangwilayah/senaraipentadbiran'], ['class' => 'btn btn-default btn-sm']) ?></p>
    ...
    <div class="x_content">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                  <?= $form->field($model, 'status_tempahan')->label(false)->widget(Select2::classname(), [
                    'data' => ['TELAH DITEMPAH' => 'TELAH DITEMPAH',
                                    ],
...
<?php } ?>
<?php if($model->status_tempahan == 'TELAH DITEMPAH'){?>
   ...
   <div class="row"> 
    ...
    <div class="x_content">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <?= $form->field($model, 'jumlah')->textArea(['maxlength' => true, 'rows' => 4])->textInput(['disabled'=>'disabled'])->label(false); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <?= $form->field($model, 'emailDt')->textArea(['maxlength' => true, 'rows' => 4])->textInput(['disabled'=>'disabled'])->label(false); ?>
        ...
        <div class="customer-form">  
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3"> 
                    <br>
                    <?= Html::a(' KEMASKINI ', ['borangwilayah/kemaskini-tempahan', 'id' => $model->id],['class' => 'btn btn-primary']); ?>
