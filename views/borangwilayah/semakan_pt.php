                ...
                <tr>
                 ...
                 <tr>
                        ...
                        <td colspan="3"> 
                           ...
                           <?php
//                            if($model->tarikh_terakhir != NULL){
//                                echo ' <input type="text" class="form-control" value="'.$model->lastdt.'" disabled="disabled">'; //id 1 n 2 
//                            } 
//                            else { 
...
//                            } 
                            ...
                            <input type="text" class="form-control" value="<?php echo $model->lastdt;?>" disabled="disabled">
                             <?php //echo $mod->lastdt;?>
                        </td>
                ...
                <tr class="headings"> 
                     <td valign="4">Kadar Kelayakan :<span class="required" style="color:red;">*</span></td>
                     <td colspan="8">
                         <?php  if($kadar){ ?>
                            <input type="text" class="form-control" value="<?php echo $kadar->tanggungan;?>" disabled="disabled">
                         <?php }else{?>
                            <input type="text" class="form-control" value=" " disabled="disabled"><br>
                             <?php // $form->field($kadar, 'tanggungan')->textArea(['maxlength' => true]) ->label(false);?> 
                             <div style="color: green; margin-top: 0px;"> Klik sini <?php echo Html::a('<i class="fa fa-edit"></i> ',['kemudahan/tanggungan'], ['class' => 'btn btn-success btn-sm','target'=>'_blank']); ?>untuk mengemaskini kadar kelayakan.
                        </div>
                         <?php }?>
...
<!--                    <td valign="4">Dokumen Sokongan :<span class="required" style="color:red;"></span></td>
    ...
    <div class="row"> 
    <div class="x_title">
            <h2><i class="fa fa-plus-circle"></i> Maklumat Pasangan dan Anak Jenis Maklumat</center></h2>
                <!--(A = Anak, S = Suami, I = Isteri)-->
            <div class="clearfix"></div>
        </div> 
             <div class="x_content">
             <div class="table-responsive">
             ...
             <div class="table-responsive">
                 <table class="table table-sm table-bordered jambo_table table-striped">
                    ...
                    <tr class="headings">
                        ...
                        <th scope="col" colspan=4" ><center>KETIBAAN</center></th>
...
<!--                        <td><center><?php// $planes->penerbangan->jenisKelas; ?></center></td>-->
                 ...
                 <div class="form-group text-right">
                      <?php echo Html::a('KEMASKINI <i class="fa fa-edit"></i> ',['borangwilayah/kemaskini-penerbangan', 'id' => $planes->parent_id], ['class' => 'btn btn-success btn-sm','target'=>'_blank']); ?>
                 </div>
                </div>
            </div>  
    </div>
        ...
        <?php if($model->status_pt == 'MENUNGGU TINDAKAN' || $model->status_pt == '' && $model->entry_type == 1){?>    
        <div class="row"> 
    <div class="x_panel">
        <div class="x_title">
     ...
     <?php if($model->status_pt == 'SEMAKAN LAYAK' || $model->status_pt == 'SEMAKAN TIDAK LAYAK' || $model->status_pt == 'LAYAK' || $model->status_pt == 'TIDAK LAYAK'){?>    
        <div class="row"> 
    <div class="x_panel">
        <div class="x_title">
             <h2><i class="fa fa-book"></i><strong>  Semakan Oleh Pembantu Tadbir BSM</strong></h2>
