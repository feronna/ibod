...
<div class="x_panel">
    ...
    <p>
        <?= \yii\helpers\Html::a('Kembali', ['biodata/adminview', 'id' => $model->icno], ['class' => 'btn btn-primary']) ?>
    ...
    <div class="row">
        ...
        //echo Html::a('Kemaskini Vaksin Dos Pertama', ['kemaskini-dos-pertama'], ['class' => 'btn btn-warning']);
    ...
    <div class="row">
        ...
        //if (Yii::$app->MP->EligibleBooster()) {
            //echo Html::a('Kemaskini Dos Penggalak', ['kemaskini-dos-penggalak'], ['class' => 'btn btn-success']) .'</br>';
            if ($dospenggalak && $model->terima_penggalak == 1) {
                echo DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            'label' => 'Jenis Dos',
                            'value' => ($dospenggalak->jenis_dos == 1) ? 'Dos Penggalak' : '(not set)',
                        ],
                        [
       ...
       // }else{
        //    echo '<span class="label label-success" style="font-size:12px">Maklumat Layak Terima Dos Penggalak</span>';
//}
