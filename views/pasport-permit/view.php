...
<div class="tab-content">
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
         ...
         <?= Html::a('Back', ['biodata/userview'], ['class' => 'btn btn-primary']) ?>
         <?= Html::a('New Passport', ['tambahpasport'], ['class' => 'btn btn-primary']) ?>   
            ...
            <table class="table table-sm table-bordered jambo_table table-striped">
                ...
                <tr>
                    ...
                    <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['lihatpasport', 'id' => $pasportkakitangan->id]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['updatepasport', 'id' => $pasportkakitangan->id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['deletepaspot', 'id' => $pasportkakitangan->id], [
                         'data' => [
    ...
    foreach ($permit as $permitkakitangan) {
        ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['lihatpermitkerja', 'id' => $permitkakitangan->id]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['updatepermitkerja', 'id' => $permitkakitangan->id]) ?> | <?=
                            Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['deletepermit', 'id' => $permitkakitangan->id], [
                                'data' => [
                                    'confirm' => 'Do you wish to remove this data ?',
                                    'method' => 'post',
                                ],
