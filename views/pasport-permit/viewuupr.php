...
<div class="col-md-12 col-sm-12 col-xs-12 ">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <?= Html::a('<i class="fa fa-repeat"> Reset</i>', ['view-u-u-pr'], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('<i class="fa fa-refresh"> Refresh</i>', ['refresh'], ['class' => 'btn btn-success']) ?>
            <?= Html::a('<i class="fa fa-download"> Download</i>', ['download-excel', 'pp' => 'pr'], ['class' => 'btn btn-success', 'target' => '_blank']) ?>

            <?= Html::a('<i class="fa fa-bell"> to Not Exist Only</i>', ['send-noty', 'status_value' => '3', 'pp' => 'pr'], ['class' => 'btn btn-success',
                'data' => [
                    'confirm' => 'Do you wish to send notifications to Not Exist Only ?',
                    'method' => 'post',
                        ],]) ?>
            <?= Html::a('<i class="fa fa-bell"> to Exipred Only</i>', ['send-noty', 'status_value' => '2', 'pp' => 'pr'], ['class' => 'btn btn-success',
                'data' => [
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'filter' => Select2::widget([
                                'name' => 'pr_noty_status',
                                'value' => isset(Yii::$app->request->queryParams['pr_noty_status']) ? Yii::$app->request->queryParams['pr_noty_status'] : '',
                                'data' => ['1' => 'ON', '0' => 'OFF'],
                                'options' => ['placeholder' => ''],
                                'pluginOptions' => [
                                    'allowClear' => true
                        ...
                        [
                            ...
                            'filter' => Select2::widget([
                                'name' => 'permit_status',
                                'value' => isset(Yii::$app->request->queryParams['permit_status']) ? Yii::$app->request->queryParams['permit_status'] : '',
                        ...
                        [
                            ...
                            'urlCreator' => function ($action, $model, $key, $index) {
                                ...
                                if ($action === 'update-noty-status') {
                                    $url = $action . '?icno=' . $model->ICNO. '&pp=pr';
                                    return $url;
                                    //return Url::to(['biodata/adminview', 'id' => $model->ICNO]);
                                }
                                if ($action === 'send-noty') {
                                    $url = $action . '?id=' . $model->ICNO. '&pp=pr' ;
                                    return $url;
                                    //return Url::to(['biodata/adminview', 'id' => $model->ICNO]);
                                }
                                if ($action === 'lock-noty') {
