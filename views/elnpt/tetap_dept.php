...
<?php
    Modal::begin([
        'header' => 'Tamabah/Kemaskini Rubrik Jabatan',
        //'id' => 'modal',
        'size' => 'modal-md',
        'options' => [
            'id' => 'modal',
...
<div class="row">
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><strong>Carian Rubrik Jabatan</strong></h2>
            ...
            <?php $form = ActiveForm::begin(['id' => 'search',  'method' => 'get', 'options' => ['class' => 'form-horizontal form-label-left']]); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <?=
                            $form->field($searchModel, 'ref_kump_dept_id')->label(false)->widget(Select2::classname(), [
                                'data' => ArrayHelper::map(RefKumpDept::find()
                                    ->all(), 'id', 'kump_dept'),
                                'hideSearch' => false,
                                'options' => [
                                    'placeholder' => 'Carian ...', 
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">JFPIU</label>
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <?=
...
<div class="row">
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><strong>Senarai JFPIU</strong></h2>
            <div class="clearfix"></div>
        </div>
        <div class="panel-body">
            <p>
                <?php $form = ActiveForm::begin([]); ?>
                <?= Html::button('Tambah JFPIU', [
                    'value' => Url::to(['elnpt/tambah-rubrik-dept']),
...
//                                ],
                                [
                                    ...
                                    'contentOptions' => ['class'=>'text-center'],
                                    'value' => function($model) {
                                        return $model->namaKumpDept->kump_dept;
