...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>CALCULATOR LNPT v0.3</strong></h2>
                ...
                <div class="row">
                    ...
                    echo Alert::widget([
                        ...
                        'body' => '<font color="black">
                            ...
                            <p>
                            Kalkulator ini bertujuan untuk membuat simulasi markah LNPT berdasarkan model LNPT 2022 UMS. Output dihasilkan hanya tujuan rujukan dan tidak mewakili mata LNPT sebenar.
                            </p>
                        </font>',
                    ]);
                    ?>
