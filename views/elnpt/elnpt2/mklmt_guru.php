...
<?= ($lpp->PYD == Yii::$app->user->identity->ICNO) ? $this->render('//elnpt/elnpt2/_menu', ['menu' => $menu, 'lppid' => $lppid, 'sah' => isset($lpp) ? $lpp->PYD_sah : false])
    : $this->render('//elnpt/elnpt2/_semakMenu', ['mrkh_all' => $menu, 'lppid' => $lppid]); ?>
                    ...
                    DetailView::widget([
                        ...
                        'attributes' => [
                            ...
                            [
                                'label' => 'PEER',
                                'value' => function ($model) {
                                    return is_null($model->peer) ? '<b>Peer Belum Ditetapkan. Sila Berhubung dengan Penetap Penilai di J/S/P/I/U anda.</b>' : ((app\models\elnpt\testing\TblTestingAccess::find()->where(['icno' => Yii::$app->user->identity->ICNO, 'access' => 1])->exists()) ? (($model->peer) ? $model->peer->CONm : null) : '<b>Peer Sudah Ditetapkan.</b>');
                                },
                                'format' => 'html',
                            ],
                            [
