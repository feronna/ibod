...
<div class="row">
    ...
    <div class="x_panel">
        ...
        <div class="panel-body">
            ...
            <p align="center">
                Saya (<?= $model->peer->CONm; ?>) mengesahkan bahawa semua maklumat yang terkandung pada Laporan Penilaian Prestasi Tahun <?= $model->tahun; ?> ini adalah benar.<br>
            </p>
            
            <div style="text-align: center">
                <?= $form->field($model, 'PEER_sah')->checkbox(['label' => null]); ?>
