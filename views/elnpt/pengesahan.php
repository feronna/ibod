            ...
            <div class="x_content">
                <div class="row">
                    ...
                    <div style="text-align: center">
                        <?= Html::button('Sahkan', ['value' =>  Url::to(['elnpt/pengesahan-pyd', 'lppid' => $lpp->lpp_id]), 'class' => 'btn btn-success btn-sm modalButton'])?>
                    </div>
                    <?php } ?>
                </div>
            </div>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="row">
                    ...
                    <div style="text-align: center">
                        <?= Html::button('Sahkan', ['value' =>  Url::to(['elnpt/pengesahan-ppp', 'lppid' => $lpp->lpp_id]), 'class' => 'btn btn-success btn-sm modalButton'])?>
                    </div>
                    <?php } ?>
                </div>
            </div>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="row">
                    ...
                    <div style="text-align: center">
                        <?= Html::button('Sahkan', ['value' =>  Url::to(['elnpt/pengesahan-ppk', 'lppid' => $lpp->lpp_id]), 'class' => 'btn btn-success btn-sm modalButton'])?>
                    </div>
                    <?php } ?>
                </div>
            </div>
