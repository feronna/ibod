...
$tester = app\models\elnpt\testing\TblTestingAccess::find()->where(['icno' => Yii::$app->user->identity->ICNO, 'access' => 99])->exists();
?>
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'value' => function ($model) {
                                        ...
                                        return Html::a('<b><u>' . $model->tahun . '</u></b>' . (($model->tahun == 2022) ? ' <b>Uji Lari</b>' : '') . '', [$u, 'lppid' => $model->lpp_id]);
                                    },
                                    //'attribute' => 'tahun',
                                    'format' => 'html',
                                ],
                                ...
                                [
                                    ...
                                    'value' => function ($model) {
                                        switch ($model->tahun) {
                                            case 2020:
                                                $u = 'elnpt2/generate-borang';
                                                break;
                                            case 2021:
                                                $u = 'elnpt2/generate-borang';
                                                break;
                                            default:
                                                $u = 'elnpt/generate-borang';
                                        }

                                        return ($model->PYD_sah == 1 && $model->PPP_sah == 1 && $model->PPK_sah == 1 && $model->PEER_sah == 1)
                                            ? Html::a('<i class="fa fa-print" aria-hidden="true"></i>', [$u, 'lppid' => $model->lpp_id])
                                            : '';
                                    },
                                    'format' => 'html',
                                ],
