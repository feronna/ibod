...
<div class="row">
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><strong>Penetapan Akses</strong></h2>
            
            <div class="clearfix"></div>
        </div>
        <div class="x_content">
            <?php $form = ActiveForm::begin(['action' => ['penetapan-akses-testing'], 'method' => 'get', 'options' => ['class' => 'form-horizontal form-label-left', 'data-pjax' => 1]]); ?>
...
<div class="row">
    ...
    <div class="x_panel">
                    ...
                    'columns' => [
                        ...
                        [
                           //'attribute' => 'CONm',
                            ...
                            'value' => function($model) {
                                return '<strong>'.$model->CONm.'</strong><br><small>'.$model->department->fullname.'</small>'.
                        ...
                        [
                           //'attribute' => 'CONm',
                            ...
                            'contentOptions' => ['class'=>'text-center'],
                            'value' => function($model) {
                                return is_null($model->testingAkses) ? '-' : $model->testingAkses->aksesDesc->desc;
                            },
                            //'attribute' => 'test'
                        ],
                        [
                           ...
                           //'attribute' => 'CONm',
                            ...
                            'buttons' => [
                                'update' => function ($url, $model) {
                                    $url = Url::to(['elnpt/akses', 'ICNO' => $model->ICNO]);
        ...
        <?php
                    Modal::begin([
                        'header' => '<strong>Kemaskini Akses Pengguna</strong>',
                        'id' => 'modal',
                        'size' => 'modal-lg',
                    ]);
