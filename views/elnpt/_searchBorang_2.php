        ...
        <div class="x_content">
            <?php $form = ActiveForm::begin(['id' => 'search',  'method' => 'get', 'options' => ['class' => 'form-horizontal form-label-left'], 'action' => $action]); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <?=
                            $form->field($model, 'gred_jawatan_id')->label(false)->widget(Select2::classname(), [
                                'data' => ArrayHelper::map(GredJawatan::find()->orderBy(['id' => SORT_ASC,])->all(), 'id', 'fname'),
                                'hideSearch' => false,
                                'options' => [
                                    'placeholder' => 'Cari Gred Jawatan', 
                                    'multiple' => true
                                    //'class' => 'form-control col-md-7 col-xs-12',
                                    //'id' => 'jenis_carian',
                                    ],
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?=
                            ...
                            $form->field($model, 'khidmat')->widget(CheckboxX::classname(), [
                                'autoLabel' => true,
                                'labelSettings' => [
                                    'label' => 'Telah berkhidmat bagi tempoh genap setahun pada hari terakhir tahun penilaian (Tarikh tamat peniliaan PEER)',
                                    'position' => CheckboxX::LABEL_RIGHT
                                ],
                                'pluginOptions'=>['threeState'=>false]
                            ])->label((false));
