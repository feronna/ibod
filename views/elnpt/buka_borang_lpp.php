        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="row">
                    ...
                    <?= Html::button('Tambah Rekod', ['value' =>  Url::to(['elnpt/buka-borang']), 'class' => 'btn btn-success btn-sm modalButton']) ?>
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'value' => function ($model) {
                                        ...
                                        return Html::button('<span class="glyphicon glyphicon-edit"></span>', ['value' => Url::to(['elnpt/kemaskini-buka-borang', 'id' => $model->id]), 'class' => 'btn btn-default btn-sm modalButton']) .
                                            Html::a('<span class="glyphicon glyphicon-trash"></span>', ['elnpt/padam-buka-borang', 'id' => $model->id], ['class' => 'btn btn-default btn-sm']);
                                    },
                                    'format' => 'raw',
                                ],
                                //                                [
