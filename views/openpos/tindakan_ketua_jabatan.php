...
?>
    <div class="x_panel">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                $form->field($model, 'jawatan_dipohon')->label(false)->widget(Select2::classname(), [
                    ...
                    'options' => ['placeholder' => 'Pilih WP', 'class' => 'form-control col-md-7 col-xs-12', 'disabled' => 'disabled'],
                    'pluginOptions' => [
                        'allowClear' => true
                    ],
                ]);
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Tujuan Permohonan <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <?= $form->field($model, 'tujuan')->textArea(['maxlength' => true, 'rows' => 4, 'disabled' => true])->label(false); ?>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
                ...
                $form->field($model, 'status_kj')->label(false)->widget(Select2::classname(), [
                    'data' => ['APPROVED' => 'PERMOHONAN DIPERAKUKAN', 'REJECTED' => 'PERMOHONAN DITOLAK', 'PINDAAN' => 'PERLU PINDAAN'],
