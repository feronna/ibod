...
<div class="x_panel">   
    ...
    <div class="col-md-12 col-sm-12 col-xs-12"> 
        <div class="x_panel">
            <?php if ($biodata->jawatan->job_category == 2) { ?>
                <p align="right"><?= Html::a('<i class="fa fa-download" aria-hidden="true"></i>', ['download-resume', 'id' => sha1($biodata->ICNO)], ['class' => 'btn btn-default btn-sm', 'target' => '_blank']); ?></p>
            <?php } else { ?>
                <br/>
            <?php } ?>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="" role="tabpanela" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                <li role="presentation" class="active"><a href="#tab_content1a" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true"><b>Professional Development (3 years taken)</b></a>
                </li>
