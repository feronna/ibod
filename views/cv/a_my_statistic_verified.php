...
<div class="x_panel">  
    <center>  <p style="font-size:18px;font-weight: bold;"><i class="fa fa-bar-chart"></i> LAPORAN "Telah Disahkan"</p></center><br/>
    ...
    <div class="x_content">     
        ...
        <div class="x_panel"> 
            <div class="x_title">
                <h2><b>PENERBITAN <button type="button" class="btn btn-default"><b>JUMLAH KESELURUHAN : <?= count($model->publication); ?></b></button></b></h2>  
                <p align="right"><button class="btn btn-default btn-md"><i class="fa fa-map-marker" aria-hidden="true"></i></button> <strong>SUMBER DATA SMPPI</strong></p>
                <div class="clearfix"></div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-6">
                <table class="table table-sm table-bordered jambo_table table-striped">
                    ...
                    <?php foreach ($model->publicationType as $r) { ?> 
                        <tr>
                            ...
                            <td class="text-center">
                                <?=
                                count(array_filter($model->publication, function ($var) use ($r) {
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2><b>PERSIDANGAN <button type="button" class="btn btn-default"><b>JUMLAH KESELURUHAN : <?= count($model->persidangan2); ?></b></button></b></h2>  
                <p align="right"><button class="btn btn-default btn-md"><i class="fa fa-map-marker" aria-hidden="true"></i></button> <strong>SUMBER DATA SMPPI</strong></p>
                <div class="clearfix"></div>
            </div>
                ...
                <table class="table table-sm table-bordered jambo_table table-striped">
                    ...
                    <?php foreach ($model->outreachingKeahlian as $r) { ?> 
                        <tr>
                            ...
                            <td class="text-center">
                                <?=
                                count(array_filter($model->outreaching2, function ($var) use ($r) {
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2><b>PERUNDINGAN KINIKAL <button type="button" class="btn btn-default"><b>JUMLAH KESELURUHAN : <?= count($model->outreachingClinical2); ?></b></button></b></h2>  
                <p align="right"><button class="btn btn-default btn-md"><i class="fa fa-map-marker" aria-hidden="true"></i></button> <strong>SUMBER DATA SMPPI</strong></p>
                <div class="clearfix"></div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-6"> 
                <table class="table table-sm table-bordered jambo_table table-striped">
                    ...
                    <?php foreach ($model->outreachingJenisRawatan as $r) { ?> 
                        <tr>
                            ...
                            <td class="text-center">
                                <?=
                                count(array_filter($model->outreachingClinical2, function ($var) use ($r) {
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                    ...
                    <tr>  
                        ...
                        <td class="text-center"><?=
                            count(array_filter($model->outreaching2, function ($var) {
