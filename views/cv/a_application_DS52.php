...
<div class="x_panel"> 
            ...
            <div class="x_panel">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <table class="table table-sm table-bordered jambo_table table-striped">
                        ...
                        <tr>
                            <th colspan="4" class="text-center"><button class="btn btn-default btn-md"><i class="fa fa-map-marker" aria-hidden="true"></i></button> Sumbar data SMPPI</th>
                        </tr>
                    </table>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-6">
    ...
    <?= Html::a($button, [''], ['class' => 'btn btn-default btn-md', 'disabled' => true]); ?>
                    ...
                    <?= Html::a('<i class="fa fa-edit"></i> <B>KEMASKINI TARIKH MULA PENGAJIAN (PHD) </b>', ['pendidikan/adminview','icno'=>$model->ICNO], ['class' => 'btn btn-default btn-sm', 'target' => '_blank',]); ?>
                </div> 
            </div>
        </div>
    </div>  
