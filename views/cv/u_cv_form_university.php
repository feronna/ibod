...
<div class="x_panel"> 
    <div class="x_title">
        <p style="font-size:18px;font-weight: bold;">SERVICE TO UNIVERSITIES</p> 
    ...
    <div class="x_content">   
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Category: <span class="required" style="color:red;">*</span>
            </label>
            <div class="col-md-5 col-sm-5 col-xs-12"> 
                <?=
                $form->field($model, 'level')->widget(Select2::classname(), [
                    'data' => ArrayHelper::map(app\models\cv\RefSwUniversity::find()->where(['active'=>1])->orderBy(['sort' => SORT_ASC])->all(), 'id', 'output'),
        ...
        <table class="table table-sm table-bordered jambo_table table-striped"> 
            ...
            foreach ($record as $record) {
                ...
                <tr>
                    ...
                    <td><?=
                        Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['delete', 'id' => $record->fid, 'title' => 'services-university'], ['class' => 'btn btn-default',
                            'data' => [
                                'confirm' => 'Are you sure you want to delete?',
                                'method' => 'post',
                        ]]);
                        ?>
                        <?= Html::a('<i class="fa fa-edit" aria-hidden="true"></i>', ['edit-services', 'id' => $record->fid, 'title' => 'services-university'], ['class' => 'btn btn-default']);
                        ?>
                    </td>  
                </tr>
