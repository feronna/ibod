        ...
        <div class="x_content">    
            ...
            <div class="form-group">
                ...
                <div class="col-md-7 col-sm-7 col-xs-12"> 
                    <?= $form->field($model, 'paperwork_activities')->textarea(['rows' => 3])->label(false); ?>
                </div>
            </div>   
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($record) {
                            return $record->paperwork_date ? $record->paperwork_date : ' ';
                        }, 
                        ...
                        'label' => 'Aktiviti',
                        'value' => function ($record) {
                            return $record->paperwork_activities ? $record->paperwork_activities : ' ';
                        }, 
                    ],  
                    [
                        'class' => 'yii\grid\DataColumn',
                        'label' => 'Tindakan',
                        'value' => function ($record) {
                            return Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['delete', 'id' => $record->id, 'title' => 'paper-work'], ['class' => 'btn btn-default',
                                        'data' => [
                                            'confirm' => 'Anda yakin ingin padam?',
                                            'method' => 'post',
                                ]]) . ' ' . Html::a('<i class="fa fa-edit" aria-hidden="true"></i>', ['edit-services', 'id' => $record->id, 'title' => 'paper-work'], ['class' => 'btn btn-default']);
                        },
                                'format' => 'raw',
