        ...
        <div class="x_content">    
            ...
            <div class="form-group">
                ...
                <div class="col-md-7 col-sm-7 col-xs-12"> 
                    <?= $form->field($model, 'genincome_activities')->textarea(['rows' => 3])->label(false); ?>
                </div>
            </div>   
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($record) {
                            return $record->genincome_date ? $record->genincome_date : ' ';
                        }, 
                        ...
                        'label' => 'Aktiviti',
                        'value' => function ($record) {
                            return $record->genincome_activities ? $record->genincome_activities : ' ';
                        }, 
                    ],  
                    [
                        'class' => 'yii\grid\DataColumn',
                        'label' => 'Tindakan',
                        'value' => function ($record) {
                            return Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['delete', 'id' => $record->id, 'title' => 'income'], ['class' => 'btn btn-default',
                                        'data' => [
                                            'confirm' => 'Anda yakin ingin padam?',
                                            'method' => 'post',
                                ]]) . ' ' . Html::a('<i class="fa fa-edit" aria-hidden="true"></i>', ['edit-services', 'id' => $record->id, 'title' => 'income'], ['class' => 'btn btn-default']);
                        },
                                'format' => 'raw',
