...
<div class="x_panel"> 
    <div class="x_title"> 
        <p style="font-size:18px;font-weight: bold;">CHECK QUALIFIED - ((DS52) Pensyarah Kanan/(DS51) Pensyarah Kanan) To (DS54) Profesor Madya</p>
        <p align="right">
            ...
            if (TblAccess::isAdminAcademic()) {
                $gridColumns = [
                    ...
                    [
                        'label' => 'Percent',
                        'value' => function ($model) {
                            return Html::a($model->percent, ['criteria-check', 'gred' => 11, 'icno' => sha1($model->user->ICNO)], ['class' => 'btn btn-default btn-md', 'target' => '_blank']);
                        },
                        'format' => 'raw',
                        'contentOptions' => ['class' => 'text-center'],
                    ],
