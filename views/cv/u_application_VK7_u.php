        ...
        <div class="table-responsive">
            ...
            <div class="x_panel"> 
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <tr>     
                                    ...
                                    if ($i == 1) {
                                        $j = count(array_filter($model->persidangan2, function ($var) {
                                                    return ($var['Peranan'] == 'Keynote Speaker' && $var['Peringkat'] == 'Antarabangsa');
                                                }));
                                        if ($j >= $p->ans_no) {
                                            $s = 1;
                                            $i_persidangan++;
                                        ...
                                        $j = count(array_filter($model->persidangan2, function ($var) {
                                                    return ($var['Peranan'] == 'Pembentang' && $var['Peringkat'] == 'Antarabangsa');
                                                }));
                                        if ($j >= $p->ans_no) {
                                            $s = 1;
                                            $i_persidangan++;
                                        ...
                                        $j = count(array_filter($model->persidangan2, function ($var) {
                                                    return (($var['Peranan'] == 'Pengerusi' || $var['Peranan'] == 'Ketua Sesi') && $var['Peringkat'] == 'Antarabangsa');
                                                }));
                                        if ($j >= $p->ans_no) {
                                            $s = 1;
                                            $i_persidangan++;
                    ...
                    <table class="table table-sm table-bordered jambo_table table-striped" style="width:100%">
                        <tr>
                            <th colspan="3" class="text-center" style="background-color:#20c997; color:white;">ii. MENGHADIRI PERSIDANGAN TEMPATAN atau,</th>
                        </tr>
                        <?php
                        $i = 1;
                        $totalPersidangan3 = 0;
                        foreach ($persidangan as $p) {
                            if (($i > 5) && ($i < 11)) {
                                ...
                                <tr>     
                                    ...
                                    if ($i == 6) {
                                        $j = count(array_filter($model->persidangan2, function ($var) {
                                                    return ($var['Peranan'] == 'Keynote Speaker' && $var['Peringkat'] == 'Negeri');
                                                }));
                                        if ($j >= $p->ans_no) {
                                            $s = 1;
                                            $ii_persidangan++;
                    ...
                    <table class="table table-sm table-bordered jambo_table table-striped" style="width:100%">
                        <tr>
                            <th colspan="3" class="text-center" style="background-color:#20c997; color:white;">iii. AHLI JAWATANKUASA PERSIDANGAN</th>
                        </tr>
                        <?php
                        $i = 1;
                        $totalPersidangan2 = 0;
                        foreach ($persidangan as $p) {
                            if (($i >= 11) && ($i <= 12)) {
                                ...
                                <tr>     
                                    ...
                                    if ($i == 11) {
//                                        $j = count(array_filter($model->persidangan2, function ($var) {
//                                                    return (($var['Peranan'] == 'Pengerusi' || $var['Peranan'] == 'Ketua Sesi' || $var['Peranan'] == 'Ahli Panel') && $var['Peringkat'] == 'Antarabangsa');
//                                                }));
//                                        if ($j >= $p->ans_no) {
//                                            $s = 1;
//                                            $iii_persidangan++;
...
//                                        $j = count(array_filter($model->persidangan2, function ($var) {
//                                                    return (($var['Peranan'] == 'Pengerusi' || $var['Peranan'] == 'Ketua Sesi' || $var['Peranan'] == 'Ahli Panel') && $var['Peringkat'] == 'kebangsaan');
//                                                }));
//                                        if ($j >= $p->ans_no) {
//                                            $s = 1;
//                                            $iii_persidangan++;
...
//                                        }
                    ...
                    <table class="table table-sm table-bordered jambo_table table-striped" style="width:100%">
                        <tr>
                            ...
                            if (($i_persidangan == 5) || ($ii_persidangan == 5)) {
                                $s = 1;
                            }
                        ...
                        <?php
                        if (($i_persidangan == 5) || ($ii_persidangan == 5) || ($iii_persidangan == 2)) {
                            $persdgn = 1;
                        } else {
                            $persdgn = 0;
                        }
                    ...
                    <table class="table table-sm table-bordered jambo_table table-striped">
                        ...
                        foreach ($penyeliaan as $p) {
                            ...
                            <tr>     
                                ...
                                if ($i == 1) {
                                    $j = 'TIDAK';
                                    if (($penyeliaanPHD >= 1) || ($penyeliaanDrPHD >= 2)) {
                                        $j = 'YA';
                                    }
            ...
            <div class="x_panel">
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <table class="table table-sm table-bordered jambo_table table-striped">
                        ...
                        <tr> 
                            <th rowspan="4">PEMERIKSA TESIS PASCASISWAZAH <?= Html::a('<i class="fa fa-search"></i>', ['view-cv', 'id' => sha1($model->ICNO), 'title' => 'esteem',], ['class' => 'btn btn-default btn-sm', 'target' => '_blank',]); ?></th>
                            <th colspan="2">PHD</th>
                            <td class="text-center"><?=
                                count(array_filter($model->asPanel, function ($var) {
                                            return ($var['type'] == 13 && ($var['level'] == 'phd')); //Thesis Examiner (By Research)
                                        }));
                                ?></td>
                        </tr>
                        <tr>  
                            <th colspan="2">DrPH</th>
                            <td class="text-center"><?=
                                count(array_filter($model->asPanel, function ($var) {
                                            return ($var['type'] == 13 && ($var['level'] == 'drph')); //Thesis Examiner (By Research)
                                        }));
                                ?></td>
                        </tr> 
                        <tr>  
                            <th colspan="2">MASTER (MEDICAL)</th>
                            <td class="text-center"><?=
                                count(array_filter($model->asPanel, function ($var) {
                                            return ($var['type'] == 13 && ($var['level'] == 'Master (Medical)')); //Thesis Examiner (By Research)
                                        }));
                                ?></td>
                        </tr> 
                        <tr>  
                            ...
                            if ($i >= 13) {
                                ...
                                <tr>     
                                    ...
                                    if ($i == 13) {
                                        ...
                                        $a = count(array_filter($model->asPanel, function ($var) {
                                                    return ($var['type'] == 13 && ($var['level'] == 'phd'));
                                                }));

                                        $b = count(array_filter($model->asPanel, function ($var) {
                                                    return ($var['type'] == 13 && ($var['level'] == 'drph'));
                                                }));

                                        $c = count(array_filter($model->asPanel, function ($var) {
                                                    return ($var['type'] == 13 && ($var['level'] == 'Master (Medical)'));
                                                }));
            ...
            <div class="x_panel">   
                <div class="table-responsive">
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        ...
                        <table class="table table-sm table-bordered jambo_table table-striped">
                            <tr>
                                <th colspan="2" class="text-center" style="background-color:#2A3F54; color:white;">KHIDMAT KEPADA UNIVERSITI <?= Html::a('<i class="fa fa-search"></i>', ['view-cv', 'id' => sha1($model->ICNO), 'title' => 'services',], ['class' => 'btn btn-default btn-sm', 'target' => '_blank',]); ?></th>
                            </tr> 
                            <tr> 
                                <th class="text-center">KRITERIA</th> 
                                <th class="text-center">JUMLAH SEMASA</th> 
                            ...
                            <tr>  
                                <th>JAWATANKUASA PERINGKAT UNIVERSITI</th>
                                <th class="text-center"><?=
                                    count(array_filter($model->serviceUniversity, function ($var) {
                                                return ($var['level'] == '5');
                                            }))
                            ...
                            <tr>  
                                <th>JAWATANKUASA PERINGKAT JFPIU</th>
                                <th class="text-center"><?=
                                    count(array_filter($model->serviceUniversity, function ($var) {
                                                return ($var['level'] == '6');
                                            }))
                            ...
                            <tr>  
                                <th>MEWAKILI UNIVERSITI  (SUKAN/KEGIATAN BUKAN AKADEMIK/TERMASUK PERTANDINGAN REKABENTUK/KIK/INOVASI/AKTIVITI KEBUDAYAAN)</th>
                                <th class="text-center"><?=
                                    count(array_filter($model->serviceUniversity, function ($var) {
                                                return ($var['level'] == '8');
                                            }))
                            ...
                            <tr>
                                <th colspan="2" class="text-center" style="background-color:#2A3F54; color:white;">KHIDMAT KEPADA MASYARAKAT <?= Html::a('<i class="fa fa-search"></i>', ['view-cv', 'id' => sha1($model->ICNO), 'title' => 'services',], ['class' => 'btn btn-default btn-sm', 'target' => '_blank',]); ?></th>
                            </tr> 
                            <tr> 
                                <th class="text-center">KRITERIA</th> 
                                <th class="text-center">JUMLAH SEMASA</th> 
                            ...
                            <tr>
                                <th colspan="2" class="text-center"><button class="btn btn-default btn-md"><i class="fa fa-map-marker" aria-hidden="true"></i></button> Sumber data HROnline</th>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <table class="table table-sm table-bordered jambo_table table-striped">
                            <tr>
                                <th colspan="2" class="text-center" style="background-color:#20c997; color:white;">KRITERIA KEANGGOTAAN JAWATANKUASA (JK)</th>
                            </tr>
                            <?php
                            $i = 1;
                            $totalService = 0;
                            ...
                            foreach ($service as $p) {
                                if (($i >= 2) && ($i <= 5)) {
                                    ...
                                    <tr>     
                                        <th><?= $p->requirement; ?></th>      
                                        <?php
                                        if ($i == 2) { //Dekan / Pengarah / Ketua Unit
                                        ...
                                        } else if ($i == 3) { // Timbalan Dekan / Timbalan Pengarah / Ketua Jabatan
                                            $j = count(array_filter($model->adminPosition, function ($var) {
                                                        return ($var['adminpos_id'] == '4' || $var['adminpos_id'] == '6' || $var['adminpos_id'] == '11' || $var['adminpos_id'] == '21' || $var['adminpos_id'] == '22' || $var['adminpos_id'] == '23' || $var['adminpos_id'] == '7' || $var['adminpos_id'] == '12');
                                                    }));
                                        ...
                                        } else if ($i == 5) { // Penyelaras atau timbalan penyelaras
                                            $j = count(array_filter($model->adminPosition, function ($var) {
                                                                return ($var['adminpos_id'] == '8');
                                                            })) + count(array_filter($model->serviceUniversity, function ($var) {
                                                                return ($var['level'] == '11');
                        ...
                        <table class="table table-sm table-bordered jambo_table table-striped">
                            <tr>
                                <th colspan="4" class="text-center" style="background-color:#20c997; color:white;">KRITERIA MEWAKILI UNIVERSITI</th>
                            </tr>
                            <?php
                            $n = 1;
                            $totalService3 = 0;
                        ...
                        <?php
                        if (($totalService >= 1) && ($totalService1 >= 1) && ($totalService2 == 2) && ($totalService3 >= 1) && ($totalService4 >= 1)) {
                            $serviceS = 1;
                        } else {
                            $serviceS = 0;
                        }
            ...
            <div class="x_panel">
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <table class="table table-sm table-bordered jambo_table table-striped">
                        ...
                        <tr>  
                            <th>BILANGAN KEPAKARAN</th>
                            <td class="text-center"><?php
                                $kepakaran = count($model->kepakaran); 
                                echo $kepakaran;
                                ?></td>
                            <th class="text-center"><?= Html::a('<i class="fa fa-search"></i>', ['view-cv', 'id' => sha1($model->ICNO), 'title' => 'personal',], ['class' => 'btn btn-default btn-sm', 'target' => '_blank',]); ?> </th>
                        </tr>
                        <tr>
                        ...
                        foreach ($perundingan as $p) {
                            ...
                            <tr>     
                                ...
                                if ($i == 1) {
                                    ...
                                    if ($model->kepakaran) { //check ada rekod kepakaran
                                        $s = 1;
                                        $totalPerundingan++;
                                    } else {
                                        $s = 0;
            ...
            <?php
            if ($totalUmum == 4 && $pyldkn == 1 && $pnrbtn == 1&& $persdgn == 1 && $pgjrn == 1 && $pnylia == 1 && $sanjungan == 1  && $serviceS == 1 && $prndgn == 1) {
                $checking = 1;
            } else {
                $checking = 0;
            }
