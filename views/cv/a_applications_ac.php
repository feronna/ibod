        ...
        <div class="table-responsive">
            ...
            $gridColumns = [
                ...
                [
                    'label' => 'Total',
                    'value' => function($model) {
                        return '<p style="color:red;"><b>' . $model->TotalAc($model->ads_id) . '</p></b>';
                    },
                    'format' => 'raw',
                        ...
                        [
                            ...
                            'value' => function($model) {
                                ...
                                [
                                    'label' => 'Reject',
                                    'value' => function($model) {
                                        return '<b><u><a href=' . Url::to(['list-candidate', 'id' => $model->ads_id, 'status' => 2]) . '> ' . $model->TotalVerify(2, $model->ads_id, 2) . '</a></u></b>';
                                    },
                                            'format' => 'raw',
                                            'contentOptions' => ['class' => 'text-center'],
                                        ],
                                        [
                                            'label' => 'Interview',
                                            'value' => function($model) {
                                                return '<b><u><a href=' . Url::to(['list-candidate-iv', 'id' => $model->ads_id]) . '> ' . $model->TotalIv(3, $model->ads_id) . '</a></u></b>';
                                            },
                                                    'format' => 'raw',
                                                    'contentOptions' => ['class' => 'text-center'],
                                                ],
...
//        '{toggleData}'
                                                                ...
                                                                'panel' => [
                                                                    ...
                                                                    'heading' => '<h2>Record Application (Permanent)</h2>',
                                                                ],
                                                            ]);
                                                            ?>
        </div>
