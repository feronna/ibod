        ...
        <div class="x_panel"> 
            ...
            <div class="col-md-6 col-sm-6 col-xs-6"> 
                <table class="table table-sm table-bordered jambo_table table-striped">
                    ...
                    <tr>     
                        <th style="background-color:#20c997; color:white;" colspan="4">STATUS KESELURUHAN <br/><br/></th>  
                ...
                <table class="table table-sm table-bordered jambo_table table-striped">
                    ...
                    foreach ($persidangan as $p) {
                        ...
                        <tr>     
                            ...
                            ?>
                    <tr>     
                        <th style="background-color:#20c997; color:white;" colspan="4">STATUS KESELURUHAN <br/><br/> * Memenuhi salah satu sub kriteria sanjungan akademik & kepimpinan akademik (i,ii,iii,iv,v,vi,vii,viii,ix) yang dinyatakan diatas.</th>  
                        <td style="background-color:<?= $Scolor; ?>; width:5%;" class="text-center">  
<?= Html::a($button, [''], ['class' => 'btn btn-default btn-md', 'disabled' => true]); ?>
                        </td>
                    </tr>
