                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <center>
                        <table class="table table-bordered table-sm jambo_table table-striped" style="width:80%"> 
                            ...
                            $ptm_status = 'TIADA MAKLUMAT';
                            $color = "red";
                            $button = "<i class='fa fa-times-circle fa-lg'></i>";
                            if ($model->ptm) {
                                if (in_array($model->ptm->status, ['LULUS', 'PENGECUALIAN PTM'])) {
                                    $ptm_status = 'HADIR';
                                    $color = "#20c997";
                                    $button = "<i class='fa fa-check-circle fa-lg'></i>";
                                }
                            ...
                            <tr>      
                                ...
                                <th>Hadir Program Transformasi Minda</th>  
                                <th><?= $ptm_status; ?></th>
                                <th>
                                    ...
                                    if (Yii::$app->user->getId() == $model->ICNO) {
                                        echo PopoverX::widget([
                                            'header' => '<span style="color:black;">Untuk maklumat lanjut, sila hubungi talian berikut:</span>',
                                            'type' => PopoverX::TYPE_DEFAULT,
                                            'placement' => PopoverX::ALIGN_BOTTOM,
                                            'content' => '<strong>Pn Delveja Jakin</strong><br/> '
                                            . '<strong>Pembantu Tadbir</strong><br/> ' 
                                            . '<strong>Tel: 088320000 (samb. 1185)</strong>',
                                            'toggleButton' => ['label' => '<i class="fa fa-info-circle" aria-hidden="true"></i></button>', 'class' => 'btn btn-default'],
                                        ]);
                                    } else {
                                        echo Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['lihat-rekod-ptm', 'id' => $model->ICNO], ['class' => 'btn btn-default', 'target' => '_blank']);
                                    }
                                    ?>
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <center>
                        <table class="table table-sm jambo_table table-striped" style="width:80%"> 
                            ...
                            <tr>       
                                <th>Memiliki kelayakan kepakaran atau ijazah sarjana kepakaran yang diiktiraf.</th>   
                                <td style="background-color:<?= $color1; ?>" class="text-center">  
                                    <?= Html::a($button1, [''], ['class' => 'btn btn-default btn-md', 'disabled' => true]); ?>
                                </td> 
                            </tr>
                            <tr>       
                                <th>Hadir dengan jayanya Program Transformasi Minda dan kursus-kursus lain yang ditetapkan.</th>   
