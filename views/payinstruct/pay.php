...
//                            return $model-> elaun_kemudahan;
                    ...
                    [
                        ...
                        'contentOptions' => ['class' => 'text-center'],
                         'value' => function ($model) {
//                            return $model-> elaun_kemudahan;
                            return $model->kakitangan->department->fullname;
...
//                            return $model-> elaun_kemudahan;
                   ...
                   [
                        ...
                        'contentOptions' => ['class' => 'text-center'],
                        'value' => function ($model) {  
                            return Html::button('', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['new-elaun', 'id' => $model->id]),'style'=>'background-color: transparent; 
