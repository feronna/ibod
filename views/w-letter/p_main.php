...
<div class="x_panel"> 
    ...
    <div class="x_content"> 
        <div class="form-group">     
            <ul><font color="red" style="font-family:Times New Roman;font-size:120%;">
                <li>Sila ambil maklum bahawa permohonan surat kebenaran ke pejabat hanya boleh dibuat untuk penilaian UMS-Shiels berstatus <strong>KUNING & HIJAU</strong> sahaja.</li>
                <li>
                    Permohonan kehadiran ke pejabat adalah secara harian dan bukan secara tarikh terkumpul.
                </li>
                </font>
            </ul>
        </div>
...
<div class="x_panel">  
    <div class="x_content">
        <div class="x_title">
            <h2>Surat Bertugas Pejabat (Baru)</h2> 
            <p align ="right">
                <?= Html::a('Lihat Semua', ['all-surat'], ['class' => 'btn btn-primary btn-sm', 'target' => '_blank']); ?>
            </p>
            <div class="clearfix"></div>
        </div>
...
if ($permohonanLama) {
    ...
    <div class="x_panel">  
        <div class="x_content">
            ...
            <div class="x_title">
                <h2>Surat Bertugas Pejabat (Lama)</h2> 
                <div class="clearfix"></div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                    ...
                    if ($permohonanLama) {
                        $counter = 0;
                        foreach ($permohonanLama as $model) {
                            $counter = $counter + 1;
                            ?> 
