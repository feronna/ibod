...
$sheet->setCellValue('A1', 'LAPORAN TUNTUTAN LESEN MEMANDU');;
...
$writer->save("LAPORAN TUNTUTAN LESEN MEMANDU.xlsx");
Yii::$app->response->redirect(['LAPORAN TUNTUTAN LESEN MEMANDU.xlsx']);
?>
<a href="<?php echo Url::to('@web/'.'hello worldsssssss.xlsx', true); ?>" target="_blank" ><i class="fa fa-download"></i> Laporan Tuntutan Lesen Memandu</a><br>
