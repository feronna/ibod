...
<table class="table table-striped table-bordered jambo_table" >
                        <thead>
                            <th scope="col" colspan=17" width="30%" class="headings"><center>LESEN MEMANDU<br>
                            <tr class="headings">
                    ...
                    <?php if ($model) { ?>
                        <?php foreach ($model as $list) { ?>
                            <tr>
                                ...
                                <?php if ($list->jeniskemudahan == '8') { ?>
                                <td style=" ">
                                 <?php if($list->isActive2 == '1' && $list->jeniskemudahan == '8'){?>
                                <div class="container" align="center">
                                <?= \yii\helpers\Html::a(' KELULUSAN KETUA BSM', ['boranglesen/slulus', 'id' => $list->id], ['class'=>'fa fa-download', 'target' => '_blank'])?></td>
                                <?php }?>  
                                ...
                                <td class="text-center"><?= Html::a('<i class="fa fa-eye">', ["boranglesen/tindakan_bendahari", 'id' => $list->id]); ?></td>
                                <?php } else { ?><td class="text-center"><?= Html::a('<i class="fa fa-eye">', ["boranglesen/tindakan_bendahari", 'id' => $list->id]); ?></td>
                                <?php } ?>
