...
<div class="col-md-12 col-xs-12"> 
    ...
    <div class="x_panel">
         <div class="x_title">
                <h2><i class="fa fa-book"></i><strong> PENGISIAN PERMOHONAN LESEN MEMANDU</strong></h2>
        ...
        <thead>
                <th scope="col" colspan=12" width="30%" style="background-color:lightgrey;"><center>MAKLUMAT TUNTUAN LESEN MEMANDU</center></th>
                <tr>
                ...
                <tr>
                        ...
                        <td colspan="5">  
                            <div class="col-md-6 col-sm-6 col-xs-10"> 
                              <?= $form->field($model, 'jeniskemudahan')->textInput(['disabled'=>'disabled', 'value' =>  'Lesen Memandu'])->label(false)?>
                            </div>
                        </td>
                </tr>
                <tr>
