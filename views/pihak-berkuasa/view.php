...
$this->title = 'Pihak Berkuasa Melantik';
...
<div class="col-md-12 col-sm-12 col-xs-12 "> 
    <div class="x_panel">
        ...
        <div class="x_content">
         ...
         <?= Html::a('Tambah', ['tambah-kuasa', 'icno' => $ICNO], ['class' => 'btn btn-primary']) ?>   
            <div class="table-responsive">
            <table class="table table-sm table-bordered jambo_table table-striped">
                <thead>
                <tr class="headings">
                    <th>Kuasa Melantik</th>
                ...
                <tr>
                    <td><?= $alamatkakitangan->kuasa->AptAthyNm; ?></td>
