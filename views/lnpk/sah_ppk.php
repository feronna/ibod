...
<div class="row">
    ...
    <div class="x_panel">
        ...
        <div class="panel-body">
            ...
            <p align="center">
                Saya (<?= $model->ppk->CONm; ?>) mengesahkan bahawa semua maklumat yang terkandung pada Laporan Penilaian Prestasi Tahun <?= $model->tahun; ?> ini adalah benar.<br><br>
                Saya bersetuju Laporan Penilaian Prestasi Tahun <?= $model->tahun; ?> ini untuk disahkan oleh Ketua Jabatan.<br>
            </p>
            
            <div style="text-align: center">
                <?= $form->field($model, 'PPK_sah')->checkbox(['label' => null]); ?>
