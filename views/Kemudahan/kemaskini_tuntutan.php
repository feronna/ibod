...
<p>
        <?= Html::a('Kembali', ['senaraituntutan', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12"> 
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Maksimum Tuntutan<span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Budget<span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Syarat<span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
