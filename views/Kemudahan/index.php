...
<?= \app\widgets\TopMenuWidget::widget(['top_menu' => [74,77,79,81,86,1183,1295,1297,1299,1314,1410,1470], 'vars' => []]); //1303 for admin is taken ?>  
<div class="row">
 ...
 <div class="x_panel">
   <div class="x_title">
            <h2><strong><i class="fa fa-list"></i> Permohonan Kemudahan Staf Secara Atas Talian(On-line) </strong></h2>
...
<!--                <div class="col-xs-12 col-md-4">
                    ...
                    echo Html::a($dokumen, ['borang/mohon_elaun']);
                    ?>
                </div>-->
                ...
                <div class="col-xs-12 col-md-4">
                    ...
                    echo Html::a($semakan, ['borangwilayah/maklumat-wilayah']);
                    ?>
           </div>
...
//                  echo Html::button($dokumen, ['id' => 'modalButton','value' => \yii\helpers\Url::to(['boranglesen/syarat']), 'style'=>'border: none; padding: 0px 0px;  text-align: left; width: 100%' ,'class' => 'drivers-license-o mapBtn']);
                    ?>
                </div>
...
//                                        'icon' => 'angle-double-right',
    ...
    <div class="col-xs-12 col-md-4">
     ...
     <div class="col-xs-12 col-md-4">
                    ...
                    echo Html::a($semakan, ['ikad/apply' ]);
                    ?>
           </div>
