...
<div class="row"> 
    <div class="x_panel" >
        <div class="x_title">
            <h2><i class="fa fa-list"></i><strong> Penetapan Akses Kelayakan Ibu Bapa</strong></h2>
...
<div class="row"> 
        <div class="x_panel">
            <div class="x_title">
                <h2><strong><i class="fa fa-list"></i> Akses Menggunakan Kelayakan Ibu Bapa</strong></h2>
