               ...
               <?php if ($model) { $bil=1; ?>
                    <?php foreach ($model as $list) { ?>
                        <tr>
                            ...
                            <td class="text-center"> <?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ["kemudahan/view", 'kemudahancd' => $list->kemudahancd]) ?> | <?= Html::a('<i class="fa fa-edit" aria-hidden="true"></i>', ['kemudahan/kemaskini', 'kemudahancd' => $list->kemudahancd]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['padam', 'kemudahancd' => $list->kemudahancd]) ?></td>                    
