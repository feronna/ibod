  ...
  <?php $form = ActiveForm::begin(['options' => ['class' => 'form-horizontal form-label-left']]); ?>
    ...
    <?php echo $this->render('/cutibelajar/_topmenu'); ?>
            ...
            <div class="pull-right">
                ...
                ?>    <?= Html::a('Kembali', ['cbadmin/senaraitindakanlain'], 
    ['class' => 'btn btn-primary btn-sm']) ?>
    </div> 
...
<div class="x_panel">
     ...
     PERMOHONAN PERLARASAN TARIKH PENGAJIAN
 '); ?>
                </strong> </center>
            </span> 
        </div>
...
?></td></tr>
                      ...
                      <tr> 
                        ...
                        <td style="width:20%">
                                  <?php echo strtoupper($model->study->emel_penyelia); ?></td></tr>
    ...
    <h5 ><strong><i class="fa fa-th-list"></i> MAKLUMAT PERMOHONAN</strong><br><br>
        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                 <th scope="col" colspan=12"  style="background-color:lightseagreen;color:white"><center>PERMOHONAN PERLARASAN TARIKH PENGAJIAN</center></th>

                    <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">TARIKH PENGAJIAN ASAL:</th>
                        <td><?= strtoupper($model->study->tarikhmula) ?> HINGGA <?=  strtoupper($model->study->tarikhtamat) ?> (<?=  strtoupper($model->study->tempohpengajian) ?>)</td> 
                    </tr>
                     <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">TARIKH PENGAJIAN BAHARU:</th>
                        <td><?= strtoupper($model->tarikhm) ?> HINGGA <?=  strtoupper($model->tarikht) ?> (<?=  strtoupper($model->study->r->tempohlanjutan) ?>)</td> 
                    </tr>
                     <tr class="headings">
                        <th class="col-md-3 col-sm-3 col-xs-12">
                            SURAT KELULUSAN PERLARASAN<br>
                            <i>Dari Tempat Pengajian</i>:</th>
                                                ...
                                                <td class="text-justify"> <a class="form-control" style="background-color: transparent;border:0;box-shadow: none;" 
                                                        ...
                                                        <i class="fa fa-download"></i> <small>Klik Sini Untuk Muat Turun</small></a><br>
...
<tr>
                        ...
                        <td> <?= strtoupper($model->status_bsm);?> 
</td> 
                    </tr>
...
<div class="col-xs-12 col-md-12 col-lg-12"> 
    ...
    <div class="x_panel">
<div class="x_title">
    <h5 ><strong><i class="fa fa-check"></i> STATUS KETUA JABATAN/DEKAN</strong><br><br>
       </h5>
        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                    ...
                    <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12"  style="background-color:lightseagreen;color:white">STATUS PERAKUAN:</th>
                        <td> <?= $model->status_jfpiu;?></td>
 
                    </tr>
                  <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12"  style="background-color:lightseagreen;color:white">ULASAN:</th>
                        <td> <?= $model->ulasan_jfpiu;?>  </td>

                    </tr>
                <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12"  style="background-color:lightseagreen;color:white">TARIKH DIPERAKUKAN:</th>
