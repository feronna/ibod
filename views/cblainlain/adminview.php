...
?> 
  ...
  <?php $form = ActiveForm::begin(['options' => ['class' => 'form-horizontal form-label-left']]); ?>
    ...
    ['class' => 'btn btn-primary btn-sm']) ?>
     ...
     SEKTOR PEMBANGUNAN SUMBER MANUSIA<br/><u> PERMOHONAN PERTUKARAN TEMPAT PENGAJIAN
 '); ?>
                </strong> </center>
            </span> 
        </div>
    ...
    <h5 ><strong><i class="fa fa-th-list"></i> MAKLUMAT PERMOHONAN</strong><br><br>
        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                 <th scope="col" colspan=12"  style="background-color:lightseagreen;color:white"><center>PERMOHONAN PERTUKARAN TEMPAT PENGAJIAN</center></th>

                 
                     <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">INSTITUT PENGAJIAN ASAL:</th>
                        <td><?= ucwords(strtoupper($model->maklumat->InstNm)); ?></td> 
                    </tr>
                    <tr>
                     ...
                     <tr class="headings">
                        <th class="col-md-3 col-sm-3 col-xs-12">
                            SURAT TAWARAN UNIVERSITI BAHARU<br>
