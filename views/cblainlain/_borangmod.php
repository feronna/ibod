...
<div class="x_panel">
     ...
     PERMOHONAN PERTUKARAN MOD PENGAJIAN
 '); ?>
                </strong> </center>
            </span> 
        </div>
                ...
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                 <th scope="col" colspan=12"  style="background-color:lightseagreen;color:white"><center>PERMOHONAN PERTUKARAN MOD PENGAJIAN</center></th>
                    ...
                    <tr>          
                        ...
                        <th style="width:10%" align="right">MOD PENGAJIAN ASAL</th>
                        <td style="width:20%">
...
?>
                    ...
                    <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">MOD PENGAJIAN (BAHARU):</th>
                        <td>   <?=
                    $form->field($model, 'modeID')->label(false)->widget(Select2::classname(), [
                    'data' => ArrayHelper::map(app\models\cbelajar\Modpengajian::find()->where(['id'=>[2,1,3]])->all(), 'modeID', 'studyMode'),
                    ...
                    'pluginOptions' => [
                     ...
                     <tr class="headings">
                        <th class="col-md-3 col-sm-3 col-xs-12">SURAT KELULUSAN PERTUKARAN MOD PENGAJIAN<br>
