  ...
  <?php $form = ActiveForm::begin(['options' => ['class' => 'form-horizontal form-label-left']]); ?>
    ...
    <?php echo $this->render('/cutibelajar/_topmenu'); ?>
            ...
            <div class="pull-right">
                <?php 
                echo Html::a('<i class="fa far fa-hand-point-up"></i> Cetak Borang', ['/cblainlain/cetak-bidang', 'id'=>$model->id,'i' =>$iklan->id, 'target'=>'_blank'], [
                    'class'=>'btn btn-primary btn-sm', 
                    'target'=>'_self', 
                    'data-toggle'=>'tooltip', 
                    'title'=>'Pertukaran Bidang Pengajian'
                ]);
                            ?>  
    ...
    ['class' => 'btn btn-primary btn-sm']) ?>
     ...
     SEKTOR PEMBANGUNAN SUMBER MANUSIA<br/><u> PERMOHONAN PERTUKARAN BIDANG PENGAJIAN
 '); ?>
                </strong> </center>
            </span> 
        </div>
...
?>
                    ...
                    <tr> 
                        ...
                        <th style="width:30%" align="right">BIDANG PENGAJIAN BAHARU</th>
                        <td style="width:30%">
...
?>
                     ...
                     <tr class="headings">
                        <th class="col-md-3 col-sm-3 col-xs-12">
                            SURAT KELULUSAN PERTUKARAN BIDANG PENGAJIAN<br>
