   ...
   <div class="clearfix"></div>
        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                 <th scope="col" colspan=12"  style="background-color:lightseagreen;color:white"><center>PERMOHONAN PERTUKARAN TEMPAT PENGAJIAN PENGAJIAN</center></th>

 <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12" style="width:35%">INSTITUT PENGAJIAN ASAL:</th>
                        <td><?= ucwords(strtoupper($model->study->InstNm)); ?></td> 
                    </tr>
                    

                    <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">INSTITUT PENGAJIAN BAHARU:</th>
                        <td> <?= $form->field($model, 'renewTempat')->textInput(['maxlength' => true]) ->label(false);?> 
</td> 
                    </tr>
                   
                     <tr class="headings">
                        <th class="col-md-3 col-sm-3 col-xs-12">SURAT TAWARAN UNIVERSITI BAHARU<br>
