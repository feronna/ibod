   ...
   <div class="clearfix"></div>
        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                 <th scope="col" colspan=12"  style="background-color:white;"><center>   PERMOHONAN PERLARASAN TARIKH PENGAJIAN
</center></th>

                    <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">TARIKH ASAL CUTI BELAJAR:</th>
                        <td><?=
                        strtoupper($model->study->tarikhmula) ?> HINGGA <?=
                        strtoupper($model->study->tarikhtamat) ?> (<?= strtoupper($model->study->tempohpengajian);?>)</td> 
                    </tr>
                    <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">TARIKH MULA BAHARU CUTI BELAJAR:</th>
                        <td>  <?=
                    DatePicker::widget([
                        'model' => $model,
                    ...
                    <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">TARIKH TAMAT BAHARU CUTI BELAJAR:</th>
                        <td>  <?=
                    DatePicker::widget([
                        'model' => $model,
                    ...
                    ?>  </td>
                     ...
                     <tr class="headings">
                        <th class="col-md-3 col-sm-3 col-xs-12">SURAT PELARASAN<br>
