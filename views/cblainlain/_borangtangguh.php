   ...
   <div class="clearfix"></div>
        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                 <th scope="col" colspan=12"  style="background-color:white;"><center>PERMOHONAN PENANGGUHAN PENGAJIAN</center></th>
                    ...
                    <tr class="headings">
                        <th class="col-md-3 col-sm-3 col-xs-12">TAKWIM/PELAN PENGAJIAN:<br>
                            <i>Dari Tempat Pengajian</i>:</th>
