...
<!--<div class="row">
    <ol class="breadcrumb">
        ...
        <li><?= Html::a('Maklumat Pembiayaan / Pinjaman', ['cbelajar/maklumat-biasiswa']) ?></li>
...
<label class="control-label col-md-3 col-sm-3 col-xs-12">JENIS TAJAAN :<span class="required"></span>
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        echo Dropdown::widget([
            'items' => [
                ['label' => 'Tajaan Luar', 'url' =>  ['cbelajar/tajaanluar', 'id'=>$iklan->id]],
                ['label' => 'Biasiswa Pengurusan UMS', 'url' =>  ['cbelajar/biasiswaums', 'id'=>$iklan->id]],
                ['label' => 'Kementerian Pendidikan Tinggi (KPT)', 'url' =>  ['cbelajar/kpm', 'id'=>$iklan->id]],
                ['label' => 'Tanpa Tajaan', 'url' =>  ['cbelajar/tanpatajaan', 'id'=> $iklan->id]],
...
<div class="col-xs-12 col-md-12 col-lg-12">
            ...
            <?= $this->render('_tajaanluar',[ 'model' => $model2,
