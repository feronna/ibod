...
<!--                        <th class="column-title text-center">BAKI IKATAN PERKHIDMATAN</th-->
                ...
                <tbody>
                 ...
                 <p align ="right">
                    ...
                    <?= Html::a('Seterusnya', ['cbelajar/maklumat-pengajian',  'id' => $iklan->id], ['class' => 'btn btn-info btn-sm']); ?>
                    <?php echo Html::a('Kembali',  ['cbelajar/maklumat-peribadi',  'id' => $iklan->id], ['class' => 'btn btn-primary btn-sm']); ?> 
                </p>
