...
<div class="x_panel">
        ...
        <div class="x_title">
            <h5><strong><i class="fa fa-book"></i> MAKLUMAT LAPORAN NILAIAN PRESTASI TAHUNAN (LNPT)
                    </strong></h5>
...
<div class="x_panel">
          ...
          <div class="x_title">
           ...
           <?php if($pengajian->HighestEduLevelCd == 200)
                    {?>
              
                    <h5> <strong><center>SEMAKAN SYARAT CUTI BELAJAR - POST DOKTORAL | UNIT PENGAJIAN LANJUTAN (UPL)</center></strong> </h5>
...
//                             }
                ...
                <?php 
                echo Html::a('<i class="fa far fa-hand-point-up"></i> Cetak Semakan', ['/cutibelajar/generate-semakan-syarat-doktoral', 'id' =>$kontrak->id, 'ICNO'=>$kontrak->icno, 'takwim_id'=>$kontrak->iklan_id], [
...
<div class="x_panel">
          ...
          <div class="x_title">
                    ...
                    </ul>  <?php }elseif(($pengajian->HighestEduLevelCd == 1) ||
                ($pengajian->HighestEduLevelCd == 202)|| ($pengajian->HighestEduLevelCd == 20) || ($pengajian->HighestEduLevelCd == 102)){?>
...
//                             }
                        ...
                        <?php 
                 echo Html::a('<i class="fa far fa-hand-point-up"></i> Kemaskini Semakan', ['/cutibelajar/update-semakan-syarat', 'id' =>$kontrak->id, 'ICNO'=>$kontrak->icno, 'takwim_id'=>$kontrak->iklan_id], [
                ...
                <?php 
                echo Html::a('<i class="fa far fa-hand-point-up"></i> Cetak Semakan', ['/cutibelajar/generate-semakan-syarat', 'id' =>$kontrak->id, 'ICNO'=>$kontrak->icno, 'takwim_id'=>$kontrak->iklan_id], [
                    'class'=>'btn btn-primary btn-sm', 
                    'target'=>'_self', 
                    //'data-toggle'=>'tooltip', 
                    //'title'=>'Will open the generated PDF file in a new window'
          ...
          <div class="x_title">
                    ...
                    <h5> <strong><center>SEMAKAN SYARAT CUTI BELAJAR - PENTADBIRAN | UNIT PENGAJIAN LANJUTAN (UPL)</center></strong> </h5>
...
//                             }
                ...
                <?php 
                echo Html::a('<i class="fa far fa-hand-point-up"></i> Cetak Semakan', ['/cutibelajar/generate-semakan-syarat-pentadbiran', 'id' =>$kontrak->id, 'ICNO'=>$kontrak->icno, 'takwim_id'=>$kontrak->iklan_id], [
                    'class'=>'btn btn-primary btn-sm', 
                    'target'=>'_self', 
                    //'data-toggle'=>'tooltip', 
                    //'title'=>'Will open the generated PDF file in a new window'
