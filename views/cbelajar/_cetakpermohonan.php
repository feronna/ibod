                ...
                <form id="w0" class="form-horizontal form-label-left" action="">
                   ...
                   <tr scope="col" colspan=12">
                    ...
                    <tr class="headings">
                        ...
                        <td colspan="5"><?= $model->study->tempohpengajian; ?>
                    </tr>
                ...
                <tbody>
                    ...
                    <?php $bil=1; foreach ($biasiswa as $biasiswa) { ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?= $model->biasiswa->nama_tajaan; ?></td>
                            <td class="text-center"><?=  $model->biasiswa->bantuan->bentukBantuan;?></td>
                            <td class="text-center">RM <?=  $model->biasiswa->amaunBantuan;?></td>
