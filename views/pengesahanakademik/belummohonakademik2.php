...
<div class="row">
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><strong>Senarai Kakitangan Akademik Tetap yang Akan Cukup Tempoh</strong></h2>
           <p align="right"><?= \yii\helpers\Html::a('Kembali', ['halaman-belum-mohon-akademik'], ['class' => 'btn btn-primary']) ?></p>   
<!--            <br><br>
            <p>SENARAI NAMA KAKITANGAN DICADANGKAN DIBENARKAN MENGEMUKAKAN PERMOHONAN AWAL DI  PDP BIL.1/2022 KERANA TEMPOH PERKHIDMATAN GENAP 1 TAHUN PADA TARIKH TUTUP PERMOHONAN PADA  04/02/ 2022 (TARIKH MESYUARAT JPDP 16/02/2022)</p>
            <p>AKADEMIK : 1 ORANG</p>-->
...
<!--                    <th class="text-center">Tarikh PTM</th>-->
        ...
        <?php
            ...
            if($biodatas->jawatan->job_category == "1" && $biodatas->gredJawatan != "223" && $tempohstatuspengesahan < "1" && $confirmstatuspengesahan != "1" && $confirmstatuspengesahan != "3" && $confirmstatuspengesahan != "4" && $confirmstatuspengesahan != "5" && $confirmstatuspengesahan != "6" && $confirmstatuspengesahan != "8" && $confirmstatuspengesahan != ""){
            //if($biodatas->jawatan->job_category == "1" && $biodatas->gredJawatan != "223" && \app\models\pengesahan\TblStaff::find()->where(['icno' => $icno, 'category' => 1])->exists()){
        ?>
                        <tr>
