...
<?php } ?>
            ...
            $umum = app\models\pengesahan\RequirementUmum2::umum();
            ?>
                            ...
                            <center> 
                                <table class="table table-sm table-bordered jambo_table table-striped" style="width:80%"> 
                                    ...
                                    for ($t = $tahunstarttetap; $t < date('Y'); $t++) {
                                        ...
                                        if ($recordOld) {
                                            //$allrecord1 = $allrecord1 + $recordOld->markah;
                                    ...
                                    for ($t = $tahunstarttetap; $t < date('Y'); $t++) {
                                        //$allrecord = $allrecord + $record->markah;
                                        ...
                                        if ($record) {
                                            //$allrecord2 = $allrecord2 + $record->markah;
                                    ...
                                    for ($t = $tahunstarttetap; $t < date('Y'); $t++) {
                                        //$allrecord = $allrecord + $recordPen->markah_PP;
                                        ...
                                        if ($recordPen) {
                                            //$allrecord3 = $allrecord3 + $recordPen->markah_PP;
...
//                                    $allrecord = number_format(($allrecord1 + $allrecord2 + $allrecord3) / $year, 2, '.', '');
//                                    echo $allrecord;
                                    
//                                    $jumlahLnpt = $jumlahKeseluruhan1 +$jumlahKeseluruhan2 + $jumlahKeseluruhan3;
//                                    $jumlahTahun = $i + $j + $k;
//                                   
//                                    $purata  = $jumlahLnpt/$jumlahTahun;
                                    ...
                                    foreach ($umum as $p) {
                                        ...
                                        ?></th> 
                                                ...
                                                if ($p->id == 1) {
                                                    ...
                                                    if (($subjek->Grade_id <= '14') && ($subjek->Grade_id != NULL) && ($biodata->sijilspm->filename != NULL)) {
                                                        $s = 1;
                                                        $totalUmum++;
                                                    } 
                                                    else if (($subjek2->Grade_id <= '14') && ($subjek2->Grade_id != NULL) && ($biodata->sijilspm->filename != NULL)) {
                                                        $s = 1;
                                                        $totalUmum++;
                                                    } 
                                                    else {
...
foreach ($persidangan as $p) {
    ...
    ?>
                                ...
                                if ($i == 1) {
                                    ...
                                    $k = count(array_filter($biodata->persidangan2, function ($var) {
                                                return ($var['Peringkat'] == 'Antarabangsa' && $var['Peranan'] == 'Pembentang');
                                            }));
