                            ...
                            foreach ($umum as $p) {
                                ...
                                <tr>      
                                    ...
                                    if ($p->id == 1) {
                                        ...
                                        if (($subjek->Grade_id <= '14') && ($subjek->Grade_id != NULL) && ($model->sijilspm->filename != NULL)) {
                                            $s = 1;
                                            $totalUmum++;
                                        } 
                                        else if (($subjek2->Grade_id <= '14') && ($subjek2->Grade_id != NULL) && ($model->sijilspm->filename != NULL)) {
                                            $s = 1;
                                            $totalUmum++;
                                        } 
                                        else {
            ...
            foreach ($persidangan as $p) {
                ...
                <tr>     
                    ...
                    if ($i == 1) {
                        ...
                        $k = count(array_filter($model->kakitangan->persidangan2, function ($var) {
                             return ($var['Peringkat'] == 'Antarabangsa' && $var['Peranan'] == 'Pembentang');
                        }));
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <?php if(($model->kakitangan2->tarikhPtm!= NULL)||($model->tarikh_lulus_ptm!= NULL)){?>
                    ...
                    'options' => 
                        ...
                        'required' => TRUE,
                        'onchange' => 'cal()', 
                        'id' => 'tarikh_lulus_ptm']  ])->label(false);
                    } ?>
            </div>
        </div> 
...
<!--        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <?php if(($checking==1) || ($icno == '900802125379')){?>
<!--                <php if($checking==1){?>-->
