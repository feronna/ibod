...
<div class="row">
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><strong>Senarai Kakitangan Akademik (DU51P) Tetap yang Cukup Tempoh (Percubaan 1-3 Tahun)</strong></h2>
...
<!--                    <th class="text-center">Tarikh PTM</th>-->
        ...
        <?php
            ...
            // if($biodatas->jawatan->job_category == "1" && $tempohstatuspengesahan >= "1" && $confirmstatuspengesahan != "1" && $confirmstatuspengesahan != "8"){ 
            //if($biodatas->jawatan->job_category == "1" && $confirmstatuspengesahan != "1" && $confirmstatuspengesahan != "8" && $confirmstatuspengesahan != ""){         
            // && $biodatas->gredJawatan == "223" $confirmstatuspengesahan == "6"
        ?>
                        <tr>
...
<!--                            <td class="text-center"><php echo $biodatas->statusLantikan->ApmtStatusNm; ?></td>-->
                            ...
                            <td class="text-center"><?php echo $biodatas->tarikhpengesahan; //tarikh lanjutan ?></td>
