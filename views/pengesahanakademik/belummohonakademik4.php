...
<div class="row">
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><strong>Senarai Kakitangan Tetap yang Akan Cukup Tempoh 1 Tahun <br> Dalam Percubaan Lanjutan Tanpa Denda/Dalam Percubaan Lanjutan Berdenda [Akademik]</strong></h2>
...
<!--                    <th class="text-center">Taraf Jawatan</th>-->
                    ...
                    <th class="text-center">Tarikh Pelanjutan</th>
                    <th class="text-center">Tempoh Pelanjutan</th>
...
<!--                    <th class="text-center">Tarikh PTM</th>-->
        ...
        <?php
            ...
            //$biodata = Tblprcobiodata::find()->where(['statLantikan' => "1", 'Status' => [1,2]])->orderBy(['startDateLantik' => SORT_ASC])->all();
            ...
            if($biodatas->jawatan->job_category == "1" && $biodatas->gredJawatan != "223" && $tempohstatuspengesahan < "1" && $confirmstatuspengesahan != "1" && $confirmstatuspengesahan != "2" && $confirmstatuspengesahan != "3" && $confirmstatuspengesahan != "4" && $confirmstatuspengesahan != "8" && $confirmstatuspengesahan != ""){
