...
<div class="row">
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><strong>Senarai Kakitangan Akademik Tetap yang Telah Melebihi Tempoh Percubaan Maksimum <br> (Melebihi Percubaan 3 Tahun)</strong></h2>
...
<!--                    <th class="text-center">Tarikh PTM</th>-->
        ...
        <?php
            ...
            //if(($biodatas->jawatan->job_category == "1" && $biodatas->gredJawatan != "223"  && $tempohstatuspengesahan >= "3" && $confirmstatuspengesahan != "1" && $confirmstatuspengesahan != "8") || ($biodatas->jawatan->job_category == "1" && $biodatas->gredJawatan != "223"  && $tempohstatuspengesahan >= "1" && $confirmstatuspengesahan == "5") || ($biodatas->jawatan->job_category == "1" && $biodatas->gredJawatan != "223"  && $tempohstatuspengesahan >= "1" && $confirmstatuspengesahan == "6")){ 
