...
<div class="row">
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><strong>Senarai Kakitangan Tetap yang Cukup Tempoh 6 Bulan Dalam Percubaan Lantikan Semula [Akademik]</strong></h2>
...
<!--                    <th class="text-center">Tarikh PTM</th>-->
        ...
        <?php
            ...
            if($biodatas->jawatan->job_category == "1" && $tempohstatuspengesahan >= "6" && $confirmstatuspengesahan == "4" && $confirmstatuspengesahan != [1,2,3,5,6,8]&& $confirmstatuspengesahan != ""){
