...
<div class="row">
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><strong>Senarai Kakitangan Akademik (DU51P) Tetap yang Akan Cukup Tempoh</strong></h2>
           <p align="right"><?= \yii\helpers\Html::a('Kembali', ['halaman-belum-mohon-du'], ['class' => 'btn btn-primary']) ?></p>   
<!--            <br><br>
