...
<?php 
                ...
                ?>
 <?= Html::a('Kembali', ['cbadmin/senaraitindakantuntutan'], ['class' => 'btn btn-primary btn-sm']) ?></p>
   <div class="x_panel">  
    <div class="product_price"> 
        <h5 align="center" style="font-size:16px;font-weight: bold;"> 
             PERMOHONAN TEMPAHAN TIKET PENERBANGAN PENGAJIAN LANJUTAN</5> 
...
<div class="x_panel">
            <div class="x_title">
                <h2><strong>Jadual Penerbangan Yang Dirancang / Ditempah</strong></h2>
                  <p align="right"><?= Html::button('TAMBAH JADUAL <i class="fa fa-pencil" aria-hidden="true"></i>', 
                    ['id' => 'modalButton', 
                    'value' => \yii\helpers\Url::to(['tambah-jadual', 'id' => $id]),
                     'class' => 'btn btn-primary btn-xs mapBtn']) ?></p>
                <div class="clearfix"></div>
            </div>
        ...
        <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    ...
                    $form->field($model,'status_bsm')->label(false)->widget(Select2::classname(), [
                        'data' => ['Diluluskan' => 'DILULUSKAN', 'Tidak Layak Dipertimbangkan' => 'TIDAK LAYAK DIPERTIMBANGKAN'],
          ...
          <div class="form-group"  align="center">
            <h5 style="font-size:120%;" class="text-justify"> 
                ...
                <label class="control-label col-md-3 col-sm-3 col-xs-12">No. Peruntukan: <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?= $form->field($model, 'no_peruntukan')->textarea(['maxlength' => true, 'rows' => 4])->label(false); ?>
                </div>
        </div>
