...
<div class="tab-content">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Senarai Rekod Bersara</strong></h2>
...
//                    ],
                    ...
                    [
                        'label' => 'Keterangan',
                        'value' => 'umurBersara.RetireAgeDesc',
...
//                            'class' => 'yii\grid\CheckboxColumn',
//                            'checkboxOptions' => function ($data) {
//                                if(app\models\brp\Tblrscobrp::find()->where(['icno' => $data->ICNO, 'remark' => $data->RetireAgeCd  . " (" . $data->umurBersara->RetireAgeDesc . ")"])->exists()){
...
//                        ],
                        ...
                        [
                            'class' => 'yii\grid\CheckboxColumn',
                            'checkboxOptions' => function ($data) {
                                if(app\models\brp\Tblrscobrp::find()->where(['icno' => $data->ICNO, 'remark' => 'OPSYEN UMUR PERSARAAN PAKSA DI BAWAH PEKELILING PERKHIDMATAN BILANGAN 11 TAHUN 2011"
                                      Telah memilih untuk Kekal bersara paksa apabila mencapai umur '.$data->RetireAgeCd ." ". 'tahun dan tertakluk kepada Akta Pencen 1980 [Akta 227] dibaca bersama Akta Pencen (Pindaan) 2011 / Akta Pencen Pihak Berkuasa Berkanun Dan Tempatan 1980 [Akta 239] dibaca bersama Akta Pencen Pihak Berkuasa Berkanun Dan Tempatan (Pindaan) 2011**, tertakluk kepada semua peruntukan Akta Pindaan tersebut.'])->exists()){
                                    return ['disabled' => disabled];
                                }
                               return [ 'value' => $data->id];
                            },
...
//                            return $dataProvider->RetireAgeCd  . " (" . $dataProvider->umurBersara->RetireAgeDesc . ")";
//                            },
//                        ],
