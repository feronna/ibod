    ...
    <div class="x_content">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <?=
                $form->field($adminbaru, 'staf_akses_icno')->label(false)->  widget(Select2::classname(), [
                    'data' => $allbiodata,
                    ...
                    foreach ($admin as $admins) { 
                        ...
                        <tr>
                            ...
                            <td><?= $admins->kakitangan->CONm; ?></td>
                                                <td>
        <?= Html::a('<i class="fa fa-trash-o"></i>', ['delete-admin', 'staf_akses_icno' => $admins->staf_akses_icno], [
            'data' => [
