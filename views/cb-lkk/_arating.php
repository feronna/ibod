...
?> 
 ...
 <p align="right"><?= Html::a('Back', ['lkk/adminview?id='.$model->reportID ], 
...
<p align="right"> 
    ...
    <?= Html::a('Next', ['lkk/a-achievement-phd?i='.$model->reportID.'&id='.$model->icno ], 
         ['class' => 'btn btn-primary btn-sm']) ?></p><?php }else{?>
              
    <?= Html::a('Next', ['lkk/a-achievement-master?i='.$model->reportID.'&id='.$model->icno ], 
