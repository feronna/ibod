...
?> 
 ...
 <p align="right"><?= Html::a('Back', ['lkk/tindakan-pp?i='.$model->reportID ], 
...
<p align="right"> 
    ...
    <?= Html::a('Next', ['lkk/p-achievement-phd?i='.$model->reportID.'&id='.$model->icno ], 
         ['class' => 'btn btn-primary btn-sm']) ?></p><?php }else{?>
              
    <?= Html::a('Next', ['lkk/p-achievement-master?i='.$model->reportID.'&id='.$model->icno ], 
