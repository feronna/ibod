...
<div>
            <p align="right">  <?= Html::a('Back', ['cb-lkk/student-list'], ['class' => 'btn btn-primary btn-sm']) ?></p>
        </div>
<div class="row">
...
?></center></th>
                    ...
                    <tr> 
                       ...
                       <tr> 
                        ...
                        <th style="width:10%" align="right">ORIGIN PLACE OF STUDY</th>
                        <td style="width:20%">
                        ...
                        <th style="width:10%" align="right">CURRENT PLACE OF STUDY</th>
                        <td style="width:20%">
                            
                         <?php  echo $pengajian->l->renewTempat; ?>
                    ...
                    <?php  if($pengajian->t){ 
                      ?> 
                       <tr> 
                        ...
                        <th style="width:10%" align="right">ORIGIN FIELDS OF STUDY</th>
                        <td style="width:20%">
...
?>
                        ...
                        <th style="width:10%" align="right">NEW FIELDS OF STUDY</th>
                        <td style="width:20%">
                      ...
                      <?php if($pengajian->m)
                        {?>
                        <th style="width:10%" align="right">PERIOD OF FURTHER STUDY</th>
                        <td style="width:40%">
                        <?= strtoupper($pengajian->tarikhmula)?> <b>HINGGA</b> 
                        <?= strtoupper($pengajian->tarikhtamat)?> (<?= strtoupper($pengajian->tempohpengajian);?>)</td>
                        </tr>
                   <tr> 
                        ...
                        <th style="width:10%" align="right">NEW PERIOD OF ADVANCED STUDY</th>
                        <td style="width:40%">
                        ...
                        <tr> 
                         ...
                         <th style="width:10%" align="right">DATE OF ADJUSTMENT OF NEW STUDIES</th>
                        <td style="width:20%">
                        ...
                        <tr>    
                        <th style="width:10%" align="right">PERIOD OF SUSPENSION OF STUDIES</th>
                        <td style="width:20%">
...
DATE OF EXTENSION <?= $l->idlanjutan?></th>
                        <td style="width:20%">
                    ...
                    <tr>  <?php if($pengajian->lapor)
                     {?>
                        <th style="width:10%" align="right">DATE OF SELF -REPORT BACK TO DUTY</th>
                        <td style="width:20%">
                            <?php 
                   ...
                   <th style="width:10%" align="right">STUDY STATUS</th>
                    ...
                    <tr><th style="width:10%" align="right">REMARKS</th>
...
<?php if(($pengajian->HighestEduLevelCd === 1) || ($pengajian->HighestEduLevelCd === 99)
        ...
        ($pengajian->HighestEduLevelCd === 99)|| ($pengajian->HighestEduLevelCd === 20) ||
        ($pengajian->HighestEduLevelCd === 200) ||  ($pengajian->HighestEduLevelCd === 102))
{?>
<div class="row">
...
//                                 $lkk = app\models\cbelajar\TblLkk::find()->where(['icno'=> $id, 'reportID'=> $i, 'status_form'=>2])->one();
    ...
    ['lkk/lihat-borang-sv', "id"=> $lkk->reportID], ['class' => 'btn btn-default btn-xs']) ?>
           ...
           elseif($lkk->agree == 1)
             {?>
                    ...
                    <?= Html::a('<i class="fa fa-th-list" aria-hidden="true"></i>', 
                                    ['view-penyelia', "i"=> $lkk->reportID], ['class' => 'btn btn-default btn-xs']) ?> 
