...
?> 
 ...
 <p align="right"><?= Html::a('Back', ['lkk/sv-phd-ums?i='.$model->reportID.'&id='.$model->icno ], 
         ['class' => 'btn btn-primary btn-sm']) ?></p><?php }else {?>
             
      <p align="right"><?= Html::a('Back', ['lkk/sv-master-ums?i='.$model->reportID.'&id='.$model->icno ], 
...
?>
        ...
        <ul class="to_do">
            ...
            <a href="gambar">
            <li style="#f2f2f2">
                <p><b>             <?= Html::a('SUPERVISOR RATING', ['rating-ums?i='.$model->reportID]) ?>
                </b></p><p>
...
//                                 $mod = \app\models\cbelajar\TblPrestasi::find()->where(['id' => $dok->id, 'idLanjutan'=> 37, 'iklan_id'=>15])->one();
 ...
 <div class="x_panel">
  ...
  <tr>
      ...
      <td align="text-left" colspan="10"> Submit Date: <?= $model->r_dt;?>
