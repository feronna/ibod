...
<p align="right"> <?= Html::a('Back', ['cb-lkk/halaman-penyelia'], ['class' => 'btn btn-primary btn-sm']) ?></p>
 <div class="x_content">
...
//                                ],
                        ...
                        'format' => 'raw',
                             ...
                             'value'=>function ($model)  {
                              ...
                              if($model->pengajian->l)
                              {
                              return strtoupper($model->pengajian->l->renewTempat). ' <br> '. $model->pengajian->HighestEduLevel;}

                              
                             elseif($model->pengajian->HighestEduLevel)
                             {
                ...
                'hAlign' => 'center', 
                              ...
                              [
                                            ...
                                            'buttons' => [
                                                ...
                                                {
                                                        $ICNO = $model->icno;
                                                        $url = Url::to(['view-lkk', 'id'=>$model->pengajian->icno]);
                                                       return 
