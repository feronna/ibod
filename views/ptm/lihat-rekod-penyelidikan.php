...
<div class="col-md-12 col-sm-12 col-xs-12 "> 
    <div class="x_panel">
        <div class="x_title">
            <h2><strong>Rekod Kursus Metodologi Penyelidikan</strong></h2>
            <div class="clearfix"></div>
        </div>
        <div class="x_content">
            <?php
                ...
                //if ($model->status !=0 ) {
                echo Html::button('Tambah Rekod <i class="fa fa-plus" aria-hidden="true"></i>', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['tambah-penyelidikan?ICNO='.$id]),'class' => 'btn btn-primary mapBtn']) ?>
...
//                    ['id' => 'modalButton', 
//                    'value' => \yii\helpers\Url::to(['kemaskini-rekod-penyelidikan', 'id' => $model->ICNO]),
...
//            }
                ...
                echo Html::a('Padam Rekod <i class="fa fa-trash" aria-hidden="true"></i>', ['delete-penyelidikan', 'id' => $model->ICNO], [
...
<!--            <= Html::a('Kemaskini', ['update4', 'id' => $model->ICNO], ['class' => 'btn btn-primary']) ?>-->

<!--            <= Html::button('Kemaskini', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['update4', 'id' => $model->ICNO]),'class' => 'btn btn-primary mapBtn']) ?>-->
...
//                'kakitangan.CONm',
                [
                           'label' => 'Tarikh Pembentangan',
                           'attribute' => 'tarikhpembentangan',
                       ],
                [
                           'label' => 'Tajuk Pembentangan',
                           'attribute' => 'tajukPembentangan',
                       ],
                [
                           'label' => 'Tempat Pembentangan',
                           'attribute' => 'tempatPembentangan',
                       ],
                [
                           'label' => 'Status',
                           'attribute' => 'status',
