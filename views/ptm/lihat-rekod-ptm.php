...
<div class="col-md-12 col-sm-12 col-xs-12 "> 
    <div class="x_panel">
         <div class="x_title">
            <h2><strong>Rekod Kursus PTM</strong></h2>
            <div class="clearfix"></div>
        </div>
        <div class="x_content">
            <?php
                ...
                //if ($model->status !=0 ) {
                echo Html::button('Tambah Rekod <i class="fa fa-plus" aria-hidden="true"></i>', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['tambah-ptm?ICNO='.$id]),'class' => 'btn btn-primary mapBtn']) ?>
                ...
                ['id' => 'modalButton', 
                'value' => \yii\helpers\Url::to(['kemaskini-rekod-ptm', 'id' => $model->ICNO]),
                 'class' => 'btn btn-primary mapBtn']); 
                    
                echo Html::a('Padam Rekod <i class="fa fa-trash" aria-hidden="true"></i>', ['delete-ptm', 'id' => $model->ICNO], [
...
<!--            <= Html::button('Kemaskini', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['update2', 'id' => $model->ICNO]),'class' => 'btn btn-primary mapBtn']) ?>-->
...
//                'tarikhlulusptm',
                ...
                [
                           ...
                           'attribute' => 'tarikhptm1',
                       ],
                [
                           'label' => 'Tarikh Tamat Kursus',
                           'attribute' => 'tarikhptm2',
                       ],
                [
                           'label' => 'Tempat Kursus',
                           'attribute' => 'tempatPtm',
                ...
                [
                           'label' => 'Pengecualian PTM',
                           'attribute' => 'pengecualianPtm'
                       ],
