...
<!--    <div class="x_title">
    ...
    <div class="x_content">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <?= $form->field($model, 'tempatBitk')->textArea(['maxlength' => true, 'placeholder' => 'Tempat kursus yang dihadiri', 'required' => TRUE]) ->label(false);?>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <?= $form->field($model, 'tempatExam')->textArea(['maxlength' => true, 'placeholder' => 'Tempat peperiksaan yang dihadiri', 'required' => TRUE]) ->label(false);?>
            </div>
        </div>
