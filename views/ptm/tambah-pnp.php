...
<!--        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <= $form->field($model, 'tarikhPnp')->widget(DatePicker::className(),
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Tarikh Kursus: </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
            <?= $form->field($model, 'tarikhPnp')->widget(DatePicker::className(),
            ['clientOptions' => ['changeMonth' => true,'yearRange' => '1996:2099','changeYear' => true, 'format' => 'yyyy-mm-dd', 'autoclose' => true],
...
<!--        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <= $form->field($model, 'tempatPnp')->textArea(['maxlength' => true, 'placeholder' => 'Tempat kursus yang dihadiri', 'required' => TRUE]) ->label(false);?>
            </div>
        </div>-->
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <?= $form->field($model, 'tempatPnp')->textArea(['maxlength' => true, 'placeholder' => 'Tempat kursus yang dihadiri']) ->label(false);?>
            </div>
        </div>

<!--        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Keputusan:<span class="required" style="color:red;">*</span></label>  
            <div class="col-md-6 col-sm-6 col-xs-12">
            <= $form->field($model, 'keputusan')->textArea(['maxlength' => true, 'required' => TRUE]) ->label(false);?>
            </div>
        </div>-->

        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Keputusan:</label>  
            <div class="col-md-6 col-sm-6 col-xs-12">
            <?= $form->field($model, 'keputusan')->textArea(['maxlength' => true]) ->label(false);?>
            </div>
        </div>
...
<!--        <div class="form-group">
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Tarikh Kelulusan TNC(A):</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
            <?= $form->field($model, 'tarikhKelulusan')->widget(DatePicker::className(),
            ['clientOptions' => ['changeMonth' => true,'yearRange' => '1996:2099','changeYear' => true, 'format' => 'yyyy-mm-dd', 'autoclose' => true],
            'options' => [ 'placeholder' => 'Pilih Tarikh']])->label(false);?>
...
<!--                <= Html::a('</i> Kembali', ['rekod-pnp', 'id'=>$model->ICNO], ['class'=>'btn btn-primary']) ?>       -->
