    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <?php
                ...
                //if ($model->status !=0 ) {
                echo Html::button('Tambah Rekod <i class="fa fa-plus" aria-hidden="true"></i>', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['tambah-bitk?ICNO='.$id]),'class' => 'btn btn-primary mapBtn']) ?>
...
//                    ['id' => 'modalButton', 
//                    'value' => \yii\helpers\Url::to(['kemaskini-rekod-bitk', 'id' => $model->ICNO]),
...
//                }
                ...
                echo Html::a('Padam Rekod <i class="fa fa-trash" aria-hidden="true"></i>', ['delete-bitk', 'id' => $model->ICNO], [
...
//                'kakitangan.CONm',
                [
                           'label' => 'Tarikh Kursus',
                           'attribute' => 'tarikhbitk',
                       ],
                [
                           'label' => 'Tempat Kursus',
                           'attribute' => 'tempatBitk',
                       ],
                [
                           'label' => 'Tarikh Peperiksaan',
                           'attribute' => 'tarikhexam',
                       ],
                [
                           'label' => 'Tempat Peperiksaan',
                           'attribute' => 'tempatExam',
                       ],
                [
                           'label' => 'Status',
                           'attribute' => 'status',
                ...
                [
                           'label' => 'Tarikh Surat Kelulusan (JPA)',
