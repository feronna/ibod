...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_content">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <?= $form->field($model, 'tajukPembentangan')->textArea(['maxlength' => true, 'placeholder' => 'Tempat kursus yang dihadiri']) ->label(false);?>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <?= $form->field($model, 'tempatPembentangan')->textArea(['maxlength' => true, 'placeholder' => 'Tempat kursus yang dihadiri']) ->label(false);?>
            </div>
        </div>
