...
<!--                <li><a class="close-link"><i class="fa fa-close"></i></a>-->
        ...
        <div class="x_content">
        <p>
            <?= Html::button('Tambah Rekod <i class="fa fa-plus" aria-hidden="true"></i>', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['tambah-penyelidikan']),'class' => 'btn btn-primary mapBtn']) ?>
        </p>
        <?= GridView::widget([
