...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12"> 
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Bahagian III - Laporan dan Ulasan Keseluruhan Pencapaian Sasaran Kerja Tahunan Pada Akhir Tahun Oleh PYD dan PPP</strong></h2>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-xs-6"  style="text-align:center">
                            <?= Html::a('<strong>Klik untuk tandatangan PYD</strong>', ['lppums/skt-bahagian3', 'lpp_id' => $_GET['lpp_id']],
                                [
                                    'data' => [
                        ...
                        <?php if(is_null($model->skt_ulasan_tt_ppp) AND $lpp->PPP == Yii::$app->user->identity->ICNO){ ?>
                        <div class="col-md-3 col-xs-6"  style="text-align:center">
                            <?= Html::a('<strong>Klik untuk tandatangan PPP</strong>', ['lppums/skt-bahagian3', 'lpp_id' => $_GET['lpp_id']],
                                [
                                    'data' => [
                                        'method' => 'post', // <- extra level
                                    ],
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-xs-6">
                            <?= Html::input('text','password1', (is_null($model->skt_ulasan_tt_ppp) ? '' : $model->ppp->CONm), ['class' => 'form-control', 'disabled' => true, 'style'=>'text-align: center']) ?>
                        </div>
                    </div><br>
