...
<div class="row"> 
    ...
    <div class="row" style="display: <?php if($model->status == '1'){echo 'none';}?>">
    <div class="x_panel">
        <div class="x_title">
        ...
        <br>
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <?= Html::button(' Semakan Kelayakan Tempoh Lantikan Semula', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['semakan-kelayakan', 'id' => $model->id]),'style'=>'width : 100%;', 'class' => 'btn btn-primary btn-md fa fa-info mapBtn']);?>
                    </div>
            </div>
                
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-3" for="wp_id">Status Persetujuan<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <?=
                    $form->field($model, 'status_pp')->label(false)->widget(Select2::classname(), [
                        'data' => ['4' => 'PERMOHOHAN DIPERSETUJUI', '5' => 'PERMOHONAN DITOLAK'],
            ...
            <div class="form-group" id="tempoh" style="display: <?php if($model->status_pp == '4'){echo '';}else {echo 'none';}?>">
                <label class="control-label col-md-3 col-sm-3 col-xs-3" for="wp_id">Cadangan Tempoh Lantikan Semula Kontrak<span class="required">*</span>
                </label>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?= $form->field($model, 'ulasan_pp')->textArea(['maxlength' => true, 'rows' => 4, 'required' => true])->label(false); ?>
                </div>
            </div>
