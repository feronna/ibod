...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12"> 
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Bahagian I - Penetapan Sasaran Kerja Tahunan</strong></h2>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-xs-6" style="text-align:center">
                            <?= Html::a('<strong>Klik untuk tandatangan PYD</strong>', ['lppums/skt-bahagian1', 'lpp_id' => $_GET['lpp_id']],
                                [
                                    'data' => [
                        ...
                        <div class="col-md-3 col-xs-6"  style="text-align:center">
                            <?= Html::a('<strong>Klik untuk tandatangan PPP</strong>', ['lppums/skt-bahagian1', 'lpp_id' => $_GET['lpp_id']],
                                [
                                    'data' => [
                                        'method' => 'post', // <- extra level
                                    ],
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xs-0">
                            ...
                            <?= Html::input('text','password1', (is_null($tt->skt_tt_ppp) ? '' : $tt->ppp->CONm), ['class' => 'form-control', 'disabled' => true, 'style'=>'text-align: center']) ?>
                        </div>
                    </div><br>
