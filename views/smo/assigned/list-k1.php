                ...
                <table class="table table-striped table-sm jambo_table table-bordered">
                    <thead>
                        <tr class="headings">
                            ...
                            <th class="text-center">Pemberi Maklumbalas</th>
                            <th class="text-center">Entri pada</th>
                            <th class="text-center">Kemaskini pada</th>
                    ...
                    <?php if ($model) { ?>
                        <?php foreach ($model as $v) { ?>
                            <tr>
                                ...
                                <td><strong><?= $v->update_dt; ?></strong></td>
                                <td class="text-center" style="text-align:center"><strong> <?= Html::a('<i class="fa fa-pencil"></i>', ['tindakan-k1', 'key' => hash('sha256', $v->id)]) ?></strong></td>
                            </tr>
                        <?php } ?>
                    <?php } else { ?>
                        <tr>
