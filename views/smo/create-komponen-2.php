        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12"><?= Html::activeLabel($model, 'pyd'); ?>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        echo $form->field($model, 'pyd')->widget(Select2::class, [
                            'data' => Komp2::PydList($icno),
                            'options' => ['placeholder' => '-- PILIH PYD --'],
                            'pluginOptions' => [
                                'allowClear' => true
                            ],
                        ])->label(false);
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <?php // Usage with ActiveForm and model
                        echo $form->field($model, 'bhgn_id')->widget(Select2::class, [
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        ...
                        <?=
                        $form->field($model, 'kriteria_id')->widget(DepDrop::class, [
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <?= $form->field($model, 'detail')->widget(TinyMce::class, [
                            'options' => ['rows' => 15],
                            'language' => 'en',
                            'clientOptions' => [
                                'plugins' => [
