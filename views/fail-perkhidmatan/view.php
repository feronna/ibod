...
<div class="col-md-12 col-sm-12 col-xs-12 "> 
    <div class="x_panel">
        ...
        <div class="x_content">
         ...
         <?= Html::a('Tambah', ['tambah-fail', 'icno' => $ICNO], ['class' => 'btn btn-primary']) ?>   
            <div class="table-responsive">
            <table class="table table-sm table-bordered jambo_table table-striped">
                <thead>
                <tr class="headings">
                    <th>No Rujukan Fail Perkhidmatan</th>
                ...
                <tr>
                    <td><?= $alamatkakitangan->COFileNo ?></td>
                    <td><?= $alamatkakitangan->tarikhKuatkuasa;?></td>
  ...
  <div class="x_panel">
        <div class="x_content">  
            <span class="required" style="color:red;">
                <strong>
                    <?=  ucwords(strtolower('Maklumat di dalam buku rekod perkhidmatan hanya tahun 2011 hingga kini sahaja yang direkodkan.  '
                            . 'Sebarang kekurangan akan dibaiki dari semasa ke semasa.terima kasih '
                             )); ?>
                </strong> 
            </span> 
        </div>
