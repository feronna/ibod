...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel"> 
        <div class="x_title">
            <h2><strong>Senarai Kakitangan Tetap yang Cukup Tempoh 6 Bulan Dalam Percubaan Lantikan Semula [Pentadbiran]</strong></h2>
...
<!--           <ul class="nav navbar-right panel_toolbox">
    ...
    <!--                    <th class="text-center">Tarikh PTM</th>-->
         ...
         <?php
            ...
            $tempohstatuspengesahan = date_diff($date1, $date2)->format('%m');
            //$tempohstatuspengesahan = date_diff($date1, $date2)->format('%y Tahun %m Bulan %d Hari');
            if($biodatas->jawatan->job_category == "2" && $tempohstatuspengesahan >= "6" && $confirmstatuspengesahan == "4" && $confirmstatuspengesahan != [1,2,3,5,6,8]&& $confirmstatuspengesahan != ""){
