...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel"> 
        <div class="x_title">
            <h2><strong>Senarai Kakitangan Pentadbiran Tetap yang Cukup Tempoh (Percubaan 1-3 Tahun)</strong></h2>
...
<!--                    <th class="text-center">Tarikh PTM</th>-->
        ...
        <?php
            ...
            if($biodatas->jawatan->job_category == "2" && $tempohstatuspengesahan >= "1" && $tempohstatuspengesahan < "3" && $confirmstatuspengesahan != "1" && $confirmstatuspengesahan != "3" && $confirmstatuspengesahan != "4" && $confirmstatuspengesahan != "5" && $confirmstatuspengesahan != "6" && $confirmstatuspengesahan != "8" && $confirmstatuspengesahan != ""){
