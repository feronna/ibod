...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel"> 
        <div class="x_title">
            <h2><strong>Senarai Kakitangan Tetap yang Akan Cukup Tempoh 1 Tahun <br> Dalam Percubaan Lanjutan Tanpa Denda/Dalam Percubaan Lanjutan Berdenda [Pentadbiran]</strong></h2>
    ...
    <!--                    <th class="text-center">Tarikh PTM</th>-->
         ...
         <?php
            ...
            if($biodatas->jawatan->job_category == "2" && $tempohstatuspengesahan < "1" && $confirmstatuspengesahan != "1" && $confirmstatuspengesahan != "2" && $confirmstatuspengesahan != "3" && $confirmstatuspengesahan != "4" && $confirmstatuspengesahan != "8" && $confirmstatuspengesahan != ""){
