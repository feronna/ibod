...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel"> 
        <div class="x_title">
            <h2><strong>Senarai Kakitangan Pentadbiran Tetap yang Akan Cukup Tempoh</strong></h2>
...
<!--           <ul class="nav navbar-right panel_toolbox">
    ...
    <!--                    <th class="text-center">Tarikh PTM</th>-->
        ...
        <?php
            ...
            if($biodatas->jawatan->job_category == "2" && $tempohstatuspengesahan < "1" && $confirmstatuspengesahan != "1" && $confirmstatuspengesahan != "3" && $confirmstatuspengesahan != "4" && $confirmstatuspengesahan != "5" && $confirmstatuspengesahan != "6" && $confirmstatuspengesahan != "8" && $confirmstatuspengesahan != ""){
            //if($biodatas->jawatan->job_category == "2" && \app\models\pengesahan\TblStaff::find()->where(['icno' => $icno, 'category' => 2])->exists()){
        ?>
                        <tr>
