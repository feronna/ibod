...
<div style="margin-bottom: 15px; text-align:justify">
  Universiti Malaysia Sabah mengucapkan tahniah dan semoga <?php  if ($letter->TitleCd == 'P019'){
                echo  'puan';
                }
                if ($letter->TitleCd == 'L001'){
                echo  'tuan';
            ...
            ?> akan terus memberikan perkhidmatan dengan penuh komitmen dan dedikasi untuk kemajuan dan kepentingan Universiti serta kemajuan kerjaya <?php  if ($letter->TitleCd == 'P019'){
                echo  'puan';
                }
                if ($letter->TitleCd == 'L001'){
                echo  'tuan';
...
<!--                         &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;-<= ucwords(strtolower($letter->department->chiefBiodata->jawatan->nama))?>(<?= ucwords(strtolower($letter->department->fullname))?>)-->
