...
<!--            <p align="right"><= \yii\helpers\Html::a('Kembali', ['halaman-tetapan'], ['class' => 'btn btn-primary']) ?></p>   -->
    ...
    <div class="x_content">
       ...
       <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?= $form->field($urus, 'tahun_mesyuarat')->textInput(['maxlength' => true, 'rows' => 4])->label(false);
                        ?>
                    </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Masa Mesyuarat:<span class="required" style="color:red">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                       <?= TimePicker::widget([
                        'name' => 'masa_mesyuarat',
