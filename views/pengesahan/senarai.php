...
//                            Html::a('<i class="fa fa-eye">', ["pengesahan/permohonanpengesahan", 'id' => $data->id]);}
//                            else{
//                                return Html::a('<i class="fa fa-eye">', ["pengesahan/permohonanpengesahan", 'id' => $data->id]);
//                            }
//                          },
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" align="right">  
                    <!--<?= Html::submitButton(Yii::t('app', '<i class="fa fa-list"></i> Senarai (Pentadbiran)'), ['class' => 'btn btn-primary', 'name' => 'belummohon', 'value' => 'submit_1']) ?>-->
                    ...
                    <?= Html::submitButton(Yii::t('app', '<i class="fa fa-paper-plane, "></i>&nbsp;Notifikasi (Pentadbiran)'), ['class' => 'btn btn-primary', 'data'=>['disabled-text' => 'Sila Tunggu..'], 'name' => 'notipemohon', 'value' => 'submit_1']) ?> 
                    <!--<?= Html::submitButton(Yii::t('app', '<i class="fa fa-paper-plane"></i>&nbsp;Notifikasi (Akademik)'), ['class' => 'btn btn-primary', 'name' => 'notipemohonakademik', 'value' => 'submit_1']) ?> -->
                    <?= Html::submitButton(Yii::t('app', '<i class="fa fa-paper-plane"></i>&nbsp;Notifikasi Pegawai'), ['class' => 'btn btn-primary', 'name' => 'notipegawai', 'data'=>['disabled-text' => 'Sila Tunggu..'], 'value' => 'submit_2']) ?>                   
