        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                $form = ActiveForm::begin([
                            'action' => ['admin-post-list-keseluruhan-akademik'],
                            'method' => 'get',
                            'options' => [
                                'data-pjax' => 1
                            ],
...
<!--            <= Html::a('Kembali', ['halaman-utama-akademik'], ['class' => 'btn btn-primary']) ?>-->
            <?= Html::a('<div style="float: right; font-size:18px;"><i class="text-success fa fa-download"></i> Muat Turun</div>', ['reportakademik3', 'icno' => Yii::$app->request->queryParams['ICNO'], 'admin' => Yii::$app->request->queryParams['adminpos_id'], 'dept' => Yii::$app->request->queryParams['dept_id'], 'campus' => Yii::$app->request->queryParams['campus_id'], 'flag' => Yii::$app->request->queryParams['flag']]) ?>
            <div class="x_content">
