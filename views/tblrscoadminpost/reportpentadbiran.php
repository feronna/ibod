...
//    else{
//    {
        $phpExcel = PhpOffice\PhpSpreadsheet\IOFactory::load('uploads/rekodlantikan/template-rekod-lantikan-pentadbiran.xls');
//    }
...
foreach($model as $model){
    ...
    $sheet->setCellValue('H'.$i, $model->tarikhkuatkuasa);
...
$writer->save("Senarai Rekod Lantikan Terkini (JFPIB Pentadbiran).xlsx");
Yii::$app->response->redirect(['Senarai Rekod Lantikan Terkini (JFPIB Pentadbiran).xlsx']);
?>
