        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                $form = ActiveForm::begin([
                            'action' => ['admin-post-list-pentadbiran'],
                            'method' => 'get',
                            'options' => [
                                'data-pjax' => 1
                            ],
...
//                        'data' => ArrayHelper::map(\app\models\hronline\Tblrscoadminpost::find()->joinWith('adminpos')->where(['flag' => '1', 'position_type' => '1'])->all(), 'adminpos_id', 'adminpos.position_name'),
                ...
                <div class="form-group">
                    ...
                    <?= Html::a('Reset', ['admin-post-list-pentadbiran'], ['class' => 'btn btn-warning']) ?> 
                </div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Papar Lantikan Terkini (JFPIB Pentadbiran)</strong></h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                </ul>
                <div class="clearfix"></div>
...
<!--            <= Html::a('Kembali', ['halaman-utama-pentadbiran'], ['class' => 'btn btn-primary']) ?>-->
            <?= Html::a('<div style="float: right; font-size:18px;"><i class="text-success fa fa-download"></i> Muat Turun</div>', ['reportpentadbiran', 'icno' => Yii::$app->request->queryParams['ICNO'], 'admin' => Yii::$app->request->queryParams['adminpos_id'], 'dept' => Yii::$app->request->queryParams['dept_id'], 'campus' => Yii::$app->request->queryParams['campus_id']]) ?>
            <div class="x_content">
