...
//    else{
//    {
        $phpExcel = PhpOffice\PhpSpreadsheet\IOFactory::load('uploads/rekodlantikan/template-rekod-lantikan-akademik3.xls');
//    }
...
$writer->save("Senarai Rekod Lantikan Keseluruhan (JFPIB Akademik).xlsx");
Yii::$app->response->redirect(['Senarai Rekod Lantikan Keseluruhan (JFPIB Akademik).xlsx']);
?>
