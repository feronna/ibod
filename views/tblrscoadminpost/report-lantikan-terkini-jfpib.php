...
//    else{
//    {
        $phpExcel = PhpOffice\PhpSpreadsheet\IOFactory::load('uploads/rekodlantikan/template-rekod-lantikan-terkini-jfpib.xls');
//    }
...
foreach($model as $model){
    ...
    $sheet->setCellValue('E'.$i, $model->program->NamaProgram);
    ...
    $sheet->setCellValue('I'.$i, $model->tarikhmula);
...
$writer->save("Senarai Rekod Lantikan Terkini JAFPIB.xlsx");
Yii::$app->response->redirect(['Senarai Rekod Lantikan Terkini JAFPIB.xlsx']);
?>
