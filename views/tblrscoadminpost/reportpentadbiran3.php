...
//    else{
//    {
        $phpExcel = PhpOffice\PhpSpreadsheet\IOFactory::load('uploads/rekodlantikan/template-rekod-lantikan-pentadbiran3.xls');
//    }
...
$writer->save("Senarai Rekod Lantikan Keseluruhan (Pentadbiran).xlsx");
Yii::$app->response->redirect(['Senarai Rekod Lantikan Keseluruhan (Pentadbiran).xlsx']);
?>
