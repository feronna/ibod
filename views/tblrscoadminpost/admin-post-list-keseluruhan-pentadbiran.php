...
<!--            <= Html::a('Kembali', ['halaman-utama-pentadbiran'], ['class' => 'btn btn-primary']) ?>-->
            <?= Html::a('<div style="float: right; font-size:18px;"><i class="text-success fa fa-download"></i> Muat Turun</div>', ['reportpentadbiran3', 'icno' => Yii::$app->request->queryParams['icno'], 'adminpos_id' => Yii::$app->request->queryParams['adminpos_id'], 'dept_id' => Yii::$app->request->queryParams['dept_id'], 'campus_id' => Yii::$app->request->queryParams['campus_id'], 'flag' => Yii::$app->request->queryParams['flag']]) ?>
            <div class="x_content">
