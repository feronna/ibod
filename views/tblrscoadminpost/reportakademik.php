...
//    else{
//    {
        $phpExcel = PhpOffice\PhpSpreadsheet\IOFactory::load('uploads/rekodlantikan/template-rekod-lantikan-akademik.xls');
//    }
...
$writer->save("Senarai Rekod Lantikan Terkini (JFPIB Akademik).xlsx");
Yii::$app->response->redirect(['Senarai Rekod Lantikan Terkini (JFPIB Akademik).xlsx']);
?>
