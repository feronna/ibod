...
//    else
//    {
        $phpExcel = PhpOffice\PhpSpreadsheet\IOFactory::load('uploads/rekodlantikan/template-rekod-lantikan-akademik2.xls');
//    }
...
foreach($model as $model){
    ...
    $sheet->setCellValue('K'.$i, $model->baki);
...
$writer->save("Senarai Kontrak 3 Bulan Akan Tamat (JFPIB Akademik).xlsx");
Yii::$app->response->redirect(['Senarai Kontrak 3 Bulan Akan Tamat (JFPIB Akademik).xlsx']);
?>
