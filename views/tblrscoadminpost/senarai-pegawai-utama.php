...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <?= Html::a('<div style="float: right; font-size:18px;"><i class="text-success fa fa-download"></i> Muat Turun</div>', ['reportpegawai', 'icno' => Yii::$app->request->queryParams['icno'], 'adminpos_id' => Yii::$app->request->queryParams['adminpos_id'], 'dept_id' => Yii::$app->request->queryParams['dept_id'], 'campus_id' => Yii::$app->request->queryParams['campus_id'], 'flag' => Yii::$app->request->queryParams['flag']]) ?>
            <div class="x_content">
                    ...
                    <?=
                        ...
                        [
                            ...
                            'filter' => Select2::widget([
                                'name' => 'flag',
                                'value' => $flag,
                                'data' => ['0'=>'<span class="label label-warning">Menunggu</span>',
