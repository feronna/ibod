                ...
                <div class="col-xs-12 col-md-6">
                    ...
                    $rekod_lantikan = \yiister\gentelella\widgets\StatsTile::widget(
                                    [
                                        ...
                                        'text' => 'JFPIB Pentadbiran',
                                        'number' => '1',
                                    ]
                    );
                    echo Html::a($rekod_lantikan, ['tblrscoadminpost/admin-post-list-pentadbiran']);
                    ?>
                </div>
                <div class="col-xs-12 col-md-6">
                    <?php
                    ...
                    echo Html::a($tambah_rekod, ['tblrscoadminpost/admin-post-list-keseluruhan-pentadbiran']);
                    ?>
                </div>
                <div class="col-xs-12 col-md-6">
                    <?php
                    ...
                    echo Html::a($rekod_lantikan, ['tblrscoadminpost/admin-post-list-pentadbiran2']);
                    ?>
                </div>   
