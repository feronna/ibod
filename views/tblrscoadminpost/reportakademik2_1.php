...
$sheet->setCellValue('H3', 'TARIKH TAMAT');
$sheet->setCellValue('I3', 'STATUS');
$sheet->setCellValue('J3', 'KIRAAN HARI');
...
$writer->save("Senarai Kontrak 3 Bulan Akan Tamat (Akademik).xlsx");
Yii::$app->response->redirect(['Senarai Kontrak 3 Bulan Akan Tamat (Akademik).xlsx']);
?>
