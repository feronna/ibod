...
//    else{
//    {
        $phpExcel = PhpOffice\PhpSpreadsheet\IOFactory::load('uploads/rekodlantikan/template-rekod-lantikan-sah.xls');
//    }
...
$writer->save("Senarai Rekod Lantikan Belum Disahkan.xlsx");
Yii::$app->response->redirect(['Senarai Rekod Lantikan Belum Disahkan.xlsx']);
?>
