...
<div class="col-md-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
<!--            <ol class="breadcrumb">
                <li><php echo Html::a('<i class="fa fa-home"></i> Halaman Utama', ['admin-post-list-pentadbiran']) ?></li>
                <li><= Html::a('<i class="fa fa-home"></i> Halaman Utama', Yii::$app->request->referrer) ?></li>
                <li><= Html::a('<i class="fa fa-arrow-left"></i>&nbsp;Kembali', Yii::$app->request->referrer) ?></li>
...
<!--    <div class="form-group">
    ...
    <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Fail<span class="required"></span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <?php if($model->files!= NULL){?>
