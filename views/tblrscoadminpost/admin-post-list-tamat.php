                    ...
                    <?=
                        ...
                        [
                            ...
                            'value' => function($model) {
                                return Html::button('', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['lantikan-semula', 'id' => $model->id]),'style'=>'background-color: transparent; 
                                border: none;', 'class' => 'btn btn-default fa fa-repeat mapBtn']).
    //                            return 
    //                            Html::a('<i class="fa fa-repeat" "aria-hidden="true"></i>', [
    //                                        'lantikan-semula?id='.$model->id,                
    //                                            ], [
