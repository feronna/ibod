...
<?= \app\widgets\TopMenuWidget::widget(['top_menu' => [1,2,3,4, 1179, 1180], 'vars' => null
//    [
//        [
//            'label' => '1',
////            'items' => [
                    ...
                    'columns' => [
                        ...
                        [
                           //'attribute' => 'CONm',
                            ...
                            'contentOptions' => ['class'=>'text-center'],
                            'value' => function($model) {
                                return is_null($model->userAkses) ? '-' : 'ADA';
                            },
                            //'attribute' => 'test'
                        ],
                        [
                           ...
                           //'attribute' => 'CONm',
                            ...
                            'buttons' => [
                                'update' => function ($url, $model) {
                                    $url = Url::to(['menu-manager/akses', 'ICNO' => $model->ICNO]);
