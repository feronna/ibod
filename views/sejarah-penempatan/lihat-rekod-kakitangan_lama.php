...
<!--                    <td><?php //echo $models->ICNO; ?></td>-->
                    ...
                    <td class="text-center" style="width:5%;"><?php echo Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['lihat-rekod-penempatan', 'id' => $models->id]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['kemaskini-rekod-penempatan', 'id' => $models->id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['delete', 'id' => $models->id], [
                         'data' => [
