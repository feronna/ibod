...
$this->title = Yii::t('app', 'Borang Tambah Kursus \ Latihan Berimpak Tinggi');
// $this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Senarai Kursus'), 'url' => ['index']];
                    ...
                    <form class="needs-validation" novalidate>
                        ...
                        <div class="x_content">
                            ...
                            // 'height' => '450px'
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Jenis Penganjur <span class="required"></span>
                                    </label>
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <?=
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Penganjur : <span class="required"></span>
                                    </label>
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Program : <span class="required"></span>
                                    </label>
                                    <div class="col-md-9 col-sm-9 col-xs-12">
