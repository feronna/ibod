...
<script>
    function checkDate() {
        ...
        if ((Date.parse(startDate) - 1209600000 <= Date.parse(checkDate))) {
            alert("HARAP MAAF! Tarikh mula kursus haruslah lebih daripada 14 hari daripada tarikh sekarang.");
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Permohonan Kursus Anjuran Agensi Luar</h2>
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?= $form->field($model, 'jumlahYuran')->textInput(['maxlength' => true, 'type' => 'number', 'min' => '0'], ['class' => 'form-control col-md-7 col-xs-12'])->label(false) ?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?= $form->field($model, 'jumlahTiketPenerbangan')->textInput(['maxlength' => true, 'type' => 'number', 'min' => '0'], ['class' => 'form-control col-md-7 col-xs-12'])->label(false) ?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?= $form->field($model, 'jumlahPenginapan')->textInput(['maxlength' => true, 'type' => 'number', 'min' => '0'], ['class' => 'form-control col-md-7 col-xs-12'])->label(false) ?>
                    </div>
                </div>
                ...
                <div class="form-group" style="background-color:lightgrey;">
                    <label class="control-label col-md-6 col-sm-6 col-xs-12">MAKLUMAT DIRI</label>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">No. Tel. Bimbit :
                        <span class="required" style="color:red;">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?= $form->field($modelBiodata, 'COHPhoneNo')->textInput(['maxlength' => true], ['class' => 'form-control col-md-7 col-xs-12'])->label(false) ?>
                    </div>
                </div>
                <div class="form-group">
