...
$qrCode = (new QrCode($test.'/idp/hadir-latihan?siriID='.$id.'&pesertaID='.Yii::$app->user->getId()))
    ->setSize(150)
    ->setMargin(5)
...
<header>
    ...
    <br><br>
    <h2 align="center">Slip Pengesahan Pendaftaran</h2>
  </header>
<table id="t01" align="center">   
  ...
  <tr>
    <th>Nama</th>
    <td><?= ucwords(strtolower($model->biodata->gelaran->Title)).' '.ucwords(strtolower($model->biodata->CONm)); ?></td>
  </tr>
  <tr>
    <th>No. Kad Pengenalan / <br> No. Pasport</th>
    <td><?= ucwords(strtolower($model->staffID)); ?></td>
  </tr>
  <tr>
    <th>Kursus</th>
<!--    <td><? ucwords(strtoupper($model->sasaran3->tajukLatihan)); ?> Siri <? $model->sasaran6->siri; ?></td>-->
  ...
  <tr>
    <th>Tempat</th>
    <td><?= ucwords(strtolower($model->sasaran6->lokasi)); ?></td>
  </tr>
  <tr>
    <th>Kampus</th>
    <td><?= ucwords(strtolower($model->sasaran6->campusName->campus_name)); ?></td>
  </tr>
  <tr>
    <th>Urusetia</th>
    <td>
...
<caption><strong>Sila cetak slip ini atau membawa secara digital untuk tujuan pendaftaran</strong></caption>
