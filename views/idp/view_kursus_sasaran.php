...
//                                }
                                ...
                                if ($lat2->checkPohon($lat2->kursusLatihanID) == 2){
                                    ...
                                    $v = Html::button('TELAH HADIR', ['value' => 'latihan-dihadiri?id='.$lat2->kursusLatihanID, 'class' => 'mapBtn btn-sm btn-warning btn-block']);
                                    //$v = Html::button('PILIH SIRI', ['value' => 'mohon-latihan?kategori=6', 'class' => 'mapBtn btn-sm btn-primary btn-block']);
                                } else {
                                    ...
                                    if ($lat2->checkSiri($lat2->kursusLatihanID) == 1){
                                        ...
                                        $v = Html::button('PERMOHONAN DITUTUP', ['value' => 'mohon-latihan?id='.$lat2->kursusLatihanID.'&kategori=5', 'class' => 'mapBtn btn-sm btn-danger btn-block']);
                                    }
                                    //$v = Html::button($lat2->checkSiri($lat2->kursusLatihanID), ['value' => 'mohon-latihan?id='.$lat2->kursusLatihanID.'&kategori=5', 'class' => 'mapBtn btn-sm btn-primary btn-block']);
                                    //$v = Html::button('PILIH SIRI', ['value' => 'mohon-latihan?kategori=6', 'class' => 'mapBtn btn-sm btn-primary btn-block']);
                                }
...
//                                }
                                ...
                                //if ($lat2->checkPohon($lat2->siriLatihanID)){
                                if ($lat2->checkPohon($lat2->kursusLatihanID) == 2){
                                    //$v = Html::button('TELAH MEMOHON', ['class' => 'btn-sm btn-success btn-block', 'disabled' => true]);
                                    //$v = Html::button('TELAH MEMOHON', ['value' => 'latihan-dipohon?id='.$lat2->kursusLatihanID, 'class' => 'mapBtn btn-sm btn-success btn-block']);
                                    ...
                                    if ($lat2->checkSiri($lat2->kursusLatihanID) == 1){
                                        $v = Html::button('PILIH SIRI', ['value' => 'mohon-latihan?id='.$lat2->kursusLatihanID.'&kategori=6', 'class' => 'mapBtn btn-sm btn-primary btn-block']);
                                    } else {
                                        $v = Html::button('PERMOHONAN DITUTUP', ['value' => 'mohon-latihan?id='.$lat2->kursusLatihanID.'&kategori=6', 'class' => 'mapBtn btn-sm btn-danger btn-block']);
                                    }
                                }
