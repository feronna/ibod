...
$gridColumnsK = [
    ...
    [
        ...
        'value' => function ($model) use ($year) {
            return StatistikPermohonanMata::countKursusByStatus($model->id, 1, $year);
        },
        'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
        //'pageSummary' => StatistikPermohonanMata::countKursusByStatusTotal(0, $year),
        'pageSummary' => true,
    ...
    [
        ...
        'format' => 'raw',
        'value' => function ($model) use ($year) {
            return StatistikPermohonanMata::countKursusByStatus($model->id, 0, $year);
        },
        'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
        //'pageSummary' => StatistikPermohonanMata::countKursusByStatusTotal(1, $year),
        'pageSummary' => true,
    ],
    [
        'label' => 'AKADEMIK',
        ...
        'format' => 'raw',
        'value' => function ($model) use ($year) {
            return StatistikPermohonanMata::countKursusByStatus($model->id, 3, $year);
        },
        'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
        //'pageSummary' => StatistikPermohonanMata::countKursusByStatusTotal(2, $year),
        'pageSummary' => true,
    ],
    [
        'label' => 'PENTADBIRAN',
        ...
        'format' => 'raw',
        'value' => function ($model) use ($year) {
            return StatistikPermohonanMata::countKursusByStatus($model->id, 2, $year);
        },
        'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
        //'pageSummary' => StatistikPermohonanMata::countKursusByStatusTotal(3, $year),
        'pageSummary' => true,
    ],
    [
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                $form = ActiveForm::begin([
                    'action' => ['idp/statistik-permohonan-mata-bulanan'],
                    'method' => 'get',
                ])
                ?>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><strong><i class="fa fa-line-chart"></i>&nbspStatistik Permohonan Mata IDP Mengikut Bulan Tahun <?= $tahun ?>
                    </strong></h2>
                <div class="pull-right">
                    ...
                    ExportMenu::widget([
                        ...
                        'filename' => 'Statistik Permohonan Mata IDP Bagi Tahun ' . $tahun . ' ' . date('Y-m-d'),
                        'clearBuffers' => true,
                        'stream' => false,
