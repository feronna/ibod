...
$gridColumnsK = [
                                ...
                                [
                                    ...
                                    'hAlign' => 'left',
                                    'format' => 'raw',
                                    'value' => function ($model) {return strtoupper($model->shortname);},
                                ...
                                [
                                    ...
                                    'value' => function($model){
                                        return Html::a(Department::countStaffDeptLayak($model->id, 0), ["senarai-jabatan", 'kumpulan' => $model->id, 'category' => 0, 'calctype' => 4]);
                                        },
...
//                                                  },
                                    'value' => function($model){
                                                      return Html::a(RptStatistikIdp::countStatisticsDept($model->id, 0, 0), ["senarai-jabatan", 'kumpulan' => $model->id, 'category' => 0, 'calctype' => 0]);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
...
//                                                  },
                                    'value' => function($model){
                                                      return round(RptStatistikIdp::countStatisticsDept($model->id, 0, 0)/ Department::countStaffDeptLayak($model->id, 0)*100);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
...
//                                                  },
                                    'value' => function($model){
                                                      return Html::a(RptStatistikIdp::countStatisticsDept($model->id, 0, 1), ["senarai-jabatan", 'kumpulan' => $model->id, 'category' => 0, 'calctype' => 1]);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
...
//                                                  },
                                    'value' => function($model){
                                                      return round(RptStatistikIdp::countStatisticsDept($model->id, 0, 1)/Department::countStaffDeptLayak($model->id, 0)*100);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
...
//                                                  },
                                    'value' => function($model){
                                                      return Html::a(RptStatistikIdp::countStatisticsDept($model->id, 0, 2), ["senarai-jabatan", 'kumpulan' => $model->id, 'category' => 0, 'calctype' => 2]);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
...
//                                                  },
                                    'value' => function($model){
                                                      return round(RptStatistikIdp::countStatisticsDept($model->id, 0, 2)/Department::countStaffDeptLayak($model->id, 0)*100);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
