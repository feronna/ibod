...
$gridColumns = [
    ...
    [
        'label' => 'Hari',
        'value' => 'sasaran9.sasaran4.hari',
    ],
    [
        'label' => 'Lokasi ',
        'format' => 'raw',
        'value' => 'sasaran9.sasaran4.lokasi',
        //                'value' => function ($data) {
        //                              if ($data->sasaran9->sasaran4->linkZoom){
        //                                return $data->sasaran9->sasaran4->lokasi.'<hr>'.
        //                                       Html::a('<i class="fa fa-video-camera" aria-hidden="true" text-align="center"></i>', $data->sasaran9->sasaran4->linkZoom, ['class' => 'btn-sm btn-info btn-block', 'target' => '_blank']);
        //                              } else {
        //                                return $data->sasaran9->sasaran4->lokasi.'<hr>'.
    ...
    //                                    //$a = '<span class="fa fa-unlock-alt"></span>';
    ////                                    return Html::a('<span class="glyphicon glyphicon-play-circle"></span>', [
    ////                                        'title' => Yii::t('app', 'Buka Siri'),
    ////                                    ]); 
    //                                    
    //                                } else {
    //                                    //$a = '<span class="fa fa-lock"></span>';
    ...
    [
        ...
        'value' => function ($data) {
            $datalist = [];
            if ($data->sasaran9->sasaran4->ceramah) { // if ada penceramah

                foreach ($data->sasaran9->sasaran4->ceramah as $c) { //foreach penceramah
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h5>Maklumat Kehadiran Kursus<h4><span class="label label-primary" style="color: white"><?= strtoupper($modelLatihan->tajukLatihan) ?></span></h4>
                </h5>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
