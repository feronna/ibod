    ...
    [
        'columns' => [
            [
                ...
                'format'=>'raw', 
                'value'=>'<kbd>'.ucwords(strtolower($modelLatihan->tajukLatihan)).'</kbd>',
                'displayOnly'=>true,
...
<!--        <div class="table-responsive">-->
                        ...
                        [
                            ...
                            'value' => function($model) use ($modelL, $form) {
                                ...
                                return $form->field($modelL, "$model->soalanID")->radioButtonGroup($data, [
                                    'class' => 'btn-group-sm',
                                    'itemOptions' => ['labelOptions' => ['class' => 'btn btn-info', 'disabled' => $modelL->statusBorang == 2 ? true : false]]
                                ])->label(false);
                            },
                            'format' => 'raw'
                        ],
            ...
            <?= $form->field($modelL, 'a_ulasan')->textarea(['rows' => '6', 'disabled' => $modelL->a_ulasan ? true : false])->label('<i class="fa fa-pencil-square-o" aria-hidden="true"></i> ULASAN') ?>
...
<!--        <div class="table-responsive">-->
            ...
            ?>
            <?= $form->field($modelL, 'b_ulasan')->textarea(['rows' => '6', 'disabled' => $modelL->b_ulasan ? true : false])->label('<i class="fa fa-pencil-square-o" aria-hidden="true"></i> ULASAN') ?>
<!--        </div>
        <div class="table-responsive">-->
            <?= GridView::widget([
                    'summary' => '',
            ...
            ?>
            <?= $form->field($modelL, 'c_ulasan')->textarea(['rows' => '6', 'disabled' => $modelL->c_ulasan ? true : false])->label('<i class="fa fa-pencil-square-o" aria-hidden="true"></i> ULASAN') ?>
<!--        </div>
        <div class="table-responsive">-->
            <?= GridView::widget([
                    'summary' => '',
            ...
            ?>
            <?= $form->field($modelL, 'd_ulasan')->textarea(['rows' => '6', 'disabled' => $modelL->d_ulasan ? true : false])->label('<i class="fa fa-pencil-square-o" aria-hidden="true"></i> ULASAN') ?>
<!--        </div>
        <div class="table-responsive">-->
            <?= GridView::widget([
                    'summary' => '',
...
<!--        </div>-->
                        ...
                        [
                            ...
                            'value' => function($model) use ($modelN, $form) {
                                ...
                                return $form->field($modelN, "$model->soalanID")->radioButtonGroup($data, [
                                    'class' => 'btn-group-sm',
                                    'itemOptions' => ['labelOptions' => ['class' => 'btn btn-info', 'disabled' => $modelN->statusBorang == 2 ? true : false]]
                                ])->label(false);
                            },
                            'format' => 'raw'
                        ],
        ...
        <?php if ($modelL->checkBorangStatussk($modelL->siriLatihanID, $modelL->pesertaID) == 1){ ?>
        <div class="form-group pull-right">
            <div class=""><?= Html::submitButton('Hantar / Submit', ['class' => 'btn btn-success', 'disabled' => $modelL->statusBorang == 2 ? true : false]) ?></div>
        </div>
        <?php } else { 
            if ($modelL->tarikhMasa) { ?>
                <div class="form-group pull-right">
                    <div class="">Borang anda telah dihantar pada <?php echo $modelL->tarikhMasa; ?></div>
                </div>
            <?php } else { ?>
                <div class="form-group pull-right">
