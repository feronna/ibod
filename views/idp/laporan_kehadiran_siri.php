...
////            ],
                ...
                [
                    'header' => 'Penilaian Latihan',
                    'format' => 'raw',
                    'vAlign' => 'middle',
                    'value' => function ($data){
                        
                                    return BorangPenilaianLatihan::checkBorangStatusp($data->sasaran9->siriLatihanID, $data->staffID);
                                }
                ],
                [
                    ...
                    'value' => function ($data){
                                    ...
                                    return BorangPenilaianKeberkesanan::checkBorangStatusUrusetia($data->sasaran9->siriLatihanID, $data->staffID);
                                }
                ],
];
...
$gridColumns = [
            ...
            [
                ...
                'vAlign' => 'middle',
                'value' => function ($data){
                            return ucwords(strtolower($data->biodata->displayGelaran)).' '.ucwords(strtolower($data->biodata->CONm));
                            }
            ],
            [
                'label' => 'Jawatan Disandang',
...
<div class="row">
    ...
    <div class="x_panel">
        ...
        <ul>
            ...
            <li><span class="btn btn-danger btn-md"><i class="fa fa-warning" aria-hidden="true"></i></span> : Kakitangan / Ketua Jabatan Belum Mengisi Borang Penilaian</li>
        </ul>
    </div>
    </div>
</div>
