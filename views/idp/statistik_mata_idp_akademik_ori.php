...
$gridColumnsA = [
                                ...
                                [
                                    ...
                                    'value' => function ($model) use ($tahun){
                                        ...
                                        return Html::a(Kumpulankhidmat::countStaff($model->vckl_kod_kumpulan, 1, $tahun), ["senarai", 'kumpulan' => $model->vckl_kod_kumpulan, 'category' => 1, 'calctype' => 4, 'tahun' => $tahun]);
...
//                                                },
                                    'value' => function ($model) use ($tahun){
                                                      return Html::a(RptStatistikIdp::countStatistics($model->vckl_kod_kumpulan, 1, 0, $tahun), ["senarai", 'kumpulan' => $model->vckl_kod_kumpulan, 'category' => 1, 'calctype' => 0, 'tahun' => $tahun]);
                                                },                    
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
...
//                                                  },
                                    'value' => function ($model) use ($tahun){
                                                      return round(RptStatistikIdp::countStatistics($model->vckl_kod_kumpulan, 1, 0, $tahun)/Kumpulankhidmat::countStaff($model->vckl_kod_kumpulan, 1, $tahun)*100);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
...
//                                                  },
                                    'value' => function ($model) use ($tahun){
                                                      return Html::a(RptStatistikIdp::countStatistics($model->vckl_kod_kumpulan, 1, 1, $tahun), ["senarai", 'kumpulan' => $model->vckl_kod_kumpulan, 'category' => 1, 'calctype' => 1, 'tahun' => $tahun]);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
...
//                                                  },
                                    'value' => function ($model) use ($tahun){
                                                      return round(RptStatistikIdp::countStatistics($model->vckl_kod_kumpulan, 1, 1, $tahun)/Kumpulankhidmat::countStaff($model->vckl_kod_kumpulan, 1, $tahun)*100);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
...
//                                                  },
                                    'value' => function ($model) use ($tahun){
                                                      return Html::a(RptStatistikIdp::countStatistics($model->vckl_kod_kumpulan, 1, 2, $tahun), ["senarai", 'kumpulan' => $model->vckl_kod_kumpulan, 'category' => 1, 'calctype' => 2, 'tahun' => $tahun]);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
...
//                                                  },
                                    'value' => function ($model) use ($tahun){
                                                      return round(RptStatistikIdp::countStatistics($model->vckl_kod_kumpulan, 1, 2, $tahun)/Kumpulankhidmat::countStaff($model->vckl_kod_kumpulan, 1, $tahun)*100);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Statistik Pencapaian Mata IDP Staf (Akademik)</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                ...
                <tr>
                    ...
                    <td><?php echo Html::a(Kumpulankhidmat::countStaff($model->vckl_kod_kumpulan ,3, $tahun), [''], ['target' => '_blank'])?></td>
                </tr>
                 <tr>
                    <td>JUMLAH KESELURUHAN CAPAI IDP MINIMUM</td>
                    <td><?php echo Html::a(RptStatistikIdp::countStatistics($model->vckl_kod_kumpulan ,3,0, $tahun), [''], ['target' => '_blank'])?></td>
                </tr>
                 <tr>
                    <td>JUMLAH KESELURUHAN BELUM CAPAI IDP MINIMUM</td>
                    <td><?php echo Html::a(RptStatistikIdp::countStatistics($model->vckl_kod_kumpulan ,3,1, $tahun), [''], ['target' => '_blank'])?></td>
                </tr>
                 <tr>
                    <td>JUMLAH KESELURUHAN BELUM ADA MATA IDP</td>
                    <td><?php echo Html::a(RptStatistikIdp::countStatistics($model->vckl_kod_kumpulan ,3,2, $tahun), [''], ['target' => '_blank'])?></td>
                </tr>
                </table>
