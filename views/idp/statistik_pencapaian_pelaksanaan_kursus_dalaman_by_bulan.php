...
$gridColumnsK = [
    ...
    [
        ...
        'value' => function ($model) use ($year) {
            return Html::a(StatistikKursusDalamanByBulan::countKursusByStatus($model->id, 0, $year), ["senarai-jabatan", 'kumpulan' => $model->id, 'category' => 0, 'calctype' => 4]);
        },
        ...
        'format' => 'raw',
        'footer' => StatistikKursusDalamanByBulan::countKursusByStatusTotal(0, $year)
        //'pageSummary' => count(StatistikKursusDalamanByBulan::countKursusByStatus($model->id, 0, $year))
    ...
    [
        ...
        //                                                  },
        'value' => function ($model) use ($year) {
            // $temp = StatistikKursusDalamanByBulan::countKursusByStatus($model->id, 1, $year);
            // $obj->footer += $temp;
            return Html::a(StatistikKursusDalamanByBulan::countKursusByStatus($model->id, 1, $year), ["senarai-jabatan", 'kumpulan' => $model->id, 'category' => 0, 'calctype' => 0]);
        },
        'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
    ...
    [
        ...
        //                                                  },
        'value' => function ($model) use ($year) {
            return StatistikKursusDalamanByBulan::countKursusByStatus($model->id, 2, $year);
        },
        'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
    ...
    [
        ...
        //                                                  },
        'value' => function ($model) use ($year) {
            return Html::a(StatistikKursusDalamanByBulan::countKursusByStatus($model->id, 3, $year), ["senarai-jabatan", 'kumpulan' => $model->id, 'category' => 0, 'calctype' => 1]);
        },
        'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
        'footer' => StatistikKursusDalamanByBulan::countKursusByStatusTotal(3, $year)
    ],
    [
        'label' => '%',
        'vAlign' => 'middle',
        ...
        //                                                  },
        'value' => function ($model) use ($year) {
            return StatistikKursusDalamanByBulan::countKursusByStatus($model->id, 4, $year);
        },
        'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
    ...
    [
        ...
        //                                                  },
        'value' => function ($model) use ($year) {
            return Html::a(StatistikKursusDalamanByBulan::countKursusByStatus($model->id, 5, $year), ["senarai-jabatan", 'kumpulan' => $model->id, 'category' => 0, 'calctype' => 2]);
        },
        'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
        'footer' => StatistikKursusDalamanByBulan::countKursusByStatusTotal(5, $year)
    ],
    [
        'label' => '%',
        'vAlign' => 'middle',
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                $form = ActiveForm::begin([
                    'action' => ['idp/statistik-pencapaian-pelaksanaan-kursus-dalaman'],
                    'method' => 'get',
                ])
                ?>
                                ...
                                'beforeHeader' => [
                                    [
                                        'columns' => [
                                            ...
                                            [
                                                'content' => 'JUMLAH KURSUS', 'options' => ['colspan' => 1, 'rowspan' => 2],
                                                'vAlign' => 'middle',
                                                'hAlign' => 'center'
                                            ],
                                            ...
                                            //                                                                'vAlign' => 'middle',
                                            //                                                                'hAlign' => 'center'],
                                            ['content' => 'TERLAKSANA', 'options' => ['colspan' => 2]],
                                            ['content' => 'BELUM DILAKSANAKAN', 'options' => ['colspan' => 2]],
