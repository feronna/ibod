...
$gridColumnsP = [
                                ...
                                [
                                    ...
                                    'value' => function ($model) use ($tahun){
                                        ...
                                        return Html::a(IdpStatistikPentadbiran::countStaffByKumpulan($model->vckl_kod_kumpulan, 0, $tahun), ["senarai", 'kumpulan' => $model->vckl_kod_kumpulan, 'category' => 2, 'calctype' => 4, 'tahun' => $tahun]);
                                ...
                                [
                                    ...
                                    'format' => 'raw',
                                    'value' => function ($model) use ($tahun){
                                                      return Html::a(IdpStatistikPentadbiran::countStaffByKumpulan($model->vckl_kod_kumpulan, 1, $tahun), ["senarai", 'kumpulan' => $model->vckl_kod_kumpulan, 'category' => 2, 'calctype' => 0, 'tahun' => $tahun]);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
                                    ...
                                    'format' => 'raw',
                                    'value' => function ($model) use ($tahun){
                                                      return IdpStatistikPentadbiran::countStaffByKumpulan($model->vckl_kod_kumpulan, 2, $tahun);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
...
//                                                  },
                                    'value' => function ($model) use ($tahun){
                                                      return Html::a(IdpStatistikPentadbiran::countStaffByKumpulan($model->vckl_kod_kumpulan, 3, $tahun), ["senarai", 'kumpulan' => $model->vckl_kod_kumpulan, 'category' => 2, 'calctype' => 1, 'tahun' => $tahun]);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
                                    ...
                                    'format' => 'raw',
                                    'value' => function ($model) use ($tahun){
                                                      return IdpStatistikPentadbiran::countStaffByKumpulan($model->vckl_kod_kumpulan, 4, $tahun);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
                                    ...
                                    'format' => 'raw',
                                    'value' => function ($model) use ($tahun){
                                                      return Html::a(IdpStatistikPentadbiran::countStaffByKumpulan($model->vckl_kod_kumpulan, 5, $tahun), ["senarai", 'kumpulan' => $model->vckl_kod_kumpulan, 'category' => 2, 'calctype' => 2, 'tahun' => $tahun]);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
                                [
                                    ...
                                    'format' => 'raw',
                                    'value' => function ($model) use ($tahun){
                                                      return IdpStatistikPentadbiran::countStaffByKumpulan($model->vckl_kod_kumpulan, 6, $tahun);
                                                },
                                    'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
                                ],
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <tr>
                    ...
                    <td><?= IdpStatistikPentadbiran::countStaff(0, $tahun); ?></td>
                </tr>
                 <tr>
                    <td>JUMLAH KESELURUHAN CAPAI IDP MINIMUM</td>
                    <td><?= IdpStatistikPentadbiran::countStaff(1, $tahun); ?></td>
                </tr>
                 <tr>
                    <td>JUMLAH KESELURUHAN BELUM CAPAI IDP MINIMUM</td>
                    <td><?= IdpStatistikPentadbiran::countStaff(2, $tahun); ?></td>
                </tr>
                 <tr>
                    <td>JUMLAH KESELURUHAN BELUM ADA MATA IDP</td>
                    <td><?= IdpStatistikPentadbiran::countStaff(3, $tahun); ?></td>
                </tr>
                </table>
