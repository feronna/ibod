            ...
            ExportMenu::widget([
                ...
                'columns' => [
                                ...
                                [
                                    ...
                                    'hAlign' => 'center',
                                    'format' => 'raw',
                                    'value' => function ($model){return '('.$model->idp_teras_uni.'/'.$model->matamin_teras_uni.')'; },
                                ...
                                [
                                    ...
                                    'hAlign' => 'center',
                                    'format' => 'raw',
                                    'value' => function ($model){return '('.$model->idp_teras_skim.'/'.$model->matamin_teras_skim.')'; },
                                    'contentOptions' => ['style' => 'width:80px; white-space: normal;'],
                                ],
                                [
                                    'label' => 'Elektif',
...
//                                    },
                                    ...
                                    'value' => function ($model){return '('.$model->idp_mata_sumbangan.'/'.$model->idp_kom_sumbangan.')'; },
                                    'contentOptions' => ['style' => 'width:80px; white-space: normal;'],
                                ],
                                [
                                    'header' => 'Jumlah Mata <br> Diambil Kira',
