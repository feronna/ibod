...
$gridColumnsK = [
    ...
    [
        ...
        'value' => function ($model) use ($year) {
            return PermohonanMataIdpIndividu::calcPermohonan($model->id, $year);
        },
    ...
    [
        'header' => 'BERKUMPULAN <br> (PERMOHONAN OLEH JAFPIB)',
        'vAlign' => 'middle',
        'hAlign' => 'center',
        'format' => 'raw',
        'value' => function ($model) use ($year) {
            return PermohonanMataIdpIndividu::calcPermohonanByGroup($model->id, $year);
        },
        'contentOptions' => ['style' => 'width:75px; white-space: normal;'],
        'headerOptions' => [
            'style' => 'display: none;',
    ...
    // ],
    // [
    //     'label' => 'JUMLAH TIDAK HADIR (MEMOHON)',
    //     'vAlign' => 'middle',
    //     'hAlign' => 'center',
    //     'format' => 'raw',
    //     'value' => function ($model) use ($year) {
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                $form = ActiveForm::begin([
                    'action' => ['idp/statistik-permohonan-mata'],
                    'method' => 'get',
                ])
                ?>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><strong><i class="fa fa-line-chart"></i>&nbspStatistik Permohonan Mata IDP Mengikut Jabatan Bagi Tahun <?= $tahun ?>
                    </strong></h2>
                                ...
                                'beforeHeader' => [
                                    [
                                        'columns' => [
                                            ...
                                            [
                                                'content' => 'JUMLAH PERMOHONAN', 'options' => ['colspan' => 2, 'rowspan' => 1],
                                                'vAlign' => 'middle',
                                                'hAlign' => 'center'
                                            ],
                                            [
                                                'content' => 'JENIS PERMOHONAN', 'options' => ['colspan' => 1, 'rowspan' => 1],
                                                'vAlign' => 'middle',
                                                'hAlign' => 'center'
                                            ],
                                            // ['content' => 'JUMLAH HADIR', 'options' => ['colspan' => 3, 'rowspan' => 1]],
                                            // ['content' => 'JUMLAH TIDAK HADIR (MEMOHON)', 'options' => ['colspan' => 1, 'rowspan' => 1]],
