...
//            ],
            [
                ...
                'value'=> function ($data){
                            ...
                            return Html::button('<i class="fa fa-pencil" aria-hidden="true"></i> DAFTAR KEHADIRAN', ['value' => 'daftarkehadiran?id='.$data->siriLatihanID.'&slotID='.$data->slotID, 'class' => 'btn btn-primary btn-md fa fa-edit mapButton']);
                          },
            ],
