...
$gridColumns = [
    ...
    [
        'header' => 'Bil Borang Penilaian <br> Selesai Diisi <br> Kakitangan',
        'format' => 'raw',
        'value' => function ($data) {
    ...
    // ],
    [
        'header' => 'Bil Borang <br> Keberkesanan Selesai <br> Diisi Kakitangan',
        'format' => 'raw',
        'value' => function ($data) {
            return BorangPenilaianLatihan::calculateSudahIsi($data->siriLatihanID);
        },
    ...
    [
        'header' => 'Bil Borang <br> Keberkesanan 6 Bulan <br> Selesai Diisi KJ',
        'format' => 'raw',
        'value' => function ($data) {
    ...
    [
        ...
        'format' => 'raw',
        'value' => function ($data) {
            return SiriLatihan::getStatusSixMonths($data->siriLatihanID);
        },
        'vAlign' => 'middle',
        'hAlign' => 'center',
    ],
