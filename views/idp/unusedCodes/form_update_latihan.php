...
/* @var $model app\models\models_idp\VIdpSenaraiKursus */
/* @var $form ActiveForm */
...
//                        $form->field($model, 'email')->input('email');
                        ...
                        $earliest_year = 1950;
                        $listYear = range(date('Y'), $earliest_year);
                        echo $form->field($model, 'tahun_ditawarkan')->dropDownList($listYear, ['prompt'=>'Pilih tahun...'])->hint('Sila pilih tahun penawaran kursus')->label(false);
