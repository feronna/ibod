...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Senarai Pencapaian Mata IDP Staf</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
...
<!--            <div class="x_title">
            ...
            <div class="x_title">
            <h2>Staf Pentadbiran</h2><div  class="pull-right">
            <?= 
            ExportMenu::widget([
...
//                                ],
                                ['class' => 'yii\grid\ActionColumn',
                                    ...
                                    'urlCreator' => function ($action, $model, $key, $index) {
                                      if ($action === 'view') {
                                          $url ='profil?staffChosen='.$model->staffID;
                                          return $url;
                                      }
                                    }
                                ],
...
//                                        ],
//                                    'value' => function ($data){
//                                        return '&nbsp; ('.$data->mataElektif.'/'.$data->getMinKompetensi(4).')';
//                                    }
//                                ],
                            ],
                        ]); ?> 
...
<!--            <div class="x_title">
            ...
            <div class="x_title">
            <h2>Staf Akademik</h2><div  class="pull-right">
            <?= 
            ExportMenu::widget([
