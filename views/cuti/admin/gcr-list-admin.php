                    ...
                    <table class="table table-sm table-bordered jambo_table" style="font-size: 11px">
                        <thead>
                            <tr class="headings">
                                ...
                                <th class="text-center">Catatan Penyelia JFPIB</th>
                        ...
                        <?php if ($gcr) { ?>
                            ...
                            <?php foreach ($gcr as $senarai) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo Layak::getBakiOld($senarai->pemohon_icno, $start, $end); ?></td>
                                    <td class="text-center"><?php echo $senarai->gcr_applied; ?></td>
                                    <td class="text-center"><?php echo $senarai->cbth_applied; ?></td>
                                    <td class="text-center"><?php echo $senarai->semakan_remark; ?></td>
                                    <td class="text-center"> <?= Html::button('<i class="fa fa-edit"></i>  ', ['value' => Url::to(['cuti/pegawai/gcr-verify-bsm', 'id' => $senarai->id]), 'class' => 'mapBtn']); ?></td>
