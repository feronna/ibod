        ...
        <?php $form = ActiveForm::begin(['enableAjaxValidation' => false, 'options' => ['class' => 'form-horizontal form-label-left disable-submit-buttons', 'enctype' => 'multipart/form-data']]); ?>
            ...
            <!-- <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?php echo $form->field($model, 'gcrfile', ['enableAjaxValidation' => true])->fileInput()->label(false); ?>
                </div>
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    ...
                    <?= Html::submitButton('Hantar', ['class' => 'btn btn-success', 'url' => ['index'],'data' => ['confirm' => 'Are You Sure to add Remark??']]) ?>
                </div>
            </div>
