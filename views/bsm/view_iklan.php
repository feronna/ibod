...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><?= strtoupper($iklan->jawatan->fname); ?> <?= Html::a('<i class="fa fa-edit"></i>', ['bsm/edit-iklan', 'id' => $iklan->id], ['class' => 'btn btn-success btn-xs']); ?></h2> 
                    <p align="right" >
                        <?php echo Html::a('Kembali', Yii::$app->request->referrer, ['class' => 'btn btn-primary btn-sm']); ?>  
                        <?php echo Html::a('<i class="fa fa-check"></i> Simpan', ['simpan-iklan'], ['class' => 'btn btn-success btn-sm']); ?>  
                    </p>
                ...
                <div class="x_content">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <p align="right" >
                            <?= Html::a('<i class="fa fa-edit"></i>', ['bsm/edit-iklan', 'id' => $iklan->id], ['class' => 'btn btn-success btn-xs']); ?> 
                        </p>
                        ...
                        <div class="x_panel">
                            <h2>KETERANGAN TUGAS <?= Html::a('<i class="fa fa-edit"></i>', ['bsm/tambah-tugas', 'id' => $iklan->id], ['class' => 'btn btn-success btn-xs']); ?></h2> 
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12" style="border:0px solid #e5e5e5;">
                        ...
                        <div class="x_panel">
                            <h2>JUMLAH KEKOSONGAN <?= Html::a('<i class="fa fa-edit"></i>', ['bsm/edit-iklan', 'id' => $iklan->id], ['class' => 'btn btn-success btn-xs']); ?></h2> 
                            <table class="table table-sm table-bordered jambo_table table-striped">
                                <tr>
                                    <td>
                        ...
                        <div class="x_panel">
                            <h2>SYARAT KELAYAKAN <?= Html::a('<i class="fa fa-edit"></i>', ['bsm/tambah-kelayakan', 'id' => $iklan->id], ['class' => 'btn btn-success btn-xs']); ?></h2>
                            <table class="table table-borderless">
            ...
            <?= '<b>Syarat Tambahan</b>: ' . $kelayakan->syarat_tamb_desc; ?>
                        ...
                        <div class="x_panel">
                            <h2>TARAF JAWATAN <?= Html::a('<i class="fa fa-edit"></i>', ['bsm/edit-iklan', 'id' => $iklan->id], ['class' => 'btn btn-success btn-xs']); ?></h2>
