...
<div class="col-md-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_title">
            <h2><i class="fa fa-check"></i><strong> KELULUSAN PENAMBAHAN PERUNTUKAN HAD RAWATAN KLINIK PANEL KAKITANGAN UNIVERSITI MALAYSIA SABAH </strong></h2>
        ...
        <div class="container">
            <div class="table-responsive">
                <table class="table table-sm table-bordered">
                    <thead>
                        <th scope="col" colspan=12" style="background-color:lightseagreen; color:white">
                            <center>
                                <h5><strong>SEMAKAN PERMOHONAN (UNIT PERKHIDMATAN DAN PERUBATAN)</strong></h5>
                            </center>
                        </th>
                        <tr>
                            <td valign="5" width="30%">Permohonan Kali: <span class="required" style="color:red;">*</span></td>
                            <td colspan="5">
                                <div class="col-md-12 col-sm-12 col-xs-10">
                                    <?php if ($model->entry_id == 1) {
                                        echo "<strong>KALI PERTAMA</strong>";
                                    } else {
                                        echo "KALI KEDUA";
                                    } ?>
                                </div>
                        ...
                        <tr>
                            <td valign="5">Nama Penuh:<span class="required" style="color:red;">*</span></td>
                            <td colspan="5">
                                <div class="col-md-12 col-sm-12 col-xs-10">
                                    <?= $form->field($model->kakitangan->kakitangan, 'CONm')->textArea(['maxlength' => true, 'rows' => 4, 'disabled' => TRUE])->textInput(['disabled' => 'disabled'])->label(false); ?>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="5">No. Kad Pengenalan:<span class="required" style="color:red;">*</span></td>
                            <td colspan="5">
                                <div class="col-md-12 col-sm-12 col-xs-10">
                                    <?= $form->field($model, 'icno')->textArea(['maxlength' => true, 'rows' => 4, 'disabled' => TRUE])->textInput(['disabled' => 'disabled'])->label(false); ?>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="5">Jawatan dan Gred:<span class="required" style="color:red;">*</span></td>
                            <td colspan="5">
                                <div class="col-md-12 col-sm-12 col-xs-10">
                                    <?= $form->field($model->kakitangan->kakitangan->jawatan, 'fname')->textArea(['maxlength' => true, 'rows' => 4, 'disabled' => TRUE])->textInput(['disabled' => 'disabled'])->label(false); ?>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="5">Taraf Lantikan:<span class="required" style="color:red;">*</span></td>
                            <td colspan="5">
                                <div class="col-md-12 col-sm-12 col-xs-10">
                                    <?= $form->field($model->kakitangan->kakitangan->statusLantikan, 'ApmtStatusNm')->textArea(['maxlength' => true, 'rows' => 4, 'disabled' => TRUE])->textInput(['disabled' => 'disabled'])->label(false); ?>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="5">Taraf Perkahwinan:<span class="required" style="color:red;">*</span></td>
                            <td colspan="5">
                                <div class="col-md-12 col-sm-12 col-xs-10">
                                    <?= $form->field($model->kakitangan->kakitangan->tarafPerkahwinan, 'MrtlStatus')->textArea(['maxlength' => true, 'rows' => 4, 'disabled' => TRUE])->textInput(['disabled' => 'disabled'])->label(false); ?>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="5">J/A/F/P/I/B:<span class="required" style="color:red;">*</span></td>
                            <td colspan="5">
                                <div class="col-md-12 col-sm-12 col-xs-10">
                                    <?= $form->field($model->kakitangan->kakitangan->department, 'fullname')->textArea(['maxlength' => true, 'rows' => 4, 'disabled' => TRUE])->textInput(['disabled' => 'disabled'])->label(false); ?>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td valign="5"><i class="fa fa-pencil"></i> ULASAN PENTADBIRAN<span class="required" style="color:red;">*</span></td>
                            <td colspan="5">
                                <div class="col-md-12 col-sm-12 col-xs-10">
                                    <strong>Saya telah menyemak permohonan:</strong>
                                    <br>
                                    <br>
                                    <strong>1. Permohonan ini dibuat mengikut kadar dan syarat seperti yang dinyatakan di bawah Garis Panduan Perkhidmatan Dan Kemudahan Klinik Panel Tahun 2016 dan Mesyuarat Jawatankuasa Tadbir Urus Kemudahan Perubatan (JKTUKP) Bil. 10 Tahun 2022 (Kali ke 11).</strong>
                                    <br>
                                    <br>
                                    <strong>2. Ringkasan permohonan berdasarkan Garis Panduan. </strong>
                                    <br><br>
                                    <strong>Disemak Oleh :</strong>
                                    <br>
                                    <strong><?= ($approver->pelulus_icno) ? $approver->pelulus->CONm : 'Terus kepada Pegawai Memperaku'; ?></strong>
                                    <br>
                                    <strong>Penolong Pendaftar Kanan</strong>
                                    <br><br>
                                    <strong>Disemak Pada :</strong>
                                    <br>
                                    <strong><?= $model->check_dt; ?></strong>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td valign="5"><i class="fa fa-pencil"></i> PERAKUAN BAHAGIAN SUMBER MANUSIA<span class="required" style="color:red;">*</span></td>
                            <td colspan="5">
                                <div class="col-md-12 col-sm-12 col-xs-10">
                                    <strong>Permohonan ini diperaku :</strong>
                                    <br>
                                    <br>
                                    <strong>1. Permohonan mematuhi Garis Panduan.</strong>
                                    <br>
                                    <br>
                                    <strong>Diperaku Oleh :</strong>
                                    <br>
                                    <strong><?= ($model->verifybsm_by) ? $model->verifierBsm->CONm : 'Terus kepada Pegawai Pelulus'; ?></strong>
                                    <br>
                                    <strong>Ketua Timbalan Pendaftar</strong>
                                    <br><br>
                                    <strong>Diperaku Pada :</strong>
                                    <br>
                                    <strong><?= $model->verifybsm_dt; ?></strong>
                                </div>
                            </td>
                        </tr>
                ...
                <div class="x_title">
                    <h2><i class="fa fa-check"></i><strong> KELULUSAN PENDAFTAR</strong></h2>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                    <?= $form->field($model, 'app_remarks')->textArea(['maxlength' => true, 'rows' => 2])->label(false); ?>
                    </div>
                </div>
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="text-center">
                                <div style="width: 800px; height: 90px;border:2px solid burlywood">
                                    <h5 style="color:black;"><br>
                                        &nbsp; Saya bersetuju untuk meluluskan permohonan peruntukan yang dipohon. <p>
                                    </h5>
                                    <strong>
                                        <p style="color:black;">
                                            <center>Tarikh Peraku: <?php echo date('Y-m-d H:i:s'); ?>
