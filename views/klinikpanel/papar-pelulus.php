        ...
        <div class="col-md-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="container">
                    ...
                    <div class="x_title">
                        <h2><i class="fa fa-check-square"></i><strong> KELULUSAN BAHAGIAN SUMBER MANUSIA</strong></h2>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <?php if ($model->status == 2) {
                                echo $form->field($model, 'app_remarks')->textArea(['maxlength' => true, 'rows' => 2])->label(false);
                            } else {
                                echo $form->field($model, 'app_remarks')->textArea(['maxlength' => true, 'rows' => 2, 'disabled' => TRUE])->label(false);
                            } ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <?php if ($model->status == 2) {
                                ...
                                $form->field($model, 'app_amount')->label(false)->widget(Select2::classname(), [
                                    'data' => ['1000.00' => '1000.00', '750.00' => '750.00', '500.00' => '500.00', '375.00' => '375.00'],
                                    'options' => [
                                    ...
                                    <td class="text-center">
                                        <div style="width: 800px; height: 90px;border:2px solid burlywood">
                                            <h5 style="color:black;"><br>
                                                &nbsp; Saya tidak bersetuju untuk meluluskan permohonan peruntukan yang dipohon. <p>
                                            </h5>
                                            <strong>
                                                <p style="color:black;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div style="width: 800px; height: 90px;border:2px solid burlywood">
                                            ...
                                            <strong>
                                                <p style="color:black;">
                                                    <center>Tarikh Kelulusan: <?php echo date('Y-m-d H:i:s'); ?>
                                                </p><br />
                                            </strong></center>
                                        </div>
                                    </td>
