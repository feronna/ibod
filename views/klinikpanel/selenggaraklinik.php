...
<div class="col-md-12 col-sm-12 col-xs-12"> 
    ...
    <div class="x_content">
        ...
        <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <?= $form->field($klinik, 'telefon')->textInput(['maxlength' => true, 'rows' => 2])->label(false); ?>
                </div>
            </div>
        <div class="form-group">
            ...
            <table class="table table-striped table-sm jambo_table table-bordered" style="text-align:center">
                <thead>
                    <tr class="headings">
                        ...
                        <th class="column-title text-center">EMEL</th>
...
//                    if($query){
                    foreach ($query as $admins) { 
                        ...
                        <tr>
                            ...
                            <td><?= $admins->nama; ?></td>
                            <td><?= $admins->alamat; ?></td>
                            <td><?= $admins->telefon; ?></td>
                            <td><?= $admins->klinik_email; ?></td>
                            <td>
                                
                                
        <?= Html::a('<i class="fa fa-pencil"></i>', ['updatek', 'id' => $admins->klinik_id], [  
        ])  ?> 
        |
        <?= Html::a('<i class="fa fa-trash-o"></i>', ['deleter', 'id' => $admins->klinik_id], [
            'data' => [
