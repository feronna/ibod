...
<!--            <ul class="nav navbar-right panel_toolbox">
        ...
        <div class="container">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                     <?= $form->field($model, 'ver_stat')->label(false)->widget(Select2::classname(), [
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <?= $form->field($model, 'ver_catatan')->textarea(array('rows'=>6,'cols'=>5))->label(false);?>   
                </div>
            </div>
                <div class="form-group">
    ...
    <?php } ?>
            <?php if($model->ver_stat == 'DIPERAKUI' || $model->ver_stat == 'TIDAK DIPERAKUI'){?>  
...
<!--            <ul class="nav navbar-right panel_toolbox">
        ...
        <div class="container">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                 <?= $form->field($model,  'ver_stat' )->textInput(['maxlength' => true, 'disabled'=>'disabled']) ->label(false);?>   
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Catatan : <span class="required"></span>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <?= $form->field($model, 'ver_date')->textInput(['maxlength' => true, 'disabled'=>'disabled']) ->label(false);?>     
                </div>
            </div>
