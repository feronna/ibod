...
<div class="row">
        ...
        <div class="x_content">
          <?= Html::a('Tambah', ['/profil-gaji/tambah-profil-gaji', 'umsper' => $models->COOldID], ['class' => 'btn btn-success']);?>   
                    ...
                    <th class="text-center">Tindakan</th>
                     ...
                     <?php foreach ($model as $key=>$item): ?>
                        <tr>
                             ...
                             <td><?= $item->Pencen?></td>
                             <td><?= $item->SS_RATE?></td>
                             <td class="text-center"> <?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['/profil-gaji/lihat-gaji', 'id' => $item->id]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['/profil-gaji/kemaskini-profil-gaji', 'id' => $item->id])?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['delete-profil-gaji', 'id' => $item->id]) ?> </td>  
