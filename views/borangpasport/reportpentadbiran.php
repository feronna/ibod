...
$sheet->setCellValue('A1', 'LAPORAN TUNTUTAN PASPORT');;
...
$writer->save("LAPORAN TUNTUTAN PASPORT.xlsx");
Yii::$app->response->redirect(['LAPORAN TUNTUTAN PASPORT.xlsx']);
?>
<a href="<?php echo Url::to('@web/'.'hello worldsssssss.xlsx', true); ?>" target="_blank" ><i class="fa fa-download"></i> Laporan Tuntutan Pasport</a><br>
