...
<div class="kualiti-create">
    <div class="x_panel">
        <div class="x_title">
            <h2><strong><i class="fa fa-list"></i> Kemaskini Pelan Audit</strong></h2>
        ...
        <div class="col-md-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Susunan<span class="required" style="color:red;">*</span>
                    </label>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <?=
                        $form->field($model, 'susunan')->widget(NumberControl::classname(), [
                            'name' => 'susunan',
                            'pluginOptions' => [
                                'initialize' => true,
                            ],
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <?php
                        if (empty($model->file)) {
                            echo $form->field($model, 'file')->fileInput(['maxlength' => true])->label(false);
                        } else {
                ...
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <?= Html::a('Kembali', ['manual', 'id' => $model->msiso_id], ['class' => 'btn btn-primary']) ?>
                    </div>
                </div>
