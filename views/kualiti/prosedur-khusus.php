...
<div class="kualiti-create">
    <div class="x_panel">
        <div class="x_title">
            <h2><strong><i class="fa fa-list"></i>Prosedur Khusus</strong></h2>
            <div class="clearfix"></div>
        </div>
        <p>
        <?php if($access || $isms){
              echo  Html::a('Tambah Prosedur Khusus', ['tambah-pk'], ['class' => 'btn btn-primary']);
             }else{
                echo '';
             } ?>
            <?php if($access){
        ...
        <div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">            
                <?= $form->field($searchModel, 'tajuk_prosedur')->textInput(['placeholder' => 'Carian Prosedur Khusus'])->label(false); 
                ?>
            </div>
                ...
                [
                    ...
                    'buttons' => [
                        'view' => function ($url, $query) use($access,$isms) {
                            ...
                            if($access || $isms){
                            $url = Url::to(['kualiti/view-pk', 'id' => $query->msiso_id]);
