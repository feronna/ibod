...
<div class="kualiti-view">
    ...
    <p>
        ...
        <?= Html::a('Kemaskini', ['update-pu', 'id' => $model->msiso_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Padam', ['delete-pu', 'id' => $model->msiso_id], [
        ...
        <?= Html::a('Kembali', ['prosedur-umum'], ['class' => 'btn btn-success']) ?>
    </p>
