...
<div class="kualiti-view">
    ...
    <p>
        ...
        <?= Html::a('Kemaskini', ['update-pk', 'id' => $model->msiso_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Padam', ['delete-pk', 'id' => $model->msiso_id], [
        ...
        <?= Html::a('Kembali', ['prosedur-khusus'], ['class' => 'btn btn-success']) ?>
    </p>
