...
<div class="x_panel">
        ...
        <div class="x_content"> 
           ...
           PERMOHONAN UNTUK MENDAPATKAN TUNTUTAN IELTS.</strong><br> </div>
            <div align="justify"><strong>o 
    ...
    <i>Lengkapkan permohonan anda dan pastikan muatnaik lampiran yang sewajarnya</i>
        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                 <th scope="col" colspan=12"  style="background-color:lightseagreen;color:white"><center>IELTS</center></th>
