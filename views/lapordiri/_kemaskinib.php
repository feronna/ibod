...
?> 
 ...
 <p align="right"><?= Html::a('Kembali', ['lapordiri/pengesahan-belum-selesai?i='.$i], 
                ...
                <table class="table table-bordered jambo_table">
                    ...
                    <tr>
                        ...
                        Borang ini perlu dimuat turun dan diisi untuk persetujuan pemotongan gaji bagi yang belum selesai & telah lapor diri</th>
                         ...
                         <td> <?php if($model->dokumen_6)
                        {
                           ?> <a class="form-control" style="background-color: transparent;border:0;box-shadow: none;" 
                       href="<?= Url::to(Yii::$app->FileManager->DisplayFile($model->dokumen_6), true); ?>" target="_blank" ><u>Download Document</u></a><br>
                       <?php }
                       else{?>
                           <?= $form->field($model, 'file6')->fileInput()->label(false);?> </td>
...
?>
                ...
                <tr>
                         ...
                         <a href="<?php echo Url::to('@web/'.'uploads-cutibelajar/cbelajar/dokumen/gaji.pdf', true); ?>" target="_blank" ><i class="fa fa-download"></i> Klik Sini Untuk Muat Turun</a><br>
                        Borang ini perlu dimuat turun dan diisi untuk kos kuarantin</th>
                     
                         <td> <?php if($model->dokumen5)
                        {
                           ?> <a class="form-control" style="background-color: transparent;border:0;box-shadow: none;" 
                       href="<?= Url::to(Yii::$app->FileManager->DisplayFile($model->dokumen5), true); ?>" target="_blank" ><u>Download Document</u></a><br>
                       <?php }
                       else{?>
