...
<div class="x_panel">
    ...
    <i>Lengkapkan permohonan anda dan pastikan muatnaik lampiran yang sewajarnya</i>
        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                 <th scope="col" colspan=12"  style="background-color:lightseagreen;color:white"><center>VISA</center></th>

                    
                     
               
                    <tr class="headings">
                        <th class="col-md-3 col-sm-3 col-xs-12">SALINAN RESIT BAYARAN VISA:<br>
                     ...
                     <tr class="headings">
                        <th class="col-md-6 col-sm-6 col-xs-12">SALINAN VISA:<br>
