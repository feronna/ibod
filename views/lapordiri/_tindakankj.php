        ...
        echo '<td>Tiada Maklumat</td>'.'<br>';
                    ...
                    <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    Borang Pemotongan Gaji:</th>
        <?php if ($model->upload->dokumen_6) { ?>
                                    <td class="text-left"> <a class="form-control" style="background-color: transparent;border:0;box-shadow: none;" 
                                                                href="<?= Url::to(Yii::$app->FileManager->DisplayFile($model->upload->dokumen_6), true); ?>" target="_blank" >
