...
<h5> <strong><center>PEMAKLUMAN LAPOR DIRI KEMBALI BERTUGAS</center></strong> </h5>
...
<table class="table table-sm table-bordered">
                       ...
                       <tr> 
                        ...
                        <td style="width:20%"><span class="label label-warning"> <?=  strtoupper($model->kakitangan->serviceStatus->ServStatusNm);?></span>
            ...
            dropDownList(['1' => 'LULUS/ SELESAI PENGAJIAN ',
                          '2' => 'SEDANG MENULIS',
                          ...
                          '14' => 'GAGAL PENGAJIAN DAN MELETAK JAWATAN',
                          "MIA"=> 'MIA',
