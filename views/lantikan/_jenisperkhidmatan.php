...
use app\models\hronline\Servicetype;
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Jenis Perkhidmatan<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?=
                    $form->field($model, 'ServTypeCd')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(Servicetype::find()->all(), 'ServTypeCd', 'ServTypeNm'),
