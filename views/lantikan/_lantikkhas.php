...
<div class="tblprcobiodata-form">
    ...
    <div class="x_panel" style="background-color:#b4bdcc;color:black;">
        ...
        <div class="x_content">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">E-mel Rasmi (@ums.edu.my): <span class="required" style="color:red;">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    $form->field($model, 'statLantikan')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(StatusLantikan::find()->Where(['ApmtStatusCd'=>'2'])->all(), 'ApmtStatusCd', 'ApmtStatusNm'),
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    $form->field($model, 'gredJawatan')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(GredJawatan::find()->where(['isKhas'=>'1'])->orderBy(['nama'=>SORT_ASC])->all(), 'id', 'fname'),
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    $form->field($model, 'ApmtTypeCd')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(JenisLantikan::find()->orderBy(['ApmtTypeNm'=>SORT_ASC])->all(), 'ApmtTypeCd', 'ApmtTypeNm'),
