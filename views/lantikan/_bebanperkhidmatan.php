        ...
        <div class="x_content">
            <div class="table-responsive">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Beban Perkhidmatan<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?=
                            $form->field($model, 'ServLoadCd')->label(false)->widget(Select2::classname(), [
                                'data' => ArrayHelper::map(Serviceloading::find()->all(), 'ServLoadCd', 'ServLoadNm'),
