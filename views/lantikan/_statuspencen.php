    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <?php $form = ActiveForm::begin(['options' => ['class' => 'form-horizontal form-label-left disable-submit-buttons']]); ?>
                ...
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Kod Status Pencen<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?=
                    $form->field($model, 'PsnStatusCd')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(Pensionstatus::find()->all(), 'PsnStatusCd', 'PsnStatusNm'),
