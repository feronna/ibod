            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    $form->field($model, 'statLantikan')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(StatusLantikan::find()->where(['IN','ApmtStatusCd',[54]])->all(), 'ApmtStatusCd', 'ApmtStatusNm'),
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    $form->field($model, 'gredJawatan')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(GredJawatan::find()->where(['in','id',482])->all(), 'id', 'fname'),
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    $form->field($model, 'ApmtTypeCd')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(JenisLantikan::find()->where(['ApmtTypeCd'=>12])->all(), 'ApmtTypeCd', 'ApmtTypeNm'),
