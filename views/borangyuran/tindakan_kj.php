...
<div class="form-horizontal form-label-left"> 
    ...
    <div class="x_panel">
        ...
        <thead>
                ...
                <tr>
                        ...
                        <td colspan="4">  
                            <?= $form->field($model, 'badan_prof')->textInput(['maxlength' => true, 'disabled'=>'disabled']) ->label(false);?> 
                        </td>
                </tr>
                ...
                <tr>
                        ...
                        <td colspan="4"> 
                             <?= $form->field($model, 'jumlah')->textInput(['maxlength' => true, 'disabled'=>'disabled']) ->label(false);?> 
                        </td>
                ...
                <tr>
                        ...
                        <td colspan="4">
                            <?= $form->field($model, 'payment')->textInput(['maxlength' => true, 'disabled'=>'disabled']) ->label(false);?> 
        ...
        <thead>
                <tr>
                    ...
                    <td colspan="4"><a class="form-control" style="border:0;box-shadow: none;" href="<?php echo yii\helpers\Url::to(Yii::$app->FileManager->DisplayFile($model->dokumen_sokongan), true); ?>" target="_blank" ><i></i><u>Resit Pembayaran.pdf</u></a></td>
                    <?php } ?>
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <?php if($model->status_kj == 'DILULUSKAN' || $model->status_kj == 'TIDAK DILULUSKAN'){?>     
            <div class="x_panel">
        <div class="x_title">
        ...
        <div class="x_content">
            ...
            <div class="form-group">
             ...
             <?php if($model->status_kj == 'MENUNGGU TINDAKAN' || $model->status_kj == '' ){?>
                <div class="x_panel">
        <div class="x_title">
             <h2><i class="fa fa-book"></i><strong>  Status Kelulusan Ketua BSM</strong></h2>
            <ul class="nav navbar-right panel_toolbox">
