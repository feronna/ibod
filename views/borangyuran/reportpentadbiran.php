...
$sheet->setCellValue('A1', 'LAPORAN TUNTUTAN YURAN / BADAN IKHTISAS');;
...
//    $sheet->setCellValue('H'.$i, $model->tujuan);
    $sheet->setCellValue('H'.$i, 'RM '.$model->jumlah);
...
$writer->save("LAPORAN TUNTUTAN YURAN & BADAN IKHTISAS.xlsx");
Yii::$app->response->redirect(['LAPORAN TUNTUTAN YURAN & BADAN IKHTISAS.xlsx']);
?>
<a href="<?php echo Url::to('@web/'.'hello worldsssssss.xlsx', true); ?>" target="_blank" ><i class="fa fa-download"></i> Laporan Tuntutan yuran & badan ikhtisas</a><br>
