 ...
 <div style="margin-bottom:-12px; margin-left:-61px;margin-right:-61px; font-size: 10px;">
                 <table class="table table-sm table-bordered" style=" font-size: 10px;"  width:100%;>
                    ...
                    <tr> 
                     ...
                     <tr> 
                     <td style="width:30%"  height="25px"><strong>NAMA BADAN PROFESSIONAL</strong></td>
                     <td  style="width:70%"  height="25px"><?= ucwords(strtoupper($facility->badan_prof))?></td> 
                     </tr>
                          
                     <tr> 
                     <td style="width:30%" height="25px"><strong>JUMLAH TUNTUTAN</strong></td>
                     <td style="width:70%" height="25px">RM <?= $facility->jumlah?></td> 
                     </tr>
                      
                     <tr> 
                     <td style="width:30%" height="25px"><strong>NOMBOR BIL/RESIT</strong></td>
                     <td style="width:70%" height="25px"><?= $facility->resit?></td> 
                     </tr>
                     
                      <tr> 
                     <td style="width:30%" height="25px"><strong>JENIS BAYARAN</strong></td>
                     <td style="width:70%" height="25px"><?= ucwords(strtoupper($facility->payment))?></td> 
                     </tr>
                      </table>
 </div>
