...
//                                '{toggleData}'
                    ...
                    [
                        'columns' => [
                            ['content' => 'YURAN KEAHLIAN / IKHTISAS', 'options' => ['colspan' => 9, 'class' => 'text-center ',
            ...
            [
               ...
               'value'=>function ($list){
                            if($list->isActive2 == '1' ){
                        return  Html::a(' KELULUSAN KETUA BSM', ['borangyuran/slulus', 'id' => $list->id], ['class'=>'fa fa-download', 'target' => '_blank']);
                            } 
                      },
            ],
            ...
            [
                ...
                'value'=>function ($list){
                        ...
                        return  
                        Html::a('<i class="fa fa-edit">', ["borangyuran/semakan_pt", 'id' => $list->id]);
                            }
                            else{
                        return Html::a('<i class="fa fa-edit">', ["borangyuran/semakan_pt", 'id' => $list->id]);
                            }
...
//                                '{toggleData}'
            ...
            [
                ...
                'value'=>function ($list){
                        ...
                        return  
                        Html::a('<i class="fa fa-edit">', ["borangyuran/tindakan_bsm", 'id' => $list->id]);
                            }
                            else{
                        return Html::a('<i class="fa fa-edit">', ["borangyuran/tindakan_bsm", 'id' => $list->id]);
                            }
