...
<div class="row">
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <?= Html::beginForm(['index'], 'GET', ['class' => 'form-horizontal form-label-left disable-submit-buttons']); ?>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Jawatan Pentadbiran</label>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <?= Html::dropDownList('post_id', $post_id, $arrAdminPost, ['class' => 'form-control col-md-1 col-sm-1 col-xs-12']); ?>
                </div>
            </div>
                ...
                <table class="table table-striped table-sm jambo_table table-bordered">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($gredList as $gredLists) { ?>
                            <?php if ($staff = GredSettings::getStaf($gredLists->gred, $holder_icno)) { ?>
                                <tr>
                                    <td>
                                        <div class="gred-box center-box">
                                            <?= $gredLists->gred; ?>
