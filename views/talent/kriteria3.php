...
<div class="row">
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <?= Html::beginForm(['kriteria3'], 'GET', ['class' => 'form-horizontal form-label-left disable-submit-buttons']); ?>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Program Pengajar</label>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <?= Html::dropDownList('program_id', $program_id, $arrProgram, ['class' => 'form-control col-md-3 col-sm-3 col-xs-12']); ?>
                </div>
            </div>
                ...
                <table class="table table-striped table-sm jambo_table table-bordered">
                    ...
                    <tbody>
                            ...
                            <tr style="background-color:#A7E2D7; font-weight:bold">
                                ...
                                <td>
                                    <ul class="flex-container wrap">
                                        <li class="flex-item">
                                            <img src="https://hronline.ums.edu.my/picprofile/picstf/<?php echo strtoupper(sha1($holder->ICNO)) ?>.jpeg" class="text-center" style="width: 40px">
                                            <br>
                                            <?php echo Html::a($holder->kakitangan->displayTitleName, ['data/view-cv', 'id' => $holder->ICNO, 'title' => 'personal'], ['target' => '_blank']); ?>
                                            <br>
                        ...
                        <?php foreach ($gredList as $gredLists) { ?>
                            <?php if ($staff = GredSettings::getStaf($gredLists->gred, $holder_icno, null, $program_id)) { ?>
                                <tr>
                                    <td>
                                        <div class="gred-box center-box">
                                            <?= $gredLists->gred; ?>
                                        ...
                                        <ul class="flex-container wrap">
                                            <?php foreach ($staff as $staffs) { ?>
                                                <li class="flex-item">
                                                    ...
                                                    <br>
                                                    <?php echo Html::a($staffs->displayTitleName, ['data/view-cv', 'id' => $staffs->ICNO, 'title' => 'personal'], ['target' => '_blank']); ?>
                                                    <br>
