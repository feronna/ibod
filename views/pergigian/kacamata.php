...
<div class="x_content">
            ...
            <option value="" disabled selected>Tuntutan Kacamata</option>
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr class="headings">
                    <tr class="odd"><td><strong>Peruntukan Tahunan </strong></td></strong><td><strong> RM 300.00</strong></td>
                    <tr class="odd"><td><strong>Jumlah Tuntutan Terkini</strong></td></strong><td><strong><?= Yii::$app->formatter->asCurrency( $model->jumlah, 'RM '); ?></strong></td>
                    <tr class="odd"><td><strong>Baki Kelayakan</strong></td></strong><td><strong><?= Yii::$app->formatter->asCurrency( $model->baki, 'RM '); ?></strong></td>
                    </tr>                                             
                </thead>
            </table>
                </div>
    ...
    <div class="x_panel">
        ...
        <div class="form-group">
                   <label class="control-label col-md-3 col-sm-3 col-xs-12" >Nama Kedai Kacamata<span class="required" style="color:red;">*</span></label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="used_dt">Tarikh Pembelian <span class="required">*</span>
                </label>
            ...
            <div class="form-group">
                <label class="control-label col-md-6 col-sm-6 col-xs-12">Dokumen Sokongan <span class="required">*</span>
                </label>
                <div class="col-md-4 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" value="NORNI LAGUNG" disabled />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" value="SHARIFAH ROFIDAH BINTI HABIB HASAN" disabled />
                </div>
            </div>
