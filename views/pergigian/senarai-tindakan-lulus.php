...
<div class="col-md-12 col-xs-12"> 
    <div class="x_panel">
    <div class="x_title">    
        <h2><i class="fa fa-list"></i><strong> Senarai Tindakan Selesai</strong></h2>
                            ...
                            <tr>
                               ...
                               ?> </td>
                                ...
                                <?= Html::button('', ['id' => 'modalButton', ''
                                    . 'value' => Url::to(['tindakan-selesail', 'id' => $models->tuntutan_gigi_id]),'style'=>'background-color: transparent; 
