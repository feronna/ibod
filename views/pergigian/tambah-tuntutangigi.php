            ...
            <div class="form-group row">
                ...
                <div class="col-md-4 col-sm-4 ">
                    <select class="form-control" id="foo">
                        <option value=" ../pergigian/tambah-tuntutan ">Tuntutan Rawatan Pergigian</option>
            ...
            <div class="x_panel">
                <div class="col-md-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            <h2><i class="fa fa-book"></i><strong> Tambah Tuntutan Pergigian</strong></h2>
                            <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?= $form->field($model, 'klinik_gigi_id')->widget(Select2::classname(), [
                                    ...
                                    'options' => [
                                        'placeholder' => 'Pilih Klinik Pergigian', 'class' => 'form-control col-md-7 col-xs-12',
