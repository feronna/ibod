...
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12">STATUS SEMAKAN OLEH<span class="required">*</span>
                        </label>
        <div class="col-md-4 col-sm-6 col-xs-12">
                            <?= Html::textInput('nama', $model->kakitanganCheck->CONm, ['disabled'=>true, 'class'=>'form-control']); ?>
                        </div></div>
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12">STATUS SEMAKAN PADA<span class="required">*</span>
                        </label>
        <div class="col-md-4 col-sm-6 col-xs-12">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6">
        ...
        $form->field($model, 'status_app')->label(false)->widget(Select2::classname(), [
            'data' => ['MENUNGGU PEMBAYARAN' => 'DILULUSKAN', 'DITOLAK' => 'TIDAK DILULUSKAN'],
            'options' => ['placeholder' => 'Sila Pilih', 'class' => 'form-control col-md-7 col-xs-12',
                'onchange' => 'javascript:if ($(this).val() == "Dipersetujui"){
                        $("#tempoh").show();
                        }
...
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-3" for="wp_id">STATUS PEMBAYARAN <span class="required">*</span>
    </label>
    <div class="col-md-6 col-sm-6 col-xs-6">
        
            <?=
        $form->field($model, 'status_bayar')->label(false)->widget(Select2::classname(), [
            'data' => ['BERJAYA' => 'TELAH DIBAYAR', 'DITOLAK' => 'DITOLAK'],
            'options' => ['placeholder' => 'Sila Pilih', 'class' => 'form-control col-md-7 col-xs-12',
                'onchange' => 'javascript:if ($(this).val() == "Dipersetujui"){
                        $("#tempoh").show();
                        }
...
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12">CATATAN BENDAHARI<span class="required">*</span>
                        </label>
        <div class="col-md-4 col-sm-6 col-xs-12">
                            <?= $form->field($model, 'catatan_bayar')->textArea(['maxlength' => true, 'rows' => 2,'disabled'=>TRUE])->label(false); ?>
                        </div>
    
</div>
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12">STATUS PEMBAYARAN OLEH<span class="required">*</span>
                        </label>
        <div class="col-md-4 col-sm-6 col-xs-12">
                            <?= Html::textInput('nama', $model->kakitanganBayar->CONm, ['disabled'=>TRUE, 'class'=>'form-control']); ?>
                        </div></div>
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12">STATUS PEMBAYARAN PADA<span class="required">*</span>
                        </label>
        <div class="col-md-4 col-sm-6 col-xs-12">
                            <?= $form->field($model, 'bayar_dt')->textInput(['maxlength' => true, 'rows' => 2,'disabled'=>TRUE])->label(false); ?>
                        </div></div> 
