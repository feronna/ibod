                ...
                ?>
                    <tr>
                            ...
                            <td> <?= Html::a(''  . $item->file, Url::to(Yii::$app->FileManager->DisplayFile($item->file), true), ['target' => '_blank', 'style' =>  'text-decoration: underline; color:green' ]) ?>  </td>
                                       ...
                                       <td width="50px" class="text-center"><?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['kemaskini-senarai-borang', 'id' => $item->id, 'myjd_id' => $item->myjd_id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['delete-senarai-borang', 'id' => $item->id, 'myjd_id' => $item->myjd_id], [
                                  'data' => [
