...
//                            return ucwords(strtolower($model->biodata->CONm));
                             ...
                             return Html::a('<u><strong>'.strtoupper($model->biodata->CONm).'</strong></u>',
...
//                        ],
                     ...
                     [
                        'label' => 'Tindakan',
                        'value' => function($model) {
                            $url = Url::to(['portfolio/pengesahan-kj', 'id' => $model->id]);
                            $url2 = Url::to(['portfolio/lihat-portfolio', 'id' => $model->id]);

                            return                             
\yii\helpers\Html::a('<i class="fa fa-eye fa-lg" aria-hidden="true"></i>', 
                                ['portfolio/lihat-portfolio', 'id' => $model->id],['class' => 'btn btn-default btn-sm','target' => '_blank']).
                            Html::button('<i class="fa fa-edit fa-lg"></i>', ['value' => $url, 'class' => 'btn btn-default btn-sm modalButton']);
