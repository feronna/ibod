 ...
 <div class="col-md-12 col-sm-3 col-xs-12" style="margin-bottom: 15px; font-size:15px; margin-top: 50px">
    ...
    <div class="col-md-12 col-sm-3 col-xs-12" style="margin-bottom: 15px; margin-top: 800px; font-size:15px;">
            ...
            <table> 
                    ...
                    <thead> 
                     <tr class="headings">
                        <td class="column-title"  style="background-color:#000000" color="white" colspan="2" class="text-center"><font size="2">MAKLUMAT PEGAWAI</td>  
                   </tr>
                   
     
                     
                    <tr class="headings">
                       <td id="customer"><font size="2">NAMA</font></td>    
                       <td><font size="2"><?=  ucwords(strtolower($nama->CONm))?></font></td>
                   </tr>
                    <tr class="headings">
                        <td><font size="2">GELARAN JAWATAN</font></td>
                       <td><font size="2"><?=  $nama->COOldID ?></font></td>
                    </tr>
                    <tr class="headings">
                        <td><font size="2">GRED HAKIKI JAWATAN</font></td>
