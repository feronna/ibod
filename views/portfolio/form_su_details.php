...
<div class="form-group">
                ...
                $form->field($model, 'icno')->label(false)->  widget(Select2::classname(), [
                  //  'data' => ArrayHelper::map(SenaraiPa::find()->joinWith('kakitangan')->all(), 'icno', 'kakitangan.CONm'),
                       'data' => ArrayHelper::map(SenaraiPa::find()->all(), 'icno', 'PekerjaNm2'),
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($record) {
                            return 
                            Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['padam-su', 'id' => $record->id, 'title' => 'tambah-su'], ['class' => 'btn btn-default',
                                        'data' => [
                                            'confirm' => 'Anda yakin ingin padam?',
                                            'method' => 'post',
                                ]]) . ' ' .
                                    Html::a('<i class="fa fa-edit" aria-hidden="true"></i>', ['edit-su', 'id' => $record->id, 'title' => 'tambah-su'], ['class' => 'btn btn-default']);
                        },
                                'format' => 'raw',
