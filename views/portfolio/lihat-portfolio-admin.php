                ...
                ?>
                    <tr>
                            ...
                            <td width="50px" align="center"> <?= $item->tempoh ?></td>
                               ...
                               <td width="50px" class="text-center"><?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['kemaskini-proses-kerja', 'id' => $item->id, 'myjd_id' => $item->myjd_id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['delete-proses-kerja', 'id' => $item->id, 'myjd_id' => $item->myjd_id], [
                                  'data' => [
...
<div class="col-xs-12 col-md-12 col-lg-12">
        ...
        <h5><strong><i class="fa fa-users"></i> SENARAI JAWATANKUASA</strong></h5> 
                ...
                ?>
                    <tr>
                            <td width="50px" align="center"><?= $key+1?></td>
                            <td width="50px" align="center"> <?= $item->catatan?></td>
                           <td width="50px" align="center">
