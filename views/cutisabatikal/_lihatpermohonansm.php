...
<?php 
                echo Html::a('<i class="fa far fa-hand-point-up"></i> Cetak Borang', ['cetak-borangsm', 'id'=>$model->id,
...
<div class="x_panel">
        ...
        {?>
        <?= strtoupper('
     UNIT PEMBANGUNAN PROFESIONALISME | SEKTOR PEMBANGUNAN SUMBER MANUSIA<br/><u> PERMOHONAN BAHARU PENGAJIAN LANJUTAN SEPARUH MASA KAKITANGAN AKADEMIK
        '); ?><?php }else{?>
