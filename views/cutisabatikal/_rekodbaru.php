...
<div class="row"> 
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><strong>Permohonan Cuti Sabatikal / Latihan Industri</strong></h2>
...
<!--                            <td style="width:10%;"><?= $statuss->borang->alt; ?></td>-->
                            ...
                            <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['cutibelajar/lihat-permohonan', "id"=> $statuss->iklan_id], ['class' => 'btn btn-default btn-xs']) ?></td>  
                            <td style="width:40%;">
