 ...
 <div class="row">
    ...
    <div class="x_panel">
        <div class="x_content"> 
              ...
              <p align="center"><strong><u>LAIN-LAIN PERMOHONAN PENGAJIAN LANJUTAN</u></strong></p> 
    ...
    <div class="x_panel">
        ...
        <div class="x_content" align="center">
             ...
             <h4 style="color:grey;" ><font size="3">Saya mengaku  semua keterangan di atas adalah benar dan jika saya didapati memberi
                    ...
                    <h4 style="color:grey;"><font size="3">Tarikh Hantar: <?php echo $model2->tarikhmohon;?></h4><br/>
