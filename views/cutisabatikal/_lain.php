...
?>
 ...
 <div class="x_panel">
          ...
          <div class="x_title">
            <h5>Permohonan Pengajian Lanjutan</h5>
   ...
   <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="uploadfile">Muat Naik Justifikasi Permohonan: <span class="required" style="color:red;">*</span>
                </label>
