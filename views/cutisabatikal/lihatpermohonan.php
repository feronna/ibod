...
?> 
  ...
  <?php $form = ActiveForm::begin(['options' => ['class' => 'form-horizontal form-label-left']]); ?>
    ...
    <ol class="breadcrumb">
        ...
        <li>Permohonan Cuti Sabatikal/Latihan Industri</li>
    </ol>
</div>
        </div>
  <p align="right"><?php 
                echo Html::a('<i class="fa far fa-hand-point-up"></i> Cetak Borang', ['generate-permohonan','id' =>$model->id, 'target'=>'_blank'], [
                    'class'=>'btn btn-primary btn-sm', 
                    'target'=>'_self', 
                    'data-toggle'=>'tooltip', 
                    'title'=>'Lain-Lain Permohonan Pengajian Lanjutan'
                ]);
...
<div class="x_panel">
        ...
        <?= strtoupper('
     UNIT PEMBANGUNAN PROFESIONALISME | SEKTOR PEMBANGUNAN SUMBER MANUSIA<br/><u> PERMOHONAN CUTI SABATIKAL & LATIHAN INDUSTRI
        '); ?>
...
<div class="row" > 
    ...
    <div class="x_panel">
        ...
        <div class="x_content" align="center">
             <h4 style="color:grey;" >Saya mengaku  semua keterangan di atas adalah benar dan jika saya didapati memberi <br/>
                    maklumat palsu, saya bersetuju permohonan ini (jika telah diluluskan) 
                    akan terbatal<br/> dengan sendirinya dan boleh diambil tindakan perundangan. </h4>
                    <h4 style="color:grey;">Tarikh Hantar: <?php echo $model->tarikhmohon;?></h4><br/>
        </div>
    </div>
</div>
