...
//                            'contentOptions' => ['class'=>'text-center'],                            
                            ...
                            if ($data->idBorang == 1) {
                                $ICNO = $data->icno;
                                $url = Url::to(["sepenuh-masa/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO, 'takwim_id' => $data->iklan_id]);
...
//                        Html::a('<i class="fa fa-info-circle fa-lg">', ["cutibelajar/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO]);
                                ...
                                $ICNO = $data->icno;
                                $url = Url::to(["pentadbiran/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO, 'takwim_id' => $data->iklan_id]);
//                                                        return Html::a('<i class="fa fa-info-circle fa-lg">', ["pengakuan-pemohon", 'id' => $model->id]);
                                return Html::a('<i class="fa fa-edit fa-lg"></i>', $url, [
                                            'title' => 'Lihat Permohonan']);
//                          return 
//                        Html::a('<i class="fa fa-info-circle fa-lg">', ["cutibelajar/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO]);
                                ...
                                $ICNO = $data->icno;
                                $url = Url::to(["separuh-masa/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO, 'takwim_id' => $data->iklan_id]);
//                                                        return Html::a('<i class="fa fa-info-circle fa-lg">', ["pengakuan-pemohon", 'id' => $model->id]);
                                return Html::a('<i class="fa fa-edit fa-lg"></i>', $url, [
                                            'title' => 'Lihat Permohonan']);
//                          return 
//                        Html::a('<i class="fa fa-info-circle fa-lg">', ["cutibelajar/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO]);
                                ...
                                $ICNO = $data->icno;
                                $url = Url::to(["sangkutan/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO, 'takwim_id' => $data->iklan_id]);
//                                                        return Html::a('<i class="fa fa-info-circle fa-lg">', ["pengakuan-pemohon", 'id' => $model->id]);
                                return Html::a('<i class="fa fa-edit fa-lg"></i>', $url, [
                                            'title' => 'Lihat Permohonan']);
//                          return 
//                        Html::a('<i class="fa fa-info-circle fa-lg">', ["cutibelajar/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO]);
                                ...
                                $ICNO = $data->icno;
                                $url = Url::to(["pra-warta/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO, 'takwim_id' => $data->iklan_id]);
//                                                        return Html::a('<i class="fa fa-info-circle fa-lg">', ["pengakuan-pemohon", 'id' => $model->id]);
                                return Html::a('<i class="fa fa-edit fa-lg"></i>', $url, [
                                            'title' => 'Lihat Permohonan']);
//                          return 
//                        Html::a('<i class="fa fa-info-circle fa-lg">', ["cutibelajar/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO]);
                                ...
                                $ICNO = $data->icno;
                                $url = Url::to(["pos-doktoral/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO, 'takwim_id' => $data->iklan_id]);
//                                                        return Html::a('<i class="fa fa-info-circle fa-lg">', ["pengakuan-pemohon", 'id' => $model->id]);
                                return Html::a('<i class="fa fa-edit fa-lg"></i>', $url, [
                                            'title' => 'Lihat Permohonan']);
//                          return 
//                        Html::a('<i class="fa fa-info-circle fa-lg">', ["cutibelajar/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO]);
                                ...
                                $ICNO = $data->icno;
                                $url = Url::to(["sub-kepakaran/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO, 'takwim_id' => $data->iklan_id]);
//                                                        return Html::a('<i class="fa fa-info-circle fa-lg">', ["pengakuan-pemohon", 'id' => $model->id]);
                                return Html::a('<i class="fa fa-edit fa-lg"></i>', $url, [
                                            'title' => 'Lihat Permohonan']);
//                          return 
//                        Html::a('<i class="fa fa-info-circle fa-lg">', ["cutibelajar/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO]);
                                ...
                                $ICNO = $data->icno;
                                $url = Url::to(["latihan-industri/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO, 'takwim_id' => $data->iklan_id]);
//                                                        return Html::a('<i class="fa fa-info-circle fa-lg">', ["pengakuan-pemohon", 'id' => $model->id]);
                                return Html::a('<i class="fa fa-edit fa-lg"></i>', $url, [
                                            'title' => 'Lihat Permohonan']);
//                          return 
//                        Html::a('<i class="fa fa-info-circle fa-lg">', ["cutibelajar/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO]);
                                ...
                                $ICNO = $data->icno;
                                $url = Url::to(["cuti-penyelidikan/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO, 'takwim_id' => $data->iklan_id]);
//                                                        return Html::a('<i class="fa fa-info-circle fa-lg">', ["pengakuan-pemohon", 'id' => $model->id]);
                                return Html::a('<i class="fa fa-edit fa-lg"></i>', $url, [
                                            'title' => 'Lihat Permohonan']);
//                          return 
//                        Html::a('<i class="fa fa-info-circle fa-lg">', ["cutibelajar/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO]);
                            } elseif ($data->idBorang == 51) {
                                $ICNO = $data->icno;
                                $url = Url::to(["latihan-pensijilan/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO, 'takwim_id' => $data->iklan_id]);
//                                                        return Html::a('<i class="fa fa-info-circle fa-lg">', ["pengakuan-pemohon", 'id' => $model->id]);
                                return Html::a('<i class="fa fa-edit fa-lg"></i>', $url, [
                                            'title' => 'Lihat Permohonan']);
//                          return 
//                        Html::a('<i class="fa fa-info-circle fa-lg">', ["cutibelajar/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO]);
                                ...
                                $ICNO = $data->icno;
                                $url = Url::to(["sabatikal/tindakan-kj", 'id' => $data->id, 'ICNO' => $ICNO, 'takwim_id' => $data->iklan_id]);
//                                                        return Html::a('<i class="fa fa-info-circle fa-lg">', ["pengakuan-pemohon", 'id' => $model->id]);
                                return Html::a('<i class="fa fa-edit fa-lg"></i>', $url, [
                                            'title' => 'Lihat Permohonan']);
//                          return 
