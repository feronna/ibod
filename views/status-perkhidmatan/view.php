...
<div class="col-md-12 col-sm-12 col-xs-12 "> 
    <div class="x_panel">
        ...
        <div class="x_content">
         ...
         <?= Html::a('Tambah', ['tambah-perkhidmatan', 'icno' => $ICNO], ['class' => 'btn btn-primary']) ?>   
            ...
            <table class="table table-sm table-bordered jambo_table table-striped">
                ...
                <tr>
                    <td><?= $alamatkakitangan->statusPerkhidmatan->ServStatusNm?></td>
                    <td><?= $alamatkakitangan->statusTerperinci->name?></td>
