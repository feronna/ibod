...
<div class="x-panel">
        <div class="row">
                        ...
                        <a href="<?= Url::toRoute(['data/search'])?>">
                            <div class="caption text-center" style="background-color: rgb(42,63,84)">
                                ...
                                <div class="col-sm-4"> 
                                    ...
                                    <div class="col-sm-8">
                                <h4 id="thumbnail-label" style="color: #FFFFFF;"><br>Data Profiling</h4>
            ...
            <div class="col-sm-4">
                <div class="thumbnail" style="height:auto">
                    <a href="<?= Url::toRoute(['talent/index']) ?>">
                        <div class="caption text-center" style="background-color: rgb(123,212,137)">
                            ...
                            <div class="col-sm-8">
                            <h4 id="thumbnail-label" style="color: #000000;"><br><br>Talent Pool</h4>
                ...
                <div class="thumbnail" style="height:auto">
                    <a href="<?= Url::toRoute(['#']) ?>">
                        <div class="caption text-center" style="background-color: rgb(234,144,128)">
                            ...
                            <div class="col-sm-8">
                            <h4 id="thumbnail-label" style="color: #000000;"><br><br>Pelan Penggantian</h4>
                            <!-- <div class="thumbnail-description smaller"><p> Tanggungan Kakitangan UMS </p></div> -->
                            </div>
                            </div>
                            <br>
                ...
                <div class="thumbnail" style="height:auto">
                    <a href="<?= Url::toRoute(['#']) ?>">
                        <div class="caption text-center" style="background-color: rgb(247, 207, 111)">
                            ...
                            <div class="col-sm-8">
                            <h4 id="thumbnail-label" style="color: #000000;"><br><br>Kompetensi</h4>
                            <!-- <div class="thumbnail-description smaller"><p> Tanggungan Kakitangan UMS </p></div> -->
                            </div>
                            </div>
                            <br>
