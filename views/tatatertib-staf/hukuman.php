...
<!--            <p style="color: green">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Hukuman<span class="required" style="color:red;">*</span></label>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                <?=
                        $form->field($model, 'hukuman')->label(false)->widget(Select2::classname(), [
                            'data' => [1 =>'AMARANN', 2 => 'DENDA', 3=> 'TURUN GAJI', 4=> 'BUANG KERJA', 5=>'TURUN PANGKAT'],
