    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
         ...
         <?= Html::a('Kembali', ['tatatertib-staf/index'], ['class' => 'btn btn-primary btn-sm']) ?>
            ...
            <div class="x_title">
                <h2><strong>Rekod Keputusan Mesyuarat Jawatankuasa Tatatertib Kakitangan </strong></h2>
                     ...
                     //   $pelulusId = $data->pelulus_icno;
                        ...
                        return  $list[$statuspelulus2];//return $data->statusbsm;
                            ...
                            'checkboxOptions' => function ($data) {
                                if((is_null($data->pelulus_agree2)) || ($data->pelulus_agree2 == 2) ){
