    ...
    <div class="x_panel"> 
        <div class="x_content">
            ...
            <div class="col-md-3 col-sm-3 col-xs-3 col-md-offset-8 col-sm-offset-8 col-xs-offset-8">
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 col-md-offset-8 col-sm-offset-8 col-xs-offset-8">
                 <?=
                $form->field($search, 'kategori_jawatan')->label(false)->widget(Select2::classname(), [
            ...
            <div class="table-responsive">
                ...
                $gridColumns = [
                    ...
                    [
                        'label' => 'Nama Naziran',
                        'value' => function($model) {
                            return ucwords(strtolower($model->naziranIcno->CONm));},
                        'format' => 'raw',
                    ],
                                    
                        [
                        'label' => 'Ulasan Naziran',
                        'value' => function($model) {
                            return ucwords($model->ulasan_naziran);                       },
                        'format' => 'raw',
                    ],
