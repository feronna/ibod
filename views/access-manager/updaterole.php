...
<div class="tblpraddress-create">
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="form-group" id="poskod">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="controller_name">Nama Controller: <span class="required" style="color:red;">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <?= $form->field($role, 'controller_id')->textInput(['maxlength' => true,'disabled'=>true])->label(false) ?>
                </div>
            </div>
