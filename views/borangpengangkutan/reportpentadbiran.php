...
$sheet->setCellValue('A1', 'LAPORAN PERMOHONAN PENGANGKUTAN BARANG');;
...
$writer->save("LAPORAN PERMOHONAN PENGANGKUTAN BARANG.xlsx");
Yii::$app->response->redirect(['LAPORAN PERMOHONAN PENGANGKUTAN BARANG.xlsx']);
?>
<a href="<?php echo Url::to('@web/'.'hello worldsssssss.xlsx', true); ?>" target="_blank" ><i class="fa fa-download"></i> Laporan Permohonan Pengangkutan Barang</a><br>
