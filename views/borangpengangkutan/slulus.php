                 ...
                 <table class="table table-sm table-bordered" style=" font-size: 10px;"  width:100%;>
                    ...
                    <tr> 
                     ...
                     <td style="width:70%"  height="25px"><?= ucwords(strtoupper($facility->displayjenis->kemudahan ))?></td>
                      ...
                      <tr> 
                     <td style="width:30%"  height="25px"><strong>DARI BANDAR</strong></td>
                     <td style="width:70%"  height="25px"><?= $facility->dest_berlepas?></td> 
                     </tr>
                     
                      <tr> 
                     <td style="width:30%"  height="25px"><strong>KE BANDAR</strong></td>
                     <td style="width:70%"  height="25px"><?= $facility->dest_tiba?></td> 
                     </tr>
 ...
 <div style="margin-bottom:-12px; margin-left:-61px;margin-right:-61px; font-size: 10px;">
                 ...
                 <table class="table table-sm table-bordered" style=" font-size: 10px;">
                    ...
                    <tr> 
                     ...
                     <td colspan="2"  height="25px"><strong>NAMA</strong></td>
                     <td colspan="2"  height="25px"><strong>PERTALIAN/HUBUNGAN</strong></td>
                     <td colspan="2"  height="25px"><strong>UMUR</strong></td>
                     <td colspan="4"  height="25px"><strong>NO.MYKAD</strong></td> 
                    ...
                    ?>
                     ...
                     <td  colspan="2"  height="25px"><?= $keluargakakitangan->hubungan; ?></td>
                     <td  colspan="2"  height="25px"><?= $keluargakakitangan->icno; ?></td>
                     <td  colspan="4"  height="25px"><?= $keluargakakitangan->meter_padu; ?></td>
