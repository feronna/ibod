...
<div class="tblpendidikan-form">
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bon">Bon: <span class="required" style="color:red;">*</span>
                </label>
            ...
            <div class="form-group " id="jumlahbon">
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="uploadfile">Muatnaik Fail : <span class="required" style="color:red;">*</span>
            </label>
