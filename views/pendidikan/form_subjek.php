    ...
    <div class="x_panel">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            $form->field($model, 'Subject_id')->label(false)->widget(Select2::classname(), [
                'data' => ArrayHelper::map(Subjek::find()->where(['isActive'=>1])->andWhere(['EduLevel_id'=>$lvl])->all(), 'id', 'EduSubjek'),
        ...
        <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Subjek">Gred: <span class="required" style="color:red;">*</span>
        </label>
        <div class="col-md-6 col-sm-6 col-xs-12">
            <?=
            $form->field($model, 'Grade_id')->label(false)->widget(Select2::classname(), [
                'data' => ArrayHelper::map(Gred::find()->where(['isActive'=>1])->orderBy(['grade'=>SORT_ASC])->all(), 'id', 'grade'),
