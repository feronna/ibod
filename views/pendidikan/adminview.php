...
<div class="form-group">
    ...
    <?= Html::a('Tambah Pendidikan', ['admintambahpendidikan', 'icno' => $ICNO], ['class' => 'btn btn-primary']) ?>
</div>
<br>
                        ...
                        <table class="table table-sm table-bordered jambo_table table-striped">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['adminlihatpendidikan', 'id' => $degrees->id]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['adminupdate', 'id' => $degrees->id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['admindelete', 'id' => $degrees->id], [
                                                                                                                                                                                                                                                                                                'data' => [
                        ...
                        <table class="table table-sm table-bordered jambo_table table-striped">
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['adminlihatpendidikan', 'id' => $diplomas->id]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['adminupdate', 'id' => $diplomas->id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['admindelete', 'id' => $diplomas->id], [
                                                                                                                                                                                                                                                                                                    'data' => [
                                                                                                                                                                                                                                                                                                        'confirm' => 'Anda ingin Membuang rekod ini?',
                                                                                                                                                                                                                                                                                                        'method' => 'post',
                                                                                                                                                                                                                                                                                                    ],
                        ...
                        <table class="table table-sm table-bordered jambo_table table-striped">
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['adminlihatpendidikan', 'id' => $sijils->id]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['adminupdate', 'id' => $sijils->id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['admindelete', 'id' => $sijils->id], [
                                                                                                                                                                                                                                                                                                'data' => [
                                                                                                                                                                                                                                                                                                    'confirm' => 'Anda ingin Membuang rekod ini?',
                                                                                                                                                                                                                                                                                                    'method' => 'post',
                                                                                                                                                                                                                                                                                                ],
                        ...
                        <table class="table table-sm table-bordered jambo_table table-striped">
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['adminlihatpendidikan', 'id' => $spms->id]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['adminupdate', 'id' => $spms->id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['admindelete', 'id' => $spms->id], [
                                                                                                                                                                                                                                                                                            'data' => [
                                                                                                                                                                                                                                                                                                'confirm' => 'Anda ingin Membuang rekod ini?',
                                                                                                                                                                                                                                                                                                'method' => 'post',
                                                                                                                                                                                                                                                                                            ],
                        ...
                        <table class="table table-sm table-bordered jambo_table table-striped">
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['adminlihatpendidikan', 'id' => $pmrs->id]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['adminupdate', 'id' => $pmrs->id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['admindelete', 'id' => $pmrs->id], [
                                                                                                                                                                                                                                                                                            'data' => [
                                                                                                                                                                                                                                                                                                'confirm' => 'Anda ingin Membuang rekod ini?',
                                                                                                                                                                                                                                                                                                'method' => 'post',
                                                                                                                                                                                                                                                                                            ],
                        ...
                        <table class="table table-sm table-bordered jambo_table table-striped">
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['adminlihatpendidikan', 'id' => $lainlains->id]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['adminupdate', 'id' => $lainlains->id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['admindelete', 'id' => $lainlains->id], [
                                                                                                                                                                                                                                                                                                    'data' => [
                                                                                                                                                                                                                                                                                                        'confirm' => 'Anda ingin Membuang rekod ini?',
                                                                                                                                                                                                                                                                                                        'method' => 'post',
                                                                                                                                                                                                                                                                                                    ],
    ...
    <div class="tab-pane fade " id="publications">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <?= Html::a('<i class="fa fa-plus-square"></i>&nbsp; New Publication', ['admin-add-pub','id'=>$ICNO], ['class' => 'btn btn-success']) ?>
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered jambo_table table-striped">
                            <thead>
                                <tr class="headings">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['admin-update-pub', 'id' => $publications->id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['admin-delete-pub', 'id' => $publications->id], [
                                                                                                                                                                                    'data' => [
