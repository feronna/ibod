...
<?php $form = ActiveForm::begin(['id' => 'dynamic-form', 'options' => ['class' => 'form-horizontal']]); ?>
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><strong><i class="fa fa-user"></i> Pengesahan Jabatan Teknologi Maklumat & Komunikasi </strong></h2>
            <ul class="nav navbar-right panel_toolbox">
                <i>[Tarikh terakhir dikemaskini : <?= $model->tarikh_jtmk?>]</i>
                </li>
            </ul>
        ...
        <div class="x_content">
            ...
            <label class="control-label col-md-3 col-sm-3 col-xs-12">
                Penutupan Email <span style="color: red" class="required">*</span> :
            </label>
            ...
            <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">
                Peminjaman Peralatan ICT <span style="color: red" class="required">*</span> :
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <?= $form->field($modelCustomer, 'status_jtmk')->label(false)->widget(Select2::classname(), [
                        'data' => ['1' => 'ADA', '0' => 'TIADA'],
                        'options' => ['placeholder' => 'Pilih', 'class' => 'form-control col-md-7 col-xs-12',
        ...
        <?php DynamicFormWidget::begin([
                        ...
                        'formFields' => [
                            ...
                            <div id="form" style="display:<?php if($modelCustomer->status_jtmk==0){echo none;}?>" class="container-items">
                                <div align="center"><b>SENARAIKAN PERALATAN ICT TERSEBUT<span style="color: red" class="required">*</span> :
                                    </b></div><br>
                                ...
                                <div class="item"><!-- widgetBody -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-10">
                                                <?= $form->field($modelAddress, "[{$i}]perkara")->textInput(['maxlength' => true, 'required' => true, 'placeholder' => 'Nama'])->label(false) ?>
                                            </div>
