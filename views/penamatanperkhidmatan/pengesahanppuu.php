...
<?php $form = ActiveForm::begin(['id' => 'dynamic-form', 'options' => ['class' => 'form-horizontal']]); ?>
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><strong><i class="fa fa-user"></i> Pengesahan Pejabat Penasihat Undang-undang </strong></h2>
            <ul class="nav navbar-right panel_toolbox">
                <i>[Tarikh terakhir dikemaskini : <?= $model->tarikh_ppuu?>]</i>
                </li>
            </ul>
        ...
        <div class="x_content">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <?= $form->field($modelCustomer, 'status_ppuu')->label(false)->widget(Select2::classname(), [
                        'data' => ['1' => 'ADA TINDAKAN TATATERTIB', '0' => 'TIADA TINDAKAN TATATERTIB'],
        ...
        <?php DynamicFormWidget::begin([
                        ...
                        'formFields' => [
                            ...
                            <div id="form" style="display:<?php if($modelCustomer->status_ppuu==0){echo none;}?>" class="container-items">
                                <div align="center"><b>SENARAIKAN TINDAKAN TATATERTIB TERSEBUT<span style="color: red" class="required">*</span> :
                                    </b></div><br>
