    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
                <i>[Tarikh terakhir dikemaskini : <?= $model->tarikh_jfpiu?>]</i>
                </li>
            </ul>
        ...
        <div class="x_content">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <?= $form->field($modelCustomer, 'status_jfpiu')->label(false)->widget(Select2::classname(), [
                        'data' => ['1' => 'ADA MEMINJAM HARTA / ASET UNIVERSITI', '0' => 'TIADA MEMINJAM HARTA / ASET UNIVERSITI'],
        ...
        <?php DynamicFormWidget::begin([
                        ...
                        'formFields' => [
                            ...
                            <div id="form" style="display:<?php if($modelCustomer->status_jfpiu==0){echo none;}?>" class="container-items">
                                <div align="center"><b>SENARAIKAN HARTA / ASET UNIVERSITI TERSEBUT<span style="color: red" class="required">*</span> :
                                    </b></div><br>
                                ...
                                <div class="item"><!-- widgetBody -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-10">
                                                <?= $form->field($modelAddress, "[{$i}]perkara")->textInput(['maxlength' => true, 'placeholder' => 'Nama'])->label(false) ?>
                                            </div>
