    ...
    <table class="table table-sm table-bordered" >
        ...
        <th scope="col" colspan=8" width="100%" style="background-color:lightgrey;"> </th>
            ...
            <tr>   
                    ...
                    <p>Tarikh :<p></div>
                    <div class="col-md-5 col-sm-5 col-xs-6">
                    <?= $form->field($model, 'tarikhVerifikasi')->textInput(['maxlength' => true, 'disabled'=>'disabled']) ->label(false);?>
                    </div> 
                    </td>
...
<div class="customer-form">   
    <div class="form-group">
            ...
            <?= $form->field($model->semakanby, 'CONm')->textInput(['maxlength' => true, 'disabled' => true]) ->label(false);?> 
            </div>  
    </div> 
    <div class="form-group">
            ...
            <div class="col-md-4 col-sm-4 col-xs-6">
            <?= $form->field($model, 'closing')->textInput(['maxlength' => true, 'disabled' => true]) ->label(false);?> 
    ...
    <div class="form-group">
            ...
            <div class="col-md-4 col-sm-4 col-xs-6">
            <?= $form->field($model, 'closingNcrDt')->textInput(['maxlength' => true, 'disabled' => true]) ->label(false);?> 
...
<?php }elseif( $model->status_tindakan == '3' || $model->status_tindakan == '4' || $model->status_tindakan == '5' || $model->status_tindakan == '6'  || $model->status_tindakan == '7'){?>
...
<div class="customer-form">   
    <div class="form-group">
            ...
            <div class="col-md-4 col-sm-4 col-xs-6"> 
                ...
                echo $form->field($model->semakanby, 'CONm')->textInput(['maxlength' => true, 'disabled' => true ]) ->label(false);
                }
                ?> 
            </div>  
    </div> 
    <div class="form-group">
            ...
            <div class="col-md-4 col-sm-4 col-xs-6">
            <?= $form->field($model, 'closing_ncr')->textInput(['maxlength' => true, 'disabled' => true ]) ->label(false);?>  
            </div> 
    </div> 
    <div class="form-group">
            <label class="control-label col-md-2 col-sm-2 col-xs-12">Tarikh :<span class="required"></span>
            ...
            <div class="col-md-4 col-sm-4 col-xs-6">
            <?= $form->field($model, 'closing_ncr_dt')->textInput(['maxlength' => true, 'disabled' => true ]) ->label(false);?> 
