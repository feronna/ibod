...
<div class="row"> 
    ...
    <div class="x_content"> 
        <div class="form-group">
            ...
            <?php
               echo Html::a(' '. $record->title , Yii::$app->FileManager->DisplayFile($record->audit_plan), ['class'=>'fa fa-download', 'target' => '_blank']);   
            ?> 
            </div>
        </div>

        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Muat Naik :<span class="required"></span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12"> 
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Tajuk :<span class="required"></span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
