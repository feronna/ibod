...
<div class="row"> 
    ...
    <table class="table table-sm table-bordered" >
        ...
        <?php echo Html::a('Kemaskini ',['msiso/kemaskini-notification', 'id' => $model->id], ['class' => 'btn btn-success btn-sm','target'=>'_blank']); ?>
</div>
    </div>
    ...
    <div class="x_panel" >
        <div class="x_title">
            ...
            <div class="form-group text-right">
            <?php // echo Html::a('Tambah <i class="fa fa-plus"></i> ',['msiso/notify-auditor', 'id' => $model->id], ['class' => 'btn btn-success btn-sm','target'=>'_blank']); ?>
            </div>
            <div class="clearfix"></div>
        </div>
    <div class="x_content"> 
    <?= GridView::widget([
                   'dataProvider' => $dataProvider,
                    ...
                    //         // ])       
                    //         return Html::a(' ', ['notify', 'id' => $list->id], [
