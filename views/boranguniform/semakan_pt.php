...
<div class="form-horizontal form-label-left"> 
    ...
    <div class="x_panel">
      ...
      <table class="table table-sm table-bordered" >
        ...
        <?php if($model->status_kj == 'ENTRY' || $model->status_kj == ''){?>     
         <div class="x_panel">
        <div class="x_title">
        ...
        <?php if($model->status_pt == 'MENUNGGU SEMAKAN' || $model->status_pt == ''){?>     
    <div class="x_panel">
        <div class="x_title">
     ...
     <?php if($model->status_pt == 'LAYAK' || $model->status_pt == 'TIDAK LAYAK'){?>    
