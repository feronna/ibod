...
$sheet->setCellValue('A1', 'LAPORAN TUNTUTAN KASUT DAN PAKAIAN SERAGAM');;
...
$writer->save("LAPORAN TUNTUTAN KASUT DAN PAKAIAN SERAGAM.xlsx");
Yii::$app->response->redirect(['LAPORAN TUNTUTAN KASUT DAN PAKAIAN SERAGAM.xlsx']);
?>
<a href="<?php echo Url::to('@web/'.'hello worldsssssss.xlsx', true); ?>" target="_blank" ><i class="fa fa-download"></i> Laporan Tuntutan Kasut dan Pakaian Seragam</a><br>
