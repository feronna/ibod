...
<div class="tblprcobiodata-form">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    $form->field($model, 'statLantikan')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(StatusLantikan::find()->where(['in','ApmtStatusCd',$statlantik])->andWhere(['isActive'=>1])->all(), 'ApmtStatusCd', 'ApmtStatusNm'),
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    $form->field($model, 'statSandangan')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(StatusSandangan::find()->where(['in','sandangan_id',$sandangan])->all(), 'sandangan_id', 'sandangan_name'),
    ...
    <div class="form-group text-center">
        <?= Html::a('Kembali', ['lantikan'], ['class' => 'btn btn-primary']) ?>
