            ...
            <div class="tblprcobiodata-update">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="warganegara">Status Sabah: <span class="required" style="color:red;">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="statusWarganegara">Jawatan Pentadbiran: <span class="required" style="color:red;"></span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <?=
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 style="color: red;">Mohon untuk membuat semakan sebelum mengemaskini maklumat dibawah</h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                                </li>
                            </ul>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    $form->field($model, 'gredJawatan_2')->label(false)->widget(Select2::classname(), [
                                        ...
                                        'options' => ['placeholder' => 'Pilih Gred Jawatan Hakiki', 'class' => 'form-control col-md-7 col-xs-12'],
                                        'pluginOptions' => [
                                            'allowClear' => true
                                        ],
                                    ]);
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    $form->field($model, 'DeptId_hakiki')->label(false)->widget(Select2::classname(), [
                                        ...
                                        'options' => ['placeholder' => 'Pilih JFPIU Hakiki', 'class' => 'form-control col-md-7 col-xs-12'],
                                        'pluginOptions' => [
                                            'allowClear' => true
                                        ],
                                    ]);
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    $form->field($model, 'campus_id_hakiki')->label(false)->widget(Select2::classname(), [
                                        ...
                                        'options' => ['placeholder' => 'Pilih Kampus Hakiki', 'class' => 'form-control col-md-7 col-xs-12'],
                                        'pluginOptions' => [
                                            'allowClear' => true
                                        ],
                                    ]);
