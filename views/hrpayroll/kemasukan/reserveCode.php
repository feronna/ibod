...
<div class="x_panel">
    ...
    <div class="table-responsive">
        ...
        <div class="center pull-right">
            <?= Html::a('<i class="fa fa-check" aria-hidden="true"> Hantar/Mohon</i>', ['tindakan-kemasukan-terima', 'bid' => $srb_batch_code], ['class' => 'btn btn-success ']) ?>
            <?= Html::a('<i class="fa fa-close" aria-hidden="true"> Buang</i>', ['tindakan-kemasukan-buang', 'bid' => $srb_batch_code], ['class' => 'btn btn-danger']) ?>
        </div>
    </div>
