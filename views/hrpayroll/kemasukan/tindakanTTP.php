...
<div class="row">
<?= Html::a('Kembali', ['kemasukan'], ['class' => 'btn btn-primary']) ?>
...
<?= Html::a('<i class="fa fa-check" aria-hidden="true"> Hantar</i>', ['tindakan-kemasukan-hantar','bid'=>$srb_batch_code],[
            'data' => [
                'confirm' => 'Adakah anda pasti untuk HANTAR?',
                'method' => 'post',
            ],'class'=>'btn btn-success']) ?>
<?= Html::a('<i class="fa fa-close" aria-hidden="true"> Buang</i>', ['tindakan-kemasukan-buang','bid'=>$srb_batch_code],[
            'data' => [
