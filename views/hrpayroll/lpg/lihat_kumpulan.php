...
<?= Html::a('Kembali', ['staff', 'umsper' => $staff_id], ['class' => 'btn btn-primary']) ?>
<?php
$url_tambah_elaun = Url::to(['tambah-elaun', 'bid' => $id, 'sid' => $staff_id]);
echo Html::button('Tambah Elaun', ['value' => $url_tambah_elaun, 'class' => 'btn btn-primary modalButton']);
echo '<h2>Sila tambahkan elaun-elaun lain yang berkaitan (jika ada)</h2>';
?>
