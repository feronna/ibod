...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            ...
            <div class="x_content">
         <?= Html::a('Kembali', ['viewpayroll','id'=>$models->ICNO], ['class' => 'btn btn-primary']) ?>  
         <?= Html::button('Tambah', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['/profil-gaji/tambah-profil-gaji?umsper='.$models->COOldID]),'class' => 'btn btn-success mapBtn']) ?>
            ...
            <table class="table table-sm table-bordered">
                ...
                ?>
                        ...
                        <tr>
                          ...
                          border: none;', 'class' => 'fa fa-eye mapBtn'])?> | <?= Html::button('', ['id' => 'modalButton', 'value' => \yii\helpers\Url::to(['/profil-gaji/kemaskini-profil-gaji', 'id' => $item->id]),'style'=>'background-color: transparent; 
                          border: none;', 'class' => 'fa fa-edit mapBtn'])?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['delete-profil-gaji', 'id' => $item->id]) ?> </td>  
                        </tr>
                   <?php } 
