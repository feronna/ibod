...
<div class="x_panel">
    ...
    <div class="table-responsive">
                ...
                [
                    ...
                    'buttons' => [
                        'view' => function ($url, $model) {
                            return Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['tindakan-kelulusan', 'id' => $model->srb_batch_code], ['target' => '_blank']);
                        },
                    ],
                ],
                [
        ...
        <div class="center pull-right">
            <?= Html::submitButton('<i class="fa fa-check"></i> Luluskan', ['class' => 'btn btn-success', 'name' => 'lulus', 'value' => 'submit_1']) ?>
            <?= Html::submitButton('<i class="fa fa-reply"></i> Pulangkan', ['class' => 'btn btn-warning', 'name' => 'pulang', 'value' => 'submit_2']) ?>
            <?= Html::submitButton('<i class="fa fa-close"></i> Tolak', ['class' => 'btn btn-danger', 'name' => 'tolak', 'value' => 'submit_3']) ?>
        </div>
        <?php ActiveForm::end(); ?>
    </div>
