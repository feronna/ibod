...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Senarai menunggu kelulusan bekerja dari rumah/Work from Home(WFH)</strong></h2>
                        ...
                        <?php if ($lulus) { ?>
                            ...
                            <?php foreach ($lulus as $senarai) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?= Html::a('<i class="fa fa-edit">', ["kehadiran/wfh-lulus-tindakan", 'id' => $senarai->id]); ?></td>
                                </tr>
                            <?php } ?>

                            <button type="button" class="checkall btn btn-default"><i class="fa fa-edit"></i>&nbsp;Select All</button>
                            <?= Html::submitButton('<i class="fa fa-check"></i>&nbsp;LULUSKAN PERMOHONAN WFH', ['class' => 'btn btn-success']) ?>
                            <?php ActiveForm::end() ?>
                        <?php } else { ?>
                            <tr>
