...
//                        'footer' => 'Total',
                    ...
                    [
                        'label' => 'Late In',
                        'value' => function ($model) use ($tahun) {
                            return TblRekod::totalComplianceStatus($model->ICNO, 'late_in', $tahun);
                        },
                    ],
                    [
                        'label' => 'Early Out',
                        'value' => function ($model) use ($tahun) {
                            return TblRekod::totalComplianceStatus($model->ICNO, 'early_out', $tahun);
                        },
                    ],
                    [
                        'label' => 'Incomplete',
