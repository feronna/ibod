    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="form-control col-md-3 col-sm-6 col-xs-12 disabled"><?=$model->statusAll ?></div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" value="<?=$peg->peraku_icno ? $peg->peraku->CONm : $peg->pelulus->CONm;  ?>" disabled />
                </div>
            </div>
