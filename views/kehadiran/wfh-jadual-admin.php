...
//echo TblWfh::wfhByDayAdmin('2021-01-15', $icno, $deptId);
//exit();
    ...
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <?= Html::beginForm(['wfh-jadual-admin'], 'GET', ['class' => 'form-horizontal form-label-left']); ?>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-3">JFPIB&nbsp;
                    </label>

                    <div class="col-md-3 col-sm-3 col-xs-3">
                        <?= Html::dropDownList('deptId', $deptId, ArrayHelper::map(Department::findAll(['isActive' => 1]), 'id', 'fullname'), ['class' => 'form-control col-md-3 col-sm-3 col-xs-12']); ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <?= Html::a('<i class="fa fa-print"></i> Print', ['kehadiran/print-wfh-jadual-admin', 'tahun' => $tahun, 'bulan' => $bulan, 'deptId' => $deptId], ['class' => 'btn btn-warning', 'target' => '_blank']) ?>
                    </div>
                ...
                <div class="x_content">
                    <div class="table-responsive">
                        <table class="table table-sm jambo_table">
                            ...
                            <?php foreach (Tblprcobiodata::find()->where(['DeptId' => $deptId, 'Status' => 1])->batch(10) as $staff) { ?>
                            ...
                            <?php } ?>
                            <tr class="">
                                <td class="text-right" colspan="2"><strong>PERATUS BEKERJA DARI RUMAH (WFH)</strong></td>
                                <!-- <td class="text-center">Nama Kakitangan</td> -->
                                <?php foreach ($var as $k => $v) { ?>

                                    <td class="text-center" style="text-align:center"><strong><?= TblWfh::wfhByDayAdmin($v, $icno, $deptId) == 0 ? 0 :  round(TblWfh::wfhByDayAdmin($v, $icno, $deptId) / $totalStaff * 100, 2); ?>%</strong></td>

                                <?php } ?>
                            </tr>
                            <tr class="">
                                <td class="text-right" colspan="2"><strong>PERATUS BEKERJA DI PEJABAT (WFO)</strong></td>
                                <!-- <td class="text-center">Nama Kakitangan</td> -->
                                <?php foreach ($var as $k => $v) { ?>

                                    <td class="text-center" style="text-align:center"><strong><?= TblWfh::wfhByDayAdmin($v, $icno, $deptId) == 0 ? 0 : round(($totalStaff - TblWfh::wfhByDayAdmin($v, $icno, $deptId)) / $totalStaff * 100, 2); ?>%</strong></td>
