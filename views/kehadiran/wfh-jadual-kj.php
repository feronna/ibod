    ...
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <?= Html::beginForm(['wfh-jadual-kj'], 'GET', ['class' => 'form-horizontal form-label-left']); ?>
                ...
                <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <?php // Html::a('<i class="fa fa-print"></i> Print', ['kehadiran/print-wfh-jadual', 'tahun' => $tahun, 'bulan' => $bulan], ['class' => 'btn btn-warning', 'target' => '_blank']) ?>
                    </div>
                </div>
                <?= Html::endForm(); ?>
            </div>
                        ...
                        <table class="table table-sm jambo_table">
                            ...
                            <tr class="">
                                ...
                                <?php foreach ($var as $k => $v) { ?>
                                    ...
                                    <td class="text-center" style="text-align:center"><strong><?= round(TblWfh::wfhByDay($v, $icno) / $totalStaff * 100, 2); ?>%</strong></td>
                            ...
                            <tr class="">
                                ...
                                <?php foreach ($var as $k => $v) { ?>
                                    ...
                                    <td class="text-center" style="text-align:center"><strong><?= round(($totalStaff - TblWfh::wfhByDay($v, $icno)) / $totalStaff * 100, 2); ?>%</strong></td>
