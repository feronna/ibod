...
<div class="x_panel">
    <div class="x_title">
        <h5><i class="fa fa-pencil"></i>&nbsp;UPDATE SHIFT FOR <strong><?= $staffname; ?></strong> <div class="pull-right"><i class="fa fa-calendar"></i>&nbsp;<strong><?= TblRekod::viewBulan($bulan) . ' ' . $tahun?></strong></div></h5>
        ...
        <?php foreach ($models as $index => $model) { ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-6">
                    ...
                    <?=
                    $form->field($model, "[$index]wp_id")->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map($wp, 'id', 'jenis_wp'),
