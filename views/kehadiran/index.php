        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <table class="table table-bordered table-info table-condensed table-hover table-striped">
                    ...
                    <tr>
                        <td colspan="2" style="font-size:11px; color:green; padding: 5px">* Attendance’s Card Colour Status will change <strong>every 10th of following month</strong> based on previous month attendance record.</td>
                    </tr>
                </table>
                <!--</div>-->
            </div>
