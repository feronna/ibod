                        ...
                        <?php if ($lulus) { ?>
                            ...
                            <?php foreach ($lulus as $senarai) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $senarai->formatTimeIn; ?></td>
                                    <td class="text-center"><?php echo $senarai->formatTimeOut; ?></td>
                                    <td class="text-center"><?php echo $senarai->statusAll; ?></td>
                                    <td><?php echo $senarai->remark; ?></td>
                                    <td class="text-center"><?= Html::a('<i class="fa fa-edit">', ["kehadiran/pengesahan", 'id' => $senarai->id]); ?></td>
                                </tr>
                            <?php } ?>
