...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item" aria-current="page"><?= Html::a('Pengenalan', Url::to(['intro']), ['class' => '']) ?></li>
    <li class="breadcrumb-item active" aria-current="page">Bahagian A</li>
  </ol>
</nav>
            ...
            <div class="x_content">
                ...
                <?php echo GridView::widget([
                    ...
                    'columns' => [
                        ...
                        // ],
                        [
                            'label' => "Cantril's Ladder of Life Scale",
                            'headerOptions' => ['class' => ''],
                ...
                <div class="form-group text-center">
                    <?= Html::a('<i class="fa fa-arrow-left"></i> Sebelumnya / Back', Url::to(['intro']), ['class' => 'btn btn-warning']) ?>
                    &nbsp;
