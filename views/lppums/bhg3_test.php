...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Bahagian III - Penghasilan Kerja</strong> (Wajaran <?= $mrkhBhg['markah_bahagian']; ?>%) <?= (($lpp->PYD != Yii::$app->user->identity->ICNO)) ? '(' . $lpp->pyd->CONm . ' - ' . $lpp->tahun . ')' : '' ?></h2>
                                ...
                                <th class="text-center">
                                    <math>
                                        ...
                                        <mn>
                                            ...
                                            echo ($akses or ($lpp->PPK == \Yii::$app->user->identity->ICNO)) ? \Yii::$app->formatter->asDecimal($total1, 2) : '';
                                            ?>
                                        </mn>
                                    </math>
                                </th>
