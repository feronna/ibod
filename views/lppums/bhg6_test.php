...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Bahagian VI - Kegiatan Dan Sumbangan Di Luar Tugas Rasmi / Latihan</strong> (Wajaran <?= $mrkhBhg['markah_bahagian'] ?>%) <?= (($lpp->PYD != Yii::$app->user->identity->ICNO)) ? '(' . $lpp->pyd->CONm . ' - ' . $lpp->tahun . ')' : '' ?></h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <div class="row">
                    <p>
                        Berdasarkan maklumat di Bahagian II perenggan 1, Pegawai Penilai dikehendaki memberikan penilaian dengan menggunakan skala 1 hingga 10. Tiada sebarang markah boleh diberikan (kosong) jika PYD tidak mencatat kegiatan atau sumbangannya.
                    </p>
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered">
                            ...
                            foreach ($lpp_mrkh as $ind => $p) {
                                // $p->markah_PPP = $countVer;
                                // $p->markah_PPK = $countVer;
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= '<b>' . $kriteria[$abc]['kriteria']['kriteria_label'] . '</b>' . ((empty($kriteria[$abc]['kriteria']['kriteria']) ? '' : $kriteria[$abc]['kriteria']['kriteria']) . ' ' . Html::button('<span class="glyphicon glyphicon-th-list"></span>', ['value' => Url::to(['lppums/staff-idp-list', 'lpp_id' => $lpp->lpp_id]), 'class' => ' btn btn-default btn-xs modalButtonn', 'title' => 'IDP List']) . '</b><br>'); ?></td>
                                    <td class="text-center" style="vertical-align: middle;"><?= (($lpp->PPP == \Yii::$app->user->identity->ICNO) or ($lpp->PPK == \Yii::$app->user->identity->ICNO)) ? $form1->field($p, "[$ind]markah_PPP")->textInput([
                                    ...
                                    <td class="text-center" style="vertical-align: middle;"><?= (($lpp->PPK == \Yii::$app->user->identity->ICNO)) ? $form1->field($p, "[$ind]markah_PPK")->textInput([
                                                                                                'id' => "[$ind]markah_PPP", 'class' => 'form-control', 'placeholder' => '0.0', 'style' => 'text-align:center', 'maxlength' => 2
                                                                                                //, 'onfocus' => "this.value=''"
                                                                                                , 'disabled' => true
                                ...
                                <th class="text-center">
                                    <math>
                                        ...
                                        <mn>
                                            ...
                                            $total = ($sum / (18)) * $mrkhBhg['markah_bahagian'];
...
</div <?= $this->render('_skalaPenilaianPrestasi'); ?>