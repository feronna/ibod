        ...
        <div class="x_panel">
            ...
            <div class="panel-body">
                ...
                <p align="center">
                    ...
                    <?=
                    is_null($alasan) ? Html::button('Mohon Semakan Semula', ['value' => Url::to(['lppums/markah-tidak-setuju', 'lpp_id' => $model->lpp_id]), 'class' => 'btn btn-warning ReplyButton', 'id' => 'ReplyButton', 'title' => 'Reply'])
                        : '';
                    ?>
                </p>
            </div>
