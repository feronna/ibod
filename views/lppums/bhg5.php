...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Bahagian V - Kualiti Peribadi</strong> (Wajaran <?= $mrkhBhg['markah_bahagian'] ?>%) <?= (($lpp->PYD != Yii::$app->user->identity->ICNO)) ? '(' . $lpp->pyd->CONm. ' - ' . $lpp->tahun. ')' : '' ?></h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <div class="row">
                    <p>
                        Pegawai Penilai dikehendaki memberikan penilaian berasaskan penjelasan setiap kriteria yang dinyatakan di bawah dengan menggunakan skala 1 hingga 10:
                    </p>
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            foreach ($lpp_mrkh as $ind => $p) { ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?= (($lpp->PPP == \Yii::$app->user->identity->ICNO) or ($lpp->PPK == \Yii::$app->user->identity->ICNO)) ? $form1->field($p, "[$ind]markah_PPP")->textInput(['id' => "[$ind]markah_PPP", 'class' => 'form-control', 'placeholder' => '0.0', 'style' => 'text-align:center', 'maxlength' => 2
//, 'onfocus' => "this.value=''"
, 'disabled' => ($lpp->PPP_sah == 1) or ($lpp->PPK == \Yii::$app->user->identity->ICNO and is_null($lpp->PP_ALL))])->label(false) : ($akses ? $p->markah_PPP : 'PPP'); ?></td>
                                    <td class="text-center"><?= (($lpp->PPK == \Yii::$app->user->identity->ICNO)) ? $form1->field($p, "[$ind]markah_PPK")->textInput(['id' => "[$ind]markah_PPK", 'class' => 'form-control', 'placeholder' => '0.0', 'style' => 'text-align:center', 'maxlength' => 2
//, 'onfocus' => "this.value=''"
, 'disabled' => ($lpp->PPK_sah == 1)  or ($lpp->PPP_sah == 0)])->label(false) : ($akses ? $p->markah_PPK : 'PPK'); ?></td>
                                </tr>
                            <?php
                                $abc += 1;
                            } ?>
