...
<?= $this->render('_searchBorang_2', ['model' => $searchModel, 'action' => Url::to(['lppums/pengurusan-cadangan-apc'])]) ?>
                            ...
                            [
                                ...
                                'buttons' => [
                                    ...
                                    'delete' => function ($url, $model) {
                                        $url = Url::to(['lppums/delete-file', 'filehash' => $model->filehash]);
...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Hasil Carian</strong></h2> <?= Html::a('<i class="fa fa-download"> Muat turun Laporan</i>', ['lppums/generate-laporan-apc', 'tahun' => Yii::$app->request->get('tahun')], ['class' => 'btn btn-default btn-sm pull-right']); ?>
                <div class="clearfix"></div>
            </div>
            <div class="panel-body">
                ...
                <p><i>* Klik column PYD, MARKAH LNPT untuk mengubah susunan data.</i></p>
                    ...
                    GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'headerOptions' => ['class' => 'text-center'],
                                'value' => function ($model) {
                                    return '' . $model->pyd->CONm . '<br><strong>(' . $model->PYD . ')</strong>';
                                },
                                'format' => 'html',
                                'attribute' => '`p`.`CONm`',
                            ],
                            ...
                            [
                                ...
                                'headerOptions' => ['class' => 'text-center'],
                                'value' => function ($model) {
                                    return '<strong>' . $model->gredJawatan->gred . '</strong><br>' . $model->gredJawatan->nama . '';
                                },
                                'format' => 'html',
                            ],
                            [
                                ...
                                'contentOptions' => ['class' => 'text-center'],
                                'value' => function ($model) {
                                    return is_null($model->markahSeluruh) ? '' : '<strong>' . $model->markahSeluruh->markah_PP . '</strong>';
                                },
                                'format' => 'html',
                                'attribute' => '`m`.`average_mark`',
                            ],
                            [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    return is_null($model->sandangan3) ? '' : $model->sandangan3->start_date;
                                },
                            ],
                            [
                                'label' => 'APC',
                            ...
                            [
                                ...
                                'buttons' => [
                                    'reset' => function ($url, $model) {
                                        $url = Url::to(['lppums/cadangan-apc', 'lpp_id' => $model->lpp_id]);
                                    ...
                                    'delete' => function ($url, $model) {
                                        if (is_null($model->cdg)) {
                                            ...
                                            return Html::a('<i class="fa fa-trash"></i>', ['lppums/buang-cadangan-apc', 'lpp_id' => $model->lpp_id], ['class' => 'btn btn-danger btn-xs']);
                                        }
                                    },
                                ],
                            ],
