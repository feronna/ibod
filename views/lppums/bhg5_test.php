...
$js = <<< JS
    ...
    $('.modalButtonn2').on('click', function () {
        $('#modalSkt').modal('show')
                .find('#modalContent1')
                .load($(this).attr('value'));
        $('#modalHeader').text('Card Color List');
    });
JS;
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            foreach ($lpp_mrkh as $ind => $p) { ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= '<b>' . $kriteria[$abc]['kriteria']['kriteria_label'] . ' ' . Html::button('<span class="glyphicon glyphicon-eye-open"></span>', ['value' => Url::to(['lppums/senarai-skt', 'lpp_id' => $lpp->lpp_id, 'order' => $kriteria[$abc]['kriteria_id'], 'bhg' => $kriteria[$abc]['bahagian_id']]), 'class' => ' btn btn-default btn-xs modalButtonn', 'title' => 'Senarai SKT']) . ($kriteria[$abc]['kriteria_id'] == 21 ? Html::button('<span class="glyphicon glyphicon-th-list"></span>', ['value' => Url::to(['lppums/staff-color-list', 'lpp_id' => $lpp->lpp_id]), 'class' => ' btn btn-default btn-xs modalButtonn2', 'title' => 'Card Color Summary']) : '') . '</b><br>' . $kriteria[$abc]['kriteria']['kriteria']; ?></td>
