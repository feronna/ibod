            ...
            <div class="x_content">
                <div class="table-responsive">
                    <table class="table table-sm table-bordered">
                        <tr>
                            <th style="width:700px; height:20px" colspan="5"><strong> MAKLUMAT UMUM </strong></th>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        <tr>
                            <th colspan="5" style="width:500px; height: 20px">TUJUAN PEWUJUDAN JAWATAN</strong></td>
                            </th>

                        </tr>
                        <tr>
                            <td colspan="6" style="text-align:justify"><?php echo  ucwords(strtolower($deskripsi->kata_kerja)) ?> <?php echo $deskripsi->object ?> <?php echo $deskripsi->tujuan ?></td>
                        </tr>

                        <tr>
                            <th colspan="1" style="width:50px; height: 20px">Bil.</strong></td>
                            </th>

                            <th colspan="2" style="width:200px; height: 20px"><strong>AKAUNTABILITI</strong></td>
                            </th>
                            <th colspan="2" style="width:500px; height: 20px">TUGAS UTAMA</strong></td>
                            </th>
                        </tr>
                        ...
                        <tr>
                            <th style="width:50px; height: 20px">Bil.</strong></td>
                            </th>
                            <th colspan="2" style="width:200px; height: 20px">DIMENSI</strong></td>
                            </th>
                            <th colspan="3" style="width:500px; height: 20px">SKOP</strong></td>
                            </th>
                        ...
                        <tr>
                            <th height="25px"><strong>Bil.</strong></td>
                            </th>
                            <th colspan="2" height="25px"><strong>KELAYAKAN AKADEMIK / IKHTISAS</strong></td>
                            </th>
                            <th height="25px" colspan="3"><strong>BIDANG</strong></td>
                            </th>
                        </tr>
                        <?php if ($ikhtisas) {
