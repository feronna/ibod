...
<div class="row">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><strong>Bahagian VI - Kegiatan Dan Sumbangan Di Luar Tugas Rasmi</strong> (Wajaran <?= $mrkhBhg['markah_bahagian'] ?>%) <?= (($lpp->PYD != Yii::$app->user->identity->ICNO)) ? '(' . $lpp->pyd->CONm. ' - ' . $lpp->tahun. ')' : '' ?></h2>
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            foreach ($lpp_mrkh as $ind => $p) { ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= '<b>' . $kriteria[$abc]['kriteria']['kriteria_label'] . '</b>' . (empty($kriteria[$abc]['kriteria']['kriteria']) ? '' : $kriteria[$abc]['kriteria']['kriteria'] . '</b><br>'); ?></td>
