...
<div class="col-md-12 col-sm-12 col-xs-12 ">
        ...
        <div class="x_content">
            <div class="tblpraddress-view">
                <p>
                    ...
                    <?= Html::a('Kemaskini', ['admin-update-cc', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
                </p>
                <?= DetailView::widget([
                    'model' => $model,
                    'attributes' => [
    ...
    ?>
        <div class="form-group text-center">
            <?= \yii\helpers\Html::a('Reject', ['reject-cc', 'id' => $model->id], ['class' => 'btn btn-danger']) ?>
            <?= \yii\helpers\Html::a('Approve', ['approve-cc', 'id' => $model->id], ['class' => 'btn btn-success']) ?>
        </div>
    <?php
    }
    ?>
