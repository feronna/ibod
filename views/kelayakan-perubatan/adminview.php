    ...
    <div class="tab-pane fade in active " id="certificate">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <?= Html::a('Tambah Sijil', ['admin-add-cert','icno'=>$icno], ['class' => 'btn btn-primary']) ?>
                        ...
                        <table class="table table-sm table-bordered jambo_table table-striped">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['admin-view-cc', 'id' => $cert->id]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['admin-update-cc', 'id' => $cert->id]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['admin-delete-cc', 'id' => $cert->id], []) ?></td>
                                    </tr>
    ...
    <div class="tab-pane fade " id="membership">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <?= Html::a('Tambah Keahlian', ['admin-add-membership','icno'=>$icno], ['class' => 'btn btn-primary']) ?>
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered jambo_table table-striped">
                            <thead>
                                <tr class="headings">
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?= Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['admin-view-bp', 'id' => $profBody->profId]) ?> | <?= Html::a('<i class="fa fa-pencil" aria-hidden="true"></i>', ['admin-update-bp', 'id' => $profBody->profId]) ?> | <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['admin-delete-bp', 'id' => $profBody->profId], [
                                                                                                                                                                                                                                                                                                                                            'data' => [
