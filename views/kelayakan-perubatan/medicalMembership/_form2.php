...
<div class="tbl-badan-profesional-form">
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    $form->field($model, 'ProfBodyCd')->label(false)->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(BadanProfesional::find()->where(['isActive'=>1])->orderBy(['ProfBody'=> SORT_ASC])->all(), 'ProfBodyCd', 'ProfBody'),
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    ...
                    DatePicker::widget([
                        ...
                        'options' => [array('JoinDt', 'date', 'format'=>'yyyy-M-d H:m:s'),'class' => 'form-control col-lg-4 col-md-7 col-xs-12','required'=>true],
                        'clientOptions' => [
                            'autoclose' => true,
                            'format' => 'yyyy-mm-dd'
                        ]
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tarikhTamatMenyertai">Tarikh Tamat Menyertai: <span class="required" style="color:red;"></span>
                </label>
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    ...
                    DatePicker::widget([
                        ...
                        'attribute' => 'ResignDt',
                        'template' => '{input}{addon}',
                        'options' => [array('ResignDt', 'date', 'format'=>'yyyy-M-d H:m:s'),'class' => 'form-control col-lg-4 col-md-7 col-xs-12'],
                        'clientOptions' => [
                            'autoclose' => true,
                            'format' => 'yyyy-mm-dd'
                        ]
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Status">Keahlian Berkaitan Perubatan: <span class="required" style="color:red;"></span>
                </label>
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <?= $form->field($model, 'isMedicalBody')->checkbox(['label' => 'Tandakan jika berkaitan kelayakan perubatan', 'value' => 1, 'uncheck' => 0])->label(false) ?>
                </div>
            </div>
            <div class="form-group">
