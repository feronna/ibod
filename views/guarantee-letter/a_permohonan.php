...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel"> 
        <div class="x_title">
            <h2>Maklumat Peribadi (Mohon Bagi Pihak)</h2> <p align="right"><?= Html::a('Manual Pengguna', ['manual-pengguna'], ['class' => 'btn btn-default btn-sm', 'target' => '_blank',]); ?></p>
    ...
    <div class="x_panel"> 
        ...
        <div class="x_content">    
            ...
            <?php if ($model->NatCd == "MYS") { ?>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Tangungan (Anak):
                    </label>
