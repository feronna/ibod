...
<div class="x_panel">
        ...
        <?= strtoupper('
     SEKSYEN PEMBANGUNAN PROFESIONALISME | SEKTOR PENGURUSAN BAKAT<br/><u> PERMOHONAN PENGAJIAN LANJUTAN LATIHAN INDUSTRI
...
//                             }
                ...
                <?php 
                echo Html::a('<i class="fa far fa-hand-point-up"></i> Cetak Semakan', ['generate-semakan-syarat', 'id' =>$kontrak->id, 'ICNO'=>$kontrak->icno, 'takwim_id'=>$kontrak->iklan_id], [
