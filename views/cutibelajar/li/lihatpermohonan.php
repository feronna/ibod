...
<!--            <span class="required" style="color:black;">
    ...
    <u> PERMOHONAN PENGAJIAN LANJUTAN LATIHAN INDUSTRI KAKITANGAN AKADEMIK
 '); ?>
                </strong> </center></h2>
            </span> -->
        </div>
...
<div class="x_panel">
        ...
        <?= strtoupper('
     UNIT PEMBANGUNAN PROFESIONALISME | SEKTOR PEMBANGUNAN SUMBER MANUSIA<br/><u> PERMOHONAN PENGAJIAN LANJUTAN
     LATIHAN INDUSTRI KAKITANGAN AKADEMIK
        '); ?>
...
<div class="x_title">
   <h5 ><strong><i class="fa fa-graduation-cap"></i> MAKLUMAT LATIHAN INDUSTRI YANG DIPOHON</strong></h5>
