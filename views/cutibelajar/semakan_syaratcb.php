...
//                       'value'=>function ($data)  {
//                            
//                             if($data->sokongan->namafile)
//                             {
//                         return  Html::a('', 
//                            (Yii::$app->FileManager->DisplayFile($data->sokongan->namafile)), 
                        ...
                        <table class="table table-striped table-sm jambo_table table-bordered">
                            ...
                            { $no=0;?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><input type="radio" name="<?=$dok->syarat_id.'semak_doktoral'?>" value="y" <?php if($mod->semak_doktoral){if($mod->semak_doktoral === 'y'){echo "checked";}}?>></td>
                                    <td class="text-center"><input type="radio" name="<?=$dok->syarat_id.'semak_doktoral'?>" value="n" <?php if($mod->semak_doktoral){if($mod->semak_doktoral === 'n'){echo "checked";}}?>></td>
...
<div class="x_panel">
                <div class="x_title">
                    ...
                    <?php }elseif(($pengajian->HighestEduLevelCd == 1) || ($pengajian->HighestEduLevelCd == 102) ||
...
<div class="x_panel">
                <div class="x_title">
                    ...
                    <?php }
                   elseif(($pengajian->HighestEduLevelCd == 1) ||
