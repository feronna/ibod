...
?>
    ...
    <tr>
            ...
            <td><?= $form->field($biasiswa, 'nama_tajaan')->textInput(['maxlength' => true, 'rows' => 4])->label(false); ?>
</td>
    </tr>
            ...
            echo $form->field($biasiswa,'BantuanCd')->
            dropDownList(['1' => 'SLAB',
                          '2' => 'SLAI',
...
?> </td>
            ...
            <td><?= $form->field($biasiswa, 'amaunBantuan')->textInput(['maxlength' => true, 'rows' => 4])->label(false); ?>
