...
<div class="col-xs-12 col-md-12 col-lg-12">
        ...
        <div class="x_panel">
       <fieldset class="scheduler-border">
            <legend class="scheduler-border">   <h5><i class='fa fa-graduation-cap'></i> MAKLUMAT BIASISWA / PEMBIAYAAN YANG DIPOHON</h5>
            </legend>    
              <?php 
        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                    ...
                    <tr class="headings">
                        ...
                        <td><?php if($models->status_jfpiu == "DALAM TINDAKAN KETUA JABATAN")
                        {
