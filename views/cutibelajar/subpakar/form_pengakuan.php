...
?> 
<?php
$umum = app\models\cbelajar\RefSemakan::find()->where(['id'=>[58,59,61,63,68]])->all();
...
<div class="x_panel">
            ...
            <legend class="scheduler-border">  
                ...
                SEMAKAN SYARAT SUB KEPAKARAN</h5></legend> 
...
<!--                            <tr>   
                             ...
                             <tr>   
                                ...
                                <tr>
                                    <td colspan="2">   
                                        <?php if (!empty($biodata->markahlnptCV(3, 'Tahun'))) { ?>
                                            Avg (3 Tahun) : 
                                            <?php
