...
<div class="col-xs-12 col-md-12 col-lg-12">
        ...
        <div class="x_panel">
            ...
            <div class="x_title">
                <h6><strong><i class="fa fa-list-alt"></i> DOKUMEN YANG DIMUAT NAIK</strong></h6>
                 
                <div class="clearfix"></div>
            </div>

        <div>
                <h6 style="background-color:lightseagreen;color:white" ><strong><i class="fa fa-list-alt"></i>DOKUMEN BAGI PERMOHONAN KPT</strong></h6>
                <form id="w0" class="form-horizontal form-label-left" action="">
                    ...
                    if ($dokumen2) {
                        ...
                        foreach ($dokumen2 as $dokumen2) {
                            ...
                            <tr>
                                ...
                                <td colspan="10"><font size="2"><?php if(!empty($dokumen2->dokumen->nama_dokumen)):?>
...
<!--                                            <img src="<?= Url::to('@web/uploads'.$dokumen2->namafile, true);?>"/>-->
                        ...
                        ?>
                        <tr>
                            <td colspan="80" class="text-center"  style="font-size: 10;font-family:Arial;">Tiada Maklumat</td>                     
                        </tr>
<?php }
?>
                </tbody>
...
?>
 ...
 <div>          <h6 style="background-color:lightseagreen;color:white"><strong><i class="fa fa-list-alt"></i> DOKUMEN BAGI PERMOHONAN LUAR NEGARA</strong></h6>
                <form id="w0" class="form-horizontal form-label-left" action="">
...
<!--                                            <img src="<?= Url::to('@web/uploads'.$dokumen3->namafile, true);?>"/>-->
                        ...
                        ?>
                        <tr>
                            <td colspan="70" class="text-center" style="font-size: 10px;font-family:Arial;" >Tiada Maklumat</td>                     
                        </tr>
<?php }
?>
                </tbody>
