...
<div class="x_panel">
     ...
     DIPLOMA / SARJANA MUDA / SARJANA / PHD
        '); ?>
        ...
        <div class="table-responsive">
                <table class="table table-sm table-bordered jambo_table table-striped"> 
                    ...
                    <tr class="headings">
                        ...
                        <td> <?php 
                            echo strtoupper($model4->statusjfpiu).'  [ '. $model4->app_date. ' ] ';
                        ?>
                </td>
                    ...
                    <tr class="headings">
                        ...
                        <td><?php 
                            echo strtoupper($model4->ulasan_jfpiu);
                        ?>   </td>
                     ...
                     <tr class="headings">
                        ...
                        <td> <?= $model4->tarikh_m;?>  </td>

                        
                    </tr>
                     <tr class="headings">
                        <th class="col-md-3 col-sm-3 col-xs-12">STATUS PERMOHONAN:</th>
                        <td> <?= ucwords(strtoupper($model4->status));?>  </td>
