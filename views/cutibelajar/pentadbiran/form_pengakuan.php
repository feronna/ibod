...
?> 
<?php
$umum = app\models\cbelajar\RefSemakan::find()->where(['id'=>[35,36,38,44,46,37]])->all();
                    ...
                    <center> 
                        <table class="table table-sm table-bordered jambo_table table-striped" style="width:80%"> 
                            ...
                            <tr>   
                                ...
                                <td colspan="2"><small><?= $biodata->tatatertib ? $biodata->tatatertib->statusTatatertib() : 'TIADA REKOD'; ?></small></td> 
                            </tr>
                            <tr>   
                                    <th>TARIKH PERISYTIHARAN HARTA</th>  
                                    <td colspan="2"><?php
                                        if ($biodata->harta) {
                                            echo $biodata->harta->ADDeclDt;
                                        } else {
...
<div class="x_panel">
            ...
            <legend class="scheduler-border">  
                <h5><i class='fa fa-check-square'></i>
                    SEMAKAN SYARAT DIPLOMA/ SARJANA MUDA/ SARJANA / PHD</h5></legend> 
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-sm jambo_table table-bordered">
                            <thead style="background-color:lightseagreen;color:white">
                                ...
                                <tr class="headings">
                    <th scope="col" colspan=12"  style="background-color:white;color:black;">PERMOHONAN PENGAJIAN SEPENUH MASA:</th>
