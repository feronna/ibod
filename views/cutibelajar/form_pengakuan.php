    ...
    <div class="x_panel">
        <div class="x_content">  
            <span class="required" style="color:#062f49;">
                <strong>
                    <center><?= strtoupper('
      UNIT PENGEMBANGAN PROFESIONALISME | SEKTOR PEMBANGUNAN SUMBER MANUSIA<br/><u> PERMOHONAN PENGAJIAN LANJUTAN KAKITANGAN AKADEMIK
 '); ?>
                </strong> </center>
            </span> 
        </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12"> 
                ...
                <div class="x_title">
                    <h5 ><strong><i class="fa fa-graduation-cap"></i> MAKLUMAT PENGAJIAN YANG DIPOHON</strong>
                        <?= Html::a('KEMASKINI', ['cbelajar/maklumat-pengajian', 'id' => $iklan->id], ['class' => 'btn btn-success btn-xs', 'target' => '_blank']) ?>
                    </h5>
    ...
    <div class="x_panel">
        <div class="x_content">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12"> 
                <div class="x_title">
                    <h5 ><strong><i class="fa fa-money"></i> MAKLUMAT BIASISWA/PEMBIAYAAN YANG DIPOHON</strong>                           <?= Html::a('KEMASKINI', ['cbelajar/maklumat-biasiswa', 'id' => $iklan->id], ['class' => 'btn btn-success btn-xs', 'target' => '_blank']) ?> </p>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12"> 
                ...
                <div class="x_title">
                    ...
                    <h5> <strong><i class="fa fa-paperclip"></i> DOKUMEN BAGI PERMOHONAN KPM</strong>
                        <?= Html::a('KEMASKINI', ['cbelajar/senarai-dokumen', 'id' => $iklan->id], ['class' => 'btn btn-success btn-xs', 'target' => '_blank']) ?>
                    </h5>
