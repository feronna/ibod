...
?> 
<?php
$umum = app\models\cbelajar\RefSemakan::find()->where(['id'=>[48,49,50]])->all();
                            ...
                            foreach ($umum as $p) {
                                ...
                                <tr>      
                                    ...
                                    <?php  if ($p->id == 48) {
                                         ...
                                         elseif ($p->id == 50) {
                                            if ($biodata->getServPeriod(13, 'Kriteria') >= $p->ans_no) {
                                                $s = 1;
                                                $totalUmum++;
                                            } else {
                                                $s = 0;
...
<div class="x_panel">
            ...
            <legend class="scheduler-border">  
                ...
                SEMAKAN SYARAT PASCA KEDOKTORAN</h5></legend> 
                        ...
                        foreach ($biasiswa as $sponsor) {
                            ...
                            <tr>
                             ...
                             <?php  if ($sponsor->jenisCd == '1')
                                ...
                                <td class="text-center">
                                                 <?= Html::a('<i class="fa fa-upload" aria-hidden="true"></i>', ['kpt?id='.$iklan->id], ['class' => 'btn btn-primary btn-sm', 'target'=>'_blank']) ?> </h5>
