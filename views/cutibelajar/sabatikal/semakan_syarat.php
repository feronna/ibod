                        ...
                        <table class="table table-striped table-sm jambo_table table-bordered">
                            ...
                            { $no=0;?>
                                ...
                                <tr>
                                   ...
                                   <td class="text-center"><input type="radio" name="<?=$dok->syarat_id.'semak_phd'?>" value="y" 
                                        <?php if(eval('return '.$dok->checking. ';')== 1){echo "checked";}?>></td>
                                    
                                    <td class="text-center"><input type="radio" name="<?=$kpi->syarat_id.'semak_phd'?>" value="n"<?php if(eval('return '.$dok->checking. ';')=== false){echo "checked";}?>></td>
