...
?> 
<?php
$umum = app\models\cbelajar\RefSemakan::find()->where(['id'=>[85,88,89,83,86,87]])->all();
...
<div class="x_panel">
        ...
        <?= strtoupper('
     SEKSYEN PEMBANGUNAN PROFESIONALISME | SEKTOR PENGURUSAN BAKAT<br/><u> PERMOHONAN CUTI SABATIKAL
        '); ?>
