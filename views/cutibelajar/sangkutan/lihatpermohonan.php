...
<!--            <span class="required" style="color:black;">
    ...
    <u> PERMOHONAN PENGAJIAN LANJUTAN PROGRAM SANGKUTAN PENTADBIRAN
 '); ?>
                </strong> </center></h2>
            </span> -->
        </div>
...
<div class="x_panel">
        ...
        <?= strtoupper('
     SEKSYEN PEMBANGUNAN PROFESIONALISME | SEKTOR PEMBANGUNAN SUMBER MANUSIA<br/><u> PERMOHONAN PENGAJIAN LANJUTAN
