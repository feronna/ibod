...
<div class="x_panel">
        ...
        <?= strtoupper('
     SEKSYEN PEMBANGUNAN PROFESIONALISME | SEKTOR PENGURUSAN BAKAT<br/><u> PERMOHONAN PROGRAM SANGKUTAN
        '); ?>
...
<div class="col-xs-12 col-md-12 col-lg-12">
        ...
        <div class="x_panel">
       <fieldset class="scheduler-border">
            <legend class="scheduler-border">   <h5><i class='fa fa-money'></i> MAKLUMAT BIASISWA / PEMBIAYAAN YANG DIPOHON</h5>
            </legend>    
              <?php 
    ...
    <div class="x_panel">
        ...
        <div style="width: 580px; height: 130px;border:2px solid red">
            <br><p align="left">&nbsp;Saya mengesahkan bahawa semua kenyataan yang diberikan oleh pemohon adalah benar.<br>
               &nbsp;1. Tarikh dan tempoh pengajian sesuai.<br>
