...
?> 
<?php
$umum = app\models\cbelajar\RefSemakan::find()->where(['id'=>[70,71,72,73,74]])->all();
?>
<style>
...
<div class="x_panel">
        ...
        <?= strtoupper('
     SEKSYEN PEMBANGUNAN PROFESIONALISME | SEKTOR PENGURUSAN BAKAT<br/><u> PERMOHONAN PROGRAM SANGKUTAN KAKITANGAN UMS
        '); ?>
     ...
     <?php if($pengajian){
        foreach ($pengajian as $pengajian) {
                ...
                ?>  
                    ...
                    <div class="x_content ">
 <p align ="right"><?php // Html::a('KEMASKINI <i class="fa fa-pencil" aria-hidden="true"></i>', ['', 'id' => $eduhighest->id],
...
<div class="x_panel">
            ...
            <legend class="scheduler-border">  
                <h5><i class='fa fa-check-square'></i>
                SEMAKAN SYARAT PROGRAM SANGKUTAN KAKITANGAN UMS </h5></legend> 
