...
<div class="x_panel">
      ...
      PERMOHONAN SANGKUTAN KAKITANGAN UNIVERSITI MALAYSIA SABAH
 '); ?>
                    </strong> </h5>
            </span> 
        </div>
...
<div class="x_panel">
            ...
            <legend class="scheduler-border">  
                ...
                SEMAKAN SYARAT PROGRAM SANGKUTAN</h5></legend> 
...
<div class="col-xs-12 col-md-12 col-lg-12"> 
     <fieldset class="scheduler-border">
        ...
        <legend class="scheduler-border">  
              ...
              KELAYAKAN PERMOHONAN BERDASARKAN SYARAT PERMOHONAN</h5></legend>  
<div class="table-responsive">
