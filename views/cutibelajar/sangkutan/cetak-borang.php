...
?> 
     ...
     UNIT PEMBANGUNAN PROFESIONALISME | SEKTOR PEMBANGUNAN SUMBER MANUSIA<br/><u> PERMOHONAN PENGAJIAN LANJUTAN KAKITANGAN AKADEMIK
        '); ?><?php }else{?>
            ...
            <?= strtoupper('
     UNIT PEMBANGUNAN PROFESIONALISME | SEKTOR PEMBANGUNAN SUMBER MANUSIA<br/><u> PERMOHONAN PENGAJIAN LANJUTAN PROGRAM SANGKUTAN
        '); ?><?php
        }?>
                            ...
                            <td><font size="2"><?= $biasiswa->nama_tajaan; ?></font></td>
                             <td class="text-center">
                                ...
                                <?php  
                                    ...
                                    {
                                      echo strtoupper($biasiswa->bantuan->bentukBantuan);
                                    }
