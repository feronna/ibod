...
<fieldset class="scheduler-border">
            <legend class="scheduler-border">   <h5><i class='fa fa-graduation-cap'></i> MAKLUMAT LATIHAN PENSIJILAN PROFESIONAL YANG DIPOHON</h5>
            </legend>    
...
?></td>
                        ...
                        <th style="width:10%" align="right">TEMPOH LATIHAN </th>
                        <td style="width:40%">
