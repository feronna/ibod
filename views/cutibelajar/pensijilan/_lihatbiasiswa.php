...
<div class="col-md-12 col-sm-12 col-xs-12 "> 
    ...
    <ol class="breadcrumb">
        ...
        <li><?= Html::a('Maklumat Pembiayaan / Pinjaman', ['cbelajar/maklumat-biasiswa-separuh-masa', 'id'=>$model->iklan_id]) ?></li>
        
    </ol>
</div>
    <div class="x_panel"><p align="right"><?php
          
    echo Html::button('Kemaskini Maklumat Biasiswa <i class="fa fa-pencil" aria-hidden="true"></i>', 
                    ['id' => 'modalButton', 
                    'value' => \yii\helpers\Url::to(['update-sponsor-sm', 'id' => $model->id]),
...
<?= DetailView::widget([
        ...
        <p align="right">
                    <?= Html::a('Kembali', ['maklumat-biasiswa-separuh-masa', 'id'=> $model->iklan_id], ['class' => 'btn btn-primary btn-sm']) ?>
               </p>
    </div>
</div>
