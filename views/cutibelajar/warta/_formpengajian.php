...
<div class="table-responsive">
    <table class="table table-bordered jambo_table">
                <thead>
                        ...
                        <center>MAKLUMAT LATIHAN PRA-WARTA</center></th>
                </thead>
                 <tr>
                ...
                <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12">NAMA HOSPITAL:</th>
                        <td colspan="2">   <?= $form->field($model, 'InstNm')->textArea(['maxlength' => true]) ->label(false);?> 
                        </td> 
                        <th class="col-md-3 col-sm-3 col-xs-12">NEGERI:</th>
                        <td colspan="3">
...
?>
            ...
            <?=
                   ...
                   <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12"> NAMA KETUA JABATAN: </th>
                        <td colspan="2" >  <?= $form->field($model, 'nama_kj')->textInput()->label(false); ?> </td>
                       <th class="col-md-3 col-sm-3 col-xs-12"> EMEL KETUA JABATAN: </th>
                       <td>  <?= $form->field($model, 'emel_kj')->textInput()->label(false); ?> </td>
                    </tr>
                    
                    <tr>
                        <th class="col-md-3 col-sm-3 col-xs-12"> NAMA PENYELIA: </th>
