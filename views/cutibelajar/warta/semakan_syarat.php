...
<?php
$umum = app\models\cbelajar\RefPhd::find()->where(['id'=>[1,2,4]])->all();
...
<!--            <h4 colspan="2" style="background-color:lightseagreen;color:white"><center>MAKLUMAT PERIBADI</center></h4>-->
     ...
     <fieldset class="scheduler-border">
            <legend class="scheduler-border">   <h5><i class='fa fa-user-md'></i> MAKLUMAT PERUBATAN</h5>
            </legend>
...
?>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12"> 
        ...
        <legend class="scheduler-border">  
               ...
               MAKLUMAT LATIHAN PRA-WARTA</h5></legend>       
