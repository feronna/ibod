...
<?php 
                echo Html::a('<i class="fa far fa-hand-point-up"></i> Cetak Borang', ['cetak-borang', 'id'=>$model->id,
                    ...
                    'target'=>'_self', 
                    'data-toggle'=>'tooltip', 
                    'title'=>'Permohonan Baharu Pengajian Lanjutan - Pra Warta'
                ]);
                ?>
...
<div class="x_panel">
        ...
        <?= strtoupper('
     SEKSYEN PEMBANGUNAN PROFESIONALISME | SEKTOR PENGURUSAN BAKAT<br/><u> PERMOHONAN LATIHAN PRA-WARTA 
     PEGAWAI PERUBATAN / PENSYARAH PERUBATAN
        '); ?>
                ...
                ?>  
                 ...
                 <div class="table-responsive">
                    ...
                    <tr> 
                        ...
                        <th style="width:10%" align="right">NAMA HOSPITAL</th>
                        <td style="width:20%">
...
?></td>
                  ...
                  <tr> 
                        ...
                        <th style="width:10%" align="right">NAMA KETUA JABATAN</th>
                        <td style="width:20%">
                                  <?php echo strtoupper($pengajian->nama_kj); ?></td></tr>
