...
?> 
<?php
$umum = app\models\cbelajar\RefSemakan::find()->where(['id'=>[1,5,13]])->all();
                        ...
                        <table class="table table-sm table-bordered jambo_table table-striped" style="width:80%"> 
                            ...
                            foreach ($umum as $p) {
                                ...
                                <tr>      
                                    ...
                                    if ($biodata->warganegara->CountryCd == $p->ans_char) {
                                         $s = 1;
                                        $totalUmum++;
                                    } else {
                                        $s =0;
...
[
 ...
 <div class="x_title">
    ...
    <h5> <strong><i class="fa fa-paperclip"></i> DOKUMEN KPT</strong> </h5>
...
<div class="clearfix"></div>     </div>
 ...
 <div class="table-responsive "> 
     <?= Html::a('<i class="fa fa-upload" aria-hidden="true"></i>', ['kpt?id='.$iklan->id], ['class' => 'btn btn-primary btn-sm', 'target'=>'_blank', 'title'=>'Muat Naik Dokumen KPT']) ?> </h5>

 <font><strong>MUAT NAIK DOKUMEN KPT <br>
     <small><i>Jika anda ingin memohon pembiayaan Kementerian Pengajian Tinggi (KPT)</i></small> </strong></font><br>
                        <?=
                        GridView::widget([
...
[
  ...
  <div class="x_title">
    ...
    <h5> <strong><i class="fa fa-paperclip"></i> DOKUMEN LUAR NEGARA</strong> </h5>
...
[
                                        ...
                                        if((!empty($data->nama_dokumen))&& (!empty($data->sokongan->namafile))) {
                                            return Html::a('', (Yii::$app->FileManager->DisplayFile($data->sokongan->namafile)), ['class' => 'fa fa-download fa-lg', 'target' => '_blank']). ' | '.
                                                 Html::a('<i class="fa fa-trash fa-lg" aria-hidden="true"></i>',['delete-dokumen-ln?id='.$data->sokongan->id.'&i='.$data->sokongan->iklan_id], [
                                        'data' => [
                                        'confirm' => 'Anda ingin membuang rekod ini?',
                                        'method' => 'post',
                                        ],
