...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_title">
            <h5>SENARAI DOKUMEN YANG PERLU DIMUAT NAIK</h5>
...
<!--        <div class="table-responsive">
            ...
            <table class="table table-sm jambo_table table-striped">
                ...
                <div class="x_content"> 
                    ...
                    ?> 
                    <h6><strong>DOKUMEN SOKONGAN BAGI PERMOHONAN PENGAJIAN LANJUTAN (WAJIB)</strong></h6>
                    <div class="table-responsive ">        
                        <?=
                        GridView::widget([
                            ...
                            'columns' => [
                                ...
                                return '<small>'.strtoupper($model->nama_dokumen).'</small>';
                            },
                                ],
                                [
...
<div class="x_content"> 
     <p align ="left">
                ...
                <?php echo Html::a('TUNTUTAN',['/cutibelajar/senarai-borang'], ['class' => 'btn btn-primary btn-sm']); ?>  
         <i class="fa fa-info-circle fa-xs" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="[CLAIM] IELTS/ Visa / Insurans"
                               ></i> 
                                        ...
                                        <?php
                                        $dataProvider = new ActiveDataProvider([
                                            'query' => app\models\cbelajar\TblDokumenLn::find()->where(['status' => 1]),
                                            'pagination' => [
                                                'pageSize' => 10,
                                            ],
                                        ]);
                                        ?>  
                                    <h6><strong>DOKUMEN BAGI PERMOHONAN LUAR NEGARA</strong></h6>
                                            <div class="table-responsive">

            <table class="table table-sm jambo_table table-striped">

                <tr>
                    <th style="color: red;">BORANG JUSTIFIKASI PERMOHONAN LUAR NEGARA</th>
                    <td style="color: green;"><a href="<?php echo Url::to('@web/' . 'uploads-cutibelajar/cbelajar/dokumen/Borang Justifikasi ke Luar Negara.pdf', true); ?>" target="_blank" ><i class="fa fa-download"></i> Klik Sini Untuk Muat Turun</a><br> 
                    </td>
