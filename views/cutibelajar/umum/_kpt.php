...
<div class="x_panel">
     ...
     PERMOHONAN PENGAJIAN LANJUTAN SARJANA / SARJANA KEPAKARAN / PHD
 '); ?>
                </strong> </center>
            </span> 
        </div>
...
<!--     <strong><p><i>Sila lengkapkan Borang Kementerian Pendidikan Malaysia (KPM) dan muatnaik dokumen tersebut di bahagian menu "Muat Naik Dokumen"</i></p></strong><br>-->
  ...
  <div class="table-responsive">
                         <h5> <span class="label label-success">MUAT TURUN BORANG KPT UNTUK SARJANA KEPAKARAN</span></h5>
                    ...
                    <table class="table table-sm jambo_table table-striped">
                          ...
                          <td style="color: green;" colspan="5"><a href="<?php echo Url::to('@web/'.'uploads-cutibelajar/cbelajar/dokumen/'
                               ...
                               BORANG SENARAI SEMAKAN SLAB-SLAI (Sarjana Kepakaran)
                         </td>
                            ...
                            <th>2. Lampiran A3:</th>
                             ...
                             <td style="color: green;" colspan="5"><a href="
                                 <?php echo Url::to('@web/'.'uploads-cutibelajar/cbelajar/dokumen/'
                                     ...
                                     Klik Sini Untuk Muat Turun</a><br>A3.1 Pengesahan Pelan Pengajian bagi Sarjana Kepakaran </td>
    ...
    <tr>
                   ...
                   <tr>
                       <th>5. Lampiran Borang Justifikasi<br> ke Luar Negara:</th>
                             <td style="color: green;" colspan="5"><a href="
                                 <?php echo Url::to
                                         ('@web/'.'uploads-cutibelajar/cbelajar/dokumen/'
                                         . 'Borang Justifikasi ke Luar Negara-1.pdf', true); ?>" target="_blank" ><i class="fa fa-download"></i> Klik Sini Untuk Muat Turun</a><br>
                                         Borang Justifikasi ke Luar Negara
...
<!--     <i style="color: red;"><b>Permohonan KPT hanya layak diisi sekiranya memiliki Ijazah Sarjana Muda dengan PNGK 3.0 atau Kelas Dua Atas.</b></i>-->
  <div class="table-responsive">
                    ...
                    <table class="table table-sm jambo_table table-striped">
                         <h5> <span class="label label-info">MUAT TURUN BORANG KPT UNTUK PHD</span></h5>
                               <tr>
                              <th>1. Lampiran A1:</th>
                          
                         <td style="color: green;" colspan="5"><a href="<?php echo Url::to('@web/'.'uploads-cutibelajar/cbelajar/dokumen/'
                                  . 'Lampiran A1 - BORANG SENARAI SEMAKAN SLAB-SLAI (PhD) 2021.pdf', true); ?>" target="_blank" ><i class="fa fa-download"></i> Klik Sini Untuk Muat Turun</a><br> 
                             BORANG SENARAI SEMAKAN SLAB-SLAI (PhD)
                         </td>
                        </tr>
                          <tr>
                              <th>2. Lampiran A2:</th>
                            ...
                            <th>3. Lampiran A3:</th>
                             ...
                             <td style="color: green;" colspan="5"><a href="
                                 <?php echo Url::to('@web/'.'uploads-cutibelajar/cbelajar/dokumen/'
                                     ...
                                     Klik Sini Untuk Muat Turun</a><br>A3.1 Pengesahan Pelan Pengajian bagi PHD </td>
                   </tr>
                   ...
                   <tr>
                            <th>4. Lampiran A4:</th>
                             ...
                             <td style="color: green;" colspan="5"><a href="
                                 <?php echo Url::to('@web/'.'uploads-cutibelajar/cbelajar/dokumen/'
                                         . 'Lampiran A4 - BORANG PERAKUAN - PERSEDIAAN CALON PHD (SLAB-SLAI) 2021.pdf', true); ?>" target="_blank" ><i class="fa fa-download"></i> 
                                     Klik Sini Untuk Muat Turun</a><br>A4. Borang Perakuan Persediaan Calon PHD </td>
                   </tr>
    ...
    <tr>
                   ...
                   <tr>
                       <th>6. Lampiran Borang Justifikasi<br> ke Luar Negara:</th>
                             <td style="color: green;" colspan="5"><a href="
                                 <?php echo Url::to
                                         ('@web/'.'uploads-cutibelajar/cbelajar/dokumen/'
                                         . 'Borang Justifikasi ke Luar Negara-1.pdf', true); ?>" target="_blank" ><i class="fa fa-download"></i> Klik Sini Untuk Muat Turun</a><br>
