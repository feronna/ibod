...
<div class="sticky">
    <div class="form_wizard wizard_horizontal">
        <ul class="wizard_steps">
             ...
             <li><br /> <br /> 
                <a href="<?= Url::toRoute(['gambar', 'id' => $id])?>">  
            ...
            <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['maklumat-peribadi', 'id' => $id])?>">  
            ...
            <li> <br /> <br /> 
                    <a href="<?= Url::toRoute(['maklumat-akademik','id' => $id])?>">  
            ...
            <li> <br/> <br /> 
                    <a href="<?= Url::toRoute(['maklumat-pengajian', 'id' => $id])?>">  
            ...
            <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['maklumat-biasiswa', 'id' => $id])?>">  
            ...
            <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['maklumat-keluarga', 'id' => $id])?>">  
            ...
            <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['senarai-dokumen', 'id' => $id])?>">  
             ...
             <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['pengakuan-pemohon', 'id' => $id])?>">  
