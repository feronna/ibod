    ...
    <div class="table-responsive">
           <table style="vertical-align:10px; font-size: 10px; border: 1px solid #000;">
            <tr style=" background-color: lightgrey;">
                <td><b>PERINGKAT</b></td>
               <td><?= ucwords(strtoupper($pengajian->tahapPendidikan)) ?></td>
             </tr>

            <tr>
                <td style=" background-color: lightgrey;" ><b>BIDANG</b></td>
                <td width="80%"><?=ucwords(strtoupper( $pengajian->namaMajor)) ?></td>
            </tr>

             <tr style=" background-color: lightgrey;">
                 <td><b>INSTITUT PENGAJIAN</b></td>
                 <td><?= ucwords(strtoupper($pengajian->InstNm)) ?></td>
            </tr>

             <tr>
                 <td  style=" background-color: lightgrey;"><b>MOD PENGAJIAN</b></td>
                 <td ><?= ucwords(strtoupper($pengajian->mod->studyMode)) ?></td>
            </tr>

             <tr style=" background-color: lightgrey;">
                 <td><b>TARIKH PENGAJIAN</b> </td>
                 <td><?= ucwords(strtoupper($pengajian->tarikhmula)) ?> SEHINGGA <?=ucwords(strtoupper($pengajian->tarikhtamat))?> (<?=ucwords(strtoupper($pengajian->tempohpengajian))?>)</td>
            </tr>
             
            <tr>
                 <td style=" background-color: lightgrey;"><b>PENAJAAN</b> </td>
                 <td><?= ucwords(strtoupper($biasiswa->nama_tajaan)) ?> </td>
            </tr>
            
            <tr style=" background-color: lightgrey;">
                 <td><b>CATATAN</b> </td>
                 <td><?= ucwords(strtoupper($model->ulasan_bsm)) ?> </td>
            </tr>
...
<div style="margin-bottom: 15px; text-align:justify; font-size: 11px;">
    3. Sehubungan itu, puan perlu melengkapkan dokumen seperti berikut:<br>
  <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.1. Akaun Penerimaan Tawaran, <br/>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.2. Borang Pendaftaran Pengajian (dikembalikan setelah kakitangan mendaftar pengajian) dan; <br/>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.3. Borang Perjanjian (4 Salinan) <br/>
...
<div style="margin-bottom: 15px; text-align:justify; font-size: 11px;">
   ...
   Dokumen lengkap bagi perkara 3.1 dan 3.3  di atas hendaklah dikembalikan dalam tempoh empat belas (14) hari daripada surat ini dikeluarkan.
  <br><br>
Sekian.
