...
<div class="x_panel">
        <div class="x_title">
            <h2><strong><i class="fa fa-money"></i> Maklumat Pembiayaan / Pinjaman Yang Dipohon</strong></h2> 
             <p align="right">
                <?php echo Html::a('Tambah Biasiswa', ['cbelajar/tambah-biasiswa-sm', 'id' => $iklan->id], ['class' => 'btn btn-success btn-sm']); ?>
...
?>
                ...
                <?= Html::a('Seterusnya', ['maklumat-keluarga-separuh-masa','id'=>$iklan->id], ['class' => 'btn btn-info btn-sm']);?>
