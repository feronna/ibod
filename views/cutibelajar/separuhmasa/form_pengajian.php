    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <p align="right">
                ...
                //if ($model->status !=0 ) {
                echo Html::a('Tambah Pengajian', ['cbelajar/tambah-pengajian-sm', 'id' => $iklan->id],
...
?>
                ...
                <p align ="right">
                 <?= Html::a('Seterusnya', ['maklumat-biasiswa-separuh-masa', 'id' => $iklan->id], ['class' => 'btn btn-info btn-sm']);?>
                 <?= Html::a('Kembali', ['cbelajar/maklumat-akademik-separuh-masa', 'id'=>$iklan->id], ['class' => 'btn btn-primary btn-sm']) ?>
         </p> 
