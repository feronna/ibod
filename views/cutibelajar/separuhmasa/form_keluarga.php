...
?>
            ...
            <p align ="right">
                ...
                <?= Html::a('Seterusnya', ['cbelajar/senarai-dokumen-separuh-masa', 'id'=> $iklan->id], ['class' => 'btn btn-info btn-sm']);?>
                <?php echo Html::a('Kembali',['cbelajar/maklumat-biasiswa-separuh-masa', 'id'=> $iklan->id], ['class' => 'btn btn-primary btn-sm']); ?>  
