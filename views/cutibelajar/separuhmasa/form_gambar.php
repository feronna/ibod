...
<div class="x_panel">
     ...
     PERMOHONAN BAHARU PENGAJIAN LANJUTAN SEPARUH MASA
 '); ?>
                </strong> </center>
            </span> 
        </div>
...
<?php echo $this->render('_menusm', ['title' => $name, 'id'=> $iklan->id]) ?> 
<div class="col-md-12 col-sm-12 col-xs-12"> 
...
<?php ActiveForm::end(); ?>
  ...
  <p align ="right">
                ...
                <?= Html::a('Seterusnya', ['maklumat-peribadi-separuh-masa','id'=>$iklan->id], ['class' => 'btn btn-info btn-sm']);?>
