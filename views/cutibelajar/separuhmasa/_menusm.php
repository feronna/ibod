...
<div class="sticky">
    <div class="form_wizard wizard_horizontal">
        <ul class="wizard_steps">
             ...
             <li><br /> <br /> 
                <a href="<?= Url::toRoute(['cbelajar/gambar-separuh-masa', 'id' => $id])?>">  
            ...
            <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['cbelajar/maklumat-peribadi-separuh-masa', 'id' => $id])?>">  
            ...
            <li> <br /> <br /> 
                    <a href="<?= Url::toRoute(['cbelajar/maklumat-akademik-separuh-masa','id' => $id])?>">  
            ...
            <li> <br/> <br /> 
                    <a href="<?= Url::toRoute(['cbelajar/maklumat-pengajian-separuh-masa', 'id' => $id])?>">  
            ...
            <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['cbelajar/maklumat-biasiswa-separuh-masa', 'id' => $id])?>">  
            ...
            <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['cbelajar/maklumat-keluarga-separuh-masa', 'id' => $id])?>">  
            ...
            <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['cbelajar/senarai-dokumen-separuh-masa', 'id' => $id])?>">  
             ...
             <li><br /> <br /> 
                    <a href="<?= Url::toRoute(['cutibelajar/pengakuan-pemohon-sm', 'id' => $id])?>">  
