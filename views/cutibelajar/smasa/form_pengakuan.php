...
?> 
<?php
$umum = app\models\cbelajar\RefSemakan::find()->where(['id'=>[22,23,26,33,29,24,30]])->all();
?>
<style>
...
<div class="x_panel">
      ...
      PERMOHONAN DOKTOR FALSAFAH (PHD) SEPARUH MASA
 '); ?>
                    </strong> </h5>
            </span> 
        </div>
...
<div class="x_panel">
            ...
            <legend class="scheduler-border">  
                ...
                SEMAKAN SYARAT PHD SEPARUH MASA</h5></legend> 
...
//                             }
                            ...
                            ?>
                                ...
                                <tr class="headings">
                    <th scope="col" colspan=12"  style="background-color:white;color:black;">SYARAT KHUSUS KELAYAKAN PERMOHONAN:</th>
...
KELAYAKAN PEMOHON BERDASARKAN SYARAT PERMOHONAN</h5></legend>  
<div class="table-responsive">
...
<!--                            <tr>   
                             ...
                             <tr>   
                                    ...
                                    <td colspan="2"><?= '<b>' . $biodata->markahlnptCVpen(1, 'Tahun') . ' :</b> ' . $biodata->markahlnptCVpen(1, 'Markah'); ?></td> 
                                </tr>
                                <tr>   
                                    <td colspan="2"><?= '<b>' . $biodata->markahlnptCVpen(2, 'Tahun') . ' :</b> ' . $biodata->markahlnptCVpen(2, 'Markah'); ?></td>  
                                </tr>
                                <tr>
                                    <td colspan="2"><?= '<b>' . $biodata->markahlnptCVpen(3, 'Tahun') . ' :</b> ' . $biodata->markahlnptCVpen(3, 'Markah'); ?></td> 
                                </tr> 
                                <tr>
                                    <td colspan="2">   
                                        <?php if (!empty($biodata->markahlnptCVpen(3, 'Tahun'))) { ?>
                                            Avg (3 Tahun) : 
                                            <?php
                                            $lnpt = number_format(($biodata->markahlnptCVpen(3, 'Markah') * 0.2) + ($biodata->markahlnptCVpen(2, 'Markah') * 0.35) + ($biodata->markahlnptCVpen(1, 'Markah') * 0.45), 2, '.', '');
                                            echo $lnpt;
                                        } else {
                                            ?> 
                                            Avg (2 Tahun) : 
                                            <?php
                                            $lnpt = number_format(($biodata->markahlnptCVpen(2, 'Markah') * 0.6) + ($biodata->markahlnptCVpen(1, 'Markah') * 0.4), 2, '.', '');
                                            echo $lnpt;
                                        }
                                        ?>
                                    </td> 
                            ...
                            foreach ($umum as $p) {
                                ...
                                <tr>      
                                    ...
                                    <?php  if ($p->id == 22) {
                                            ...
                                            if ($biodata->usercv->tatatertib_status == $p->ans_no) {
                                                $s = 1;
                                                $totalUmum++;
                                            } else {
                                                $s = 0;
                                          ...
                                          elseif ($p->id == 29) {
                                            if ( date("Y") - date("Y", strtotime($biodata->COBirthDt)) <= $p->ans_no) {
                                                $s = 1;
                                                $totalUmum++;
                                            } else {
                                                $s = 0;
                                         ...
                                         elseif ($p->id == 24) {
                                            if ($biodata->getServPeriod(99, 'Kriteria') >= $p->ans_no) {
                                                $s = 1;
                                                $totalUmum++;
                                            } else {
                                                $s = 0;
                                         ...
                                         elseif ($p->id == 30) {
                                            if ($biodata->HighestEduLevelCd == $p->ans_no) {
                                                $s = 1;
                                                $totalUmum++;
                                            } else {
                                                $s = 0;
...
<div class="x_panel">
            ...
            <legend class="scheduler-border">   <h5><i class='fa fa-users'></i> MAKLUMAT KELUARGA</h5>
             ...
             <?= Html::a('Kemaskini', ['keluarga/view'], ['class' => 'btn btn-primary btn-sm', 'target'=>'_blank']) ?>
<div class="table-responsive">
