...
<?php 
                echo Html::a('<i class="fa far fa-hand-point-up"></i> Cetak Borang', ['cetak-borang', 'id'=>$model->id,
                    ...
                    'target'=>'_self', 
                    'data-toggle'=>'tooltip', 
                    'title'=>'Permohonan Baharu Pengajian Lanjutan - PHD Separuh Masa'
                ]);
                ?>
...
<div class="col-xs-12 col-md-12 col-lg-12">
        ...
        <div class="x_panel">
            <fieldset class="scheduler-border">
            <legend class="scheduler-border">   <h5><i class='fa fa-money'></i> MAKLUMAT PEMBIAYAAN/PENAJAAN YANG DIPOHON</h5>
            </legend>  
              <?php 
