...
<!--            <span class="required" style="color:black;">
    ...
    <u> PERMOHONAN PENGAJIAN LANJUTAN KAKITANGAN AKADEMIK
 '); ?>
                </strong> </center></h2>
            </span> -->
        </div>
...
<div class="x_panel">
        ...
        <?= strtoupper('
     UNIT PEMBANGUNAN PROFESIONALISME | SEKTOR PEMBANGUNAN SUMBER MANUSIA<br/><u> PERMOHONAN PENGAJIAN LANJUTAN AKADEMIK
        '); ?>
