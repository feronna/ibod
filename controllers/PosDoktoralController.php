...
class PosDoktoralController extends \yii\web\Controller
{
...
//        var_dump('a');die;
       if ($model->load(Yii::$app->request->post())) {
        ...
        return $this->renderAjax('/cutibelajar/posdok/form_gambar', [
                    'model' => $model,
                    'id' => $id, 'iklan'=>$iklan
        ]);
    }
   public function actionAdminview($ICNO,$id, $takwim_id) {
        ...
        return $this->render('/cutibelajar/posdok/_lihatpermohonan', [
    ...
    public function actionPaView($ICNO,$id, $takwim_id) {
        $model = $this->findModel($id);
        $pengajian = TblPengajian::find()->where(['idPermohonan'=>$id,'icno'=> $ICNO, 'iklan_id' => $takwim_id])->all();
        $biasiswa = TblBiasiswa::find()->where(['idBorang'=>42,'icno'=> $ICNO,'iklan_id'  => $takwim_id])->all();
        $dokumen = TblFilePemohon::find()->where(['uploaded_by'=> $ICNO, 'iklan_id'  => $takwim_id])->all();
        $senarai_dokumen = $this->findDokumen(1);
        $biodata = $this->findMaklumat($ICNO);
        $statuss = $this->findPerkhidmatanbyICNO();
...
//            'lapordiri' => $lapordiri,
    ...
    public function actionGambar($id) {
        ...
        return $this->render('/cutibelajar/posdok/form_gambar', [
                    'model' => $model,
                    'iklan' => $iklan,
    ...
    public function actionMaklumatPeribadi($id)
    {
        ...
        return $this->render('/cutibelajar/posdok/form_peribadi', 
            [ 
    ...
    public function actionSemakanSyarat($id, $ICNO, $takwim_id) {
        ...
        $senarai_dokumen = $this->findDokumen(1);
        $doktoral = RefSemakan::find()->where(['cb' => "pasca"])->all();
//        $doktoral = \app\models\cbelajar\RefDoktoral::find()->all();
 ...
 $senarai_dokumenkpm = $this->findDokumenKpm(1);
        ...
        return $this->render('/cutibelajar/posdok/semakan_syarat', [
                    'kontrak' => $kontrak,
                    'doktoral' => $doktoral,
                    'message' => $message,
                    'icno' => $kontrak->icno,
...
//            $model->app_by = $i;
        ...
        return $this->renderAjax('/cutibelajar/posdok/update-ulasan', [
                    'model' => $model,
...
//        var_dump($model);die;
        ...
        return $this->renderAjax('/cutibelajar/posdok/_updatess', [
                    'model' => $model,
...
public function actionTindakanKj($ICNO,$id, $takwim_id) {
        ...
        return $this->render('/cutibelajar/posdok/semak_maklumat', [
...
//     
    ...
    public function actionMaklumatAkademik($id)
    {
        ...
        return $this->render('/cutibelajar/posdok/form_akademik', 
        [ 
    ...
    public function actionMaklumatPengajian($id) {
        ...
        return $this->render('/cutibelajar/posdok/form_pengajian', 
        [
                    'model' => $model,
                    'iklan' => $iklan,
...
//        $permohonan = $this->findPermohonanbyID($id);
        ...
        return $this->renderAjax('/cutibelajar/posdok/_formpengajian', [
                    'model' => $model,
                    'iklan' => $iklan,
        ]);
    }
...
//                              $modelAddress->idBorang = 1;
        ...
        return $this->render('/cutibelajar/posdok/_tajaanluarsm', [
            'model' => $model,
...
//            
//        }
        return $this->render('/cutibelajar/posdok/_kpt', [
//            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
...
//            'iklan' => $this->findIklanbyID($model->iklan_id),
   ...
   public function actionMaklumatBiasiswa($id)
    {   $request = Yii::$app->request;
        ...
        return $this->render('/cutibelajar/posdok/form_biasiswa', [
                    'model' => $model,
                    'iklan' => $iklan,
                    'sponsor'=> $sponsor,
                    'searchModel' => $searchModel,
    ...
    public function actionMaklumatKeluarga($id)
    {
        ...
        $model = new TblPermohonan();
        $model->icno = $icno;
        return $this->render('/cutibelajar/posdok/form_keluarga', 
            [ 
    ...
    public function actionTambahBiasiswa($id) {
        ...
        return $this->render('/cutibelajar/posdok/_formbiasiswa', [
            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
            'modelCustomer' => $modelCustomer,
    ...
    public function actionSenaraiDokumenDimuatnaik($id)
    {
        ...
        return $this->render('/cutibelajar/posdok/form_dokumen', 
            [ 
    ...
    public function actionSenaraiDokumen($id)
    {
        ...
        $senarai_dokumenln = $this->findDokumenLn(1);
        $iklan = $this->findIklanbyID($id);
        return $this->render('/cutibelajar/posdok/form_upload_dokumen', 
        [
            'senarai_dokumen' => $senarai_dokumen,
            'senarai_dokumenkpm' => $senarai_dokumenkpm,
            'senarai_dokumenln' => $senarai_dokumenln,
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/posdok/update-dokumen-ln', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/posdok/update-dokumen-kpm', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/posdok/update-dokumen', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//    }
     public function findDokumen($status) 
    {
        $senarai_dokumen = new ActiveDataProvider([
            'query' => \app\models\cbelajar\TblDokumen::find()->where(['status' => $status,'kategori'=>11]),
...
//            $model->tarikh_mohon = NULL;
    ...
    public function actionPengakuanPemohon($id) {
        $icno = Yii::$app->user->getId();
        $pengajian = TblPengajian::find()->where(['icno' => $this->ICNO(), 'iklan_id' => $id, 'idBorang' => 42, 'status' => [1, 9]])->all();
        $biasiswa = TblBiasiswa::findAll(['icno' => $this->ICNO(), 'iklan_id' => $id, 'idBorang' => 42]);
        $status = TblPermohonan::findAll(['icno' => $icno]); //senarai status permohonan
        $model = TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 42])->one() ? TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 42])->one() : new TblPermohonan();
        $pengajian2 = TblPengajian::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 42, 'status' => [1, 9]])->one() ? TblPengajian::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 42, 'status' => [1, 9]])->one() : new TblPengajian();
        $sponsor2 = TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 42])->all() ?
                TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 42])->all() :
                new TblBiasiswa();
        $ums = TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 42, 'jenisCd' => 2])->all() ?
                TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 42, 'jenisCd' => 2])->all() :
                new TblBiasiswa();
        $sokongan = \app\models\cbelajar\TblFilePemohon::find()->where(['uploaded_by' => $this->ICNO(),
                    'iklan_id' => $id, 'idBorang' => 42])->all();
//        $doktoral = \app\models\cbelajar\TblDokumen::find()->WHERE(['kategori' => 7])->all();
        $senarai_dokumen = $this->findDokumen(1);
        $senarai_dokumenkpm = $this->findDokumenKpm(1);
        $senarai_dokumenln = $this->findDokumenLn(2);

        $dok = $this->findWajib(109);
          $doktoral = \app\models\cbelajar\TblDokumen::find()->WHERE(['kategori' => 7])->all();
        $wajib = TblFilePemohon::find()->where(['uploaded_by' => $icno, 'iklan_id' => $id, 'idBorang' => 42]);
        $check = TblpImage::findOne(['ICNO' => $this->ICNO(), 'iklan_id' => $id]);
...
//                        }
        ...
        if (TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' =>42, 'status_proses' => "Selesai Permohonan"])->exists()) {
        ...
        if (($model->kakitangan->statLantikan == "1" && $model->kakitangan->jawatan->job_category == "1")){
            return $this->render(
                            '/cutibelajar/posdok/form_pengakuan', [
                        'iklan' => $iklan,
                        'model' => $model,
                        'img' => $biodata->img,
                        'biodata' => $biodata,
            ...
            Yii::$app->session->setFlash('alert', ['title' => 'Harap Maaf', 'type' => 'error', 'msg' => 'Permohonan ini hanya untuk lantikan TETAP sahaja']);
...
//        var_dump('a');die;
        ...
        return $this->renderAjax('/cutibelajar/posdok/_updates', [
            'model' => $model,
    ...
    public function actionLihatPermohonan($id) {
        ...
        $icno = Yii::$app->user->getId();
        $model->icno = $icno;
        $model2 = TblPermohonan::find()->where(['icno' => $icno, 'idBorang' => 42])->one();
        $model3 = TblPermohonan::find()->where(['icno' => $icno, 'idBorang' => 42])->one(); //senarai status permohonan
        //senarai status permohonan
        $biodata = $this->findBiodata();
        $pengajian = TblPengajian::find()->where(['icno' => $icno, 'idPermohonan' => $id, 'idBorang' => 42])->all();
        $biasiswa = TblBiasiswa::find()->where(['icno' => $icno, 'idBorang' => 42])->all();
        $dokumen = TblFilePemohon::find()->where(['uploaded_by' => $icno, 'idBorang' => 42])->all();
                $semak = RefSemakan::find()->where(['cb'=>"pasca"])->all();
 $senarai_dokumen = $this->findDokumen(1);
        $senarai_dokumenkpm = $this->findDokumenKpm(1);
        $senarai_dokumenln = $this->findDokumenLn(2);
        ...
        if (($model->kakitangan->statLantikan == "1" && $model->kakitangan->jawatan->job_category == "1") ) {
            if (TblPermohonan::find()->where(['icno' => $icno, 'id' => $id, 'status_proses' => "Selesai Permohonan"])->exists()) {
                return $this->render(
                                '/cutibelajar/posdok/lihatpermohonan', [
                            //              'iklan' => $iklan,
                            'model' => $model,
                            'img' => $biodata->img,
                            'biodata' => $biodata,
...
//                              $modelAddress->idBorang = 1;
        ...
        return $this->render('/cutibelajar/posdok/_biasiswaums', [
            'model' => $model,
            'modelsAddress' => (empty($modelsAddress)) ? [new TblBiasiswa] : $modelsAddress,
            'iklan' => $iklan,
    ...
    public function actionTanpatajaan($id) {
        ...
        return $this->render('/cutibelajar/posdok/_tanpatajaan', [
            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
