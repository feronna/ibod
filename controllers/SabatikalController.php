...
class SabatikalController extends \yii\web\Controller
{
             ...
             'access' => [
                ...
                'only' => ['senarai-borang','gambar', 'maklumat-peribadi', 'maklumat-akademik','maklumat-pengajian',
                           ...
                           'pengakuan-pemohon', 'tambah-pengajian', 'tambah-biasiswa',
                            ...
                            'muat-naik-dokumen','senaraitindakan','biasiswaums',
                    ],
                'rules' => [
...
//        $biasiswa = TblBiasiswa::findAll(['idPermohonan'=>$id,'icno'=> $ICNO,'iklan_id'  => $takwim_id]);
        $biasiswa = TblBiasiswa::find()->where(['icno'=>$ICNO, 'idBorang'=>2])->all();
        ...
        $icno = Yii::$app->user->getId();
        $semak = RefSemakan::find()->where(['cb'=>"sabatikal"])->all();
        ...
        return $this->render('/cutibelajar/sabatikal/_lihatpermohonan', [
  ...
  public function actionPaView($ICNO,$id, $takwim_id) {
        $model = $this->findModel($id);
        $pengajian = TblPengajian::find()->where(['idPermohonan'=>$id,'icno'=> $ICNO, 'iklan_id' => $takwim_id])->all();
        $biasiswa = TblBiasiswa::find()->where(['idBorang'=>2,'icno'=> $ICNO,'iklan_id'  => $takwim_id])->all();
        $dokumen = TblFilePemohon::find()->where(['uploaded_by'=> $ICNO, 'iklan_id'  => $takwim_id])->all();
        $senarai_dokumen = $this->findDokumen(1);
        $biodata = $this->findMaklumat($ICNO);
        $statuss = $this->findPerkhidmatanbyICNO();
...
//          $biasiswa = TblBiasiswa::findAll(['idPermohonan'=>$id,'icno'=> $ICNO,'iklan_id'  => $takwim_id]);
$biasiswa = TblBiasiswa::find()->where(['icno'=>$ICNO,'idBorang'=>2])->all();
          $dokumen = TblFilePemohon::findAll(['uploaded_by'=> $ICNO, 'iklan_id'  => $takwim_id,'kategori'=>9]);

             $content = $this->renderPartial('/cutibelajar/sabatikal/cetak-borang', [ 'model' => $model,
              'biodata' => $biodata,
              'keluarga' => $biodata->keluarga,
              'biasiswa' => $biasiswa,
              'akademik' => $biodata->akademik,
...
//            'lapordiri' => $lapordiri,
    ...
    public function actionGambar($id) {
        ...
        return $this->render('/cutibelajar/sabatikal/form_gambar', [
                    'model' => $model,
                    'iklan' => $iklan,
    ...
    public function actionMaklumatPeribadi($id)
    {
        ...
        return $this->render('/cutibelajar/sabatikal/form_peribadi', 
            [ 
...
$senarai_dokumenkpm = $this->findDokumenKpm(1);
        ...
        return $this->render('/cutibelajar/sabatikal/semak_maklumat', [
...
//     
    ...
    public function actionMaklumatAkademik($id)
    {
        ...
        return $this->render('/cutibelajar/sabatikal/form_akademik', 
        [ 
    ...
    public function actionMaklumatPengajian($id) {
        ...
        $pengajianTinggi = TblPengajian::findAll(['icno' =>$this->ICNO(),'iklan_id' => $id, 'idBorang' => 2,'status'=>9]);
        $iklan = $this->findIklanbyID($id);
        $icno = Yii::$app->user->getId();
        $sabatikal2= $this->findSabatikal();
        ...
        return $this->render('/cutibelajar/sabatikal/form_pengajian', 
        [
                    'model' => $model,
                    'iklan' => $iklan,
...
//        $permohonan = $this->findPermohonanbyID($id);
        ...
        return $this->renderAjax('/cutibelajar/sabatikal/_formpengajian', [
                    'model' => $model,
                    'iklan' => $iklan,
        ]);
    }
...
//        var_dump('a');die;
       if ($model->load(Yii::$app->request->post())) {
        ...
        return $this->renderAjax('/cutibelajar/sabatikal/form_gambar', [
                    'model' => $model,
                    'id' => $id, 'iklan'=>$iklan
        ]);
    }
...
//    }
   ...
   public function actionMaklumatBiasiswa($id)
    {   $request = Yii::$app->request;
        $sponsor = TblBiasiswa::find()->where(['icno' =>$this->ICNO(),'iklan_id' => $id, 'idBorang'=>2])->all();
        $icno = Yii::$app->user->getId();
        $iklan = $this->findIklanbyID($id);
        ...
        return $this->render('/cutibelajar/sabatikal/form_biasiswa', [
                    'model' => $model,
                    'iklan' => $iklan,
                    'sponsor'=> $sponsor,
                    'searchModel' => $searchModel,
    ...
    public function actionMaklumatKeluarga($id)
    {
        ...
        $model = new TblPermohonan();
        $model->icno = $icno;
        return $this->render('/cutibelajar/sabatikal/form_keluarga', 
            [ 
    ...
    public function actionTambahBiasiswa($id) {
        ...
        return $this->render('/cutibelajar/sabatikal/_formbiasiswa', [
            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
    ...
    public function actionSenaraiDokumenDimuatnaik($id)
    {
        ...
        return $this->render('/cutibelajar/sabatikal/form_dokumen', 
            [ 
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/sabatikal/update-dokumen-ln', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/sabatikal/update-dokumen-kpm', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//                              $modelAddress->idBorang = 1;
        ...
        return $this->render('/cutibelajar/sabatikal/_tajaanluarsm', [
            'model' => $model,
...
//            
//        }
        return $this->render('/cutibelajar/sabatikal/_kpt', [
//            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
            'modelCustomer' => $modelCustomer,
   ...
   public function actionSenaraiDokumen($id)
    {
        ...
        $senarai_dokumenln = $this->findDokumenLn(2);
        $iklan = $this->findIklanbyID($id);
        return $this->render('/cutibelajar/sabatikal/form_upload_dokumen', 
        [
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/sabatikal/update-dokumen', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//            ]);
     ...
     public function findDokumen($status) 
    {
        $senarai_dokumen = new ActiveDataProvider([
            'query' => \app\models\cbelajar\TblDokumen::find()->where(['status' => $status,'kategori'=>9]),
...
//            $model->tarikh_mohon = NULL;
    ...
    protected function findAkademik() {
     ...
     public function actionPengakuanPemohon($id) {
        $icno = Yii::$app->user->getId();
        $pengajian = TblPengajian::find()->where(['icno' => $this->ICNO(), 'iklan_id' => $id, 'idBorang' => 2, 'status' => [1, 9]])->all();
        ...
        $pengajian2 = TblPengajian::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 2, 'status' => [1, 9]])->one() ? TblPengajian::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 2, 'status' => [1, 9]])->one() : new TblPengajian();
        $sponsor2 = TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 2])->all() ?
                TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 2])->all() :
                new TblBiasiswa();
        $ums = TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 2, 'jenisCd' => 2])->all() ?
                TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 2, 'jenisCd' => 2])->all() :
                new TblBiasiswa();
        $sokongan = \app\models\cbelajar\TblFilePemohon::find()->where(['uploaded_by' => $this->ICNO(),
                    'iklan_id' => $id, 'idBorang' => 2])->all();
//        $doktoral = \app\models\cbelajar\TblDokumen::find()->WHERE(['kategori' => 7])->all();
        $senarai_dokumen = $this->findDokumen(1);
        $senarai_dokumenkpm = $this->findDokumenKpm(1);
        $senarai_dokumenln = $this->findDokumenLn(2);
        $dok = $this->findWajib(88);
          $doktoral = \app\models\cbelajar\TblDokumen::find()->WHERE(['kategori' => 1])->all();
        $wajib = TblFilePemohon::find()->where(['uploaded_by' => $icno, 'iklan_id' => $id, 'idBorang' => 2]);
        $check = TblpImage::findOne(['ICNO' => $this->ICNO(), 'iklan_id' => $id]);
        $checkb = TblBiasiswa::find()->where(['icno' => $this->ICNO(), 'iklan_id' => $id,'idBorang'=> 2])->one();
         $checkp = TblPengajian::find()->where(['icno' => $this->ICNO(), 'iklan_id' => $id,'idBorang'=> 2])->one();
...
//                        }
                    ...
                    Yii::$app->session->setFlash('alert', ['title' => 'Maaf,', 'type' => 'error', 'msg' => ''
                        . 'Sila isi maklumat sabatikal anda.']);
                    return $this->redirect(['pengakuan-pemohon?id=' . $id]);
                }
            } else {
                Yii::$app->session->setFlash('alert', ['title' => 'Maaf,', 'type' => 'error', 'msg' => ''
        ...
        if (TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 2, 'status_proses' => "Selesai Permohonan"])->exists()) {
            ...
            return $this->render(
                            '/cutibelajar/sabatikal/form_pengakuan', [
                        'iklan' => $iklan,
                        'model' => $model,
                        'img' => $biodata->img,
                        'biodata' => $biodata,
    ...
    public function actionSemakanSyarat($id, $ICNO, $takwim_id) {
        ...
        $message = '';
        $pengajian = TblPengajian::find()->where(['idPermohonan' => $id])->all();
        $akad = Tblpendidikan::find()->where(['ICNO' => $ICNO, 'HighestEduLevelCd' => 1])->one();
        $senarai_dokumen = $this->findDokumen(1);
        $doktoral = RefSemakan::find()->where(['cb' => "sabatikal"])->all();
//        $doktoral = \app\models\cbelajar\RefDoktoral::find()->all();
 ...
 $senarai_dokumenkpm = $this->findDokumenKpm(1);
        ...
        return $this->render('/cutibelajar/sabatikal/semakan_syarat', [
                    'kontrak' => $kontrak,
                    'doktoral' => $doktoral,
                    'message' => $message,
                    'icno' => $kontrak->icno,
...
//            $mod->catatan_phd = Yii::$app->request->post($kpi->syarat_id . 'catatan_phd');
     ...
     public function actionViewSyarat($id, $ICNO,$takwim_id) {
        ...
        $kriteriakpi = RefSemakan::find()->where(['cb'=>"sabatikal"])->all();
        $pengajian = TblPengajian::find()->where(['idPermohonan' => $id])->all();
        $studi = TblPengajian::find()->where(['icno'=>$ICNO, 'status'=>9])->one();
        $senarai_dokumen = $this->findDokumen(1);
        $kontrak = $this->findModel($id);
...
//        var_dump($model);die;
        ...
        return $this->renderAjax('/cutibelajar/sabatikal/_updatess', [
                    'model' => $model,
...
//        var_dump('a');die;
        ...
        return $this->renderAjax('/cutibelajar/sabatikal/_updates', [
            'model' => $model,
...
//        }
     ...
     public function actionGenerateSemakanSyarat($id, $ICNO) {
        ...
        $pdf = new Pdf([
            ...
            'destination' => Pdf::DEST_BROWSER,
            'content' => $this->renderPartial('/cutibelajar/sabatikal/_laporansemakan', [
   ...
   public function actionLihatPermohonan($id) {
        ...
        $model3 = TblPermohonan::find()->where(['icno' => $icno, 'idBorang' => 2])->one(); //senarai status permohonan
        //senarai status permohonan
        $biodata = $this->findBiodata();
        $pengajian = TblPengajian::findAll(['icno' => $icno, 'idPermohonan' => $id, 'idBorang' => 2]);
        $biasiswa = TblBiasiswa::find()->where(['icno' => $icno, 'idBorang' => 2])->all();
        $dokumen = TblFilePemohon::find()->where(['uploaded_by' => $icno, 'idBorang' => 2])->all();
 ...
 $senarai_dokumen = $this->findDokumen(1);
        ...
        $iklan = $this->findIklanbyID($p);
            if (TblPermohonan::find()->where(['icno' => $icno, 'id' => $id, 'status_proses' => "Selesai Permohonan"])->exists()) {
                return $this->render(
                                '/cutibelajar/sabatikal/lihatpermohonan', [
                            //              'iklan' => $iklan,
                            'model' => $model,
                            'img' => $biodata->img,
                            'biodata' => $biodata,
...
//                              $modelAddress->idBorang = 1;
        ...
        return $this->render('/cutibelajar/sabatikal/_biasiswaums', [
            'model' => $model,
            'modelsAddress' => (empty($modelsAddress)) ? [new TblBiasiswa] : $modelsAddress,
            'iklan' => $iklan,
    ...
    public function actionTanpatajaan($id) {
        ...
        return $this->render('/cutibelajar/sabatikal/_tanpatajaan', [
            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
