...
class SangkutanController extends \yii\web\Controller
{
...
//        var_dump('a');die;
       if ($model->load(Yii::$app->request->post())) {
        ...
        return $this->renderAjax('/cutibelajar/sangkutan/form_gambar', [
                    'model' => $model,
                    'id' => $id, 'iklan'=>$iklan
        ]);
    }
...
//          $pengajian = $this->findPengajian($ICNO);
                    ...
                    $semak = RefSemakan::find()->where(['cb'=>"sangkutan"])->all();

          $model = TblPermohonan::find()->where(['id'=>$id, 'status_proses' => ["Selesai Permohonan","Buka Borang"]])->one();
          $biasiswa = TblBiasiswa::find()->where(['idPermohonan'=>$id, 'idBorang'=>40])->all();
         ...
         return $this->render('/cutibelajar/sangkutan/_lihatpermohonan',[ 
              'model' => $model,
              'biodata' => $biodata,
   ...
   public function actionPaView($ICNO,$id, $takwim_id) {
        ...
        $biasiswa = TblBiasiswa::find()->where(['idBorang'=>40,'icno'=> $ICNO,'iklan_id'  => $takwim_id])->all();
...
//$biasiswa = TblBiasiswa::find()->where(['icno'=>$ICNO])->all();
          ...
          $dokumen3 = \app\models\cbelajar\TblFileLn::findAll(['uploaded_by' =>$ICNO,'iklan_id' => $takwim_id]);
             ...
             $content = $this->renderPartial('/cutibelajar/sangkutan/cetak-borang', [ 'model' => $model,
              'biodata' => $biodata,
              'keluarga' => $biodata->keluarga,
              'biasiswa' => $biasiswa,
              'akademik' => $biodata->akademik,
            ...
            'options' => ['title' => 'Permohonan Cuti Belajar - Program Sangkutan'],
...
//                     'WriteHTML' => [$css, 1]
    ...
    public function actionGambar($id) {
        ...
        return $this->render('/cutibelajar/sangkutan/form_gambar', [
                    'model' => $model,
                    'iklan' => $iklan,
    ...
    public function actionMaklumatPeribadi($id)
    {
        ...
        return $this->render('/cutibelajar/sangkutan/form_peribadi', 
            [ 
...
//        $doktoral = \app\models\cbelajar\RefDoktoral::find()->all();
        ...
        return $this->render('/cutibelajar/sangkutan/semakan_syarat', [
                    'kontrak' => $kontrak,
                    'semak' => $semak,
                    'message' => $message,
                    'icno' => $kontrak->icno,
...
//            $mod->catatan_phd = Yii::$app->request->post($kpi->syarat_id . 'catatan_phd');
     ...
     public function actionViewSyarat($id, $ICNO,$takwim_id) {
        ...
        $doktoral = RefSemakan::find()->where(['cb'=>"sangkutan"])->all();
        $pengajian = TblPengajian::find()->where(['idPermohonan' => $id])->all();
        $studi = TblPengajian::find()->where(['icno'=>$ICNO, 'status'=>9])->one();
        $senarai_dokumen = $this->findDokumen(1);
        $kontrak = $this->findModel($id);
...
//            $model->app_by = $i;
        ...
        return $this->renderAjax('/cutibelajar/sangkutan/update-ulasan', [
                    'model' => $model,
...
//        var_dump($model);die;
        ...
        return $this->renderAjax('/cutibelajar/sangkutan/_updatess', [
                    'model' => $model,
    ...
    public function actionGenerateSemakanSyarat($id, $ICNO) {
        ...
        $pdf = new Pdf([
            ...
            'mode' => Pdf::MODE_BLANK, // leaner size using standard fonts
            'destination' => Pdf::DEST_BROWSER,
            'content' => $this->renderPartial('/cutibelajar/sangkutan/_laporansemakan', [
...
public function actionTindakanKj($ICNO,$id, $takwim_id) {
        ...
        return $this->render('/cutibelajar/sangkutan/semak_maklumat', [
...
//     
    ...
    public function actionMaklumatAkademik($id)
    {
        ...
        return $this->render('/cutibelajar/sangkutan/form_akademik', 
        [ 
    ...
    public function actionMaklumatPengajian($id) {
        ...
        $pengajianTinggi = TblPengajian::findAll(['icno' =>$this->ICNO(),'iklan_id' => $id, 'idBorang' => 40,'status'=>9]);
        $iklan = $this->findIklanbyID($id);
        $icno = Yii::$app->user->getId();
        $sabatikal2= $this->findSabatikal();
        ...
        return $this->render('/cutibelajar/sangkutan/form_pengajian', 
        [
                    'model' => $model,
                    'iklan' => $iklan,
...
//        $permohonan = $this->findPermohonanbyID($id);
        ...
        return $this->renderAjax('/cutibelajar/sangkutan/_formpengajian', [
                    'model' => $model,
                    'iklan' => $iklan,
        ]);
    }
...
//                              $modelAddress->idBorang = 1;
        ...
        return $this->render('/cutibelajar/sangkutan/_tajaanluarsm', [
            'model' => $model,
   ...
   public function actionMaklumatBiasiswa($id)
    {   $request = Yii::$app->request;
        $sponsor = TblBiasiswa::find()->where(['icno' =>$this->ICNO(),'iklan_id' => $id, 'idBorang'=>40])->all();
        $icno = Yii::$app->user->getId();
        $iklan = $this->findIklanbyID($id);
        ...
        return $this->render('/cutibelajar/sangkutan/form_biasiswa', [
                    'model' => $model,
                    'iklan' => $iklan,
                    'sponsor'=> $sponsor,
                    'searchModel' => $searchModel,
    ...
    public function actionMaklumatKeluarga($id)
    {
        ...
        $model = new TblPermohonan();
        $model->icno = $icno;
        return $this->render('/cutibelajar/sangkutan/form_keluarga', 
            [ 
    ...
    public function actionTambahBiasiswa($id) {
        ...
        return $this->render('/cutibelajar/sangkutan/_formbiasiswa', [
            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
    ...
    public function actionSenaraiDokumenDimuatnaik($id)
    {
        ...
        $dokumen2 = \app\models\cbelajar\TblFilePemohon::findAll(['uploaded_by' =>$this->ICNO(),'iklan_id' => $id, 'idBorang' => 40]);

        return $this->render('/cutibelajar/sangkutan/form_dokumen', 
            [ 
    ...
    public function actionSenaraiDokumen($id)
    {
        ...
        $senarai_dokumen = $this->findDokumen(1);
        $iklan = $this->findIklanbyID($id);
        return $this->render('/cutibelajar/sangkutan/form_upload_dokumen', 
        [
            'senarai_dokumen' => $senarai_dokumen,
            'iklan' => $iklan,
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/sangkutan/update-dokumen', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//            ]);
     ...
     public function findDokumen($status) 
    {
        $senarai_dokumen = new ActiveDataProvider([
            'query' => \app\models\cbelajar\TblDokumen::find()->where(['status' => $status,'kategori'=>7]),
...
//            $model->tarikh_mohon = NULL;
    ...
    public function actionPengakuanPemohon($id) {
        $icno = Yii::$app->user->getId();
        $pengajian = TblPengajian::find()->where(['icno' => $this->ICNO(), 'iklan_id' => $id, 'idBorang' => [40,47], 'status' => [1, 9]])->all();
        $biasiswa = TblBiasiswa::findAll(['icno' => $this->ICNO(), 'iklan_id' => $id, 'idBorang' => [40,47]]);
        $status = TblPermohonan::findAll(['icno' => $icno]); //senarai status permohonan
        $model = TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => [40,47]])->one() ? TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => [40,47]])->one() : new TblPermohonan();
        $pengajian2 = TblPengajian::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => [40,47], 'status' => [1, 9]])->one() ? TblPengajian::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => [40,47], 'status' => [1, 9]])->one() : new TblPengajian();
        $sponsor2 = TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => [40,47]])->all() ?
                TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => [40,47]])->all() :
                new TblBiasiswa();
        ...
        $sokongan = \app\models\cbelajar\TblFilePemohon::find()->where(['uploaded_by' => $this->ICNO(),
                    'iklan_id' => $id, 'idBorang' => [40,47]])->all();
//        $doktoral = \app\models\cbelajar\TblDokumen::find()->WHERE(['kategori' => 7])->all();
        $senarai_dokumen = $this->findDokumen(1);
        $dok = $this->findWajib(79);
          $doktoral = \app\models\cbelajar\TblDokumen::find()->WHERE(['kategori' => 7])->all();
        $wajib = TblFilePemohon::find()->where(['uploaded_by' => $icno, 'iklan_id' => $id, 'idBorang' => [40,47]]);
        $check = TblpImage::findOne(['ICNO' => $this->ICNO(), 'iklan_id' => $id]);
...
//                        }
        ...
        if (TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => [47,40], 'status_proses' => "Selesai Permohonan"])->exists()) {
            ...
            return $this->render(
                            '/cutibelajar/sangkutan/form_pengakuan', [
                        'iklan' => $iklan,
                        'model' => $model,
                        'img' => $biodata->img,
                        'biodata' => $biodata,
    ...
    public function actionPengakuanPemohon2($id) {
        $icno = Yii::$app->user->getId();
        $pengajian = TblPengajian::find()->where(['icno' => $this->ICNO(), 'iklan_id' => $id, 'idBorang' => 40, 'status' => [1, 9]])->all();
        $biasiswa = TblBiasiswa::findAll(['icno' => $this->ICNO(), 'iklan_id' => $id, 'idBorang' => 40]);
        $status = TblPermohonan::findAll(['icno' => $icno]); //senarai status permohonan
        $model = TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 40])->one() ? TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 40])->one() : new TblPermohonan();
        $pengajian2 = TblPengajian::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 40, 'status' => [1, 9]])->one() ? TblPengajian::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 40, 'status' => [1, 9]])->one() : new TblPengajian();
        $sponsor2 = TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 40, 'status' => [1, 9]])->one() ? TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 40, 'status' => [1, 9]])->one() : new TblBiasiswa();
        $ums = TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 40, 'jenisCd' => 2])->one() ? TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 40, 'jenisCd' => 2])->one() : new TblBiasiswa();
        $sokongan = \app\models\cbelajar\TblFilePemohon::find()->where(['uploaded_by' => $this->ICNO(), 'iklan_id' => $id, 'idBorang' => 38])->all();
        $doktoral = \app\models\cbelajar\TblDokumen::find()->WHERE(['kategori' => 8])->all();
        $senarai_dokumen = $this->findDokumen(1);
                $semak = RefSemakan::find()->where(['cb'=>"sangkutan"])->all();
        $model->icno = $icno;
        $model->tahun = date("Y");
        ...
        if (TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 40, 'status_proses' => "Selesai Permohonan"])->exists()) {
            Yii::$app->session->setFlash('alert', ['title' => 'Anda Telah Memohon!', 'type' => 'error', 'msg' => 'Permohonan hanya boleh dibuat sekali sahaja.']);
            return $this->redirect(['lihat-permohonan',  'id' => $model->id]); //
        }
...
//        var_dump('a');die;
        ...
        return $this->renderAjax('/cutibelajar/sangkutan/_updates', [
            'model' => $model,
    ...
    public function actionLihatPermohonan($id) {
        ...
        $icno = Yii::$app->user->getId();
        $model->icno = $icno;
        $model2 = TblPermohonan::find()->where(['icno' => $icno, 'idBorang' => 40])->one();
        $model3 = TblPermohonan::find()->where(['icno' => $icno, 'idBorang' => 40])->one(); //senarai status permohonan
        //senarai status permohonan
        $biodata = $this->findBiodata();
        $pengajian = TblPengajian::findAll(['icno' => $icno, 'idPermohonan' => $id, 'idBorang' => 40]);
        $biasiswa = TblBiasiswa::find()->where(['icno' => $icno, 'idBorang' => 40])->all();
        $dokumen = TblFilePemohon::find()->where(['uploaded_by' => $icno, 'idBorang' => 40])->all();
                $semak = RefSemakan::find()->where(['cb'=>"sangkutan"])->all();
$senarai_dokumen = $this->findDokumen(1);
    $p = $model2->iklan_id;
        ...
        if (($model->kakitangan->statLantikan == "1" && $model->kakitangan->jawatan->job_category == "2") || ($model->kakitangan->statLantikan == "1" && $model->kakitangan->jawatan->job_category == "1")) {
            if (TblPermohonan::find()->where(['icno' => $icno, 'id' => $id, 'status_proses' => "Selesai Permohonan"])->exists()) {
                return $this->render(
                                '/cutibelajar/sangkutan/lihatpermohonan_1', [
                            //              'iklan' => $iklan,
                            'model' => $model,
                            'img' => $biodata->img,
                            'biodata' => $biodata,
                            ...
                            'model3' => $model3,
                                    'semak'=>$semak,
                                    'models'=>$models,
                                                                      'senarai_dokumen' => $senarai_dokumen,'iklan'=>$iklan
...
//                              $modelAddress->idBorang = 1;
        ...
        return $this->render('/cutibelajar/sangkutan/_biasiswaums', [
            'model' => $model,
            'modelsAddress' => (empty($modelsAddress)) ? [new TblBiasiswa] : $modelsAddress,
            'iklan' => $iklan,
    ...
    public function actionTanpatajaan($id) {
        ...
        return $this->render('/cutibelajar/sangkutan/_tanpatajaan', [
            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
