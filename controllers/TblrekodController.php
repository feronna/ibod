...
use Yii;
use app\models\TblRekod;
use app\models\TblRekodSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * TblRekodController implements the CRUD actions for TblRekod model.
 */
class TblrekodController extends Controller
{
    /**
     * {@inheritdoc}
     */
