...
class PentadbiranController extends \yii\web\Controller
{
...
//          $pengajian = $this->findPengajian($ICNO);
          ...
          $biasiswa = TblBiasiswa::findAll(['idBorang'=>32,'icno'=> $ICNO,'iklan_id'  => $takwim_id]);
//$biasiswa = TblBiasiswa::find()->where(['icno'=>$ICNO])->all();
          ...
          $dokumen3 = \app\models\cbelajar\TblFileLn::findAll(['uploaded_by' =>$ICNO,'iklan_id' => $takwim_id]);
             ...
             $content = $this->renderPartial('/cutibelajar/pentadbiran/cetak-borang', [ 'model' => $model,
              'biodata' => $biodata,
...
//                     'WriteHTML' => [$css, 1]
  ...
  public function actionAdminview($ICNO,$id, $takwim_id) {
        ...
        $biasiswa = TblBiasiswa::find()->where(['idBorang'=>32,'icno'=> $ICNO,'iklan_id'  => $takwim_id])->all();
...
//        $biasiswa = TblBiasiswa::find()->where(['icno' => $icno, 'idBorang' => 43])->all();
 $semak = RefSemakan::find()->where(['cb'=>"admin",'jenis'=>"umum"])->all();
        ...
        return $this->render('/cutibelajar/pentadbiran/_lihatpermohonan', [
...
//            'lapordiri' => $lapordiri,
    ...
    public function actionGambar($id) {
        ...
        return $this->render('/cutibelajar/pentadbiran/form_gambar', [
                    'model' => $model,
                    'iklan' => $iklan,
    ...
    public function actionMaklumatPeribadi($id)
    {
        ...
        return $this->render('/cutibelajar/pentadbiran/form_peribadi', 
            [ 
...
//        $biasiswa = TblBiasiswa::find()->where(['icno' => $icno, 'idBorang' => 43])->all();
 $semak = RefSemakan::find()->where(['cb'=>"admin",'jenis'=>"umum"])->all();
        ...
        return $this->render('/cutibelajar/pentadbiran/semak_maklumat', [
...
//     
    ...
    public function actionMaklumatAkademik($id)
    {
        ...
        return $this->render('/cutibelajar/pentadbiran/form_akademik', 
        [ 
    ...
    public function actionMaklumatPengajian($id) {
        ...
        $pengajianTinggi = TblPengajian::findAll(['icno' =>$this->ICNO(),'iklan_id' => $id, 'idBorang' => 32,'status'=>9]);
        $iklan = $this->findIklanbyID($id);
        $icno = Yii::$app->user->getId();
        $sabatikal2= $this->findSabatikal();
        ...
        return $this->render('/cutibelajar/pentadbiran/form_pengajian', 
        [
                    'model' => $model,
                    'iklan' => $iklan,
...
//        $permohonan = $this->findPermohonanbyID($id);
        ...
        return $this->renderAjax('/cutibelajar/pentadbiran/_formpengajian', [
                    'model' => $model,
                    'iklan' => $iklan,
        ]);
    }
...
//        var_dump('a');die;
       if ($model->load(Yii::$app->request->post())) {
        ...
        return $this->renderAjax('/cutibelajar/pentadbiran/form_gambar', [
                    'model' => $model,
                    'id' => $id, 'iklan'=>$iklan
        ]);
    }
...
//            'iklan' => $this->findIklanbyID($model->iklan_id),
   ...
   public function actionMaklumatBiasiswa($id)
    {   $request = Yii::$app->request;
        ...
        return $this->render('/cutibelajar/pentadbiran/form_biasiswa', [
                    'model' => $model,
                    'iklan' => $iklan,
                    'sponsor'=> $sponsor,
                    'searchModel' => $searchModel,
    ...
    public function actionMaklumatKeluarga($id)
    {
        ...
        $model = new TblPermohonan();
        $model->icno = $icno;
        return $this->render('/cutibelajar/pentadbiran/form_keluarga', 
            [ 
    ...
    public function actionTambahBiasiswa($id) {
        ...
        return $this->render('/cutibelajar/pentadbiran/_formbiasiswa', [
            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
    ...
    public function actionSenaraiDokumenDimuatnaik($id)
    {
        ...
        $dokumen2 = \app\models\cbelajar\TblFilePemohon::findAll(['uploaded_by' =>$this->ICNO(),'iklan_id' => $id, 'idBorang' => 32]);

        return $this->render('/cutibelajar/pentadbiran/form_dokumen', 
            [ 
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/pentadbiran/update-dokumen-ln', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/pentadbiran/update-dokumen-kpm', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//                              $modelAddress->idBorang = 1;
        ...
        return $this->render('/cutibelajar/pentadbiran/_tajaanluarsm', [
            'model' => $model,
   ...
   public function actionSenaraiDokumen($id)
    {
        ...
        $senarai_dokumen = $this->findDokumen(1);
        $iklan = $this->findIklanbyID($id);
        return $this->render('/cutibelajar/pentadbiran/form_upload_dokumen', 
        [
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/pentadbiran/update-dokumen', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//            ]);
     ...
     public function findDokumen($status) 
    {
        $senarai_dokumen = new ActiveDataProvider([
            'query' => \app\models\cbelajar\TblDokumen::find()->where(['status' => $status,'kategori'=>2]),
...
//            $model->tarikh_mohon = NULL;
    ...
    protected function findAkademik() {
     ...
     public function actionPengakuanPemohon($id) {
        $icno = Yii::$app->user->getId();
        $pengajian = TblPengajian::find()->where(['icno' => $this->ICNO(), 'iklan_id' => $id, 'idBorang' => 32, 'status' => [1, 9]])->all();
        $biasiswa = TblBiasiswa::findAll(['icno' => $this->ICNO(), 'iklan_id' => $id, 'idBorang' => 32]);
        $status = TblPermohonan::findAll(['icno' => $icno]); //senarai status permohonan
        $model = TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 32])->one() ? TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 32])->one() : new TblPermohonan();
        $pengajian2 = TblPengajian::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 32, 'status' => [1, 9]])->one() ? TblPengajian::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 32, 'status' => [1, 9]])->one() : new TblPengajian();
        $sponsor2 = TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 32])->all() ?
                TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 32])->all() :
                new TblBiasiswa();
        $ums = TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 32, 'jenisCd' => 2])->all() ?
                TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 32, 'jenisCd' => 2])->all() :
                new TblBiasiswa();
        $sokongan = \app\models\cbelajar\TblFilePemohon::find()->where(['uploaded_by' => $this->ICNO(),
                    'iklan_id' => $id, 'idBorang' => 32])->all();
//        $doktoral = \app\models\cbelajar\TblDokumen::find()->WHERE(['kategori' => 7])->all();
        $senarai_dokumen = $this->findDokumen(1);
        $senarai_dokumenkpm = $this->findDokumenKpm(1);
        $senarai_dokumenln = $this->findDokumenLn(1);
        $dok = $this->findWajib(20);
          $doktoral = \app\models\cbelajar\TblDokumen::find()->WHERE(['kategori' => 1])->all();
        $wajib = TblFilePemohon::find()->where(['uploaded_by' => $icno, 'iklan_id' => $id, 'idBorang' => 32]);
        $check = TblpImage::findOne(['ICNO' => $this->ICNO(), 'iklan_id' => $id]);
        $checkb = TblBiasiswa::find()->where(['icno' => $this->ICNO(), 'iklan_id' => $id,'idBorang'=> 32])->one();
                        $semak = RefSemakan::find()->where(['cb'=>"admin",'jenis'=>"umum"])->all();
        $khusus = \app\models\cbelajar\RefSemakan::find()->where(['cb'=>"admin",'jenis'=>'khusus'])->all();
        $khusus_ln = \app\models\cbelajar\RefSemakan::find()->where(['cb'=>"admin",'jenis'=>'khusus_ln'])->all();
...
//                        }
        ...
        if (TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 32, 'status_proses' => "Selesai Permohonan"])->exists()) {
        ...
        if (($model->kakitangan->statLantikan == "1" && $model->kakitangan->jawatan->job_category == "2") || ($model->kakitangan->statLantikan == "3" && $model->kakitangan->jawatan->job_category == "2")) {
            ...
            return $this->render(
                            '/cutibelajar/pentadbiran/form_pengakuan', [
                        'iklan' => $iklan,
                        'model' => $model,
                        'img' => $biodata->img,
                        'biodata' => $biodata,
                        ...
                        'icno' => $icno,'semak'=>$semak,
                                ...
                                'senarai_dokumenln' => $senarai_dokumenln, 'khusus'=>$khusus,'khusus_ln'=>$khusus_ln
                            ]
            );
  ...
  $semak = RefSemakan::find()->where(['cb'=>"admin",'jenis'=>"umum"])->all();
        ...
        return $this->render('/cutibelajar/pentadbiran/semakan_syarat', [
                    'kontrak' => $kontrak,
                    'message' => $message,
                    'icno' => $kontrak->icno,
                    'edit' => $edit,
            ...
            'studi'=>$studi,'ICNO'=>$ICNO,'biasiswa'=>$biasiswa,'semak' => $semak,'khusus'=>$khusus,'khusus_ln'=>$khusus_ln
        ]);
    }
...
//            $mod->catatan_phd = Yii::$app->request->post($kpi->syarat_id . 'catatan_phd');
     ...
     public function actionViewSyarat($id, $ICNO,$takwim_id) {
        ...
        return $this->render(
                        '/cutibelajar/pentadbiran/_syarat', [
                    'icno' => $kontrak->icno,
                    'id' => $kontrak->id,
                    'edit' => $edit,
                    'view' => $view,
 ...
 'senarai_dokumen' => $senarai_dokumen,'semak' => $semak,'khusus'=>$khusus,'khusus_ln'=>$khusus_ln   ,'senarai_dokumenkpm'=>$senarai_dokumenkpm,'senarai_dokumenln'=>$senarai_dokumenln         ]
        );
    }
...
//        var_dump($model);die;
        ...
        return $this->renderAjax('/cutibelajar/pentadbiran/_updatess', [
                    'model' => $model,
...
//        var_dump('a');die;
        ...
        return $this->renderAjax('/cutibelajar/pentadbiran/_updates', [
            'model' => $model,
 ...
 $semak = RefSemakan::find()->where(['cb'=>"admin",'jenis'=>"umum"])->all();
        $khusus = \app\models\cbelajar\RefSemakan::find()->where(['cb'=>"sepenuh",'jenis'=>'khusus'])->all();
        $khusus_ln = \app\models\cbelajar\RefSemakan::find()->where(['cb'=>"sepenuh",'jenis'=>'khusus_ln'])->all();        $senarai_dokumen = $this->findDokumen(1);
...
//        }
     ...
     public function actionGenerateSemakanSyarat($id, $ICNO) {
        ...
        $biodata = $this->findMaklumat($ICNO);
        $kriteriakpi = RefSemakan::find()->where(['cb'=>'admin'])->all();
        ...
        $pdf = new Pdf([
            ...
            'mode' => Pdf::MODE_BLANK, // leaner size using standard fonts
            'destination' => Pdf::DEST_BROWSER,
            'content' => $this->renderPartial('/cutibelajar/pentadbiran/_laporansemakan', [
   ...
   public function actionLihatPermohonan($id) {
        ...
        $icno = Yii::$app->user->getId();
        $model->icno = $icno;
        $model2 = TblPermohonan::find()->where(['icno' => $icno, 'idBorang' => 32])->one();
        $model3 = TblPermohonan::find()->where(['icno' => $icno, 'idBorang' => 32])->one(); //senarai status permohonan
        //senarai status permohonan
        $biodata = $this->findBiodata();
                $model4 = $this->findModel($id);

        $pengajian = TblPengajian::findAll(['icno' => $icno, 'idPermohonan' => $id, 'idBorang' => 32]);
        $biasiswa = TblBiasiswa::find()->where(['icno' => $icno, 'idBorang' => 32])->all();
        $dokumen = TblFilePemohon::find()->where(['uploaded_by' => $icno, 'idBorang' => 32])->all();
       $semak = RefSemakan::find()->where(['cb'=>"admin",'jenis'=>"umum"])->all();
        $khusus = \app\models\cbelajar\RefSemakan::find()->where(['cb'=>"sepenuh",'jenis'=>'khusus'])->all();
        $khusus_ln = \app\models\cbelajar\RefSemakan::find()->where(['cb'=>"sepenuh",'jenis'=>'khusus_ln'])->all(); $senarai_dokumen = $this->findDokumen(1);
        $senarai_dokumenkpm = $this->findDokumenKpm(1);
        ...
        if (($model->kakitangan->statLantikan == "1" && $model->kakitangan->jawatan->job_category == "2") ) {
            if (TblPermohonan::find()->where(['icno' => $icno, 'id' => $id, 'status_proses' => "Selesai Permohonan"])->exists()) {
                return $this->render(
                                '/cutibelajar/pentadbiran/lihatpermohonan', [
                            //              'iklan' => $iklan,
                            'model' => $model,
                            'img' => $biodata->img,
                            'biodata' => $biodata,
      ...
      public function actionKemaskiniUlasan($id,$ICNO) {
        ...
        return $this->renderAjax('/cutibelajar/pentadbiran/update-ulasan', [
                    'model' => $model,
...
//                              $modelAddress->idBorang = 1;
        ...
        return $this->render('/cutibelajar/pentadbiran/_biasiswaums', [
            'model' => $model,
            'modelsAddress' => (empty($modelsAddress)) ? [new TblBiasiswa] : $modelsAddress,
            'iklan' => $iklan,
    ...
    public function actionTanpatajaan($id) {
        ...
        return $this->render('/cutibelajar/pentadbiran/_tanpatajaan', [
            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
