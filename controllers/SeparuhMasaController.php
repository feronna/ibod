...
class SeparuhMasaController extends \yii\web\Controller
{
...
//        $biasiswa = TblBiasiswa::find()->where(['idPermohonan'=>$id,'icno'=> $ICNO,'iklan_id'  => $takwim_id])->all();
      $biasiswa = TblBiasiswa::find()->where(['icno'=>$ICNO, 'iklan_id'=>$takwim_id,'idBorang'=>38])->all();
...
//        $biasiswa = TblBiasiswa::find()->where(['icno' => $icno, 'idBorang' => 43])->all();
       $semak = RefSemakan::find()->where(['cb'=>"separuh"])->all();
        ...
        return $this->render('/cutibelajar/smasa/_lihatpermohonan', [
     ...
     public function actionPaView($ICNO,$id, $takwim_id) {
        $model = $this->findModel($id);
        $pengajian = TblPengajian::find()->where(['idPermohonan'=>$id,'icno'=> $ICNO, 'iklan_id' => $takwim_id])->all();
        $biasiswa = TblBiasiswa::find()->where(['idBorang'=>38,'icno'=> $ICNO,'iklan_id'  => $takwim_id])->all();
        $dokumen = TblFilePemohon::find()->where(['uploaded_by'=> $ICNO, 'iklan_id'  => $takwim_id])->all();
        $senarai_dokumen = $this->findDokumen(1);
        $biodata = $this->findMaklumat($ICNO);
        $statuss = $this->findPerkhidmatanbyICNO();
...
//$biasiswa = TblBiasiswa::find()->where(['icno'=>$ICNO])->all();
          $dokumen = TblFilePemohon::findAll(['uploaded_by'=> $ICNO, 'iklan_id'  => $takwim_id,'kategori'=>1]);
          ...
          $dokumen3 = \app\models\cbelajar\TblFileLn::findAll(['uploaded_by' =>$ICNO,'iklan_id' => $takwim_id]);
             ...
             $content = $this->renderPartial('/cutibelajar/smasa/cetak-borang', [ 'model' => $model,
              'biodata' => $biodata,
              'keluarga' => $biodata->keluarga,
              'biasiswa' => $biasiswa,
              'akademik' => $biodata->akademik,
...
//            'lapordiri' => $lapordiri,
    ...
    public function actionGambar($id) {
        ...
        return $this->render('/cutibelajar/smasa/form_gambar', [
                    'model' => $model,
                    'iklan' => $iklan,
    ...
    public function actionMaklumatPeribadi($id)
    {
        ...
        return $this->render('/cutibelajar/smasa/form_peribadi', 
            [ 
...
$senarai_dokumenkpm = $this->findDokumenKpm(1);
        ...
        return $this->render('/cutibelajar/smasa/semak_maklumat', [
...
//     
    ...
    public function actionMaklumatAkademik($id)
    {
        ...
        return $this->render('/cutibelajar/smasa/form_akademik', 
        [ 
    ...
    public function actionMaklumatPengajian($id) {
        ...
        return $this->render('/cutibelajar/smasa/form_pengajian', 
        [
                    'model' => $model,
                    'iklan' => $iklan,
...
//        $permohonan = $this->findPermohonanbyID($id);
        ...
        return $this->renderAjax('/cutibelajar/smasa/_formpengajian', [
                    'model' => $model,
                    'iklan' => $iklan,
        ]);
    }
...
//        var_dump('a');die;
       if ($model->load(Yii::$app->request->post())) {
        ...
        return $this->renderAjax('/cutibelajar/smasa/form_gambar', [
                    'model' => $model,
                    'id' => $id, 'iklan'=>$iklan
        ]);
    }
...
//            'iklan' => $this->findIklanbyID($model->iklan_id),
   ...
   public function actionMaklumatBiasiswa($id)
    {   $request = Yii::$app->request;
        $sponsor = TblBiasiswa::find()->where(['icno' =>$this->ICNO(),'iklan_id' => $id, 'idBorang'=>38])->all();
        $icno = Yii::$app->user->getId();
        $iklan = $this->findIklanbyID($id);
        ...
        return $this->render('/cutibelajar/smasa/form_biasiswa', [
                    'model' => $model,
                    'iklan' => $iklan,
                    'sponsor'=> $sponsor,
                    'searchModel' => $searchModel,
    ...
    public function actionMaklumatKeluarga($id)
    {
        ...
        $model = new TblPermohonan();
        $model->icno = $icno;
        return $this->render('/cutibelajar/smasa/form_keluarga', 
            [ 
    ...
    public function actionTambahBiasiswa($id) {
        ...
        return $this->render('/cutibelajar/smasa/_formbiasiswa', [
            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
    ...
    public function actionSenaraiDokumenDimuatnaik($id)
    {
        ...
        $dokumen2 = \app\models\cbelajar\TblFilePemohon::findAll(['uploaded_by' =>$this->ICNO(),'iklan_id' => $id, 'idBorang' => 38]);

        return $this->render('/cutibelajar/smasa/form_dokumen', 
            [ 
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/smasa/update-dokumen-ln', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/smasa/update-dokumen-kpm', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//                              $modelAddress->idBorang = 1;
        ...
        return $this->render('/cutibelajar/smasa/_tajaanluarsm', [
            'model' => $model,
...
//            
//        }
        return $this->render('/cutibelajar/smasa/_kpt', [
//            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
            'modelCustomer' => $modelCustomer,
   ...
   public function actionSenaraiDokumen($id)
    {
        ...
        $iklan = $this->findIklanbyID($id);
        return $this->render('/cutibelajar/smasa/form_upload_dokumen', 
        [
            'senarai_dokumen' => $senarai_dokumen,
            'senarai_dokumenkpm' => $senarai_dokumenkpm,
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/smasa/update-dokumen', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//            $model->tarikh_mohon = NULL;
    ...
    protected function findAkademik() {
     ...
     public function actionPengakuanPemohon($id) {
        ...
        $sponsor2 = TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 38])->all() ?
                TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 38])->all() :
                new TblBiasiswa();
        $ums = TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 38, 'jenisCd' => 2])->all() ?
                TblBiasiswa::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 38, 'jenisCd' => 2])->all() :
                new TblBiasiswa();
        $sokongan = \app\models\cbelajar\TblFilePemohon::find()->where(['uploaded_by' => $this->ICNO(),
                    'iklan_id' => $id, 'idBorang' => 38])->all();
//        $doktoral = \app\models\cbelajar\TblDokumen::find()->WHERE(['kategori' => 7])->all();
        $senarai_dokumen = $this->findDokumen(1);
        $senarai_dokumenkpm = $this->findDokumenKpm(1);
        $senarai_dokumenln = $this->findDokumenLn(2);
        $dok = $this->findWajib(48);
          $doktoral = \app\models\cbelajar\TblDokumen::find()->WHERE(['kategori' => 1])->all();
        $wajib = TblFilePemohon::find()->where(['uploaded_by' => $icno, 'iklan_id' => $id, 'idBorang' => 38]);
        $check = TblpImage::findOne(['ICNO' => $this->ICNO(), 'iklan_id' => $id]);
        $checkb = TblBiasiswa::find()->where(['icno' => $this->ICNO(), 'iklan_id' => $id,'idBorang'=> 38])->one();
                        $semak = RefSemakan::find()->where(['cb'=>"separuh",'jenis'=>"umum"])->all();
        $khusus = \app\models\cbelajar\RefSemakan::find()->where(['cb'=>"separuh",'jenis'=>'khusus'])->all();
...
//                        }
        ...
        if (TblPermohonan::find()->where(['icno' => $icno, 'iklan_id' => $id, 'idBorang' => 38, 'status_proses' => "Selesai Permohonan"])->exists()) {
        ...
        if (($model->kakitangan->statLantikan == "1" && $model->kakitangan->jawatan->job_category == "1") ){
            ...
            return $this->render(
                            '/cutibelajar/smasa/form_pengakuan', [
                        'iklan' => $iklan,
                        'model' => $model,
                        'img' => $biodata->img,
                        'biodata' => $biodata,
                        ...
                        'icno' => $icno,'semak'=>$semak,
                                'senarai_dokumenkpm' => $senarai_dokumenkpm,
                                'senarai_dokumenln' => $senarai_dokumenln, 'khusus'=>$khusus
                            ]
            );
    ...
    public function actionSemakanSyarat($id, $ICNO, $takwim_id) {
        ...
        $akad = Tblpendidikan::find()->where(['ICNO' => $ICNO, 'HighestEduLevelCd' => 7])->one();
        $senarai_dokumen = $this->findDokumen(1);
        $doktoral = RefSemakan::find()->where(['cb' => "separuh"])->all();
        ...
        return $this->render('/cutibelajar/smasa/semakan_syarat', [
                    'kontrak' => $kontrak,
                    'doktoral' => $doktoral,
                    'message' => $message,
                    'icno' => $kontrak->icno,
...
//        var_dump($model);die;
        ...
        return $this->renderAjax('/cutibelajar/smasa/_updatess', [
                    'model' => $model,
...
//        var_dump('a');die;
        ...
        return $this->renderAjax('/cutibelajar/smasa/_updates', [
            'model' => $model,
...
//        }
     ...
     public function actionGenerateSemakanSyarat($id, $ICNO) {
        ...
        $pdf = new Pdf([
            ...
            'mode' => Pdf::MODE_BLANK, // leaner size using standard fonts
            'destination' => Pdf::DEST_BROWSER,
            'content' => $this->renderPartial('/cutibelajar/smasa/_laporansemakan', [
   ...
   public function actionLihatPermohonan($id) {
        ...
        $icno = Yii::$app->user->getId();
        $model->icno = $icno;
        $model2 = TblPermohonan::find()->where(['icno' => $icno, 'idBorang' => 38])->one();
 ...
 $senarai_dokumen = $this->findDokumen(1);
        ...
        if (($model->kakitangan->statLantikan == "1" && $model->kakitangan->jawatan->job_category == "1") ) {
            if (TblPermohonan::find()->where(['icno' => $icno, 'id' => $id, 'status_proses' => "Selesai Permohonan"])->exists()) {
                return $this->render(
                                '/cutibelajar/smasa/lihatpermohonan', [
                            //              'iklan' => $iklan,
                            'model' => $model,
                            'img' => $biodata->img,
                            'biodata' => $biodata,
...
//                              $modelAddress->idBorang = 1;
        ...
        return $this->render('/cutibelajar/smasa/_biasiswaums', [
            'model' => $model,
            'modelsAddress' => (empty($modelsAddress)) ? [new TblBiasiswa] : $modelsAddress,
            'iklan' => $iklan,
    ...
    public function actionTanpatajaan($id) {
        ...
        return $this->render('/cutibelajar/smasa/_tanpatajaan', [
            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
