...
class SepenuhMasaController extends \yii\web\Controller
{
...
//$biasiswa = TblBiasiswa::find()->where(['icno'=>$ICNO])->all();
          ...
          $dokumen3 = \app\models\cbelajar\TblFileLn::findAll(['uploaded_by' =>$ICNO,'iklan_id' => $takwim_id]);
             ...
             $content = $this->renderPartial('/cutibelajar/umum/cetak-borang', [ 'model' => $model,
              'biodata' => $biodata,
...
//        $biasiswa = TblBiasiswa::find()->where(['icno' => $icno, 'idBorang' => 43])->all();
       $semak = RefSemakan::find()->where(['cb'=>"sepenuh",'jenis'=>"umum"])->all();
        ...
        return $this->render('/cutibelajar/umum/_lihatpermohonan', [
     ...
     public function actionPaView($ICNO,$id, $takwim_id) {
        $model = $this->findModel($id);
        $pengajian = TblPengajian::find()->where(['idPermohonan'=>$id,'icno'=> $ICNO, 'iklan_id' => $takwim_id])->all();
        $biasiswa = TblBiasiswa::find()->where(['idBorang'=>1,'icno'=> $ICNO,'iklan_id'  => $takwim_id])->all();
        $dokumen = TblFilePemohon::find()->where(['uploaded_by'=> $ICNO, 'iklan_id'  => $takwim_id])->all();
        $senarai_dokumen = $this->findDokumen(1);
        $biodata = $this->findMaklumat($ICNO);
        $statuss = $this->findPerkhidmatanbyICNO();
...
//            'lapordiri' => $lapordiri,
    ...
    public function actionGambar($id) {
        ...
        return $this->render('/cutibelajar/umum/form_gambar', [
                    'model' => $model,
                    'iklan' => $iklan,
    ...
    public function actionMaklumatPeribadi($id)
    {
        ...
        return $this->render('/cutibelajar/umum/form_peribadi', 
            [ 
...
//        $biasiswa = TblBiasiswa::find()->where(['icno' => $icno, 'idBorang' => 43])->all();
 $semak = RefSemakan::find()->where(['cb'=>"sepenuh",'jenis'=>"umum"])->all();
        ...
        return $this->render('/cutibelajar/umum/semak_maklumat', [
...
//     
    ...
    public function actionMaklumatAkademik($id)
    {
        ...
        return $this->render('/cutibelajar/umum/form_akademik', 
        [ 
    ...
    public function actionMaklumatPengajian($id) {
        ...
        $pengajianTinggi = TblPengajian::findAll(['icno' =>$this->ICNO(),'iklan_id' => $id, 'idBorang' => 1,'status'=>9]);
        $iklan = $this->findIklanbyID($id);
        $icno = Yii::$app->user->getId();
        $sabatikal2= $this->findSabatikal();
        ...
        return $this->render('/cutibelajar/umum/form_pengajian', 
        [
                    'model' => $model,
                    'iklan' => $iklan,
...
//        $permohonan = $this->findPermohonanbyID($id);
        ...
        return $this->renderAjax('/cutibelajar/umum/_formpengajian', [
                    'model' => $model,
                    'iklan' => $iklan,
        ]);
    }
...
//        var_dump('a');die;
       if ($model->load(Yii::$app->request->post())) {
        ...
        return $this->renderAjax('/cutibelajar/umum/form_gambar', [
                    'model' => $model,
                    'id' => $id, 'iklan'=>$iklan
        ]);
    }
...
//            'iklan' => $this->findIklanbyID($model->iklan_id),
   ...
   public function actionMaklumatBiasiswa($id)
    {   $request = Yii::$app->request;
        ...
        return $this->render('/cutibelajar/umum/form_biasiswa', [
                    'model' => $model,
                    'iklan' => $iklan,
                    'sponsor'=> $sponsor,
                    'searchModel' => $searchModel,
    ...
    public function actionMaklumatKeluarga($id)
    {
        ...
        $model = new TblPermohonan();
        $model->icno = $icno;
        return $this->render('/cutibelajar/umum/form_keluarga', 
            [ 
    ...
    public function actionTambahBiasiswa($id) {
        ...
        return $this->render('/cutibelajar/umum/_formbiasiswa', [
            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
    ...
    public function actionSenaraiDokumenDimuatnaik($id)
    {
        ...
        $dokumen2 = \app\models\cbelajar\TblFilePemohon::findAll(['uploaded_by' =>$this->ICNO(),'iklan_id' => $id, 'idBorang' => 1]);

        return $this->render('/cutibelajar/umum/form_dokumen', 
            [ 
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/umum/update-dokumen-ln', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/umum/update-dokumen-kpm', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//                              $modelAddress->idBorang = 1;
        ...
        return $this->render('/cutibelajar/umum/_tajaanluarsm', [
            'model' => $model,
...
//            
//        }
        return $this->render('/cutibelajar/umum/_kpt', [
//            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
            'modelCustomer' => $modelCustomer,
   ...
   public function actionSenaraiDokumen($id)
    {
        ...
        $senarai_dokumenln = $this->findDokumenLn(1);
        $iklan = $this->findIklanbyID($id);
        return $this->render('/cutibelajar/umum/form_upload_dokumen', 
        [
...
//                $simpan->namafile = $file_path;
           ...
           //}
                        ...
                        return $this->renderAjax('/cutibelajar/umum/update-dokumen', [
                        'model' => $model,
                            'iklan'=>$iklan
...
//        $doktoral = \app\models\cbelajar\TblDokumen::find()->WHERE(['kategori' => 7])->all();
        ...
        $check = TblpImage::findOne(['ICNO' => $this->ICNO(), 'iklan_id' => $id]);
        $checkb = TblBiasiswa::find()->where(['icno' => $this->ICNO(), 'iklan_id' => $id,'idBorang'=> 1])->one();
        $checkp = TblPengajian::find()->where(['icno' => $this->ICNO(), 'iklan_id' => $id,'idBorang'=> 1])->one();
...
//                        }
            ...
            {
                Yii::$app->session->setFlash('alert', ['title' => 'Maaf,', 'type' => 'error', 'msg' => ''
                    . 'Sila isi Maklumat Pengajian anda']);
                return $this->redirect(['pengakuan-pemohon?id=' . $id]);  
            }
        ...
        if (($model->kakitangan->statLantikan == "1" && $model->kakitangan->jawatan->job_category == "1") ||
                ($model->kakitangan->statLantikan == "2" && $model->kakitangan->jawatan->job_category == "1") ||
                 ($model->kakitangan->statLantikan == "7" && $model->kakitangan->jawatan->job_category == "1")){
       
            return $this->render(
                            '/cutibelajar/umum/form_pengakuan', [
                        'iklan' => $iklan,
                        'model' => $model,
                        'img' => $biodata->img,
                        'biodata' => $biodata,
  ...
  $semak = RefSemakan::find()->where(['cb'=>"sepenuh",'jenis'=>"umum"])->all();
        ...
        if (Yii::$app->request->post()) {
            ...
            foreach ($semak as $kpi) {
             ...
             foreach ($khusus as $dok) {
                $this->savekpi($takwim_id, $id, $kontrak->icno, $dok);
            }
             foreach ($khusus_ln as $dok) {
                $this->savekpi($takwim_id, $id, $kontrak->icno, $dok);
            }
...
//        var_dump($model);die;
        ...
        return $this->renderAjax('/cutibelajar/umum/_updatess', [
                    'model' => $model,
...
//        var_dump('a');die;
        ...
        return $this->renderAjax('/cutibelajar/umum/_updates', [
            'model' => $model,
...
//        }
     ...
     public function actionGenerateSemakanSyarat($id, $ICNO) {
        ...
        $biodata = $this->findMaklumat($ICNO);
        $kriteriakpi = RefSemakan::find()->where(['cb'=>'sepenuh'])->all();
        ...
        $pdf = new Pdf([
            ...
            'mode' => Pdf::MODE_BLANK, // leaner size using standard fonts
            'destination' => Pdf::DEST_BROWSER,
            'content' => $this->renderPartial('/cutibelajar/umum/_laporansemakan', [
   ...
   public function actionLihatPermohonan($id) {
        ...
        $model2 = TblPermohonan::find()->where(['icno' => $icno, 'idBorang' => 1])->one();
       ...
       $semak = RefSemakan::find()->where(['cb'=>"sepenuh",'jenis'=>"umum"])->all();
        ...
        if (($model->kakitangan->statLantikan == "1" && $model->kakitangan->jawatan->job_category == "1") || ($model->kakitangan->statLantikan == "7" && $model->kakitangan->jawatan->job_category == "1")  ) {
            if (TblPermohonan::find()->where(['icno' => $icno, 'id' => $id, 'status_proses' => "Selesai Permohonan"])->exists()) {
                return $this->render(
                                '/cutibelajar/umum/lihatpermohonan', [
                            //              'iklan' => $iklan,
                            'model' => $model,
                            'img' => $biodata->img,
                            'biodata' => $biodata,
                            ...
                            'model3' => $model3,
                                ...
                                'senarai_dokumenln' => $senarai_dokumenln,'iklan'=>$iklan,
                                    'khusus'=>$khusus, 'khusus_ln'=>$khusus_ln,'icno'=>$icno,'models'=>$models
                                ]
                );
            }
        } else {
...
//                              $modelAddress->idBorang = 1;
        ...
        return $this->render('/cutibelajar/umum/_biasiswaums', [
            'model' => $model,
            'modelsAddress' => (empty($modelsAddress)) ? [new TblBiasiswa] : $modelsAddress,
            'iklan' => $iklan,
    ...
    public function actionTanpatajaan($id) {
        ...
        return $this->render('/cutibelajar/umum/_tanpatajaan', [
            'model' => $model,
            'iklan' => $iklan,
            'model2' => $model2,
