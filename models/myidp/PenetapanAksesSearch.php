...
/**
 * PenetapanAksesSearch represents the model behind the search form of `app\models\hronline\Tblprcobiodata`.
 */
class PenetapanAksesSearch extends Tblprcobiodata
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['ICNO', 'ReligionCd', 'RaceCd', 'EthnicCd', 'ArmyPoliceCd', 'BloodTypeCd', 'MrtlStatusCd', 'TitleCd', 'ConfermentDt', 'GenderCd', 'COBirthPlaceCd', 'COBirthCountryCd', 'NegaraAsalCd', 'NegeriAsalCd', 'NegeriAsalIbu', 'NegeriAsalBapa', 'NatCd', 'NatStatusCd', 'CONm', 'COEmail', 'COEmail2', 'COOldID', 'COBirthCertNo', 'COBirthDt', 'COHPhoneNo', 'COHPhoneNo2', 'COOffTelNo', 'COOffTelNoExtn', 'COOffTelNoExtn2', 'COOUCTelNo', 'COOPass', 'COHPhoneStatus', 'startDateLantik', 'endDateLantik', 'startDateStatus', 'startDateSandangan', 'endDateSandangan', 'gredJawatan_2', 'startDateSandangan_2', 'endDateSandangan_2', 'jawatanTadbir', 'last_update', 'last_updater', 'last_login', 'pp', 'bos', 'program_ums', 'kemaskini_terakhir', 'tarikh_sah'], 'safe'],
            [['HighestEduLevelCd', 'COBumiStatus', 'COOIsNew', 'accessLevel', 'accessSecondLevel', 'DeptId', 'campus_id', 'statLantikan', 'substatLantikan', 'Status', 'noWaran', 'gredJawatan', 'statSandangan', 'statSandangan_2', 'ApmtTypeCd', 'DeptId_hakiki', 'campus_id_hakiki', 'KodProgram', 'sah_keluarga', 'sah_alamat', 'sah_notel', 'sah_statuskahwin', 'sah_emel', 'sah_akademik', 'sah_agama', 'sah_passport', 'showposition'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'substatLantikan' => $this->substatLantikan,
