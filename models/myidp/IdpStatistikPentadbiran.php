...
/**
 * This is the model class for table "hrd.idp_statistik_pentadbiran".
 *
 * @property int $tahun
 * @property int $vckl_kod_kumpulan
 ...
 */
class IdpStatistikPentadbiran extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'hrd.idp_statistik_pentadbiran';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['tahun', 'vckl_kod_kumpulan', 'jumlah_staf', 'jumlah_capai', 'jumlah_belum_capai', 'jumlah_belum_ada_mata', 'per_jumlah_capai', 'per_jumlah_belum_capai', 'per_jumlah_belum_ada_mata'], 'integer'],
    ...
    public static function countStaffByKumpulan($kumpulan, $category, $tahun)
    {
        ...
        $model = IdpStatistikPentadbiran::find()
                    ->where(['tahun' => $tahun])
    ...
    public static function countStaff($category, $tahun)
    {
        ...
        $model = IdpStatistikPentadbiran::find()->where(['tahun' => $tahun])->all();
