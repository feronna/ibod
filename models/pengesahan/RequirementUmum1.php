...
/**
 * This is the model class for table "hrm.sah_requirement_umum_pentadbiran".
 *
 * @property int $id
 ...
 */
class RequirementUmum1 extends \yii\db\ActiveRecord
{
    ...
    {
        return 'hrm.sah_requirement_umum_pentadbiran';
    }
    ...
    public static function umum() {
        return RequirementUmum1::find()->all();
    }
