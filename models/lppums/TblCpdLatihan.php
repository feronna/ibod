...
use Yii;
use app\models\lppums\TblCpdSenaraiLatihan;
/**
 ...
 */
class TblCpdLatihan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
...
//    }
    ...
    public function getNamaLatihan() {
        return $this->hasOne(TblCpdSenaraiLatihan::classname(), ['vcsl_kod_latihan' => 'vcl_kod_latihan']);
    }
}
