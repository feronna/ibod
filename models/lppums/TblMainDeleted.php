...
/**
 * This is the model class for table "hrm.lppums_lpp_deleted".
 *
 ...
 */
class TblMainDeleted extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            [['lpp_id'], 'required'],
            [['lpp_id', 'PYD_sts_lantikan', 'gred_jawatan_id', 'jspiu', 'gred_jawatan_id_PPP', 'jspiu_PPP', 'gred_jawatan_id_PPK', 'jspiu_PPK', 'PYD_sah', 'PPP_sah', 'PPK_sah'], 'integer'],
            [['lpp_datetime', 'tahun', 'PYD_sah_datetime', 'PPP_sah_datetime', 'PPK_sah_datetime', 'KJ_sah_datetime'], 'safe'],
            [['PYD', 'PPP', 'PPK', 'PP_ALL', 'KJ_sah', 'deleted_by'], 'string', 'max' => 12],
            [['lpp_id'], 'unique'],
        ];
    }
