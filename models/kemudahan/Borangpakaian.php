...
/**
 * This is the model class for table "facility.tbl_pakaian".
 *
 * @property int $id
 ...
 */
class Borangpakaian extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'utilities.fac_tbl_pakaian';
    }
    ...
    public function perMonth($year,$mth) {
        ...
        return Borangpakaian::find()->where(['YEAR(entry_date)' => $year])->andWhere(['MONTH(entry_date)' => $mth])->andWhere(['mohon' => 1])->count();
    }
    public function getTotal($year,$mth) {
        
        return Borangpakaian::find()->where(['YEAR(entry_date)' => $year])->andWhere(['MONTH(entry_date)' => $mth])->andWhere(['mohon' => 1])->sum('jumlah');
    }
     public function getTotalYear($year) {
        
        return Borangpakaian::find()->where(['YEAR(entry_date)' => $year])->andWhere(['mohon' => 1])->sum('jumlah');
    }
    public function getTotalCount($year,$mth) {
        
        return Borangpakaian::find()->where(['YEAR(entry_date)' => $year])->andWhere(['mohon' => 1])->count();
    }
}
