...
/**
 * This is the model class for table "hrm.elnpt_user".
 *
...
class TblUser extends \yii\db\ActiveRecord
{
    ...
    public function getMarkahLama() {
        return $this->hasOne(TblMarkahLama::className(), ['staff_id' => 'staff_id']);
    }
}
