...
/**
 * This is the model class for table "dbo.vw_CV_Creative".
 *
 * @property int $ID
 ...
 */
class DboVwCVCreative extends \yii\db\ActiveRecord
{
    public $jenis;
