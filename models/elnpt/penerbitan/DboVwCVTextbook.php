...
/**
 * This is the model class for table "dbo.vw_CV_Textbook".
 *
 * @property int $ID
 ...
 */
class DboVwCVTextbook extends \yii\db\ActiveRecord
{
    public $jenis;
    ...
    public function afterFind()
    {
        ...
        $this->jenis = "BUKU-LAPORAN TEKNIKAL / KLINIKAL";
    }
}
