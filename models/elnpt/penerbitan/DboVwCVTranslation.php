...
/**
 * This is the model class for table "dbo.vw_CV_Translation".
 *
 * @property int $ID
 ...
 */
class DboVwCVTranslation extends \yii\db\ActiveRecord
{
    public $jenis;
    ...
    public function afterFind()
    {
        ...
        $this->jenis = "BUKU-TRANSLATION/ADAPTATION";
    }
}
