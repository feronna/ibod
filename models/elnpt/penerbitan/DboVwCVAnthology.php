...
/**
 * This is the model class for table "dbo.vw_CV_Anthology".
 *
 * @property int $ID
 ...
 */
class DboVwCVAnthology extends \yii\db\ActiveRecord
{
    public $kategori;
