...
/**
 * This is the model class for table "dbo.vw_CV_BookChapter".
 *
 * @property int $ID
 ...
 */
class DboVwCVBookChapter extends \yii\db\ActiveRecord
{
    public $jenis;
    ...
    public function afterFind()
    {
        ...
        $this->jenis = "BUKU-BAB DALAM BUKU";
    }
}
