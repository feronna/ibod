 ...
 */
class TblLnptPublicationV3 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['PubID'], 'string', 'max' => 20],
            [['Keterangan_PublicationStatus', 'IndexingDesc', 'User_Ic', 'KeteranganBI_WriterStatus', 'PageNumber', 'Volume', 'SubCategory'], 'string', 'max' => 50],
