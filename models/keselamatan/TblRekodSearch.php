...
/**
 * TblRekodSearch represents the model behind the search form of `app\models\keselamatan\TblRekod`.
 */
class TblRekodSearch extends TblRekod
{
    ...
    public function rules()
    {
        return [
            ...
            [['icno', 'day', 'tarikh', 'time_in', 'time_out', 'ot_in', 'ot_out', 'status_in', 'status_out', 'incomplete', 'absent', 'external', 'app_by', 'app_dt', 'remark_status', 'in_lat_lng', 'out_lat_lng', 'ot_in_lat_lng', 'ot_out_lat_lng', 'in_ip', 'out_ip', 'remark', 'app_remark', 'ot_in_ip', 'ot_out_ip'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'icno', $this->icno])
            ...
            ->andFilterWhere(['like', 'ot_in_lat_lng', $this->ot_in_lat_lng])
            ->andFilterWhere(['like', 'ot_out_lat_lng', $this->ot_out_lat_lng])
            ...
            ->andFilterWhere(['like', 'ot_in_ip', $this->ot_in_ip])
            ->andFilterWhere(['like', 'ot_out_ip', $this->ot_out_ip]);
