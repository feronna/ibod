...
/**
 * This is the model class for table "keselamatan.tbl_rekod_peg_medan".
 *
 * @property int $id
 ...
 */
class TblRekodPegMedan extends \yii\db\ActiveRecord {
    ...
    public static function tableName() {
        return 'keselamatan.tbl_rekod_peg_medan';
    }
...
//        }
    ...
    public static function DisplayTime($icno, $tarikh, $type) {
        ...
        if ($icno && $tarikh) {
            $model = TblRekodPegMedan::findOne(['icno' => $icno, 'tarikh' => $tarikh]);
        }
...
//        }
    ...
    public static function DisplayHours($icno, $tarikh) {
        ...
        $model = TblRekodPegMedan::findBySql($sql, [':icno' => $icno, 'tarikh' => $tarikh])->asArray()->one();
...
//    }
    ...
    public static function checkToday($icno, $tarikh) {
        ...
        $model = TblRekodPegMedan::find()->where(['icno' => $icno, 'tarikh' => $tarikh])->one();
