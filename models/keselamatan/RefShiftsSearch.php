...
/**
 * RefShiftsSearch represents the model behind the search form of `app\models\keselamatan\RefShifts`.
 */
class RefShiftsSearch extends RefShifts
{
    /**
     * {@inheritdoc}
     */
