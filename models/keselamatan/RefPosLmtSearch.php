...
/**
 * RefPosLmtSearch represents the model behind the search form of `app\models\keselamatan\RefPosLmt`.
 */
class RefPosLmtSearch extends RefPosLmt
{
    /**
     * {@inheritdoc}
     */
