...
use app\models\gaji\TblIncomeCodeMappingSmbu;
use app\models\gaji\RefIncomeType;

class TblStaffRocSmbu extends \yii\db\ActiveRecord
{
...
//                ->andFilterWhere(['=', 'DeptId', $this->DeptId]);
    ...
    public function getElaunn() {
        return $this->hasOne(TblIncomeCodeMappingSmbu::className(), ['income_code' => 'SR_ROC_TYPE']);
    }
