...
use app\models\gaji\TblIncomeCodeMapping;
use app\models\gaji\RefIncomeType;

/**
 * This is the model class for table "hrm.gaji_staff_roc".
 *
...
//    }
    ...
    {
        return [
            [['SR_REF_ID'], 'thamtech\uuid\validators\UuidValidator'],
            [[
                // 'SR_REF_ID', 'SR_CMPY_CODE', 'SR_CHANGE_TYPE', 'SR_ROC_TYPE', 'SR_CHANGE_REASON'
                'SR_DATE_TO',
            ], 'required'],
            ...
            [['SR_REF_ID'], 'unique'],
            [['SR_DATE_FROM', 'SR_DATE_TO'], 'date', 'format' => 'yyyy-mm-dd']
        ];
    }
    ...
    {
        return $this->hasOne(RefRocReason::className(), ['RR_REASON_CODE' => 'SR_CHANGE_REASON']);
    }
    ...
    {
        return $this->hasOne(RefIncomeType::className(), ['it_income_code' => 'SR_ROC_TYPE']);
    }

    public function getElaunn()
    {
        return $this->hasOne(TblIncomeCodeMapping::className(), ['income_code' => 'SR_ROC_TYPE']);
    }
    ...
    {
        return $this->hasOne(\app\models\vhrms\IncomeType::className(), ['it_income_code' => 'SR_ROC_TYPE']);
    }
}
