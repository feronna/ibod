...
/**
 * This is the model class for table "hronline.tblrscopsnathy".
 *
 * @property string $ICNO
 * @property string $PsnAthyCd
 * @property string $PsnAthyStDt
 * @property string $id
 */
class Tblrscopsnathy extends \yii\db\ActiveRecord
{
    ...
    {
        return 'hronline.tblrscopsnathy';
    }
    ...
    public function rules()
    {
        return [
            [['PsnAthyStDt'], 'safe'],
            [['ICNO'], 'string', 'max' => 12],
            [['PsnAthyCd'], 'string', 'max' => 10],
            [['PsnAthyCd', 'PsnAthyStDt'], 'required', 'message' => "Wajib Diisi"],
        ];
    }
    ...
    public function getTarikhMula() {
        return  $this->getTarikh($this->PsnAthyStDt);
    }
    public function getKuasaPencen() {
        return $this->hasOne(Pensionauthority::className(), ['PsnAthyCd' => 'PsnAthyCd']);
    }
