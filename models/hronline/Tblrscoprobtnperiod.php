...
/**
 * This is the model class for table "hronline.tblrscoprobtnperiod".
 *
 * @property string $ICNO
 * @property int $ProbtnPeriod
 * @property string $ProbtnStDt
 * @property string $ProbtnEndDt
 * @property int $ProbtnPeriodMin
 * @property string $id
 */
class Tblrscoprobtnperiod extends \yii\db\ActiveRecord
{
    ...
    {
        return 'hronline.tblrscoprobtnperiod';
    }
    ...
    {
        return [
            [['ProbtnPeriod', 'ProbtnStDt', 'ProbtnPeriodMin','ProbtnEndDt'],'required', 'message' => "Wajib Diisi"],
            [['ProbtnPeriod', 'ProbtnPeriodMin'], 'integer'],
            [['ProbtnStDt', 'ProbtnEndDt'], 'safe'],
            [['ICNO'], 'string', 'max' => 12],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            'ICNO' => 'Icno',
            'ProbtnPeriod' => 'Probtn Period',
            'ProbtnStDt' => 'Probtn St Dt',
            'ProbtnEndDt' => 'Probtn End Dt',
            'ProbtnPeriodMin' => 'Probtn Period Min',
            'id' => 'ID',
        ];
    }
    ...
    public function getTarikhMula() {
        return  $this->getTarikh($this->ProbtnStDt);
    }
    public function getTarikhTamat() {
        return  $this->getTarikh($this->ProbtnEndDt);
    }
