...
/**
 * This is the model class for table "hronline.tblrscoaptathy".
 *
 * @property string $ICNO
 * @property string $AptAthyCd
 * @property string $ICNOHeadServ
 * @property string $AptAthyStDt
 * @property string $id
 */
class Tblrscoaptathy extends \yii\db\ActiveRecord
{
    ...
    {
        return 'hronline.tblrscoaptathy';
    }
    ...
    {
        return [
            [['AptAthyCd', 'AptAthyStDt'], 'required', 'message' => "Wajib Diisi"],
            [['AptAthyStDt'], 'safe'],
            [['ICNO', 'ICNOHeadServ'], 'string', 'max' => 12],
            [['AptAthyCd'], 'string', 'max' => 7],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'ICNOHeadServ' => 'Icno Head Serv',
            'AptAthyStDt' => 'Apt Athy St Dt',
            'id' => 'ID',
        ];
    }
    ...
    public function getTarikhMula() {
        return  $this->getTarikh($this->AptAthyStDt);
    }
    
    public function getKuasa() {
        return $this->hasOne(Appointingauthority::className(), ['AptAthyCd' => 'AptAthyCd']);
    }
