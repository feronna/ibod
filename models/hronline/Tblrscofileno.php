...
/**
 * This is the model class for table "hronline.tblrscofileno".
 *
 * @property string $ICNO
 * @property string $COFileNo
 * @property string $COFileNoEftvDt
 * @property string $id
 */
class Tblrscofileno extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['COFileNo','COFileNoEftvDt'], 'required', 'message' => "Wajib Diisi"],
            [['COFileNoEftvDt'], 'safe'],
            [['ICNO'], 'string', 'max' => 12],
            [['COFileNo'], 'string', 'max' => 25],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            'ICNO' => 'Icno',
            'COFileNo' => 'Co File No',
            'COFileNoEftvDt' => 'Co File No Eftv Dt',
            'id' => 'ID',
        ];
    }
    ...
    public function getTarikhKuatkuasa() {
        return  $this->getTarikh($this->COFileNoEftvDt);
    }
