 ...
 * @property int $id
 */
class Tblrscoapmtstatus extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ICNO', 'ApmtStatusCd'], 'required','on'=>'lantikstafbaru'],
            [['ApmtStatusCd'], 'integer'],
            [['ApmtStatusStDt', 'ApmtStatusEndDt'], 'safe'],
            [['ICNO'], 'string', 'max' => 12],
            [['ApmtStatusCd', 'ApmtStatusStDt','ApmtStatusEndDt'], 'required', 'message' => "Wajib Diisi"],
        ];
    }
    ...
    public function getTarikhmulalantikan() {
        return  $this->getTarikh($this->ApmtStatusStDt);
    }
    
    public function getTarikhtamatlantikan() {
        return  $this->getTarikh($this->ApmtStatusEndDt);
    }
