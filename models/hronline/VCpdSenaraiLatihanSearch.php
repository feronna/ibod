...
use app\models\hronline\Vcpdsenarailatihan;

/**
 * VCpdSenaraiLatihanSearch represents the model behind the search form of `app\models\hronline\Vcpdsenarailatihan`.
 */
