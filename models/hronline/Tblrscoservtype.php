...
/**
 * This is the model class for table "hronline.tblrscoservtype".
 *
 * @property string $ICNO
 * @property string $ServTypeStDt
 * @property string $ServTypeCd
 * @property string $id
 */
class Tblrscoservtype extends \yii\db\ActiveRecord
{
    ...
    {
        return 'hronline.tblrscoservtype';
    }
    ...
    {
        return [
            [['ServTypeStDt', 'ServTypeCd','ServTypeStDt'], 'required', 'message' => "Wajib Diisi"],
            [['ServTypeStDt'], 'safe'],
            [['ICNO'], 'string', 'max' => 12],
            [['ServTypeCd'], 'string', 'max' => 5],
        ];
    }
    ...
    public function getTarikhMula() {
        return  $this->getTarikh($this->ServTypeStDt);
    }
    public function getJenisPerkhidmatan() {
        return $this->hasOne(Servicetype::className(), ['ServTypeCd' => 'ServTypeCd']);
    }
