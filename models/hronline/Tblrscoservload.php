...
/**
 * This is the model class for table "hronline.tblrscoservload".
 *
 * @property string $ICNO
 * @property string $ServLoadCd
 * @property string $ServLoadStDt
 * @property string $id
 */
class Tblrscoservload extends \yii\db\ActiveRecord
{
    ...
    {
        return 'hronline.tblrscoservload';
    }
    ...
    public function rules()
    {
        return [
            [['ServLoadStDt'], 'safe'],
            [['ICNO'], 'string', 'max' => 12],
            [['ServLoadCd'], 'string', 'max' => 2],
            [['ServLoadCd', 'ServLoadStDt'], 'required', 'message' => "Wajib Diisi"],
        ];
    }
    ...
    public function getTarikhMula() {
        return  $this->getTarikh($this->ServLoadStDt);
    }
     public function getBebanPerkhidmatan() {
        return $this->hasOne(Serviceloading::className(), ['ServLoadCd' => 'ServLoadCd']);
    }
