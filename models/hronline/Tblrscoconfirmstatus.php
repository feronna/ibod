 ...
 * @property string $id
 */
class Tblrscoconfirmstatus extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['ConfirmStatusCd', 'ConfirmStatusStDt'], 'required',  'message' => "Wajib Diisi"],
        ];
    }
    ...
    public function getstatusPengesahan() {
       return $this->hasOne(Confirmationstatus::className(), ['ConfirmStatusCd' => 'ConfirmStatusCd']);
   }
