...
/**
 * This is the model class for table "hronline.tblrscopersalpoint".
 *
 * @property string $ICNO
 * @property string $PerSalPointStDt
 * @property string $PerSalPointEndDt
 * @property string $SalPointCd
 * @property string $id
 */
class Tblrscopersalpoint extends \yii\db\ActiveRecord
{
    ...
    {
        return 'hronline.tblrscopersalpoint';
    }
    ...
    {
        return [
            [['SalPointCd','PerSalPointStDt', 'SalPointCd'], 'required', 'message' => "Wajib Diisi"],
            [['PerSalPointStDt', 'PerSalPointEndDt'], 'safe'],
            [['ICNO'], 'string', 'max' => 12],
            [['SalPointCd'], 'string', 'max' => 20],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            'ICNO' => 'Icno',
            'PerSalPointStDt' => 'Per Sal Point St Dt',
            'PerSalPointEndDt' => 'Per Sal Point End Dt',
    ...
    public function getTarikhMula() {
        return  $this->getTarikh($this->PerSalPointStDt);
    }
    
       public function getGajiPokok() {
        return $this->hasOne(Salarypoint::className(), ['SalPointCd' => 'SalPointCd']);
    }
