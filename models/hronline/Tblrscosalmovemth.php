...
/**
 * This is the model class for table "hronline.tblrscosalmovemth".
 *
 ...
 * @property string $id
 */
class Tblrscosalmovemth extends \yii\db\ActiveRecord
{
    ...
    {
        return 'hronline.tblrscosalmovemth';
    }
    ...
    {
        return [
            [['SalMoveMth','SalMoveMthType', 'SalMoveMthStDt'], 'required', 'message' => "Wajib Diisi"],
            [['SalMoveMthType'], 'integer'],
            [['SalMoveMthStDt'], 'safe'],
            [['ICNO'], 'string', 'max' => 12],
    ...
    public function getTarikhMula() {
        return  $this->getTarikh($this->SalMoveMthStDt);
    }
    
       public function getJenisPergerakan() {
        return $this->hasOne(Movemonthtype::className(), ['id' => 'SalMoveMthType']);
    }
    
     public function getBulanPergerakan() {
        return $this->hasOne(Movemonth::className(), ['id' => 'SalMoveMth']);
    }
