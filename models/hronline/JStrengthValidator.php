...
use kartik\password\StrengthValidatorAsset;
 ...
 * @since 1.0
 */
class JStrengthValidator extends StrengthValidator
{
    ...
    protected function applyPreset()
    {
        ...
        if (!isset($this->presetsSource)) {
            $this->presetsSource = '../vendor/kartik-v/yii2-password/src/presets.php';
        }
    ...
    protected static function getRuleMessage($rule)
    {
        switch ($rule) {
            case self::RULE_MIN:
                return Yii::t(
                    'kvpwdstrength',
                    '{attribute} sekurang-kurangnya {n, plural, one{one Aksara minimum} other{# Aksara minimum}}!'
                );
            case self::RULE_MAX:
                return Yii::t(
                    'kvpwdstrength',
                    '{attribute} melebihi {n, plural, one{one Aksara maximum} other{# Aksara maximum}}!'
                );
            case self::RULE_LEN:
                return Yii::t(
                    'kvpwdstrength',
            ...
            case self::RULE_LOW:
                return Yii::t(
                    'kvpwdstrength',
                    '{attribute} sekurang-kurangnya {n, plural, one{1 lowercase characters (a-z)} other{# lowercase characters (a-z)}} ({found} found)!'
                );
            case self::RULE_UP:
                return Yii::t(
                    'kvpwdstrength',
                    '{attribute} sekurang-kurangnya {n, plural, one{1 uppercase characters (A-Z)} other{# uppercase characters (A-Z)}}!'
                );
            case self::RULE_NUM:
                return Yii::t(
                    'kvpwdstrength',
                    '{attribute} sekurang-kurangnya mengandungi {n, plural, one{1 nombor (0-9)} other{# nombor (0-9)}}!'
                );
            case self::RULE_SPL:
                return Yii::t(
                    'kvpwdstrength',
                    '{attribute} sekurang-kurangnya {n, plural, one{non alpha-numeric (!@#$%^&*( )~)} other{# non alpha-numeric (!@#$%^&*( )~)}}!'
                );
        }
        return null;
    }
