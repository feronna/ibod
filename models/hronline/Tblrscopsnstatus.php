...
/**
 * This is the model class for table "hronline.tblrscopsnstatus".
 *
 * @property string $ICNO
 * @property string $PsnStatusCd
 * @property string $PsnStatusNo
 * @property string $PsnIncomeTaxNo
 * @property string $PsnEpfNo
 * @property string $PsnStatusStDt
 * @property string $id
 */
class Tblrscopsnstatus extends \yii\db\ActiveRecord
{
    ...
    {
        return 'hronline.tblrscopsnstatus';
    }
    ...
    {
        return [
           // [['ICNO', 'PsnStatusCd', 'PsnStatusStDt'], 'required'],
            [['PsnStatusStDt'], 'safe'],
            [['ICNO'], 'string', 'max' => 12],
            [['PsnStatusCd'], 'string', 'max' => 2],
            [['PsnStatusNo'], 'string', 'max' => 15],
            [['PsnIncomeTaxNo', 'PsnEpfNo'], 'string', 'max' => 100],
             [['PsnStatusCd', 'PsnStatusNo', 'PsnIncomeTaxNo', 'PsnEpfNo', 'PsnStatusStDt'],'required', 'message' => "Wajib Diisi"],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'PsnStatusNo' => 'Psn Status No',
            'PsnIncomeTaxNo' => 'Psn Income Tax No',
            'PsnEpfNo' => 'Psn Epf No',
            'PsnStatusStDt' => 'Psn Status St Dt',
            'id' => 'ID',
        ];
    }
    ...
    public function getTarikhMula() {
        return  $this->getTarikh($this->PsnStatusStDt);
    }
    public function getStatusPencen() {
        return $this->hasOne(Pensionstatus::className(), ['PsnStatusCd' => 'PsnStatusCd']);
    }
