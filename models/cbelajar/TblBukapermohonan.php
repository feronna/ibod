...
/**
 * This is the model class for table "cbelajar.tbl_bukapermohonan".
 *
 * @property int $id
...
class TblBukapermohonan extends \yii\db\ActiveRecord
{
    ...
    {
        return 'cbelajar.tbl_bukapermohonan';
    }
    ...
    {
        return [
            [['start_tamatkontrak', 'end_tamatkontrak', 'start_bolehmohon', 'end_bolehmohon', 'tahun'], 'safe'],
            [['category'], 'integer'],
            [['sesi'], 'string', 'max' => 50],
        ];
    }
