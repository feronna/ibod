...
/**
 * SamanSearch represents the model behind the search form of `app\models\saman\SamanOld`.
 */
class SamanSearch extends SamanOld
{
    public $STATUS_SAMAN;
    /**
     * {@inheritdoc}
    ...
    {
        return [
            [['NOSAMAN', 'TRKHSAMAN', 'KATEGORI', 'IDNO', 'NAMA', 'ICNO', 'NO_KENDERAAN', 'SIRI_PELEKAT', 'KODJENIS', 'KODMODEL', 'LOKASI', 'KODKAMPUS', 'KODKOLEJ', 'KODJFPIU', 'KODPROGRAM', 'KODSALAH1', 'NOTA1', 'KODSALAH2', 'NOTA2', 'KODSALAH3', 'NOTA3', 'KODSALAH4', 'NOTA4', 'NOKUNCI', 'KODBADAN', 'KODPGUATKUASA', 'DATELOG', 'LATITUD', 'LONGITUD', 'ACTION', 'ISTRANSFER', 'STATUS', 'CATATAN','STATUS_SAMAN'], 'safe'],
    ...
    public function search($params)
    {
        ...
        ->andFilterWhere(['like', 't_19_eks_bayar.STATUS', $this->STATUS_SAMAN]); 
