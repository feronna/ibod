...
/**
 * LaporanShKontraktorSearch represents the model behind the search form of `app\models\esticker\TblRekodKontraktor`.
 */
class LaporanShKontraktorSearch extends TblRekodKontraktor
{
   public $bulanan,$syarikat_id;
    ...
    {
        $query = TblRekodKontraktor::find()->joinWith('pekerja')->where(['is not','stc_kontraktor_in_out.flag_open_reason',NULL]);
