...
/**
 * LaporanPelawatHarianSearch represents the model behind the search form of `app\models\esticker\TblRekodPelawat`.
 */
class LaporanPelawatHarianSearch extends TblRekodPelawat
{
    public $bulanan;
    /**
     * {@inheritdoc}
