...
/**
 * This is the model class for table "tatatertib_staf.tbl_urus_mesyuarat_jrtk".
 *
 * @property int $id
 * @property string $tarikh_mesyuarat
 * @property string $nama_mesyuarat
 * @property string $tempat_mesyuarat
 * @property int $bidang_kuasa
 * @property string $pengerusi_icno
 * @property string $created_at
 * @property int $status
 */
class TblUrusMesyuaratJrtk extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'hrm.tertib_tbl_urus_mesyuarat_jrtk';
    }
...
//            [['nama_mesyuarat', 'tempat_mesyuarat'], 'string', 'max' => 122],
            [['nama_mesyuarat', 'tempat_mesyuarat', 'tarikh_mesyuarat', 'pengerusi_icno', 'bidang_kuasa'], 'required','message' => Yii::t('app', 'Wajib Diisi')],
        ];
    }
