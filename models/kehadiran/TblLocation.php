...
class TblLocation extends \yii\db\ActiveRecord {
    ...
    public static function tableName() {
        return 'attendance.tbl_location';
    }
    ...
    public static function CheckZone($latlng, $isRaw = false) {
        ...
        $lat = $myArray[0];
        $lng = $myArray[1];
        $sql = 'SELECT * FROM attendance.tbl_location WHERE :lat BETWEEN lat_start AND lat_end AND :lng BETWEEN lng_start AND lng_end AND status = 1';
